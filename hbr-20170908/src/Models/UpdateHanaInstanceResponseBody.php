...
class UpdateHanaInstanceResponseBody extends Model
{
    /**
     * @description The HTTP status code. The status code 200 indicates that the call was successful.
     *
     * @example 200
     *
     * @var string
     ...
     * @param array $map
     *
     * @return UpdateHanaInstanceResponseBody
     */
