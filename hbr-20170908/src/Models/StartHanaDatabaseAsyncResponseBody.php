...
class StartHanaDatabaseAsyncResponseBody extends Model
{
    /**
    ...
    /**
     * @description The ID of the job that is used to initialize the backup vault. You can call the DescribeTask operation to query the status of the job.
     *
     ...
     * @param array $map
     *
     * @return StartHanaDatabaseAsyncResponseBody
     */
