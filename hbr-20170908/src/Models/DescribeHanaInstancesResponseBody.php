...
use AlibabaCloud\SDK\Hbr\V20170908\Models\DescribeHanaInstancesResponseBody\hanas;
use AlibabaCloud\Tea\Model;

class DescribeHanaInstancesResponseBody extends Model
{
    /**
    ...
    public function toMap()
    {
        ...
        if (null !== $this->hanas) {
            $res['Hanas'] = null !== $this->hanas ? $this->hanas->toMap() : null;
        }
     ...
     * @param array $map
     *
     * @return DescribeHanaInstancesResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Hanas'])) {
            $model->hanas = hanas::fromMap($map['Hanas']);
        }
