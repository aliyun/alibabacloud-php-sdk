...
use AlibabaCloud\SDK\ComputeNestSupplier\V20210521\Models\ListArtifactBuildLogsResponseBody\buildLogs;

class ListArtifactBuildLogsResponseBody extends Model
{
    /**
     * @var buildLogs[]
     */
