...
class GetOpsNoticeResponseBody extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->serviceInstanceCount) {
            $res['ServiceInstanceCount'] = $this->serviceInstanceCount;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ServiceInstanceCount'])) {
            $model->serviceInstanceCount = $map['ServiceInstanceCount'];
        }
