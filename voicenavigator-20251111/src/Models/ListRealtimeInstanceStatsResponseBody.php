...
use AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\ListRealtimeInstanceStatsResponseBody\data;

class ListRealtimeInstanceStatsResponseBody extends Model
{
    /**
     * @var string
     */
