...
use AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\GetRealtimeInstanceStatsResponseBody\data;

class GetRealtimeInstanceStatsResponseBody extends Model
{
    /**
     * @var string
     */
