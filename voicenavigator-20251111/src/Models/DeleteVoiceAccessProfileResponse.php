...
class DeleteVoiceAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteVoiceAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteVoiceAccessProfileResponseBody::fromMap($map['body']);
        }
