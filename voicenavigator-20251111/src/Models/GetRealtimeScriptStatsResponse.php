...
class GetRealtimeScriptStatsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetRealtimeScriptStatsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetRealtimeScriptStatsResponseBody::fromMap($map['body']);
        }
