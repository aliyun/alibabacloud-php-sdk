...
use AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\ListHistoricalScriptReportResponseBody\data;

class ListHistoricalScriptReportResponseBody extends Model
{
    /**
     * @var string
     */
