...
class GetScriptTrendingReportResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetScriptTrendingReportResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetScriptTrendingReportResponseBody::fromMap($map['body']);
        }
