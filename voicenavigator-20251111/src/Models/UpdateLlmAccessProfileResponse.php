...
class UpdateLlmAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateLlmAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateLlmAccessProfileResponseBody::fromMap($map['body']);
        }
