...
class ListCallCenterProvidersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListCallCenterProvidersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListCallCenterProvidersResponseBody::fromMap($map['body']);
        }
