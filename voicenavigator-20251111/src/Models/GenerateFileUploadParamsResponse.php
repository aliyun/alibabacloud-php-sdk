...
class GenerateFileUploadParamsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GenerateFileUploadParamsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GenerateFileUploadParamsResponseBody::fromMap($map['body']);
        }
