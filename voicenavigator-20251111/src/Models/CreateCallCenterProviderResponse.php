...
class CreateCallCenterProviderResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateCallCenterProviderResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateCallCenterProviderResponseBody::fromMap($map['body']);
        }
