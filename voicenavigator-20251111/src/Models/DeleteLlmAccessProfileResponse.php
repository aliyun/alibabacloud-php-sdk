...
class DeleteLlmAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteLlmAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteLlmAccessProfileResponseBody::fromMap($map['body']);
        }
