...
class GetRealtimeInstanceStatsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetRealtimeInstanceStatsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetRealtimeInstanceStatsResponseBody::fromMap($map['body']);
        }
