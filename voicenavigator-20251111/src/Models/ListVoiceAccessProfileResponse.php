...
class ListVoiceAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListVoiceAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListVoiceAccessProfileResponseBody::fromMap($map['body']);
        }
