...
class UpdateVoiceAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateVoiceAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateVoiceAccessProfileResponseBody::fromMap($map['body']);
        }
