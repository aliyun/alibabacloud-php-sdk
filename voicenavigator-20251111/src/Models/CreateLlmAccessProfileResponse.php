...
class CreateLlmAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateLlmAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateLlmAccessProfileResponseBody::fromMap($map['body']);
        }
