...
class ListRealtimeInstanceStatsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListRealtimeInstanceStatsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListRealtimeInstanceStatsResponseBody::fromMap($map['body']);
        }
