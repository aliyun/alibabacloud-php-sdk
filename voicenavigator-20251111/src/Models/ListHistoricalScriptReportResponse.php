...
class ListHistoricalScriptReportResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListHistoricalScriptReportResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListHistoricalScriptReportResponseBody::fromMap($map['body']);
        }
