...
class GetDataChannelCredentialResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataChannelCredentialResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataChannelCredentialResponseBody::fromMap($map['body']);
        }
