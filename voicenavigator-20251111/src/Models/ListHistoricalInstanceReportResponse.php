...
class ListHistoricalInstanceReportResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListHistoricalInstanceReportResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListHistoricalInstanceReportResponseBody::fromMap($map['body']);
        }
