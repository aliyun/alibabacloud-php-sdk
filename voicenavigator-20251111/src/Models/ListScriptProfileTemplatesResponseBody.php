...
use AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\ListScriptProfileTemplatesResponseBody\data;

class ListScriptProfileTemplatesResponseBody extends Model
{
    /**
     * @var string
     */
