...
use AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\ListHistoricalInstanceReportResponseBody\data;

class ListHistoricalInstanceReportResponseBody extends Model
{
    /**
     * @var string
     */
