...
class CreateVoiceAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateVoiceAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateVoiceAccessProfileResponseBody::fromMap($map['body']);
        }
