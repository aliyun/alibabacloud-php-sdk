...
namespace AlibabaCloud\SDK\VoiceNavigator\V20251111\Models\ListHistoricalScriptReportResponseBody\data;
...
class list_ extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->labelDistribution) {
            $res['LabelDistribution'] = $this->labelDistribution;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['LabelDistribution'])) {
            $model->labelDistribution = $map['LabelDistribution'];
        }
