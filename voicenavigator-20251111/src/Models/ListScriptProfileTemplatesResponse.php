...
class ListScriptProfileTemplatesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListScriptProfileTemplatesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListScriptProfileTemplatesResponseBody::fromMap($map['body']);
        }
