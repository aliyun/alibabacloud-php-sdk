...
class GetWorkloadAccessTokenForUserIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetWorkloadAccessTokenForUserIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetWorkloadAccessTokenForUserIdResponseBody::fromMap($map['body']);
        }
