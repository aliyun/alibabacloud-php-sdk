...
class GetWorkloadAccessTokenForJWTResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetWorkloadAccessTokenForJWTResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetWorkloadAccessTokenForJWTResponseBody::fromMap($map['body']);
        }
