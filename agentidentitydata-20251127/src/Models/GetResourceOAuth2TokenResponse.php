...
class GetResourceOAuth2TokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetResourceOAuth2TokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetResourceOAuth2TokenResponseBody::fromMap($map['body']);
        }
