...
class GetWorkloadAccessTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetWorkloadAccessTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetWorkloadAccessTokenResponseBody::fromMap($map['body']);
        }
