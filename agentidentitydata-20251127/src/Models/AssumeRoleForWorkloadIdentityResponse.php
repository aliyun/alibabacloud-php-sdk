...
class AssumeRoleForWorkloadIdentityResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AssumeRoleForWorkloadIdentityResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AssumeRoleForWorkloadIdentityResponseBody::fromMap($map['body']);
        }
