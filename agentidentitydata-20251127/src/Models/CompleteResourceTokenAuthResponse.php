...
class CompleteResourceTokenAuthResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CompleteResourceTokenAuthResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CompleteResourceTokenAuthResponseBody::fromMap($map['body']);
        }
