...
namespace AlibabaCloud\SDK\Edas\V20170405;

use AlibabaCloud\Endpoint\Endpoint;
use AlibabaCloud\OpenApiUtil\OpenApiUtilClient;
use AlibabaCloud\SDK\Edas\V20170405\Models\EdasProduceRequest;
use AlibabaCloud\SDK\Edas\V20170405\Models\EdasProduceResponse;
...
class Edas extends OpenApiClient
{
    ...
    /**
     * @param EdasProduceRequest $request
     * @param RuntimeOptions     $runtime
     *
     * @return EdasProduceResponse
     */
    public function edasProduceWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->sourceFlag)) {
        ...
        return EdasProduceResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return EdasProduceResponse
     */
    public function edasProduce($request)
    {
        $runtime = new RuntimeOptions([]);

        return $this->edasProduceWithOptions($request, $runtime);
    }
}
