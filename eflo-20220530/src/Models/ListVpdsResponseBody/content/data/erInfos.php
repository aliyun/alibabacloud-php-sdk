...
namespace AlibabaCloud\SDK\Eflo\V20220530\Models\ListVpdsResponseBody\content\data;
...
class erInfos extends Model
{
    ...
    /**
     * @description The name of the Lingjun HUB(ER) instance.
     *
     * @example er-1
     *
     * @var string
