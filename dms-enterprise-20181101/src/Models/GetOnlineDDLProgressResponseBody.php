...
class GetOnlineDDLProgressResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->onlineDDLTaskDetail) {
            $this->onlineDDLTaskDetail->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->onlineDDLTaskDetail) {
            $res['OnlineDDLTaskDetail'] = null !== $this->onlineDDLTaskDetail ? $this->onlineDDLTaskDetail->toArray($noStream) : $this->onlineDDLTaskDetail;
        }
