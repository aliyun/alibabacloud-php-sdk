...
class GetUserUploadFileJobResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->uploadFileJobDetail) {
            $this->uploadFileJobDetail->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->uploadFileJobDetail) {
            $res['UploadFileJobDetail'] = null !== $this->uploadFileJobDetail ? $this->uploadFileJobDetail->toArray($noStream) : $this->uploadFileJobDetail;
        }
