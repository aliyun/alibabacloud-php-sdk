...
class ListSQLExecAuditLogResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->SQLExecAuditLogList) {
            $this->SQLExecAuditLogList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->SQLExecAuditLogList) {
            $res['SQLExecAuditLogList'] = null !== $this->SQLExecAuditLogList ? $this->SQLExecAuditLogList->toArray($noStream) : $this->SQLExecAuditLogList;
        }
