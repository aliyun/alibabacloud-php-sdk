...
class GetDataExportOrderDetailResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->dataExportOrderDetail) {
            $this->dataExportOrderDetail->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->dataExportOrderDetail) {
            $res['DataExportOrderDetail'] = null !== $this->dataExportOrderDetail ? $this->dataExportOrderDetail->toArray($noStream) : $this->dataExportOrderDetail;
        }
