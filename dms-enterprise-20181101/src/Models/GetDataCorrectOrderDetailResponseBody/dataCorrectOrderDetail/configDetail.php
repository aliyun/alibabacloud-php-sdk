...
class configDetail extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->cronExtConfig) {
            $this->cronExtConfig->validate();
        }
        if (null !== $this->importExtConfig) {
            $this->importExtConfig->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->cronExtConfig) {
            $res['CronExtConfig'] = null !== $this->cronExtConfig ? $this->cronExtConfig->toArray($noStream) : $this->cronExtConfig;
        }
        ...
        if (null !== $this->importExtConfig) {
            $res['ImportExtConfig'] = null !== $this->importExtConfig ? $this->importExtConfig->toArray($noStream) : $this->importExtConfig;
        }
