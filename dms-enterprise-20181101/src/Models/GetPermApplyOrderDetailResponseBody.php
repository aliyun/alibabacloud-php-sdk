...
class GetPermApplyOrderDetailResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->permApplyOrderDetail) {
            $this->permApplyOrderDetail->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->permApplyOrderDetail) {
            $res['PermApplyOrderDetail'] = null !== $this->permApplyOrderDetail ? $this->permApplyOrderDetail->toArray($noStream) : $this->permApplyOrderDetail;
        }
