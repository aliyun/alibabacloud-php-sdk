...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeDecisionResultTrendResponseBody\resultObject;

class DescribeDecisionResultTrendResponseBody extends Model
{
    /**
     * @var string
     */
