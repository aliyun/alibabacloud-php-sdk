...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeOperationLogMonitoringResponseBody\resultObject;

class DescribeOperationLogMonitoringResponseBody extends Model
{
    /**
     * @var string
     */
