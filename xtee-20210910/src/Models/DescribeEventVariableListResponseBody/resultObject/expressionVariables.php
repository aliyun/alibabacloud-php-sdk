...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeEventVariableListResponseBody\resultObject\expressionVariables\outputThreshold;
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeEventVariableListResponseBody\resultObject\expressionVariables\variableVelocity;

class expressionVariables extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        if (null !== $this->variableVelocity) {
            $this->variableVelocity->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->variableVelocity) {
            $res['variableVelocity'] = null !== $this->variableVelocity ? $this->variableVelocity->toArray($noStream) : $this->variableVelocity;
        }
