...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeRiskTagsLineChartResponseBody\resultObject;

class DescribeRiskTagsLineChartResponseBody extends Model
{
    /**
     * @var string
     */
