...
class baseInfo extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->sceneDesc)) {
            Model::validateArray($this->sceneDesc);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->sceneDesc) {
            if (\is_array($this->sceneDesc)) {
                $res['sceneDesc'] = [];
                $n1 = 0;
                foreach ($this->sceneDesc as $item1) {
                    $res['sceneDesc'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['sceneDesc'])) {
            if (!empty($map['sceneDesc'])) {
                $model->sceneDesc = [];
                $n1 = 0;
                foreach ($map['sceneDesc'] as $item1) {
                    $model->sceneDesc[$n1] = $item1;
                    ++$n1;
                }
            }
        }
