...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeSampleDataByBatchUUidPageResponseBody\resultObject;

class DescribeSampleDataByBatchUUidPageResponseBody extends Model
{
    /**
     * @var string
     */
