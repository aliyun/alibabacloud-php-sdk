...
use AlibabaCloud\SDK\Xtee\V20210910\Models\DescribeVariableVersionDetailResponseBody\resultObject;

class DescribeVariableVersionDetailResponseBody extends Model
{
    /**
     * @var string
     */
