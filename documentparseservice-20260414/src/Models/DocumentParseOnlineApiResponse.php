...
class DocumentParseOnlineApiResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DocumentParseOnlineApiResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DocumentParseOnlineApiResponseBody::fromMap($map['body']);
        }
