...
class DashboardCheckServiceStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DashboardCheckServiceStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DashboardCheckServiceStatusResponseBody::fromMap($map['body']);
        }
