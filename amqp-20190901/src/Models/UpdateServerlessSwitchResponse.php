...
class UpdateServerlessSwitchResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateServerlessSwitchResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateServerlessSwitchResponseBody::fromMap($map['body']);
        }
