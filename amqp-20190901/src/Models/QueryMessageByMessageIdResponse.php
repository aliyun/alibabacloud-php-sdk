...
class QueryMessageByMessageIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryMessageByMessageIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryMessageByMessageIdResponseBody::fromMap($map['body']);
        }
