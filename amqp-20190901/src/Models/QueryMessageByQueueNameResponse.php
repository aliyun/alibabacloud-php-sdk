...
class QueryMessageByQueueNameResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryMessageByQueueNameResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryMessageByQueueNameResponseBody::fromMap($map['body']);
        }
