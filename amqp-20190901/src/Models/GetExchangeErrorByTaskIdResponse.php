...
class GetExchangeErrorByTaskIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetExchangeErrorByTaskIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetExchangeErrorByTaskIdResponseBody::fromMap($map['body']);
        }
