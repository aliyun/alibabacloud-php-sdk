...
class GetBindingErrorByTaskIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetBindingErrorByTaskIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetBindingErrorByTaskIdResponseBody::fromMap($map['body']);
        }
