...
class UpdateInstanceRetryStrategyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateInstanceRetryStrategyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateInstanceRetryStrategyResponseBody::fromMap($map['body']);
        }
