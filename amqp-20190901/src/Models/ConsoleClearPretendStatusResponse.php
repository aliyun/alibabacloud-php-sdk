...
class ConsoleClearPretendStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ConsoleClearPretendStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ConsoleClearPretendStatusResponseBody::fromMap($map['body']);
        }
