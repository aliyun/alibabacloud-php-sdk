...
class ConsoleSavePretendStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ConsoleSavePretendStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ConsoleSavePretendStatusResponseBody::fromMap($map['body']);
        }
