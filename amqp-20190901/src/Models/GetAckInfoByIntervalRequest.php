...
class GetAckInfoByIntervalRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->intervalSec) {
            $res['IntervalSec'] = $this->intervalSec;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IntervalSec'])) {
            $model->intervalSec = $map['IntervalSec'];
        }
