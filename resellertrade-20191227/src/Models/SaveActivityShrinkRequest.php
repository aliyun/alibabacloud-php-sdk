...
use AlibabaCloud\SDK\ResellerTrade\V20191227\Models\SaveActivityShrinkRequest\fusionPromotionParamList;
use AlibabaCloud\Tea\Model;

class SaveActivityShrinkRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return SaveActivityShrinkRequest
     */
