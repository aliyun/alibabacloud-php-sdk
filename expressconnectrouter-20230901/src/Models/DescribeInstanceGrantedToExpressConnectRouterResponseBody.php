...
class DescribeInstanceGrantedToExpressConnectRouterResponseBody extends Model
{
    ...
    /**
     * @description The network instances whose permissions are granted to the ECR.
     *
    ...
    /**
     * @description The total number of network instances whose permissions are granted to the ECR.
     *
     * @example 10
     *
     * @var int
