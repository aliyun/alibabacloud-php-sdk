...
class DescribeExpressConnectRouterRegionResponseBody extends Model
{
    /**
    ...
    /**
     * @description The region in which the ECR feature is activated.
     *
     * @var string[]
     */
    public $regionIdList;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->regionIdList) {
            $res['RegionIdList'] = $this->regionIdList;
        }
     ...
     * @param array $map
     *
     * @return DescribeExpressConnectRouterRegionResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['RegionIdList'])) {
            if (!empty($map['RegionIdList'])) {
                $model->regionIdList = $map['RegionIdList'];
            }
        }
