...
class DescribeExpressConnectRouterResponseBody extends Model
{
    ...
    /**
     * @description The total number of ECRs.
     *
     * @example 2
     *
     * @var int
    ...
    public function toMap()
    {
        ...
        if (null !== $this->ecrList) {
            $res['EcrList'] = [];
            if (null !== $this->ecrList && \is_array($this->ecrList)) {
                $n = 0;
                foreach ($this->ecrList as $item) {
                    $res['EcrList'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return DescribeExpressConnectRouterResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['EcrList'])) {
            if (!empty($map['EcrList'])) {
                $model->ecrList = [];
                $n = 0;
                foreach ($map['EcrList'] as $item) {
                    $model->ecrList[$n++] = null !== $item ? ecrList::fromMap($item) : $item;
                }
            }
        }
