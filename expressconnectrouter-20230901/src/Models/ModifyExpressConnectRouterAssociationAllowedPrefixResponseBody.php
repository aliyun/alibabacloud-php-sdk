...
class ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return ModifyExpressConnectRouterAssociationAllowedPrefixResponseBody
     */
