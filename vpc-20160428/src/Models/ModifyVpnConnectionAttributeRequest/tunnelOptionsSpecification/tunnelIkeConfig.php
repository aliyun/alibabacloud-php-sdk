...
class tunnelIkeConfig extends Model
{
    ...
    /**
     * @description The identifier of the tunnel on the Alibaba Cloud side, which is used in Phase 1 negotiations. The identifier can be up to 100 characters in length. The default identifier is the tunnel IP address.
     *
    ...
    /**
     * @description The identifier of the tunnel peer, which is used in Phase 1 negotiations. The identifier can be up to 100 characters in length. The default identifier is the IP address of the customer gateway.
     *
