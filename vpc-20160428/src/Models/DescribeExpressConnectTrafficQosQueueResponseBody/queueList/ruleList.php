...
class ruleList extends Model
{
     ...
     *
     * @example qos-91xz9f8zd7yj8xwknz
     *
     * @var string
     */
    public $qosId;
     ...
     *
     * @example qos-queue-iugg0l9x27f2nocouj
     *
     * @var string
     */
    public $queueId;
    ...
    /**
     * @description The new DSCP value. Valid values: **0** to **63**. If you do not change the value, the value is -1.
     *
     * @example 1
     *
     * @var int
