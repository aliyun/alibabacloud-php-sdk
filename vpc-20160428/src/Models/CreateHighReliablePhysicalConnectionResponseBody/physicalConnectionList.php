...
{
    /**
     * @var physicalConnectionList\physicalConnectionList[]
     */
        ...
        if (isset($map['physicalConnectionList'])) {
            if (!empty($map['physicalConnectionList'])) {
                ...
                foreach ($map['physicalConnectionList'] as $item) {
                    $model->physicalConnectionList[$n++] = null !== $item ? physicalConnectionList\physicalConnectionList::fromMap($item) : $item;
                }
            }
        }
