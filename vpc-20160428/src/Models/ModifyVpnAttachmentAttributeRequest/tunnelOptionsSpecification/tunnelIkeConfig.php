...
{
    /**
     * @description The authentication algorithm that is used in Phase 1 negotiations. Valid values: **md5**, **sha1**, **sha256**, **sha384**, and **sha512**.
     *
     * @example sha1
     *
     * @var string
    ...
    /**
     * @description The encryption algorithm that is used in Phase 1 negotiations. Valid values: **aes**, **aes192**, **aes256**, **des**, and **3des**.
     *
     * @example aes
     *
     * @var string
    ...
    /**
     * @description The negotiation mode of IKE. Valid values: **main** and **aggressive**.
     *
    ...
    /**
     * @description The identifier of the tunnel on the Alibaba Cloud side, which is used in Phase 1 negotiations. The identifier cannot exceed 100 characters in length and cannot contain spaces.
     *
    ...
    /**
     * @description The identifier of the tunnel peer, which is used in Phase 1 negotiations. The identifier cannot exceed 100 characters in length and cannot contain spaces.
     *
