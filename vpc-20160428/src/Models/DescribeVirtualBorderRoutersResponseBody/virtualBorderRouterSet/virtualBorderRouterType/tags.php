        ...
        if (isset($map['Tags'])) {
            if (!empty($map['Tags'])) {
                ...
                foreach ($map['Tags'] as $item1) {
                    $model->tags[$n1++] = \AlibabaCloud\SDK\Vpc\V20160428\Models\DescribeVirtualBorderRoutersResponseBody\virtualBorderRouterSet\virtualBorderRouterType\tags\tags::fromMap($item1);
                }
            }
        }
