        ...
        if (isset($map['tags'])) {
            if (!empty($map['tags'])) {
                ...
                foreach ($map['tags'] as $item1) {
                    $model->tags[$n1++] = \AlibabaCloud\SDK\Vpc\V20160428\Models\DescribePhysicalConnectionsResponseBody\physicalConnectionSet\physicalConnectionType\tags\tags::fromMap($item1);
                }
            }
        }
