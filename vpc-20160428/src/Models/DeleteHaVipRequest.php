...
class DeleteHaVipRequest extends Model
{
    ...
    /**
     * @description The region where the HaVip resides. Call the [DescribeRegions](https://help.aliyun.com/document_detail/36063.html) operation to query the region list.
     *
     * This parameter is required.
     *
     * @example cn-shanghai
