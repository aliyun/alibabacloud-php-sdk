...
class crossAccountAuthorizations extends Model
{
    ...
    /**
     * @description The type of resource that can be associated with the IPsec-VPN connection.
     *
    ...
    /**
     * @description The ID of the Alibaba Cloud account whose resources the IPsec-VPN connection is authorized to be associated with.
     *
    ...
    /**
     * @description The time when the authorization for the IPsec-VPN connection was created.
     *
