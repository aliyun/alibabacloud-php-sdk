...
class ipv6Translator extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->ipv6TranslatorEntryIds) {
            $this->ipv6TranslatorEntryIds->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->ipv6TranslatorEntryIds) {
            $res['Ipv6TranslatorEntryIds'] = null !== $this->ipv6TranslatorEntryIds ? $this->ipv6TranslatorEntryIds->toArray($noStream) : $this->ipv6TranslatorEntryIds;
        }
