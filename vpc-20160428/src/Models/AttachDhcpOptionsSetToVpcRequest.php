...
class AttachDhcpOptionsSetToVpcRequest extends Model
{
    /**
    ...
    /**
     * @description The ID of the VPC to be associated with the DHCP options set.
     *
     ...
     * @param array $map
     *
     * @return AttachDhcpOptionsSetToVpcRequest
     */
