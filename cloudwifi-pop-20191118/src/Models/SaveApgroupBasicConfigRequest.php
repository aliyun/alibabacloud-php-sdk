...
class SaveApgroupBasicConfigRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @var bool
     */
    public $isConfigStrongConsistency;
    ...
    protected $_name = [
        ...
        'isConfigStrongConsistency' => 'IsConfigStrongConsistency',
        'lanIp' => 'LanIp',
        'lanMask' => 'LanMask',
        'lanStatus' => 'LanStatus',
        'logIp' => 'LogIp',
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->isConfigStrongConsistency) {
            $res['IsConfigStrongConsistency'] = $this->isConfigStrongConsistency;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IsConfigStrongConsistency'])) {
            $model->isConfigStrongConsistency = $map['IsConfigStrongConsistency'];
        }
