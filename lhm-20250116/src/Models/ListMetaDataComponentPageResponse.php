...
class ListMetaDataComponentPageResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMetaDataComponentPageResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMetaDataComponentPageResponseBody::fromMap($map['body']);
        }
