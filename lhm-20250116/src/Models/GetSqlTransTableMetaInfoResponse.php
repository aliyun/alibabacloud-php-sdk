...
class GetSqlTransTableMetaInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSqlTransTableMetaInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSqlTransTableMetaInfoResponseBody::fromMap($map['body']);
        }
