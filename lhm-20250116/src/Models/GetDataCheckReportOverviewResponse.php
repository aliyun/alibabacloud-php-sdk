...
class GetDataCheckReportOverviewResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataCheckReportOverviewResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataCheckReportOverviewResponseBody::fromMap($map['body']);
        }
