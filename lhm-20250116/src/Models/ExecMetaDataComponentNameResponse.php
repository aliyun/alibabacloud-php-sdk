...
class ExecMetaDataComponentNameResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ExecMetaDataComponentNameResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ExecMetaDataComponentNameResponseBody::fromMap($map['body']);
        }
