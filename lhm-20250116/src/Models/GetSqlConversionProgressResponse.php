...
class GetSqlConversionProgressResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSqlConversionProgressResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSqlConversionProgressResponseBody::fromMap($map['body']);
        }
