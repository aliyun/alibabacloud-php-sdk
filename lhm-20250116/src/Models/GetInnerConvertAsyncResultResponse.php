...
class GetInnerConvertAsyncResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetInnerConvertAsyncResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetInnerConvertAsyncResultResponseBody::fromMap($map['body']);
        }
