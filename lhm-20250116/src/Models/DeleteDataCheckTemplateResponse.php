...
class DeleteDataCheckTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteDataCheckTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteDataCheckTemplateResponseBody::fromMap($map['body']);
        }
