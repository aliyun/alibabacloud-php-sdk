...
class ExecDataCheckSqlPreviewResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ExecDataCheckSqlPreviewResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ExecDataCheckSqlPreviewResponseBody::fromMap($map['body']);
        }
