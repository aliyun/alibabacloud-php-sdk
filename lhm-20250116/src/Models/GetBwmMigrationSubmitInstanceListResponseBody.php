...
use AlibabaCloud\SDK\LHM\V20250116\Models\GetBwmMigrationSubmitInstanceListResponseBody\data;

class GetBwmMigrationSubmitInstanceListResponseBody extends Model
{
    /**
     * @var data[]
     */
