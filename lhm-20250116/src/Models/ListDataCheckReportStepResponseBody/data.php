...
namespace AlibabaCloud\SDK\LHM\V20250116\Models\ListDataCheckReportStepResponseBody;
...
class data extends Model
{
    ...
    {
        if (\is_array($this->signNameList)) {
            Model::validateArray($this->signNameList);
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->signNameList) {
            if (\is_array($this->signNameList)) {
                $res['signNameList'] = [];
                $n1 = 0;
                foreach ($this->signNameList as $item1) {
                    $res['signNameList'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['signNameList'])) {
            if (!empty($map['signNameList'])) {
                $model->signNameList = [];
                $n1 = 0;
                foreach ($map['signNameList'] as $item1) {
                    $model->signNameList[$n1] = $item1;
                    ++$n1;
                }
            }
        }
