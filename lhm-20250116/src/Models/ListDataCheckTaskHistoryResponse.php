...
class ListDataCheckTaskHistoryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDataCheckTaskHistoryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDataCheckTaskHistoryResponseBody::fromMap($map['body']);
        }
