...
class GetInnerReadAsyncResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetInnerReadAsyncResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetInnerReadAsyncResultResponseBody::fromMap($map['body']);
        }
