...
class UpdateDataCheckTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateDataCheckTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateDataCheckTemplateResponseBody::fromMap($map['body']);
        }
