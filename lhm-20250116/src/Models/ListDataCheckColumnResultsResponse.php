...
class ListDataCheckColumnResultsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDataCheckColumnResultsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDataCheckColumnResultsResponseBody::fromMap($map['body']);
        }
