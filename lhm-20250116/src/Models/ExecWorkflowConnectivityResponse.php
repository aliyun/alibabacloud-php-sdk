...
class ExecWorkflowConnectivityResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ExecWorkflowConnectivityResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ExecWorkflowConnectivityResponseBody::fromMap($map['body']);
        }
