...
class GetSqlConversionResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSqlConversionResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSqlConversionResultResponseBody::fromMap($map['body']);
        }
