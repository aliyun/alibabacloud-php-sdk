...
class ExecDataCheckRunFailedResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ExecDataCheckRunFailedResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ExecDataCheckRunFailedResponseBody::fromMap($map['body']);
        }
