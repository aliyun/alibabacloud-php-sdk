...
class GetDataCheckTaskConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataCheckTaskConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataCheckTaskConfigResponseBody::fromMap($map['body']);
        }
