...
class ListDataCheckReportStepResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDataCheckReportStepResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDataCheckReportStepResponseBody::fromMap($map['body']);
        }
