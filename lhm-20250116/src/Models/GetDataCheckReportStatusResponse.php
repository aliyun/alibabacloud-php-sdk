...
class GetDataCheckReportStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataCheckReportStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataCheckReportStatusResponseBody::fromMap($map['body']);
        }
