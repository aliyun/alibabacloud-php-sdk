...
class CreateExecuteSqlConversionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateExecuteSqlConversionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateExecuteSqlConversionResponseBody::fromMap($map['body']);
        }
