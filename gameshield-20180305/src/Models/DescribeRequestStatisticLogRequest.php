...
class DescribeRequestStatisticLogRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @var int
     */
    public $escapedLessThan;

    /**
     * @var int
     */
    public $escapedGreaterThan;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->escapedLessThan) {
            $res['EscapedLessThan'] = $this->escapedLessThan;
        }
        if (null !== $this->escapedGreaterThan) {
            $res['EscapedGreaterThan'] = $this->escapedGreaterThan;
        }
     ...
     * @param array $map
     *
     * @return DescribeRequestStatisticLogRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['EscapedLessThan'])) {
            $model->escapedLessThan = $map['EscapedLessThan'];
        }
        if (isset($map['EscapedGreaterThan'])) {
            $model->escapedGreaterThan = $map['EscapedGreaterThan'];
        }
