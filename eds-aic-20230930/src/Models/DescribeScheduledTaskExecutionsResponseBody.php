...
use AlibabaCloud\SDK\Edsaic\V20230930\Models\DescribeScheduledTaskExecutionsResponseBody\executions;

class DescribeScheduledTaskExecutionsResponseBody extends Model
{
    /**
     * @var string
     */
