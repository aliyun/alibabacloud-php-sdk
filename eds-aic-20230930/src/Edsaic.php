...
class Edsaic extends OpenApiClient
{
    ...
    /**
     * Create files for data backup.
     *
     * @remarks
     * Currently, only supports saving backup files generated by cloud phones in OSS (Object Storage Service).
     *
    ...
    /**
     * Creates Android instance groups.
     *
     * @remarks
     * <props="china">Before creating a cloud phone instance group, you need to complete real-name authentication. For more details, see [Personal Real-Name Authentication](https://help.aliyun.com/document_detail/48263.html).
     * When creating a cloud phone instance group, please note that creating an instance group involves resource billing. It is recommended that you understand the [Billing Method](https://help.aliyun.com/document_detail/2807121.html) of the cloud phone instance group in advance.
     *   - If the billing method for the instance group is Subscription (PrePaid), the default value of AutoPay (automatic payment) is false. After calling the interface, you need to go to <props="china">[Alibaba Cloud Costs and Billing](https://usercenter2.aliyun.com/order/list)<props="intl">[Alibaba Cloud Costs and Billing](https://usercenter2-intl.aliyun.com/order/list) to manually pay the order.
     *  - If you need automatic payment, set the value of AutoPay to true.
     *
     ...
     * @remarks
     * ### Preparation
     * Please log in to the [Elastic Desktop Service (EDS) Enterprise Edition Console](https://eds.console.aliyun.com/osshelp), and follow the instructions on the page to upload your application files to the EDS App Center, so as to obtain the required request parameters for this API (`FileName`+`FilePath` or `OssAppUrl`).
     *
     ...
     *
     * @remarks
     * In addition to creating a key pair by calling CreateKeyPair, you can also create a key pair using the ADB tool and then upload it (ImportKeyPair) to the Cloud Phone console. The usage is the same as for key pairs created by the system.
     * Each tenant can have up to 500 key pairs.
     *
    ...
    /**
     * Create a policy for the instance group.
     *
    ...
    /**
     * Delete Android Instance Group.
     *
     * @remarks
     * Pay-as-you-go instance groups can be deleted directly;
     * Subscription instance groups can only be deleted after they have expired, meaning that only \\"Expired\\" subscription instance groups are eligible for deletion.
     *
     ...
     *
     * @remarks
     * Images in use by an instance group cannot be deleted.
     *
     ...
     *
     * @remarks
     * - If a cloud phone instance is already bound to this ADB key pair, the key pair cannot be deleted.
     * - After deleting the ADB key pair, it cannot be queried using DescribeKeyPairs.
     *
    ...
    /**
     * Queries the information about instance groups.
     *
    ...
    /**
     * Query the list of Android instances.
     *
     ...
     *
     * @remarks
     * Currently, only backup files generated by cloud phones and stored in OSS (Object Storage Service) are supported.
     *
    ...
    /**
     * Modify Android Instance Information.
     *
    ...
    /**
     * Modifies the name of a key pair.
     *
    ...
    /**
     * Android Instance Group Scaling Up.
     *
     * @remarks
     * Currently, only supports increasing the number of instances in the instance group, i.e., scaling up the instance group.
     *
