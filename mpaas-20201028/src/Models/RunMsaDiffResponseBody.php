...
use AlibabaCloud\SDK\MPaaS\V20201028\Models\RunMsaDiffResponseBody\resultContent;
use AlibabaCloud\Tea\Model;

class RunMsaDiffResponseBody extends Model
{
    /**
     * @var string
     */
