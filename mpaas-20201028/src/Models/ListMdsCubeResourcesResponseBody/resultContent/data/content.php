...
namespace AlibabaCloud\SDK\MPaaS\V20201028\Models\ListMdsCubeResourcesResponseBody\resultContent\data;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\ListMdsCubeResourcesResponseBody\resultContent\data\content\list_;
...
class content extends Model
{
     ...
     * @var string
     */
    public $currentMaxAndroidVersion;

    /**
     * @var string
     */
    public $currentMaxIosVersion;
    ...
    {
        $res = [];
        if (null !== $this->currentMaxAndroidVersion) {
            $res['CurrentMaxAndroidVersion'] = $this->currentMaxAndroidVersion;
        }

        if (null !== $this->currentMaxIosVersion) {
            $res['CurrentMaxIosVersion'] = $this->currentMaxIosVersion;
        }
    ...
    {
        $model = new self();
        if (isset($map['CurrentMaxAndroidVersion'])) {
            $model->currentMaxAndroidVersion = $map['CurrentMaxAndroidVersion'];
        }

        if (isset($map['CurrentMaxIosVersion'])) {
            $model->currentMaxIosVersion = $map['CurrentMaxIosVersion'];
        }
