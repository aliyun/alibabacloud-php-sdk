...
class ExportMappCenterAppConfigResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->exportMappCenterAppConfigResult) {
            $this->exportMappCenterAppConfigResult->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->exportMappCenterAppConfigResult) {
            $res['ExportMappCenterAppConfigResult'] = null !== $this->exportMappCenterAppConfigResult ? $this->exportMappCenterAppConfigResult->toArray($noStream) : $this->exportMappCenterAppConfigResult;
        }
