...
use AlibabaCloud\SDK\MPaaS\V20201028\Models\ListMgsApiResponseBody\resultContent;
use AlibabaCloud\Tea\Model;

class ListMgsApiResponseBody extends Model
{
    /**
     * @var string
     */
