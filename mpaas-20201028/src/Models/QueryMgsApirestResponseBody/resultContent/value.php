...
namespace AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\apiInvoker;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\cacheRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\circuitBreakerRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\defaultLimitRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\headerRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\headerRules;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\limitRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\migrateRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\mockRule;
use AlibabaCloud\SDK\MPaaS\V20201028\Models\QueryMgsApirestResponseBody\resultContent\value\requestParams;
...
class value extends Model
{
    ...
    /**
     * @var defaultLimitRule
     */
    public $defaultLimitRule;
    ...
    public function validate()
    {
        ...
        if (null !== $this->defaultLimitRule) {
            $this->defaultLimitRule->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->defaultLimitRule) {
            $res['DefaultLimitRule'] = null !== $this->defaultLimitRule ? $this->defaultLimitRule->toArray($noStream) : $this->defaultLimitRule;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DefaultLimitRule'])) {
            $model->defaultLimitRule = defaultLimitRule::fromMap($map['DefaultLimitRule']);
        }
