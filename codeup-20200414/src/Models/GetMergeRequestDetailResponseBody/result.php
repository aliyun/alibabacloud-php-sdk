...
namespace AlibabaCloud\SDK\Codeup\V20200414\Models\GetMergeRequestDetailResponseBody;

use AlibabaCloud\SDK\Codeup\V20200414\Models\GetMergeRequestDetailResponseBody\result\approveCheckResult;
use AlibabaCloud\SDK\Codeup\V20200414\Models\GetMergeRequestDetailResponseBody\result\assigneeList;
use AlibabaCloud\SDK\Codeup\V20200414\Models\GetMergeRequestDetailResponseBody\result\author;
...
class result extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->isSupportMerge) {
            $res['IsSupportMerge'] = $this->isSupportMerge;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IsSupportMerge'])) {
            $model->isSupportMerge = $map['IsSupportMerge'];
        }
