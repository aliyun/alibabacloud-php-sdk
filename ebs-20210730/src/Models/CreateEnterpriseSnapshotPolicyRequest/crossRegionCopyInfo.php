...
use AlibabaCloud\SDK\Ebs\V20210730\Models\CreateEnterpriseSnapshotPolicyRequest\crossRegionCopyInfo\regions;
...
class crossRegionCopyInfo extends Model
{
    ...
    /**
     * @description The list of destination regions.
     *
     * @var regions[]
     */
    public $regions;
