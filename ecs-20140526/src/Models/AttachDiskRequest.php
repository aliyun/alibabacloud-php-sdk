...
{
    /**
     * @description Specifies whether to attach the cloud disk as a system disk.
     *
    ...
    /**
     * @description The ID of the cloud disk that you want to attach. The cloud disk specified by the `DiskId` parameter and the instance specified by the `InstanceId` parameter must reside in the same zone.
     *
