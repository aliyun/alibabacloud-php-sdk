...
class permissions extends Model
{
    ...
    /**
     * @description The Alibaba Cloud account that manages the source security group when you set security group rule N across accounts.
     *
    ...
    /**
     * @description The ID of the source prefix list to be referenced in security group rule N. You can call the [DescribePrefixLists](~~205046~~) operation to query the IDs of available prefix lists.
     *
     * Take note of the following items:
     *
