...
{
    /**
     * @description The key of tag N to add to the snapshot. Valid values of N: 1 to 20.
     *
    ...
    /**
     * @description The value of tag N to add to the snapshot. Valid values of N: 1 to 20.
     *
     * @example TestValue
     *
     * @var string
