...
class dedicatedHostType extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('supportCpuOverCommitRatio', $this->supportCpuOverCommitRatio, true);
        Model::validateRequired('cpuOverCommitRatioRange', $this->cpuOverCommitRatioRange, true);
