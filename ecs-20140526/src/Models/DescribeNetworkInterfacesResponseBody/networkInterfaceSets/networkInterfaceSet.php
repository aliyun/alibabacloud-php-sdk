...
class networkInterfaceSet extends Model
{
    ...
    /**
     * @description Indicates whether the source and destination IP address check feature is enabled. To improve network security, enable this feature. Valid values:
     *
     *   true
     *   false
     *
