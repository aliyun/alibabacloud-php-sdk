...
class DescribeInstanceHistoryEventsResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->instanceSystemEventSet) {
            $this->instanceSystemEventSet->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->instanceSystemEventSet) {
            $res['InstanceSystemEventSet'] = null !== $this->instanceSystemEventSet ? $this->instanceSystemEventSet->toArray($noStream) : $this->instanceSystemEventSet;
        }
