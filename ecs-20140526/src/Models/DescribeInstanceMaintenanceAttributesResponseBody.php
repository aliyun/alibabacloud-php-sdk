...
class DescribeInstanceMaintenanceAttributesResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->maintenanceAttributes) {
            $this->maintenanceAttributes->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->maintenanceAttributes) {
            $res['MaintenanceAttributes'] = null !== $this->maintenanceAttributes ? $this->maintenanceAttributes->toArray($noStream) : $this->maintenanceAttributes;
        }
