...
class DescribeForwardTableEntriesResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->forwardTableEntries) {
            $this->forwardTableEntries->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->forwardTableEntries) {
            $res['ForwardTableEntries'] = null !== $this->forwardTableEntries ? $this->forwardTableEntries->toArray($noStream) : $this->forwardTableEntries;
        }
