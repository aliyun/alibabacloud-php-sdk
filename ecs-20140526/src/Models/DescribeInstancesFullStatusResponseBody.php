...
class DescribeInstancesFullStatusResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->instanceFullStatusSet) {
            $this->instanceFullStatusSet->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->instanceFullStatusSet) {
            $res['InstanceFullStatusSet'] = null !== $this->instanceFullStatusSet ? $this->instanceFullStatusSet->toArray($noStream) : $this->instanceFullStatusSet;
        }
