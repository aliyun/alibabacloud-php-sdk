...
class launchTemplateConfig extends Model
{
    ...
    /**
     * @description The numbers of vCPUs of instance types.
     *
     * @var int[]
     */
    public $cores;
    ...
    /**
     * @description The instance family level of the instance type in extended configuration N. This parameter is used to filter instance types. Valid values of Nextended configuration N, Valid values:
     *
    ...
    /**
     * @description The instance type in extended configuration N. Valid values of N: 1 to 20. For information about the valid values of this parameter, see [Overview of instance families](https://help.aliyun.com/document_detail/25378.html).
     *
    ...
    /**
     * @description The maximum price of spot instances in extended configuration N.
     *
    ...
    /**
     * @description The memory sizes of instance types.
     *
     * @var float[]
     */
    public $memories;
