...
class DescribeCloudAssistantStatusResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->instanceCloudAssistantStatusSet) {
            $this->instanceCloudAssistantStatusSet->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->instanceCloudAssistantStatusSet) {
            $res['InstanceCloudAssistantStatusSet'] = null !== $this->instanceCloudAssistantStatusSet ? $this->instanceCloudAssistantStatusSet->toArray($noStream) : $this->instanceCloudAssistantStatusSet;
        }
