...
use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribePlanMaintenanceWindowsRequest\targetResourceTags;

class DescribePlanMaintenanceWindowsRequest extends Model
{
    /**
     * @var bool
     */
    ...
    /**
     * @var targetResourceTags
     */
    public $targetResourceTags;
    protected $_name = [
        'enable' => 'Enable',
    ...
    public function validate()
    {
        if (null !== $this->targetResourceTags) {
            $this->targetResourceTags->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->targetResourceTags) {
            $res['TargetResourceTags'] = null !== $this->targetResourceTags ? $this->targetResourceTags->toArray($noStream) : $this->targetResourceTags;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TargetResourceTags'])) {
            $model->targetResourceTags = targetResourceTags::fromMap($map['TargetResourceTags']);
        }
