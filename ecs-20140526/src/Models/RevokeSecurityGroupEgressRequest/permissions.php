...
class permissions extends Model
{
    ...
    /**
     * @description The ID of the destination security group of the security group rule.
     *
    ...
    /**
     * @description The protocol type. The values of this parameter are case-insensitive. Valid values:
     *
     *   TCP.
     *   UDP.
     *   ICMP.
