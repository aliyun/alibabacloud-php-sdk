...
class RunCommandRequest extends Model
{
    ...
    /**
     * @description The container ID. Only 64-bit hexadecimal strings are supported. `docker://`, `containerd://`, or `cri-o://` can be used as the prefix of the container ID to specify the container runtime.
     *
    ...
    /**
     * @description The IDs of instances on which to create and run the command. Specify at least one instance ID. You can specify up to 100 instance IDs.
     *
    ...
    /**
     * @description The tags of the instance. You can leave this parameter empty or specify up to 20 tags. If you do not specify InstanceId, the command is run on instances that have the specified tags.
     *
     * @var resourceTag[]
     */
    public $resourceTag;
    ...
    /**
     * @description The tags to add to the command task. You can leave this parameter empty or specify up to 20 tags.
     *
     * @var tag[]
     */
    public $tag;
