...
class DescribePriceRequest extends Model
{
    ...
    /**
     * @description Recurrence rules for the time-segmented assurance of the elasticity assurance.
     *
    ...
    /**
     * @description The time when the time-segmented assurance of the elasticity assurance takes effect. Specify the time in the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time must be in UTC. For more information, see [ISO 8601](https://help.aliyun.com/document_detail/25696.html).
     *
