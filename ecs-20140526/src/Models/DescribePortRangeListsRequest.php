...
class DescribePortRangeListsRequest extends Model
{
     ...
     *
     * @example 727d41872117f2816343eeb432fbc5bfd21dc824589d2a4be0b5e8707e68181f
     *
     * @var string
     */
    public $nextToken;
    ...
    /**
     * @description The ID of the port list. Valid values of N: 0 to 100.
     *
     * @var string[]
     */
    ...
    /**
     * @description The ID of the resource group. If you specify this parameter to query resources, up to 1,000 resources that belong to the specified resource group can be returned in the response. You can call the [ListResourceGroups](https://help.aliyun.com/document_detail/2716558.html) operation to query the most recent resource group list.
     *
    ...
    /**
     * @description The tags that are added to the port list.
     *
     * @var tag[]
     */
    public $tag;
     ...
     * @param array $map
     *
     * @return DescribePortRangeListsRequest
     */
