...
class AuthorizeSecurityGroupEgressRequest extends Model
{
    ...
    /**
     * @description The security group rules. You can specify 1 to 100 security group rules.
     *
     * @var permissions[]
     */
    public $permissions;
    ...
    /**
     * @description The region ID of the source security group. You can call the [DescribeRegions](https://help.aliyun.com/document_detail/25609.html) operation to query the most recent region list.
     *
