...
class dedicatedHost extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->supportedCustomInstanceTypeFamilies) {
            $this->supportedCustomInstanceTypeFamilies->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->hostDetailInfo) {
            $res['HostDetailInfo'] = null !== $this->hostDetailInfo ? $this->hostDetailInfo->toArray($noStream) : $this->hostDetailInfo;
        }
        ...
        if (null !== $this->supportedCustomInstanceTypeFamilies) {
            $res['SupportedCustomInstanceTypeFamilies'] = null !== $this->supportedCustomInstanceTypeFamilies ? $this->supportedCustomInstanceTypeFamilies->toArray($noStream) : $this->supportedCustomInstanceTypeFamilies;
        }
