...
{
    /**
     * @description The percentage of the average spot instance price relative to the pay-as-you-go instance price in the previous 30 days. Unit: %. Valid values: 1 to 100.
     *
    ...
    /**
     * @description The release rate range of spot instances in the previous 30 days, which corresponds to the `InterruptionRate` value. Valid values:
     *
     *   0-3%
     *   3-5%
     *   5-10%
    ...
    /**
     * @description The average release rate of spot instances in the previous 30 days. Unit: %.
     *
     * @example 0
     *
     * @var float
