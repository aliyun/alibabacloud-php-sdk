...
{
    /**
     * @description The percentage of the average preemptible instance relative to the pay-as-you-go instance price in the last 30 days. Unit: percentage (%). Valid values: 1 to 100.
     *
    ...
    /**
     * @description The average release rate of preemptible instances forn the last 30 days. Unit: percent (%).
     *
     * @example 0
     *
     * @var float
