...
class instanceType extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('maximumQueueNumberPerEni', $this->maximumQueueNumberPerEni, true);
        Model::validateRequired('primaryEniQueueNumber', $this->primaryEniQueueNumber, true);
        Model::validateRequired('secondaryEniQueueNumber', $this->secondaryEniQueueNumber, true);
    }
