...
class DescribeCloudAssistantStatusRequest extends Model
{
    ...
    /**
     * @description The region ID of the instance. You can call [DescribeRegions](https://help.aliyun.com/document_detail/25609.html) to query the most recent region list.
     *
     ...
     * @param array $map
     *
     * @return DescribeCloudAssistantStatusRequest
     */
