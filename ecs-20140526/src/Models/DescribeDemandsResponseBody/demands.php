...
use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribeDemandsResponseBody\demands\supplyInfos;
...
class demands extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->supplyInfos) {
            $res['SupplyInfos'] = [];
            if (null !== $this->supplyInfos && \is_array($this->supplyInfos)) {
                $n = 0;
                foreach ($this->supplyInfos as $item) {
                    $res['SupplyInfos'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SupplyInfos'])) {
            if (!empty($map['SupplyInfos'])) {
                $model->supplyInfos = [];
                $n                  = 0;
                foreach ($map['SupplyInfos'] as $item) {
                    $model->supplyInfos[$n++] = null !== $item ? supplyInfos::fromMap($item) : $item;
                }
            }
        }
