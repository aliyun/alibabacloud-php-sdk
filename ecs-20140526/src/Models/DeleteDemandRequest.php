...
class DeleteDemandRequest extends Model
{
    ...
    /**
     * @description The reason why you want to delete the demand.
     *
     * @example test-reason
     *
     * @var string
    ...
    /**
     * @description The region ID of the demand. You can call the [DescribeRegions](https://help.aliyun.com/document_detail/25609.html) operation to query the most recent region list.
     *
     * This parameter is required.
     * @example cn-hangzhou
     *
