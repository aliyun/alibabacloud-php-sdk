...
use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribeDedicatedHostClustersResponse\dedicatedHostClusters;
use AlibabaCloud\Tea\Model;

class DescribeDedicatedHostClustersResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('dedicatedHostClusters', $this->dedicatedHostClusters, true);
    }
