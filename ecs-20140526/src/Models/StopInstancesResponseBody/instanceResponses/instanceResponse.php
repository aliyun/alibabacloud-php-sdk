...
class instanceResponse extends Model
{
    ...
    /**
     * @description The error message returned for the instance. The return value `success` indicates that the operation is successful. For more information, see the "Error codes" section of this topic.
     *
     * @example success
     *
     * @var string
