...
class DescribePrefixListAssociationsRequest extends Model
{
    ...
    /**
     * @description The query token. Set the value to the `NextToken` value returned in the last call to this operation. Leave this parameter empty the first time you call this operation.
     *
     * @example AAAAAdDWBF2****
     *
     * @var string
     ...
     * @param array $map
     *
     * @return DescribePrefixListAssociationsRequest
     */
