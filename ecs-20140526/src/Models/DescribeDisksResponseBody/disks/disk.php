...
class disk extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->mountInstances) {
            $res['MountInstances'] = null !== $this->mountInstances ? $this->mountInstances->toArray($noStream) : $this->mountInstances;
        }
        ...
        if (null !== $this->placement) {
            $res['Placement'] = null !== $this->placement ? $this->placement->toArray($noStream) : $this->placement;
        }
