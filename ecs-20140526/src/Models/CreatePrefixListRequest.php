...
use AlibabaCloud\SDK\Ecs\V20140526\Models\CreatePrefixListRequest\tag;
...
class CreatePrefixListRequest extends Model
{
    ...
    /**
     * @description The ID of the resource group to which to assign the prefix list.
     *
    ...
    /**
     * @description The tags to add to the prefix list.
     *
     * @var tag[]
     */
    public $tag;
