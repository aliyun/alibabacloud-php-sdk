...
class DescribeLaunchTemplateVersionsResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->launchTemplateVersionSets) {
            $this->launchTemplateVersionSets->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->launchTemplateVersionSets) {
            $res['LaunchTemplateVersionSets'] = null !== $this->launchTemplateVersionSets ? $this->launchTemplateVersionSets->toArray($noStream) : $this->launchTemplateVersionSets;
        }
