...
class instance extends Model
{
    ...
    /**
     * @description The interruption mode of the spot instance when the system initiates a spot instance interruption operation. Valid values:
     *
    ...
    public function toMap()
    {
        ...
        if (null !== $this->clockOptions) {
            $res['ClockOptions'] = null !== $this->clockOptions ? $this->clockOptions->toMap() : null;
        }
