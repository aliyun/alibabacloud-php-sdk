...
use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribeInstancesResponseBody\instances\instance\clockOptions;
...
class instance extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->clockOptions) {
            $this->clockOptions->validate();
        }
        ...
        if (null !== $this->dedicatedInstanceAttribute) {
            $this->dedicatedInstanceAttribute->validate();
        }
        if (null !== $this->ecsCapacityReservationAttr) {
            $this->ecsCapacityReservationAttr->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->additionalInfo) {
            $res['AdditionalInfo'] = null !== $this->additionalInfo ? $this->additionalInfo->toArray($noStream) : $this->additionalInfo;
        }
        ...
        if (null !== $this->clockOptions) {
            $res['ClockOptions'] = null !== $this->clockOptions ? $this->clockOptions->toArray($noStream) : $this->clockOptions;
        }
        ...
        if (null !== $this->dedicatedInstanceAttribute) {
            $res['DedicatedInstanceAttribute'] = null !== $this->dedicatedInstanceAttribute ? $this->dedicatedInstanceAttribute->toArray($noStream) : $this->dedicatedInstanceAttribute;
        }
        ...
        if (null !== $this->ecsCapacityReservationAttr) {
            $res['EcsCapacityReservationAttr'] = null !== $this->ecsCapacityReservationAttr ? $this->ecsCapacityReservationAttr->toArray($noStream) : $this->ecsCapacityReservationAttr;
        }
        ...
        if (null !== $this->enableNVS) {
            $res['EnableNVS'] = $this->enableNVS;
        }
        ...
        if (null !== $this->metadataOptions) {
            $res['MetadataOptions'] = null !== $this->metadataOptions ? $this->metadataOptions->toArray($noStream) : $this->metadataOptions;
        }
        ...
        if (null !== $this->rdmaIpAddress) {
            $res['RdmaIpAddress'] = null !== $this->rdmaIpAddress ? $this->rdmaIpAddress->toArray($noStream) : $this->rdmaIpAddress;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ClockOptions'])) {
            $model->clockOptions = clockOptions::fromMap($map['ClockOptions']);
        }
        ...
        if (isset($map['EnableNVS'])) {
            $model->enableNVS = $map['EnableNVS'];
        }
