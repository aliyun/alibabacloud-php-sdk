...
namespace AlibabaCloud\SDK\Ecs\V20140526\Models\DescribeCapacityReservationsResponse\capacityReservationSet\capacityReservationItem;

use AlibabaCloud\SDK\Ecs\V20140526\Models\DescribeCapacityReservationsResponse\capacityReservationSet\capacityReservationItem\allocatedResources\allocatedResource;
...
class allocatedResources extends Model
{
    ...
    {
        Model::validateRequired('allocatedResource', $this->allocatedResource, true);
    }
