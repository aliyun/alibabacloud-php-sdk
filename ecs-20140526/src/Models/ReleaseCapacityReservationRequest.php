...
class ReleaseCapacityReservationRequest extends Model
{
    ...
    /**
     * @description Specifies whether to check the validity of the request. Set the value to false. Capacity reservations are directly released.
     *
     * @example false
     *
     * @var bool
    ...
    /**
     * @description The region ID of the capacity reservation. You can call the [DescribeRegions](~~25609~~) operation to query the most recent list of regions.
     *
     * @example cn-hangzhou
     *
     * @var string
