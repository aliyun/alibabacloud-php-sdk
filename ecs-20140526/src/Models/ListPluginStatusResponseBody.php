...
use AlibabaCloud\SDK\Ecs\V20140526\Models\ListPluginStatusResponseBody\instancePluginStatusSet;
...
class ListPluginStatusResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->instancePluginStatusSet) {
            $this->instancePluginStatusSet->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->instancePluginStatusSet) {
            $res['InstancePluginStatusSet'] = null !== $this->instancePluginStatusSet ? $this->instancePluginStatusSet->toArray($noStream) : $this->instancePluginStatusSet;
        }
