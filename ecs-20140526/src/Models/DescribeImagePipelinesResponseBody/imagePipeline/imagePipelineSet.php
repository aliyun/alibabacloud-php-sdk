...
class imagePipelineSet extends Model
{
    ...
    /**
     * @description The attributes and settings of the imported image.
     *
    ...
    /**
     * @description Indicates whether the image created based on the image template supports the Non-Volatile Memory Express (NVMe) protocol.
     *
