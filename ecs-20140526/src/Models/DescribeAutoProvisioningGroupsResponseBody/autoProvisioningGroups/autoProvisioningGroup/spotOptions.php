...
{
    /**
     * @description The policy for creating spot instances. Valid values:
     *
    ...
    /**
     * @description The action to be performed after the excess spot instances are stopped. Valid values:
     *
