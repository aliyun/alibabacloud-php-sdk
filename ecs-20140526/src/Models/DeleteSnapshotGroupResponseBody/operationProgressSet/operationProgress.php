...
namespace AlibabaCloud\SDK\Ecs\V20140526\Models\DeleteSnapshotGroupResponseBody\operationProgressSet;

use AlibabaCloud\SDK\Ecs\V20140526\Models\DeleteSnapshotGroupResponseBody\operationProgressSet\operationProgress\relatedItemSet;
...
class operationProgress extends Model
{
    ...
    /**
     * @description Indicates whether the operation was successful. If the operation was successful, a value of Success is returned. If the operation failed, an error code and an error message are returned.
     *
     * @example Success
     *
     * @var string
