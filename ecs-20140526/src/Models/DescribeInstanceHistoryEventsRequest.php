...
class DescribeInstanceHistoryEventsRequest extends Model
{
    ...
    /**
     * @description The number of entries to return on each page. Valid values: 10 to 100.
     *
     * Default values:
     *
    ...
    /**
     * @description >  This parameter is deprecated. We recommend that you specify MaxResults or NextToken for a paged query.
     *
     * @example 1
     *
     * @var int
