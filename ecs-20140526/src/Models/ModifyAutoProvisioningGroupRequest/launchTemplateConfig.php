...
class launchTemplateConfig extends Model
{
    ...
    /**
     * @description The priority of extended configuration N. A value of 0 indicates the highest priority. The value must be greater than 0.
     *
     * @example 1
     *
     * @var int
    ...
    /**
     * @description The weight of the instance type in extended configuration N. A greater weight indicates that a single instance has more computing power and that fewer instances are required. The value must be greater than 0.
     *
