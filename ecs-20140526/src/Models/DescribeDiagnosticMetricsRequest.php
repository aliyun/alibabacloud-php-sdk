...
class DescribeDiagnosticMetricsRequest extends Model
{
    ...
    /**
     * @description The ID of diagnostic metrics.
     *
     * @var string[]
     */
    public $metricIds;
    ...
    /**
     * @description The region ID pf the diagnostic metric. You can call the [DescribeRegions](https://help.aliyun.com/document_detail/25609.html) operation to query the most recent region list.
     *
