...
class DescribeSubscriptionInstancesResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->subscriptionInstances) {
            $this->subscriptionInstances->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->subscriptionInstances) {
            $res['SubscriptionInstances'] = null !== $this->subscriptionInstances ? $this->subscriptionInstances->toArray($noStream) : $this->subscriptionInstances;
        }
