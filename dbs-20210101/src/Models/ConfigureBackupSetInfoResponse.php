...
class ConfigureBackupSetInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ConfigureBackupSetInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ConfigureBackupSetInfoResponseBody::fromMap($map['body']);
        }
