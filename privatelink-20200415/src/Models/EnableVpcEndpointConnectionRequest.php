...
class EnableVpcEndpointConnectionRequest extends Model
{
    /**
     * @description The bandwidth of the endpoint connection. Unit: Mbit/s. Valid values: **3072 to 10240**.
     *
     ...
     * @param array $map
     *
     * @return EnableVpcEndpointConnectionRequest
     */
