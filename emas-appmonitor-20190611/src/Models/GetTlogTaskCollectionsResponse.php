...
class GetTlogTaskCollectionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetTlogTaskCollectionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetTlogTaskCollectionsResponseBody::fromMap($map['body']);
        }
