...
class GetKnowledgeBasePreSignedUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetKnowledgeBasePreSignedUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetKnowledgeBasePreSignedUrlResponseBody::fromMap($map['body']);
        }
