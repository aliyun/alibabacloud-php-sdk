...
use AlibabaCloud\SDK\Iovcc\V20180501\Models\GenerateOssUploadMetaResponseBody\ossUploadMeta;
use AlibabaCloud\Tea\Model;

class GenerateOssUploadMetaResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return GenerateOssUploadMetaResponseBody
     */
