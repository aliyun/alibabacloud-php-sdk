...
class ChangeMessageVisibilityResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChangeMessageVisibilityResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChangeMessageVisibilityResponseBody::fromMap($map['body']);
        }
