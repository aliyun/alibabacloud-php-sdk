...
class GenerateWuyingServerSceneUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GenerateWuyingServerSceneUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GenerateWuyingServerSceneUrlResponseBody::fromMap($map['body']);
        }
