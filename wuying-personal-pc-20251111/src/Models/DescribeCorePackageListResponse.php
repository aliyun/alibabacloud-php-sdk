...
class DescribeCorePackageListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeCorePackageListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeCorePackageListResponseBody::fromMap($map['body']);
        }
