...
class DescribeAccessibleImagesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeAccessibleImagesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeAccessibleImagesResponseBody::fromMap($map['body']);
        }
