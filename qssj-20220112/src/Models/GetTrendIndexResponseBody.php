...
use AlibabaCloud\SDK\Qssj\V20220112\Models\GetTrendIndexResponseBody\data;
use AlibabaCloud\Tea\Model;

class GetTrendIndexResponseBody extends Model
{
    /**
     * @example OK
     *
     ...
     * @param array $map
     *
     * @return GetTrendIndexResponseBody
     */
