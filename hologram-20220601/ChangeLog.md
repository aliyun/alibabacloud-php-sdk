2026-07-29 Version: 1.11.1
- Update API GetInstanceModel: add response parameters Body.modelServiceList.$.supportApiKeyAccess.
- Update API ListModelCatalog: add request parameters provider.
- Update API ListModelCatalog: add response parameters Body.modelList.$.supportApiKeyAccess.
