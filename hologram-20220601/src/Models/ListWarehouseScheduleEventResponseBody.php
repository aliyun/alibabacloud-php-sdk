...
use AlibabaCloud\SDK\Hologram\V20220601\Models\ListWarehouseScheduleEventResponseBody\eventList;

class ListWarehouseScheduleEventResponseBody extends Model
{
    /**
     * @var eventList[]
     */
