...
class QueryDomainByInstanceIdResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->domainLifecycleStatus) {
            $res['DomainLifecycleStatus'] = $this->domainLifecycleStatus;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DomainLifecycleStatus'])) {
            $model->domainLifecycleStatus = $map['DomainLifecycleStatus'];
        }
