...
class scalingConfigurations extends Model
{
    ...
    /**
     * @description The resource pools used for instance creation, which can be the public pool or a private pool associated with any active elasticity assurance or capacity reservation.
     *
