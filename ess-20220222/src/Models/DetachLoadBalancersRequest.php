...
class DetachLoadBalancersRequest extends Model
{
    ...
    /**
     * @description Specifies whether to remove Elastic Compute Service (ECS) instances in the scaling group from the backend server groups of the load balancer. Valid values:
     *
     *   true
     *   false
     *
