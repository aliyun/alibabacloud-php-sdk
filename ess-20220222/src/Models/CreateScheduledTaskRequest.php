...
class CreateScheduledTaskRequest extends Model
{
    ...
    /**
     * @description The point in time at which the scheduled task is triggered. Specify the time in the ISO 8601 standard. The time must be in UTC. You cannot trigger a scheduled task more than 90 days after its creation.
     *
