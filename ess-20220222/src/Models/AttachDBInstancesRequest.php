...
class AttachDBInstancesRequest extends Model
{
    ...
    /**
     * @description Specifies whether to add the private IP addresses of all ECS instances in the scaling group to the IP address whitelist of the ApsaraDB RDS instance that you want to attach to the scaling group. Valid values:
     *
     *   true
     *   false
     *
