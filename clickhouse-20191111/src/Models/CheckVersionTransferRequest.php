...
class CheckVersionTransferRequest extends Model
{
    /**
     * @var bool
     */
    ...
    {
        $res = [];
        if (null !== $this->checkAccount) {
            $res['CheckAccount'] = $this->checkAccount;
        }
     ...
     * @param array $map
     *
     * @return CheckVersionTransferRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['CheckAccount'])) {
            $model->checkAccount = $map['CheckAccount'];
        }
