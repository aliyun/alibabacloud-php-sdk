...
use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainTrafficDataResponseBody\trafficDataPerInterval;
use AlibabaCloud\Tea\Model;

class DescribeLiveDomainTrafficDataResponseBody extends Model
{
    /**
     * @var string
     */
