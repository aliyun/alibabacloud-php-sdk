...
class DescribeLiveAudioAuditConfigResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->liveAudioAuditConfigList) {
            $this->liveAudioAuditConfigList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->liveAudioAuditConfigList) {
            $res['LiveAudioAuditConfigList'] = null !== $this->liveAudioAuditConfigList ? $this->liveAudioAuditConfigList->toArray($noStream) : $this->liveAudioAuditConfigList;
        }
