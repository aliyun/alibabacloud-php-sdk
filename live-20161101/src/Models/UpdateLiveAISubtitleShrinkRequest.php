...
class UpdateLiveAISubtitleShrinkRequest extends Model
{
    /**
     ...
     * @var string
     */
    public $positionNormalizedShrink;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->positionNormalizedShrink) {
            $res['PositionNormalized'] = $this->positionNormalizedShrink;
        }
     ...
     * @param array $map
     *
     * @return UpdateLiveAISubtitleShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['PositionNormalized'])) {
            $model->positionNormalizedShrink = $map['PositionNormalized'];
        }
