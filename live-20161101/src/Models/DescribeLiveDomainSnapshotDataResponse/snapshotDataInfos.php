...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainSnapshotDataResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainSnapshotDataResponse\snapshotDataInfos\snapshotDataInfo;
...
class snapshotDataInfos extends Model
{
    ...
    {
        Model::validateRequired('snapshotDataInfo', $this->snapshotDataInfo, true);
    }
