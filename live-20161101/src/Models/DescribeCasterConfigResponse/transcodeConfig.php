...
use AlibabaCloud\SDK\Live\V20161101\Models\DescribeCasterConfigResponse\transcodeConfig\liveTemplateIds;
...
class transcodeConfig extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('liveTemplateIds', $this->liveTemplateIds, true);
    }
