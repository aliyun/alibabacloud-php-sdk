...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeBoardSnapshotResponse\snapshot\board\pages;
...
class elements extends Model
{
    ...
    {
        Model::validateRequired('elementIndex', $this->elementIndex, true);
