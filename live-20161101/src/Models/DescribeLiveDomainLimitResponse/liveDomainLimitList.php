...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainLimitResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainLimitResponse\liveDomainLimitList\liveDomainLimit;
...
class liveDomainLimitList extends Model
{
    ...
    {
        Model::validateRequired('liveDomainLimit', $this->liveDomainLimit, true);
    }
