...
class RecoverLiveMessageDeletedGroupRequest extends Model
{
    /**
    ...
    /**
     * @description The ID of the group that you want to restore.
     *
     * This parameter is required.
     *
     * @example grouptest
     ...
     * @param array $map
     *
     * @return RecoverLiveMessageDeletedGroupRequest
     */
