...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamRecordIndexFilesResponseBody\recordIndexInfoList;
...
class recordIndexInfo extends Model
{
    ...
    /**
     * @description The time when the index file was created.
     *
