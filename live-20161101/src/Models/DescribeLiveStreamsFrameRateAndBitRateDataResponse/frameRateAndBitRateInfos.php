...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamsFrameRateAndBitRateDataResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamsFrameRateAndBitRateDataResponse\frameRateAndBitRateInfos\frameRateAndBitRateInfo;
...
class frameRateAndBitRateInfos extends Model
{
    ...
    {
        Model::validateRequired('frameRateAndBitRateInfo', $this->frameRateAndBitRateInfo, true);
    }
