...
class subtitleConfig extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->positionNormalized) {
            $this->positionNormalized->validate();
        }
        if (null !== $this->rulesRefer) {
            $this->rulesRefer->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->positionNormalized) {
            $res['PositionNormalized'] = null !== $this->positionNormalized ? $this->positionNormalized->toArray($noStream) : $this->positionNormalized;
        }

        if (null !== $this->rulesRefer) {
            $res['RulesRefer'] = null !== $this->rulesRefer ? $this->rulesRefer->toArray($noStream) : $this->rulesRefer;
        }
