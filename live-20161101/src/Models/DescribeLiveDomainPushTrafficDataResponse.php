...
use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainPushTrafficDataResponse\trafficDataPerInterval;
use AlibabaCloud\Tea\Model;

class DescribeLiveDomainPushTrafficDataResponse extends Model
{
    /**
     * @var string
     */
