...
class RemoveLiveMessageGroupBandShrinkRequest extends Model
{
    /**
    ...
    /**
     * @description The users whom you want to unmute.
     *
     * This parameter is required.
     *
     * @var string
     */
    public $unbannedUsersShrink;
    protected $_name = [
        'appId' => 'AppId',
    ...
    public function toMap()
    {
        ...
        if (null !== $this->unbannedUsersShrink) {
            $res['UnbannedUsers'] = $this->unbannedUsersShrink;
        }
     ...
     * @param array $map
     *
     * @return RemoveLiveMessageGroupBandShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['UnbannedUsers'])) {
            $model->unbannedUsersShrink = $map['UnbannedUsers'];
        }
