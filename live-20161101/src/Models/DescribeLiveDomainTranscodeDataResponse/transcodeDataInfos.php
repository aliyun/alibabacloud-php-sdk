...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainTranscodeDataResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveDomainTranscodeDataResponse\transcodeDataInfos\transcodeDataInfo;
...
class transcodeDataInfos extends Model
{
    ...
    {
        Model::validateRequired('transcodeDataInfo', $this->transcodeDataInfo, true);
    }
