...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamOnlineUserNumResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamOnlineUserNumResponse\onlineUserInfo\liveStreamOnlineUserNumInfo;
...
class onlineUserInfo extends Model
{
    ...
    {
        Model::validateRequired('liveStreamOnlineUserNumInfo', $this->liveStreamOnlineUserNumInfo, true);
    }
