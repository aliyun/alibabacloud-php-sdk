...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeCasterSyncGroupResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeCasterSyncGroupResponse\syncGroups\syncGroup;
...
class syncGroups extends Model
{
    ...
    {
        Model::validateRequired('syncGroup', $this->syncGroup, true);
    }
