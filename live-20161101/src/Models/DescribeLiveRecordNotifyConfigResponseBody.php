...
class DescribeLiveRecordNotifyConfigResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->liveRecordNotifyConfig) {
            $this->liveRecordNotifyConfig->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->liveRecordNotifyConfig) {
            $res['LiveRecordNotifyConfig'] = null !== $this->liveRecordNotifyConfig ? $this->liveRecordNotifyConfig->toArray($noStream) : $this->liveRecordNotifyConfig;
        }
