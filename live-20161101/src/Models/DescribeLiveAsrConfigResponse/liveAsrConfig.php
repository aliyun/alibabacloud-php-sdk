...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveAsrConfigResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveAsrConfigResponse\liveAsrConfig\liveAsrConfigList;
...
class liveAsrConfig extends Model
{
    ...
    {
        Model::validateRequired('liveAsrConfigList', $this->liveAsrConfigList, true);
    }
