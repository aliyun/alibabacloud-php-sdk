...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveAsrConfigResponse\liveAsrConfig;
...
class liveAsrConfigList extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('mnsTopic', $this->mnsTopic, true);
        Model::validateRequired('mnsRegion', $this->mnsRegion, true);
        Model::validateRequired('httpCallbackURL', $this->httpCallbackURL, true);
    }
