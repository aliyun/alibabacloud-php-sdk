...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamTranscodeInfoResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamTranscodeInfoResponse\domainTranscodeList\domainTranscodeInfo;
...
class domainTranscodeList extends Model
{
    ...
    {
        Model::validateRequired('domainTranscodeInfo', $this->domainTranscodeInfo, true);
    }
