...
class DescribeLiveRecordNotifyRecordsRequest extends Model
{
    /**
    ...
    /**
     * @description Specifies whether the callback is successful. Valid values:
     *
     *   success
     *   failed
     *
     ...
     * @param array $map
     *
     * @return DescribeLiveRecordNotifyRecordsRequest
     */
