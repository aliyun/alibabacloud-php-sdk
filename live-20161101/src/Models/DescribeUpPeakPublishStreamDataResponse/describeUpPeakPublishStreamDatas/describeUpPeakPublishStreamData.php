...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeUpPeakPublishStreamDataResponse\describeUpPeakPublishStreamDatas;
...
class describeUpPeakPublishStreamData extends Model
{
    ...
    {
        Model::validateRequired('publishStreamNum', $this->publishStreamNum, true);
