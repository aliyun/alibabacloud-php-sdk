...
use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamsFrameRateAndBitRateDataResponseBody\frameRateAndBitRateInfos;
use AlibabaCloud\Tea\Model;

class DescribeLiveStreamsFrameRateAndBitRateDataResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return DescribeLiveStreamsFrameRateAndBitRateDataResponseBody
     */
