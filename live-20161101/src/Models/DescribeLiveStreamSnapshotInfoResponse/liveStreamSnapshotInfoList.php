...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamSnapshotInfoResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveStreamSnapshotInfoResponse\liveStreamSnapshotInfoList\liveStreamSnapshotInfo;
...
class liveStreamSnapshotInfoList extends Model
{
    ...
    {
        Model::validateRequired('liveStreamSnapshotInfo', $this->liveStreamSnapshotInfo, true);
    }
