...
class DescribeLiveSnapshotDetectPornConfigResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->liveSnapshotDetectPornConfigList) {
            $this->liveSnapshotDetectPornConfigList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->liveSnapshotDetectPornConfigList) {
            $res['LiveSnapshotDetectPornConfigList'] = null !== $this->liveSnapshotDetectPornConfigList ? $this->liveSnapshotDetectPornConfigList->toArray($noStream) : $this->liveSnapshotDetectPornConfigList;
        }
