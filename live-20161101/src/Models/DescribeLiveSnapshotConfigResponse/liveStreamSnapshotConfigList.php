...
namespace AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveSnapshotConfigResponse;

use AlibabaCloud\SDK\Live\V20161101\Models\DescribeLiveSnapshotConfigResponse\liveStreamSnapshotConfigList\liveStreamSnapshotConfig;
...
class liveStreamSnapshotConfigList extends Model
{
    ...
    {
        Model::validateRequired('liveStreamSnapshotConfig', $this->liveStreamSnapshotConfig, true);
    }
