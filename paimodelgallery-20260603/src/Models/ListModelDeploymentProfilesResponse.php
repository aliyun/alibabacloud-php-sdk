...
class ListModelDeploymentProfilesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListModelDeploymentProfilesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListModelDeploymentProfilesResponseBody::fromMap($map['body']);
        }
