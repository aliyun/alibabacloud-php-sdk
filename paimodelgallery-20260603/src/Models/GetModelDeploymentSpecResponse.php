...
class GetModelDeploymentSpecResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetModelDeploymentSpecResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetModelDeploymentSpecResponseBody::fromMap($map['body']);
        }
