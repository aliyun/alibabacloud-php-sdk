...
class GetModelDeploymentResourcesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetModelDeploymentResourcesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetModelDeploymentResourcesResponseBody::fromMap($map['body']);
        }
