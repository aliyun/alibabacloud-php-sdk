...
{
    /**
     * @description The number of data entries displayed on the current page.
     *
     * @example 10
     *
     * @var int
    ...
    /**
     * @description The maximum number of data entries displayed per page in a paginated query.
     *
     * @example 20
     *
     * @var int
