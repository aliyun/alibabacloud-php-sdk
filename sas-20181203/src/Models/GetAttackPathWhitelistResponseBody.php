...
use AlibabaCloud\SDK\Sas\V20181203\Models\GetAttackPathWhitelistResponseBody\attackPathWhitelist;

class GetAttackPathWhitelistResponseBody extends Model
{
    /**
