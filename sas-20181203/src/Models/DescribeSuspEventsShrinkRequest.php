...
class DescribeSuspEventsShrinkRequest extends Model
{
    /**
    ...
    public function toMap()
    {
        ...
        if (null !== $this->sourceAliUidsShrink) {
            $res['SourceAliUids'] = $this->sourceAliUidsShrink;
        }
     ...
     * @param array $map
     *
     * @return DescribeSuspEventsShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SourceAliUids'])) {
            $model->sourceAliUidsShrink = $map['SourceAliUids'];
        }
