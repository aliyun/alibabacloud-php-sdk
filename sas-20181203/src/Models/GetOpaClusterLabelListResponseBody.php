...
use AlibabaCloud\SDK\Sas\V20181203\Models\GetOpaClusterLabelListResponseBody\data;
use AlibabaCloud\Tea\Model;

class GetOpaClusterLabelListResponseBody extends Model
{
    /**
    ...
    /**
     * @description The information about the tags that are added to containers.
     *
     * @var data[]
     */
    public $data;
     ...
     * @param array $map
     *
     * @return GetOpaClusterLabelListResponseBody
     */
