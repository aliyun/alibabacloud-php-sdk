...
class data extends Model
{
    ...
    /**
     * @description The timestamp when the information about the images was collected. Unit: milliseconds.
     *
    ...
    /**
     * @description The progress of the image scan task. Unit: percent.
     *
     * @example 100
     *
     * @var int
    ...
    /**
     * @description The total number of images that need to be scanned.
     *
     * @example 5
     *
     * @var int
