...
class instances extends Model
{
    ...
    /**
     * @description The subtype of the cloud service. The subtype of the cloud asset. Valid values:
     *
     *   **0**: ECS
     *
     *   **0**: instance
    ...
    /**
     * @description The public IP address of the cloud asset.
     *
     * @example 1.2.XX.XX
     *
     * @var string
    ...
    /**
     * @description The ID of the region to which the cloud asset belongs.
     *
     * @example cn-hanghzou
     *
     * @var string
    ...
    /**
     * @description The service provider (SP) of the cloud asset. Valid values:
     *
