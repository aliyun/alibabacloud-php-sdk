...
class GetAuthSummaryResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->invalidBindStatus) {
            $res['InvalidBindStatus'] = $this->invalidBindStatus;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['InvalidBindStatus'])) {
            $model->invalidBindStatus = $map['InvalidBindStatus'];
        }
