...
class ListCheckInstanceResultRequest extends Model
{
    ...
    /**
     * @description The instance ID of the check item.
     *
    ...
    /**
     * @description The instance name of the check item.
     *
     * @example i-uf64w4q6p9jti5gl****
     *
     * @var string
    ...
    /**
     * @description The type of the condition based on which the check items are sorted. Set the value to **STATUS**.
     *
     * @var string[]
     */
    public $sortTypes;
