...
{
    /**
     * @description The name of the field that displays tracing information.
     *
     * @example sshd
     *
     * @var string
    ...
    /**
     * @description The type of the field that displays tracing information. Valid values:
     *
     *   **text**
     *   **html**
     *
    ...
    /**
     * @description The value of the field that displays tracing information.
     *
