...
use AlibabaCloud\SDK\Sas\V20181203\Models\ListCriteriaStrategyResponseBody\data;
use AlibabaCloud\Tea\Model;

class ListCriteriaStrategyResponseBody extends Model
{
    /**
    ...
    /**
     * @description The IDs and names of the rules.
     *
     * @var data[]
     */
    public $data;
     ...
     * @param array $map
     *
     * @return ListCriteriaStrategyResponseBody
     */
