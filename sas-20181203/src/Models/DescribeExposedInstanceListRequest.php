...
class DescribeExposedInstanceListRequest extends Model
{
     ...
     * @var string
     */
    public $exposureComponentBizType;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->exposureComponentBizType) {
            $res['ExposureComponentBizType'] = $this->exposureComponentBizType;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ExposureComponentBizType'])) {
            $model->exposureComponentBizType = $map['ExposureComponentBizType'];
        }
