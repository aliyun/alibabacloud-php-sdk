...
class propertys extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->installationPath) {
            $res['InstallationPath'] = $this->installationPath;
        }
        ...
        if (null !== $this->middlewareVersion) {
            $res['MiddlewareVersion'] = $this->middlewareVersion;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['InstallationPath'])) {
            $model->installationPath = $map['InstallationPath'];
        }
        ...
        if (isset($map['MiddlewareVersion'])) {
            $model->middlewareVersion = $map['MiddlewareVersion'];
        }
