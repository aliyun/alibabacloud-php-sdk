...
class entityTypeList extends Model
{
    ...
    /**
     * @description The icon that corresponds to the entity.
     *
    ...
    /**
     * @description The display sequence of the entity.
     *
     * @example 5
     *
     * @var string
    ...
    /**
     * @description The tag that indicates whether tracing was successful.
     *
     * @example 1
     *
     * @var string
