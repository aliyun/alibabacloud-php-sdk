...
namespace AlibabaCloud\SDK\Sas\V20181203\Models\GetClientInstallationStatisticResponseBody\clientInstallRatio\historyItems;
...
class items extends Model
{
    ...
    /**
     * @description The timestamp of the calculation. Unit: millisecond.
     *
    ...
    /**
     * @description The number of cloud assets on which the client is installed.
     *
     * @example 80
     *
     * @var int
