...
class DescribePropertyCountResponseBody extends Model
{
     ...
     * @var int
     */
    public $agentlessLlmService;

    /**
     * @var int
     */
    public $agentlessScaAiComponent;
    ...
    {
        $res = [];
        if (null !== $this->agentlessLlmService) {
            $res['AgentlessLlmService'] = $this->agentlessLlmService;
        }

        if (null !== $this->agentlessScaAiComponent) {
            $res['AgentlessScaAiComponent'] = $this->agentlessScaAiComponent;
        }
    ...
    {
        $model = new self();
        if (isset($map['AgentlessLlmService'])) {
            $model->agentlessLlmService = $map['AgentlessLlmService'];
        }

        if (isset($map['AgentlessScaAiComponent'])) {
            $model->agentlessScaAiComponent = $map['AgentlessScaAiComponent'];
        }
