...
class groupedFields extends Model
{
     ...
     * @var int
     */
    public $volcengineInstanceCount;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->googleInstanceCount) {
            $res['GoogleInstanceCount'] = $this->googleInstanceCount;
        }
        ...
        if (null !== $this->volcengineInstanceCount) {
            $res['VolcengineInstanceCount'] = $this->volcengineInstanceCount;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['GoogleInstanceCount'])) {
            $model->googleInstanceCount = $map['GoogleInstanceCount'];
        }
        ...
        if (isset($map['VolcengineInstanceCount'])) {
            $model->volcengineInstanceCount = $map['VolcengineInstanceCount'];
        }
