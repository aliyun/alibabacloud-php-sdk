...
use AlibabaCloud\SDK\Sas\V20181203\Models\UpdateAttackPathSensitiveAssetConfigRequest\attackPathAssetList;

class UpdateAttackPathSensitiveAssetConfigRequest extends Model
{
    /**
