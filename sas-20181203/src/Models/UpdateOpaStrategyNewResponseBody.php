...
class UpdateOpaStrategyNewResponseBody extends Model
{
    /**
    ...
    /**
     * @description The IDs of the clusters that failed to be updated.
     *
     * @var string[]
     */
    public $data;
     ...
     * @param array $map
     *
     * @return UpdateOpaStrategyNewResponseBody
     */
