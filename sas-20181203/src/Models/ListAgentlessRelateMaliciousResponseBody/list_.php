...
{
    /**
     * @description The details of the alert events.
     *
     * @var details[]
     */
    public $details;
    ...
    /**
     * @description The timestamp when the alert is handled. Unit: milliseconds.
     *
     * @example 168257753****
     *
     * @var string
    ...
    /**
     * @description The type of the task object. Valid values:
     *
     *   **1**: snapshot.
     *   **2**: image.
     *
