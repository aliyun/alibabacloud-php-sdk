...
use AlibabaCloud\SDK\Sas\V20181203\Models\CreateAttackPathSensitiveAssetConfigResponseBody\attackPathSensitiveAssetConfig;

class CreateAttackPathSensitiveAssetConfigResponseBody extends Model
{
    /**
