...
class DescribeCustomizeReportConfigDetailResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->memberAccountSyncFlag) {
            $res['MemberAccountSyncFlag'] = $this->memberAccountSyncFlag;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['MemberAccountSyncFlag'])) {
            $model->memberAccountSyncFlag = $map['MemberAccountSyncFlag'];
        }
