...
use AlibabaCloud\SDK\Sas\V20181203\Models\VerifyCheckCustomConfigShrinkRequest\customConfigs;
use AlibabaCloud\SDK\Sas\V20181203\Models\VerifyCheckCustomConfigShrinkRequest\repairConfigs;

class VerifyCheckCustomConfigShrinkRequest extends Model
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    public $customCheckConfigShrink;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->customCheckConfigShrink) {
            $res['CustomCheckConfig'] = $this->customCheckConfigShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CustomCheckConfig'])) {
            $model->customCheckConfigShrink = $map['CustomCheckConfig'];
        }
