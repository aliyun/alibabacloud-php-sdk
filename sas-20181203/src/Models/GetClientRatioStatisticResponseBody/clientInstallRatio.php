...
{
    /**
     * @description The list of current statistics on the installation rate of the client.
     *
     * @var currentItems[]
     */
    public $currentItems;
    ...
    /**
     * @description The list of historical statistics on the installation rate of the client.
     *
     * @var historyItems[]
     */
    public $historyItems;
