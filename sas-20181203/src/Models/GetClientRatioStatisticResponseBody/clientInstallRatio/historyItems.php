...
use AlibabaCloud\SDK\Sas\V20181203\Models\GetClientRatioStatisticResponseBody\clientInstallRatio\historyItems\items;
use AlibabaCloud\Tea\Model;

class historyItems extends Model
{
    /**
     * @description The list of statistics on the client installation rate.
     *
     * @var items[]
     */
    public $items;
