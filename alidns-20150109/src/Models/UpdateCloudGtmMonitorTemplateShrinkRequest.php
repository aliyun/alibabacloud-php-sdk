...
class UpdateCloudGtmMonitorTemplateShrinkRequest extends Model
{
    /**
    ...
    /**
     * @description The health check nodes. You can call the [ListCloudGtmMonitorNodes](https://help.aliyun.com/document_detail/2797327.html) operation to obtain the health check nodes.
     *
     * @var string
     */
     ...
     * @param array $map
     *
     * @return UpdateCloudGtmMonitorTemplateShrinkRequest
     */
