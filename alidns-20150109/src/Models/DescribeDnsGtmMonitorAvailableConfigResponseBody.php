...
{
    /**
     * @description The nodes that perform health checks on domain names that use public IPv4 addresses.
     *
    ...
    /**
     * @description The nodes that perform health checks on domain names that use public IPv6 addresses.
     *
    ...
    /**
     * @description The nodes that perform health checks on public IPv4 addresses.
     *
    ...
    /**
     * @description The nodes that perform health checks on public IPv6 addresses.
     *
