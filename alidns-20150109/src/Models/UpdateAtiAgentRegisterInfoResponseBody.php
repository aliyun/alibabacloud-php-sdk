...
use AlibabaCloud\SDK\Alidns\V20150109\Models\UpdateAtiAgentRegisterInfoResponseBody\accessDeniedDetail;

class UpdateAtiAgentRegisterInfoResponseBody extends Model
{
    /**
