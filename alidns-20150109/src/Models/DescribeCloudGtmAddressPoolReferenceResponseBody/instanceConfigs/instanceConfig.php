...
class instanceConfig extends Model
{
    ...
    /**
     * @description DNS record types for scheduling domains:
     * - A: IPv4 address
     * - AAAA: IPv6 address
     * - CNAME: Domain name
     *
    ...
    /**
     * @description Global TTL, the TTL value for resolving the accessed domain name to addresses in the address pool, which affects the caching time of DNS records in the operator\\"s LocalDNS. Supports custom TTL values.
     *
     * @example 30
     *
     * @var int
