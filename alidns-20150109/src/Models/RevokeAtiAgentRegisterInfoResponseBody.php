...
use AlibabaCloud\SDK\Alidns\V20150109\Models\RevokeAtiAgentRegisterInfoResponseBody\accessDeniedDetail;

class RevokeAtiAgentRegisterInfoResponseBody extends Model
{
    /**
