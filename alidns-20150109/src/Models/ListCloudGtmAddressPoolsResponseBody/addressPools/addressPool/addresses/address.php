...
namespace AlibabaCloud\SDK\Alidns\V20150109\Models\ListCloudGtmAddressPoolsResponseBody\addressPools\addressPool\addresses;

use AlibabaCloud\SDK\Alidns\V20150109\Models\ListCloudGtmAddressPoolsResponseBody\addressPools\addressPool\addresses\address\healthTasks;
use AlibabaCloud\SDK\Alidns\V20150109\Models\ListCloudGtmAddressPoolsResponseBody\addressPools\addressPool\addresses\address\requestSource;
...
class address extends Model
{
    ...
    /**
     * @description The availability state of the address when AvailableMode is set to manual for the address. Valid values:
     *
    ...
    /**
     * @description List of request sources.
     *
     * @var requestSource
     */
    ...
    /**
     * @description Weight value (integer between 1 and 100), supports setting different weight values for each address, enabling resolution queries to return addresses according to the weight ratio.
     *
     * @example 1
     *
     * @var int
