...
use AlibabaCloud\SDK\Alidns\V20150109\Models\UpdateAtiAlertSettingsResponseBody\accessDeniedDetail;

class UpdateAtiAlertSettingsResponseBody extends Model
{
    /**
