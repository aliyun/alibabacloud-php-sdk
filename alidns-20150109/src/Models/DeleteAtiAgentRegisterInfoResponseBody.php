...
use AlibabaCloud\SDK\Alidns\V20150109\Models\DeleteAtiAgentRegisterInfoResponseBody\accessDeniedDetail;

class DeleteAtiAgentRegisterInfoResponseBody extends Model
{
    /**
