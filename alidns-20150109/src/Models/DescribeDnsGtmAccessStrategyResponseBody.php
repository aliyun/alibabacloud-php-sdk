...
class DescribeDnsGtmAccessStrategyResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->defaultAddrPools) {
            $this->defaultAddrPools->validate();
        }
        if (null !== $this->failoverAddrPools) {
            $this->failoverAddrPools->validate();
        }
        if (null !== $this->lines) {
            $this->lines->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->defaultAddrPools) {
            $res['DefaultAddrPools'] = null !== $this->defaultAddrPools ? $this->defaultAddrPools->toArray($noStream) : $this->defaultAddrPools;
        }
        ...
        if (null !== $this->failoverAddrPools) {
            $res['FailoverAddrPools'] = null !== $this->failoverAddrPools ? $this->failoverAddrPools->toArray($noStream) : $this->failoverAddrPools;
        }
