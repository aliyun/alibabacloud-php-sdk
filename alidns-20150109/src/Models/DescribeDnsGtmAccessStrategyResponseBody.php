...
class DescribeDnsGtmAccessStrategyResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->failoverAddrPools) {
            $res['FailoverAddrPools'] = [];
            if (null !== $this->failoverAddrPools && \is_array($this->failoverAddrPools)) {
                $n = 0;
                foreach ($this->failoverAddrPools as $item) {
                    $res['FailoverAddrPools'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
        ...
        if (null !== $this->defaultAddrPools) {
            $res['DefaultAddrPools'] = [];
            if (null !== $this->defaultAddrPools && \is_array($this->defaultAddrPools)) {
                $n = 0;
                foreach ($this->defaultAddrPools as $item) {
                    $res['DefaultAddrPools'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['FailoverAddrPools'])) {
            if (!empty($map['FailoverAddrPools'])) {
                $model->failoverAddrPools = [];
                $n                        = 0;
                foreach ($map['FailoverAddrPools'] as $item) {
                    $model->failoverAddrPools[$n++] = null !== $item ? failoverAddrPools::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['DefaultAddrPools'])) {
            if (!empty($map['DefaultAddrPools'])) {
                $model->defaultAddrPools = [];
                $n                       = 0;
                foreach ($map['DefaultAddrPools'] as $item) {
                    $model->defaultAddrPools[$n++] = null !== $item ? defaultAddrPools::fromMap($item) : $item;
                }
            }
        }
