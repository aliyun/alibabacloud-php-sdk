...
use AlibabaCloud\SDK\Alidns\V20150109\Models\DescribeDnsGtmAccessStrategyAvailableConfigResponse\domainAddrPools\domainAddrPool;
...
class domainAddrPools extends Model
{
    ...
    {
        Model::validateRequired('domainAddrPool', $this->domainAddrPool, true);
    }
