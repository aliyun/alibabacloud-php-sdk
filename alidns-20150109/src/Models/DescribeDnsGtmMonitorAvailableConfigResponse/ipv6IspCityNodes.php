...
use AlibabaCloud\SDK\Alidns\V20150109\Models\DescribeDnsGtmMonitorAvailableConfigResponse\ipv6IspCityNodes\ipv6IspCityNode;
...
class ipv6IspCityNodes extends Model
{
    ...
    {
        Model::validateRequired('ipv6IspCityNode', $this->ipv6IspCityNode, true);
    }
