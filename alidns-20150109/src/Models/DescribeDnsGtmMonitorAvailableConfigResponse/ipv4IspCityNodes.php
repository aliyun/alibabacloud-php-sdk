...
use AlibabaCloud\SDK\Alidns\V20150109\Models\DescribeDnsGtmMonitorAvailableConfigResponse\ipv4IspCityNodes\ipv4IspCityNode;
...
class ipv4IspCityNodes extends Model
{
    ...
    {
        Model::validateRequired('ipv4IspCityNode', $this->ipv4IspCityNode, true);
    }
