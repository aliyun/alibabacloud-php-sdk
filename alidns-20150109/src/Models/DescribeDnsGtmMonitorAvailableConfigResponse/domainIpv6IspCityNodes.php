...
use AlibabaCloud\SDK\Alidns\V20150109\Models\DescribeDnsGtmMonitorAvailableConfigResponse\domainIpv6IspCityNodes\domainIpv6IspCityNode;
...
class domainIpv6IspCityNodes extends Model
{
    ...
    {
        Model::validateRequired('domainIpv6IspCityNode', $this->domainIpv6IspCityNode, true);
    }
