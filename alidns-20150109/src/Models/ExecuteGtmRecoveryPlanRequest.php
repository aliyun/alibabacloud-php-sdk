...
class ExecuteGtmRecoveryPlanRequest extends Model
{
    /**
    ...
    /**
     * @description The ID of the disaster recovery plan that you want to executed.
     *
     ...
     * @param array $map
     *
     * @return ExecuteGtmRecoveryPlanRequest
     */
