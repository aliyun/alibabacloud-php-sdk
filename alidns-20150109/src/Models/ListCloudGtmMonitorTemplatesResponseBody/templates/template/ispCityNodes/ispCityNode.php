...
namespace AlibabaCloud\SDK\Alidns\V20150109\Models\ListCloudGtmMonitorTemplatesResponseBody\templates\template\ispCityNodes;
...
class ispCityNode extends Model
{
    ...
    /**
     * @description Probe node group name.
     *
     * @example BGP Nodes
     *
     * @var string
