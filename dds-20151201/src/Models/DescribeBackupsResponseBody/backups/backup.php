...
class backup extends Model
{
    ...
    /**
     * @description The name of the backup set. The parameter is invalid.
     *
    ...
    /**
     * @description The backup granularity. The parameter is invalid.
     *
     * @example DBInstance
     *
     * @var string
    ...
    /**
     * @description Version of the backuped instance.
     *
     *   **6.0**
     *   **5.0**
     *   **4.4**
