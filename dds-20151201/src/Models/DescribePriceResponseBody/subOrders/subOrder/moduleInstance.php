...
{
    /**
     * @var \AlibabaCloud\SDK\Dds\V20151201\Models\DescribePriceResponseBody\subOrders\subOrder\moduleInstance\moduleInstance[]
     */
        ...
        if (isset($map['ModuleInstance'])) {
            if (!empty($map['ModuleInstance'])) {
                ...
                foreach ($map['ModuleInstance'] as $item) {
                    $model->moduleInstance[$n++] = null !== $item ? \AlibabaCloud\SDK\Dds\V20151201\Models\DescribePriceResponseBody\subOrders\subOrder\moduleInstance\moduleInstance::fromMap($item) : $item;
                }
            }
        }
