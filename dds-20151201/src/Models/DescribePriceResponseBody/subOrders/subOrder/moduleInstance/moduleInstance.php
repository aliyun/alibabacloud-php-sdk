...
class moduleInstance extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->unitPriceUnit4Buy) {
            $res['UnitPriceUnit4Buy'] = $this->unitPriceUnit4Buy;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['UnitPriceUnit4Buy'])) {
            $model->unitPriceUnit4Buy = $map['UnitPriceUnit4Buy'];
        }
