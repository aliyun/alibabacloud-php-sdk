...
class stackGroupOperation extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->operationPreferences) {
            $this->operationPreferences->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->operationPreferences) {
            $res['OperationPreferences'] = null !== $this->operationPreferences ? $this->operationPreferences->toArray($noStream) : $this->operationPreferences;
        }
