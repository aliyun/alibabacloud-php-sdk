...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\GetUserPoolSyncJobResponseBody\synchronizationJob;

class GetUserPoolSyncJobResponseBody extends Model
{
    /**
     * @var string
     */
