...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\GetSpecificIdentityProviderResponseBody\specificIdentityProviderConfiguration;

class GetSpecificIdentityProviderResponseBody extends Model
{
    /**
     * @var string
     */
