...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\GetAPIKeyCredentialProviderResponseBody\APIKeyCredentialProvider;

class GetAPIKeyCredentialProviderResponseBody extends Model
{
    /**
