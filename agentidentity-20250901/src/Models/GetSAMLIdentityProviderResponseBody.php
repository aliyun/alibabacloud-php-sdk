...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\GetSAMLIdentityProviderResponseBody\SSOIdentityProviderConfiguration;

class GetSAMLIdentityProviderResponseBody extends Model
{
    /**
     * @var string
     */
