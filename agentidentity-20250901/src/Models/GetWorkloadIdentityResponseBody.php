...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\GetWorkloadIdentityResponseBody\workloadIdentity;

class GetWorkloadIdentityResponseBody extends Model
{
    /**
     * @var string
     */
