...
use AlibabaCloud\SDK\AgentIdentity\V20250901\Models\UpdateGatewayPolicyConfigResponseBody\gatewayPolicyConfig;

class UpdateGatewayPolicyConfigResponseBody extends Model
{
    /**
