...
class CreateOssBucketScanTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateOssBucketScanTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateOssBucketScanTaskResponseBody::fromMap($map['body']);
        }
