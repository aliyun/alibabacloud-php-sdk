...
namespace AlibabaCloud\SDK\Devops\V20210625\Models\ListMergeRequestCommentsResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Devops\V20210625\Models\ListMergeRequestCommentsResponseBody\result\author;
use AlibabaCloud\SDK\Devops\V20210625\Models\ListMergeRequestCommentsResponseBody\result\childComments;
use AlibabaCloud\SDK\Devops\V20210625\Models\ListMergeRequestCommentsResponseBody\result\relatedPatchSet;
...
class result extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->childComments)) {
            Model::validateArray($this->childComments);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->childComments) {
            if (\is_array($this->childComments)) {
                $res['childComments'] = [];
                $n1                   = 0;
                foreach ($this->childComments as $item1) {
                    $res['childComments'][$n1++] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['childComments'])) {
            if (!empty($map['childComments'])) {
                $model->childComments = [];
                $n1                   = 0;
                foreach ($map['childComments'] as $item1) {
                    $model->childComments[$n1++] = childComments::fromMap($item1);
                }
            }
        }
