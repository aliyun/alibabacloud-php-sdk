...
class result extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->childComments) {
            $res['childComments'] = [];
            if (null !== $this->childComments && \is_array($this->childComments)) {
                $n = 0;
                foreach ($this->childComments as $item) {
                    $res['childComments'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['childComments'])) {
            if (!empty($map['childComments'])) {
                $model->childComments = [];
                $n                    = 0;
                foreach ($map['childComments'] as $item) {
                    $model->childComments[$n++] = null !== $item ? childComments::fromMap($item) : $item;
                }
            }
        }
