...
use AlibabaCloud\SDK\Devops\V20210625\Models\UpdateWorkItemResponseBody\workitem;
use AlibabaCloud\Tea\Model;

class UpdateWorkItemResponseBody extends Model
{
    /**
     * @description 错误码
     *
     ...
     * @param array $map
     *
     * @return UpdateWorkItemResponseBody
     */
