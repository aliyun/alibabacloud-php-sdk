...
use AlibabaCloud\SDK\Devops\V20210625\Models\ListAppReleaseStageExecutionIntegratedMetadataResponse\body;
use AlibabaCloud\Tea\Model;

class ListAppReleaseStageExecutionIntegratedMetadataResponse extends Model
{
    /**
     * @var string[]
     */
