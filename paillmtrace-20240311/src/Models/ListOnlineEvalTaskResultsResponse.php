...
class ListOnlineEvalTaskResultsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListOnlineEvalTaskResultsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListOnlineEvalTaskResultsResponseBody::fromMap($map['body']);
        }
