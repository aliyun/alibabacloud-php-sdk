...
class GetEvaluationTemplatesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetEvaluationTemplatesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetEvaluationTemplatesResponseBody::fromMap($map['body']);
        }
