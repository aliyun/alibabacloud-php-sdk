...
class parts extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->infoPart) {
            $this->infoPart->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->infoPart) {
            $res['infoPart'] = null !== $this->infoPart ? $this->infoPart->toArray($noStream) : $this->infoPart;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['infoPart'])) {
            $model->infoPart = infoPart::fromMap($map['infoPart']);
        }
