...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetLiveReplayUrlHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class GetLiveReplayUrlHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return GetLiveReplayUrlHeaders
     */
