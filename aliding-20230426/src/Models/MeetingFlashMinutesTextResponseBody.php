...
use AlibabaCloud\SDK\Aliding\V20230426\Models\MeetingFlashMinutesTextResponseBody\paragraphList;

class MeetingFlashMinutesTextResponseBody extends Model
{
    /**
     * @var bool
     */
