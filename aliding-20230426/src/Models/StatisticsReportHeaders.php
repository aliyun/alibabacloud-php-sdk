...
use AlibabaCloud\SDK\Aliding\V20230426\Models\StatisticsReportHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class StatisticsReportHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return StatisticsReportHeaders
     */
