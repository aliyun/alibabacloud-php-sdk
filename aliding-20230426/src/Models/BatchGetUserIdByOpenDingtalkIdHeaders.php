...
use AlibabaCloud\SDK\Aliding\V20230426\Models\BatchGetUserIdByOpenDingtalkIdHeaders\accountContext;

class BatchGetUserIdByOpenDingtalkIdHeaders extends Model
{
    /**
     * @var string[]
     */
