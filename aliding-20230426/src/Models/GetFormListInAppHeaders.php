...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetFormListInAppHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class GetFormListInAppHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return GetFormListInAppHeaders
     */
