...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetScencegroupFileDownloadurlHeaders\accountContext;

class GetScencegroupFileDownloadurlHeaders extends Model
{
    /**
     * @var string[]
     */
