...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetDingtalkMeetingMemberEventHeaders\accountContext;

class GetDingtalkMeetingMemberEventHeaders extends Model
{
    /**
     * @var string[]
     */
