...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetDingtalkMeetingMemberListHeaders\accountContext;

class GetDingtalkMeetingMemberListHeaders extends Model
{
    /**
     * @var string[]
     */
