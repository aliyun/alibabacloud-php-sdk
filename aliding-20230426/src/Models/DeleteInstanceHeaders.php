...
use AlibabaCloud\SDK\Aliding\V20230426\Models\DeleteInstanceHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class DeleteInstanceHeaders extends Model
{
