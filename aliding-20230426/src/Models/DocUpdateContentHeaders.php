...
use AlibabaCloud\SDK\Aliding\V20230426\Models\DocUpdateContentHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class DocUpdateContentHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return DocUpdateContentHeaders
     */
