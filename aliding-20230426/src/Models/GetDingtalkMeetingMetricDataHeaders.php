...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetDingtalkMeetingMetricDataHeaders\accountContext;

class GetDingtalkMeetingMetricDataHeaders extends Model
{
    /**
     * @var string[]
     */
