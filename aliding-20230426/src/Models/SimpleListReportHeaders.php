...
use AlibabaCloud\SDK\Aliding\V20230426\Models\SimpleListReportHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class SimpleListReportHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return SimpleListReportHeaders
     */
