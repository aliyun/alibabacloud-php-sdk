...
use AlibabaCloud\SDK\Aliding\V20230426\Models\ListDriveSpacesHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class ListDriveSpacesHeaders extends Model
{
