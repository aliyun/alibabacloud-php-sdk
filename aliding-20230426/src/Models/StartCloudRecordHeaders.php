...
use AlibabaCloud\SDK\Aliding\V20230426\Models\StartCloudRecordHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class StartCloudRecordHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return StartCloudRecordHeaders
     */
