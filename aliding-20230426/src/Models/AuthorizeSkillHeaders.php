...
use AlibabaCloud\SDK\Aliding\V20230426\Models\AuthorizeSkillHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class AuthorizeSkillHeaders extends Model
{
