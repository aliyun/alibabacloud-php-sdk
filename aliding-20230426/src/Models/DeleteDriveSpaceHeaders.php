...
use AlibabaCloud\SDK\Aliding\V20230426\Models\DeleteDriveSpaceHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class DeleteDriveSpaceHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return DeleteDriveSpaceHeaders
     */
