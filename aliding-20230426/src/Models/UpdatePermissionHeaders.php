...
use AlibabaCloud\SDK\Aliding\V20230426\Models\UpdatePermissionHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class UpdatePermissionHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return UpdatePermissionHeaders
     */
