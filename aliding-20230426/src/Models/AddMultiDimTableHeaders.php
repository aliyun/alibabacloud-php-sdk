...
use AlibabaCloud\SDK\Aliding\V20230426\Models\AddMultiDimTableHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class AddMultiDimTableHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return AddMultiDimTableHeaders
     */
