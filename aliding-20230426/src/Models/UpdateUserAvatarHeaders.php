...
use AlibabaCloud\SDK\Aliding\V20230426\Models\UpdateUserAvatarHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class UpdateUserAvatarHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return UpdateUserAvatarHeaders
     */
