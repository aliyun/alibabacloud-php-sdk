...
use AlibabaCloud\SDK\Aliding\V20230426\Models\CreateSearchDomeHeaders\accountContext;
use AlibabaCloud\Tea\Model;

class CreateSearchDomeHeaders extends Model
{
     ...
     * @param array $map
     *
     * @return CreateSearchDomeHeaders
     */
