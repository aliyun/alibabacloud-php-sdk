...
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetCardTemplateHeaders;
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetCardTemplateRequest;
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetCardTemplateResponse;
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetCardTemplateShrinkHeaders;
use AlibabaCloud\SDK\Aliding\V20230426\Models\GetCardTemplateShrinkRequest;
...
class Aliding extends OpenApiClient
{
     ...
     *
     * @param ChangeDingTalkIdRequest $tmpReq
     * @param ChangeDingTalkIdHeaders $tmpHeader
     * @param RuntimeOptions          $runtime
     *
     ...
     * @returns ChangeDingTalkIdResponse
     *
     * @param ChangeDingTalkIdRequest $request
     *
     * @return ChangeDingTalkIdResponse
     */
    ...
    public function createTodoTaskWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (null !== $tmpReq->remindNotifyConfigs) {
            $request->remindNotifyConfigsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->remindNotifyConfigs, 'remindNotifyConfigs', 'json');
        }
        ...
        if (null !== $request->remindNotifyConfigsShrink) {
     ...
     *
     * @param GetCardTemplateRequest $tmpReq
     * @param GetCardTemplateHeaders $tmpHeader
     * @param RuntimeOptions         $runtime
     *
     * @return GetCardTemplateResponse
     */
    public function getCardTemplateWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        $tmpReq->validate();
        $request = new GetCardTemplateShrinkRequest([]);
        Utils::convert($tmpReq, $request);
        $headers = new GetCardTemplateShrinkHeaders([]);
        Utils::convert($tmpHeader, $headers);
        if (null !== $tmpHeader->accountContext) {
            $headers->accountContextShrink = Utils::arrayToStringWithSpecifiedStyle($tmpHeader->accountContext, 'AccountContext', 'json');
        }
        ...
        return GetCardTemplateResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @returns GetCardTemplateResponse
     *
     * @param GetCardTemplateRequest $request
     *
     * @return GetCardTemplateResponse
     */
    public function getCardTemplate($request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = new GetCardTemplateHeaders([]);
