...
use AlibabaCloud\SDK\Aliding\V20230426\Models\ChangeDingTalkIdHeaders;
use AlibabaCloud\SDK\Aliding\V20230426\Models\ChangeDingTalkIdRequest;
use AlibabaCloud\SDK\Aliding\V20230426\Models\ChangeDingTalkIdResponse;
use AlibabaCloud\SDK\Aliding\V20230426\Models\ChangeDingTalkIdShrinkHeaders;
use AlibabaCloud\SDK\Aliding\V20230426\Models\ChangeDingTalkIdShrinkRequest;
...
class Aliding extends OpenApiClient
{
     ...
     * @summary 添加文件夹
     *  *
     * @param AddFolderRequest $tmpReq    AddFolderRequest
     * @param AddFolderHeaders $tmpHeader AddFolderHeaders
     * @param RuntimeOptions   $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 新增数据表
     *  *
     * @param AddMultiDimTableRequest $tmpReq    AddMultiDimTableRequest
     * @param AddMultiDimTableHeaders $tmpHeader AddMultiDimTableHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
     * @return AddMultiDimTableResponse AddMultiDimTableResponse
     */
     ...
     * @summary 新增数据表
     *  *
     * @param AddMultiDimTableRequest $request AddMultiDimTableRequest
     *
     * @return AddMultiDimTableResponse AddMultiDimTableResponse
     */
     ...
     * @summary 添加文件权限
     *  *
     * @param AddPermissionRequest $tmpReq    AddPermissionRequest
     * @param AddPermissionHeaders $tmpHeader AddPermissionHeaders
     * @param RuntimeOptions       $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 校验AI技能调用权限
     *  *
     * @param AuthorizeSkillRequest $tmpReq    AuthorizeSkillRequest
     * @param AuthorizeSkillHeaders $tmpHeader AuthorizeSkillHeaders
     * @param RuntimeOptions        $runtime   runtime options for this request RuntimeOptions
     *
     * @return AuthorizeSkillResponse AuthorizeSkillResponse
     */
    public function authorizeSkillWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        $body = [];
        if (!Utils::isUnset($request->permissionCodesShrink)) {
     ...
     * @summary 校验AI技能调用权限
     *  *
     * @param AuthorizeSkillRequest $request AuthorizeSkillRequest
     *
     * @return AuthorizeSkillResponse AuthorizeSkillResponse
     */
     ...
     * @summary 修改阿里钉号
     *  *
     * @param ChangeDingTalkIdRequest $tmpReq    ChangeDingTalkIdRequest
     * @param ChangeDingTalkIdHeaders $tmpHeader ChangeDingTalkIdHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
     * @return ChangeDingTalkIdResponse ChangeDingTalkIdResponse
     */
    public function changeDingTalkIdWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        Utils::validateModel($tmpReq);
        $request = new ChangeDingTalkIdShrinkRequest([]);
        OpenApiUtilClient::convert($tmpReq, $request);
        $headers = new ChangeDingTalkIdShrinkHeaders([]);
        OpenApiUtilClient::convert($tmpHeader, $headers);
        if (!Utils::isUnset($tmpHeader->accountContext)) {
            $headers->accountContextShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpHeader->accountContext, 'AccountContext', 'json');
        }
        ...
        return ChangeDingTalkIdResponse::fromMap($this->callApi($params, $req, $runtime));
    }
    ...
    /**
     * @param CreateAlidingAssistantRequest $tmpReq    CreateAlidingAssistantRequest
     * @param CreateAlidingAssistantHeaders $tmpHeader CreateAlidingAssistantHeaders
     * @param RuntimeOptions                $runtime   runtime options for this request RuntimeOptions
     *
     * @return CreateAlidingAssistantResponse CreateAlidingAssistantResponse
     */
    public function createAlidingAssistantWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($tmpReq->recommendPrompts)) {
            $request->recommendPromptsShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->recommendPrompts, 'RecommendPrompts', 'json');
        }
        if (!Utils::isUnset($tmpReq->tenantContext)) {
            $request->tenantContextShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->tenantContext, 'TenantContext', 'json');
        }
        ...
        if (!Utils::isUnset($request->recommendPromptsShrink)) {
            $body['RecommendPrompts'] = $request->recommendPromptsShrink;
        }
        if (!Utils::isUnset($request->source)) {
            $body['Source'] = $request->source;
        }
        if (!Utils::isUnset($request->sourceIdentityId)) {
    ...
    /**
     * @param CreateAlidingAssistantRequest $request CreateAlidingAssistantRequest
     *
     * @return CreateAlidingAssistantResponse CreateAlidingAssistantResponse
     */
    ...
    public function createMessageWithOptions($request, $headers, $runtime)
    {
        ...
        if (!Utils::isUnset($request->originalAssistantId)) {
            $body['originalAssistantId'] = $request->originalAssistantId;
        }
        if (!Utils::isUnset($request->sourceIdOfOriginalAssistantId)) {
            $body['sourceIdOfOriginalAssistantId'] = $request->sourceIdOfOriginalAssistantId;
        }
        if (!Utils::isUnset($request->sourceTypeOfOriginalAssistantId)) {
        ...
        if (!Utils::isUnset($headers->accountId)) {
            $realHeaders['accountId'] = Utils::toJSONString($headers->accountId);
        }
        $req = new OpenApiRequest([
            'headers' => $realHeaders,
            'body' => OpenApiUtilClient::parseToMap($body),
     ...
     * @summary 创建字段
     *  *
     * @param CreateMultiDimTableFieldRequest $tmpReq    CreateMultiDimTableFieldRequest
     * @param CreateMultiDimTableFieldHeaders $tmpHeader CreateMultiDimTableFieldHeaders
     * @param RuntimeOptions                  $runtime   runtime options for this request RuntimeOptions
     *
     * @return CreateMultiDimTableFieldResponse CreateMultiDimTableFieldResponse
     */
     ...
     * @summary 创建字段
     *  *
     * @param CreateMultiDimTableFieldRequest $request CreateMultiDimTableFieldRequest
     *
     * @return CreateMultiDimTableFieldResponse CreateMultiDimTableFieldResponse
     */
     ...
     * @param CreateRunHeaders $headers CreateRunHeaders
     * @param RuntimeOptions   $runtime runtime options for this request RuntimeOptions
     *
    ...
    public function createRunWithOptions($request, $headers, $runtime)
    {
        Utils::validateModel($request);
        $body = [];
        if (!Utils::isUnset($request->allowStructViewContent)) {
     ...
     * @summary 创建线程
     *  *
     * @param CreateThreadRequest $request CreateThreadRequest
     * @param CreateThreadHeaders $headers CreateThreadHeaders
     * @param RuntimeOptions      $runtime runtime options for this request RuntimeOptions
     *
     * @return CreateThreadResponse CreateThreadResponse
     */
    ...
    public function createTodoTaskWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($tmpReq->actionList)) {
            $request->actionListShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->actionList, 'actionList', 'json');
        }
        ...
        if (!Utils::isUnset($request->actionListShrink)) {
    ...
    /**
     * @param DeleteAlidingAssistantRequest $tmpReq    DeleteAlidingAssistantRequest
     * @param DeleteAlidingAssistantHeaders $tmpHeader DeleteAlidingAssistantHeaders
     * @param RuntimeOptions                $runtime   runtime options for this request RuntimeOptions
     *
     * @return DeleteAlidingAssistantResponse DeleteAlidingAssistantResponse
     */
    ...
    /**
     * @param DeleteAlidingAssistantRequest $request DeleteAlidingAssistantRequest
     *
     * @return DeleteAlidingAssistantResponse DeleteAlidingAssistantResponse
     */
     ...
     * @summary 删除文件或文件夹
     *  *
     * @param DeleteDentryRequest $tmpReq    DeleteDentryRequest
     * @param DeleteDentryHeaders $tmpHeader DeleteDentryHeaders
     * @param RuntimeOptions      $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 删除字段
     *  *
     * @param DeleteMultiDimTableFieldRequest $tmpReq    DeleteMultiDimTableFieldRequest
     * @param DeleteMultiDimTableFieldHeaders $tmpHeader DeleteMultiDimTableFieldHeaders
     * @param RuntimeOptions                  $runtime   runtime options for this request RuntimeOptions
     *
     * @return DeleteMultiDimTableFieldResponse DeleteMultiDimTableFieldResponse
     */
    public function deleteMultiDimTableFieldWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($request->fieldIdOrName)) {
     ...
     * @summary 删除字段
     *  *
     * @param DeleteMultiDimTableFieldRequest $request DeleteMultiDimTableFieldRequest
     *
     * @return DeleteMultiDimTableFieldResponse DeleteMultiDimTableFieldResponse
     */
     ...
     * @summary 删除多行记录
     *  *
     * @param DeleteMultiDimTableRecordsRequest $tmpReq    DeleteMultiDimTableRecordsRequest
     * @param DeleteMultiDimTableRecordsHeaders $tmpHeader DeleteMultiDimTableRecordsHeaders
     * @param RuntimeOptions                    $runtime   runtime options for this request RuntimeOptions
     *
     * @return DeleteMultiDimTableRecordsResponse DeleteMultiDimTableRecordsResponse
     */
     ...
     * @summary 删除多行记录
     *  *
     * @param DeleteMultiDimTableRecordsRequest $request DeleteMultiDimTableRecordsRequest
     *
     * @return DeleteMultiDimTableRecordsResponse DeleteMultiDimTableRecordsResponse
     */
     ...
     * @summary 删除文件权限
     *  *
     * @param DeletePermissionRequest $tmpReq    DeletePermissionRequest
     * @param DeletePermissionHeaders $tmpHeader DeletePermissionHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 查询块元素
     *  *
     * @param DocBlocksQueryRequest $tmpReq    DocBlocksQueryRequest
     * @param DocBlocksQueryHeaders $tmpHeader DocBlocksQueryHeaders
     * @param RuntimeOptions        $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 覆写文档
     *  *
     * @param DocUpdateContentRequest $tmpReq    DocUpdateContentRequest
     * @param DocUpdateContentHeaders $tmpHeader DocUpdateContentHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 获取阿里钉ai助理信息
     *  *
     * @param GetAlidingAssistantInfoRequest $tmpReq    GetAlidingAssistantInfoRequest
     * @param GetAlidingAssistantInfoHeaders $tmpHeader GetAlidingAssistantInfoHeaders
     * @param RuntimeOptions                 $runtime   runtime options for this request RuntimeOptions
     *
     * @return GetAlidingAssistantInfoResponse GetAlidingAssistantInfoResponse
     */
     ...
     * @summary 获取阿里钉ai助理信息
     *  *
     * @param GetAlidingAssistantInfoRequest $request GetAlidingAssistantInfoRequest
     *
     * @return GetAlidingAssistantInfoResponse GetAlidingAssistantInfoResponse
     */
     ...
     * @summary 获取助理能力
     *  *
     * @param GetAssistantCapabilityRequest $request GetAssistantCapabilityRequest
     * @param GetAssistantCapabilityHeaders $headers GetAssistantCapabilityHeaders
     * @param RuntimeOptions                $runtime runtime options for this request RuntimeOptions
     *
     * @return GetAssistantCapabilityResponse GetAssistantCapabilityResponse
     */
     ...
     * @summary 文档中插入内容
     *  *
     * @param InsertContentWithOptionsRequest $tmpReq    InsertContentWithOptionsRequest
     * @param InsertContentWithOptionsHeaders $tmpHeader InsertContentWithOptionsHeaders
     * @param RuntimeOptions                  $runtime   runtime options for this request RuntimeOptions
     *
     * @return InsertContentWithOptionsResponse InsertContentWithOptionsResponse
     */
    public function insertContentWithOptionsWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($tmpReq->path)) {
            $request->pathShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->path, 'Path', 'json');
        }
        if (!Utils::isUnset($tmpReq->tenantContext)) {
            $request->tenantContextShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->tenantContext, 'TenantContext', 'json');
        }
        ...
        if (!Utils::isUnset($request->pathShrink)) {
     ...
     * @summary 文档中插入内容
     *  *
     * @param InsertContentWithOptionsRequest $request InsertContentWithOptionsRequest
     *
     * @return InsertContentWithOptionsResponse InsertContentWithOptionsResponse
     */
     ...
     * @summary 插入下拉列表
     *  *
     * @param InsertDropDownListRequest $tmpReq    InsertDropDownListRequest
     * @param InsertDropDownListHeaders $tmpHeader InsertDropDownListHeaders
     * @param RuntimeOptions            $runtime   runtime options for this request RuntimeOptions
     *
     * @return InsertDropDownListResponse InsertDropDownListResponse
     */
     ...
     * @summary 插入下拉列表
     *  *
     * @param InsertDropDownListRequest $request InsertDropDownListRequest
     *
     * @return InsertDropDownListResponse InsertDropDownListResponse
     */
     ...
     * @summary 新增记录
     *  *
     * @param InsertMultiDimTableRecordRequest $tmpReq    InsertMultiDimTableRecordRequest
     * @param InsertMultiDimTableRecordHeaders $tmpHeader InsertMultiDimTableRecordHeaders
     * @param RuntimeOptions                   $runtime   runtime options for this request RuntimeOptions
     *
     * @return InsertMultiDimTableRecordResponse InsertMultiDimTableRecordResponse
     */
     ...
     * @summary 新增记录
     *  *
     * @param InsertMultiDimTableRecordRequest $request InsertMultiDimTableRecordRequest
     *
     * @return InsertMultiDimTableRecordResponse InsertMultiDimTableRecordResponse
     */
     ...
     * @summary 调用助理
     *  *
     * @param InvokeAssistantRequest $request InvokeAssistantRequest
     * @param InvokeAssistantHeaders $headers InvokeAssistantHeaders
     * @param RuntimeOptions         $runtime runtime options for this request RuntimeOptions
     *
     * @return InvokeAssistantResponse InvokeAssistantResponse
     */
     ...
     * @summary 调用AI技能
     *  *
     * @param InvokeSkillRequest $tmpReq    InvokeSkillRequest
     * @param InvokeSkillHeaders $tmpHeader InvokeSkillHeaders
     * @param RuntimeOptions     $runtime   runtime options for this request RuntimeOptions
     *
     * @return InvokeSkillResponse InvokeSkillResponse
     */
     ...
     * @summary 调用AI技能
     *  *
     * @param InvokeSkillRequest $request InvokeSkillRequest
     *
     * @return InvokeSkillResponse InvokeSkillResponse
     */
     ...
     * @param ListMessageHeaders $headers ListMessageHeaders
     * @param RuntimeOptions     $runtime runtime options for this request RuntimeOptions
     *
     ...
     * @summary 获取文件权限列表
     *  *
     * @param ListPermissionsRequest $tmpReq    ListPermissionsRequest
     * @param ListPermissionsHeaders $tmpHeader ListPermissionsHeaders
     * @param RuntimeOptions         $runtime   runtime options for this request RuntimeOptions
     *
     ...
     * @summary 列出AI技能
     *  *
     * @param ListSkillRequest $request   ListSkillRequest
     * @param ListSkillHeaders $tmpHeader ListSkillHeaders
     * @param RuntimeOptions   $runtime   runtime options for this request RuntimeOptions
     *
     * @return ListSkillResponse ListSkillResponse
     */
     ...
     * @summary 获取文件或文件夹信息
     *  *
     * @param QueryDentriesInfoRequest $tmpReq    QueryDentriesInfoRequest
     * @param QueryDentriesInfoHeaders $tmpHeader QueryDentriesInfoHeaders
     * @param RuntimeOptions           $runtime   runtime options for this request RuntimeOptions
     *
     * @return QueryDentriesInfoResponse QueryDentriesInfoResponse
     */
    public function queryDentriesInfoWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($tmpReq->appIdsForAppProperties)) {
            $request->appIdsForAppPropertiesShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->appIdsForAppProperties, 'AppIdsForAppProperties', 'json');
        }
        if (!Utils::isUnset($tmpReq->tenantContext)) {
            $request->tenantContextShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->tenantContext, 'TenantContext', 'json');
        }
        $body = [];
        if (!Utils::isUnset($request->appIdsForAppPropertiesShrink)) {
     ...
     * @summary 获取文件或文件夹信息
     *  *
     * @param QueryDentriesInfoRequest $request QueryDentriesInfoRequest
     *
     * @return QueryDentriesInfoResponse QueryDentriesInfoResponse
     */
     ...
     * @summary 查询运行
     *  *
     * @param RetrieveRunRequest $request RetrieveRunRequest
     * @param RetrieveRunHeaders $headers RetrieveRunHeaders
     * @param RuntimeOptions     $runtime runtime options for this request RuntimeOptions
     *
     * @return RetrieveRunResponse RetrieveRunResponse
     */
     ...
     * @summary 订阅文件变更事件
     *  *
     * @param SubscribeEventRequest $tmpReq    SubscribeEventRequest
     * @param SubscribeEventHeaders $tmpHeader SubscribeEventHeaders
     * @param RuntimeOptions        $runtime   runtime options for this request RuntimeOptions
     *
    ...
    /**
     * @param SwitchMainOrgRequest $tmpReq    SwitchMainOrgRequest
     * @param SwitchMainOrgHeaders $tmpHeader SwitchMainOrgHeaders
     * @param RuntimeOptions       $runtime   runtime options for this request RuntimeOptions
     *
     * @return SwitchMainOrgResponse SwitchMainOrgResponse
     */
    public function switchMainOrgWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        $body = [];
        if (!Utils::isUnset($request->targetOrgId)) {
    ...
    /**
     * @param SwitchMainOrgRequest $request SwitchMainOrgRequest
     *
     * @return SwitchMainOrgResponse SwitchMainOrgResponse
     */
     ...
     * @summary 取消订阅文件变更事件
     *  *
     * @param UnsubscribeEventRequest $tmpReq    UnsubscribeEventRequest
     * @param UnsubscribeEventHeaders $tmpHeader UnsubscribeEventHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
    ...
    /**
     * @param UpdateAlidingAssistantRequest $tmpReq    UpdateAlidingAssistantRequest
     * @param UpdateAlidingAssistantHeaders $tmpHeader UpdateAlidingAssistantHeaders
     * @param RuntimeOptions                $runtime   runtime options for this request RuntimeOptions
     *
     * @return UpdateAlidingAssistantResponse UpdateAlidingAssistantResponse
     */
    ...
    /**
     * @param UpdateAlidingAssistantRequest $request UpdateAlidingAssistantRequest
     *
     * @return UpdateAlidingAssistantResponse UpdateAlidingAssistantResponse
     */
    ...
    /**
     * @param UpdateConvExtensionRequest $tmpReq    UpdateConvExtensionRequest
     * @param UpdateConvExtensionHeaders $tmpHeader UpdateConvExtensionHeaders
     * @param RuntimeOptions             $runtime   runtime options for this request RuntimeOptions
     *
     * @return UpdateConvExtensionResponse UpdateConvExtensionResponse
     */
    public function updateConvExtensionWithOptions($tmpReq, $tmpHeader, $runtime)
    {
        ...
        if (!Utils::isUnset($tmpReq->staffIdList)) {
            $request->staffIdListShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->staffIdList, 'StaffIdList', 'json');
        }
        if (!Utils::isUnset($tmpReq->tenantContext)) {
            $request->tenantContextShrink = OpenApiUtilClient::arrayToStringWithSpecifiedStyle($tmpReq->tenantContext, 'TenantContext', 'json');
        }
        ...
        if (!Utils::isUnset($request->staffIdListShrink)) {
            $body['StaffIdList'] = $request->staffIdListShrink;
        }
        if (!Utils::isUnset($request->systemUid)) {
    ...
    /**
     * @param UpdateConvExtensionRequest $request UpdateConvExtensionRequest
     *
     * @return UpdateConvExtensionResponse UpdateConvExtensionResponse
     */
     ...
     * @summary 更新数据表
     *  *
     * @param UpdateMultiDimTableRequest $tmpReq    UpdateMultiDimTableRequest
     * @param UpdateMultiDimTableHeaders $tmpHeader UpdateMultiDimTableHeaders
     * @param RuntimeOptions             $runtime   runtime options for this request RuntimeOptions
     *
     * @return UpdateMultiDimTableResponse UpdateMultiDimTableResponse
     */
     ...
     * @summary 更新数据表
     *  *
     * @param UpdateMultiDimTableRequest $request UpdateMultiDimTableRequest
     *
     * @return UpdateMultiDimTableResponse UpdateMultiDimTableResponse
     */
     ...
     * @summary 更新字段
     *  *
     * @param UpdateMultiDimTableFieldRequest $tmpReq    UpdateMultiDimTableFieldRequest
     * @param UpdateMultiDimTableFieldHeaders $tmpHeader UpdateMultiDimTableFieldHeaders
     * @param RuntimeOptions                  $runtime   runtime options for this request RuntimeOptions
     *
     * @return UpdateMultiDimTableFieldResponse UpdateMultiDimTableFieldResponse
     */
     ...
     * @summary 更新字段
     *  *
     * @param UpdateMultiDimTableFieldRequest $request UpdateMultiDimTableFieldRequest
     *
     * @return UpdateMultiDimTableFieldResponse UpdateMultiDimTableFieldResponse
     */
     ...
     * @summary 更新多行记录
     *  *
     * @param UpdateMultiDimTableRecordsRequest $tmpReq    UpdateMultiDimTableRecordsRequest
     * @param UpdateMultiDimTableRecordsHeaders $tmpHeader UpdateMultiDimTableRecordsHeaders
     * @param RuntimeOptions                    $runtime   runtime options for this request RuntimeOptions
     *
     * @return UpdateMultiDimTableRecordsResponse UpdateMultiDimTableRecordsResponse
     */
     ...
     * @summary 更新多行记录
     *  *
     * @param UpdateMultiDimTableRecordsRequest $request UpdateMultiDimTableRecordsRequest
     *
     * @return UpdateMultiDimTableRecordsResponse UpdateMultiDimTableRecordsResponse
     */
     ...
     * @summary 更新文件权限
     *  *
     * @param UpdatePermissionRequest $tmpReq    UpdatePermissionRequest
     * @param UpdatePermissionHeaders $tmpHeader UpdatePermissionHeaders
     * @param RuntimeOptions          $runtime   runtime options for this request RuntimeOptions
     *
