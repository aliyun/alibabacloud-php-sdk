...
namespace AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListSuccessInstanceAmountResponse;

use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListSuccessInstanceAmountResponse\instanceStatusTrend\avgTrend;
use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListSuccessInstanceAmountResponse\instanceStatusTrend\todayTrend;
use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListSuccessInstanceAmountResponse\instanceStatusTrend\yesterdayTrend;
...
class instanceStatusTrend extends Model
{
    ...
    {
        Model::validateRequired('todayTrend', $this->todayTrend, true);
        Model::validateRequired('yesterdayTrend', $this->yesterdayTrend, true);
        Model::validateRequired('avgTrend', $this->avgTrend, true);
    }
