...
class RunCycleDagNodesRequest extends Model
{
    ...
    /**
     * @description The time when the node starts to run. This parameter is required only for auto triggered nodes that are scheduled by hour. Specify the value in the HH:mm:ss format. Valid values: 00:00:00 to 23:59:59.
     *
     * @example 00:00:00
     *
     * @var string
    ...
    /**
     * @description The time when the node stops running. This parameter is required only for auto triggered nodes that are scheduled by hour. Specify the value in the HH:mm:ss format. Valid values: 00:00:00 to 23:59:59.
     *
     * @example 01:00:00
     *
     * @var string
    ...
    /**
     * @description The number of nodes that can run in parallel. Valid values: 2 to 10.
     *
     * @example 5
     *
     * @var int
    ...
    /**
     * @description The ID of the node for which you want to backfill data. If you want to backfill data for multiple nodes, separate the IDs of the nodes with commas (,). You can call the [ListNodes](https://help.aliyun.com/document_detail/173979.html) operation to obtain the node ID.
     *
     * This parameter is required.
     * @example 74324,74325
     *
    ...
    /**
     * @description The ID of the node for which data is first backfilled. You can call the [ListNodes](https://help.aliyun.com/document_detail/173979.html) operation to obtain the node ID.
     *
     * This parameter is required.
     * @example 1234
     *
