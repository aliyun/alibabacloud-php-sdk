...
class data extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->blockInstance) {
            $this->blockInstance->validate();
        }
        if (null !== $this->lastInstance) {
            $this->lastInstance->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->blockInstance) {
            $res['BlockInstance'] = null !== $this->blockInstance ? $this->blockInstance->toArray($noStream) : $this->blockInstance;
        }
        ...
        if (null !== $this->lastInstance) {
            $res['LastInstance'] = null !== $this->lastInstance ? $this->lastInstance->toArray($noStream) : $this->lastInstance;
        }
