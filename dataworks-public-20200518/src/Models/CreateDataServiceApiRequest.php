...
class CreateDataServiceApiRequest extends Model
{
    ...
    /**
     * @description The details of the API generated by registration. For more information, see the registrationDetails parameter returned by the [GetDataServiceApi](https://help.aliyun.com/document_detail/174013.html) operation.
     *
    ...
    /**
     * @description The format of the data to be requested. Valid values:
     *
     *   0: XML format
     *   1: JSON format
     *   2: form format
    ...
    /**
     * @description The details of the API generated in script mode. For more information, see the scriptDetails parameter returned by the [GetDataServiceApi](https://help.aliyun.com/document_detail/174013.html) operation.
     *
    ...
    /**
     * @description *   The SQL mode. Valid values: 0: The basic mode is used.
     *   1: Mybatis is used.
     *
     * @example 0
     *
    ...
    /**
     * @description The scope in which the API is visible. Valid values: 0 and 1. The value 0 indicates that the API is visible to all members in the workspace. The value 1 indicates that the API is visible only to its owner.
     *
     * This parameter is required.
     * @example 0
     *
    ...
    /**
     * @description The details of the API generated in wizard mode. For more information, see the WizardDetails parameter returned by the [GetDataServiceApi](https://help.aliyun.com/document_detail/174013.html) operation.
     *
