...
namespace AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\GetBaselineConfigResponseBody;
...
class data extends Model
{
    ...
    /**
     * @description The type of the baseline. Valid values: DAILY and HOURLY. The value DAILY indicates that the baseline is a day-level baseline. The value HOURLY indicates that the baseline is an hour-level baseline.
     *
     * @example DAILY
     *
     * @var string
    ...
    /**
     * @description The minute in the committed time of the day-level baseline. Valid values: 0 to 59.
     *
     * @example 30
     *
     * @var int
