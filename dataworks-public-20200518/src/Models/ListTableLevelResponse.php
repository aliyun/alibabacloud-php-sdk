...
use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListTableLevelResponse\tableLevelInfo;
use AlibabaCloud\Tea\Model;

class ListTableLevelResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('tableLevelInfo', $this->tableLevelInfo, true);
    }
