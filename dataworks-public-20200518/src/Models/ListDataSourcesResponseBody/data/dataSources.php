...
class dataSources extends Model
{
    ...
    /**
     * @description The data connection string. The value of this parameter is in the JSON format. Examples of connection strings of common data sources:
     *
     *   MaxCompute
     *
    ...
    /**
     * @description The sequence number of the data source. Data sources are sorted in descending order based on the value of this parameter.
     *
     * @example 300
     *
     * @var int
