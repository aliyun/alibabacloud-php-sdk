...
class apis extends Model
{
    ...
    /**
     * @description The protocols used by the API. Valid values: 0 and 1. A value of 0 indicates that the API uses HTTP. A value of 1 indicates that the API uses HTTPS. Multiple protocols are presented in a list.
     *
    ...
    /**
     * @description The ID of the folder in which the API is stored.
     *
     * @example 0
     *
     * @var int
    ...
    /**
     * @description The APIs in the development state.
     *
     * @example 10000
     *
     * @var int
