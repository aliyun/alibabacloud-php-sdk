...
namespace AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\GetPermissionApplyOrderDetailResponse;

use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\GetPermissionApplyOrderDetailResponse\applyOrderDetail\approveAccountList;
use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\GetPermissionApplyOrderDetailResponse\applyOrderDetail\approveContent;
use AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\GetPermissionApplyOrderDetailResponse\applyOrderDetail\granteeObjectList;
...
class applyOrderDetail extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('approveAccountList', $this->approveAccountList, true);
        Model::validateRequired('granteeObjectList', $this->granteeObjectList, true);
