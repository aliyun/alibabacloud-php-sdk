...
class granteeObjectList extends Model
{
    ...
    {
        Model::validateRequired('granteeId', $this->granteeId, true);
        Model::validateRequired('granteeName', $this->granteeName, true);
        Model::validateRequired('granteeType', $this->granteeType, true);
        Model::validateRequired('granteeTypeSub', $this->granteeTypeSub, true);
    }
