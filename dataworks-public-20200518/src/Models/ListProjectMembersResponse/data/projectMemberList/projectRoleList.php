...
namespace AlibabaCloud\SDK\Dataworkspublic\V20200518\Models\ListProjectMembersResponse\data\projectMemberList;
...
class projectRoleList extends Model
{
    ...
    {
        Model::validateRequired('projectRoleCode', $this->projectRoleCode, true);
        Model::validateRequired('projectRoleId', $this->projectRoleId, true);
        Model::validateRequired('projectRoleName', $this->projectRoleName, true);
        Model::validateRequired('projectRoleType', $this->projectRoleType, true);
    }
