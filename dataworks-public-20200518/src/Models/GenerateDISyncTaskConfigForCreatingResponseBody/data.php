...
class data extends Model
{
    ...
    /**
     * @description The ID of the asynchronous thread. You can call the [QueryDISyncTaskConfigProcessResult](https://help.aliyun.com/document_detail/383465.html) operation to obtain the asynchronously generated parameters based on the ID. The parameters are used to create a synchronization task in Data Integration.
     *
     * @example 10
     *
     * @var int
    ...
    /**
     * @description Indicates whether the ID of the asynchronous thread is generated. Valid values: Valid values:
     *
