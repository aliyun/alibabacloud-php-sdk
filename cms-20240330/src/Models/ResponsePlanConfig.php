...
use AlibabaCloud\SDK\Cms\V20240330\Models\ResponsePlanConfig\pushingSetting;
use AlibabaCloud\SDK\Cms\V20240330\Models\ResponsePlanConfig\repeatNotifySetting;

class ResponsePlanConfig extends Model
{
    /**
     * @var int
     */
