...
use AlibabaCloud\SDK\Cms\V20240330\Models\CreateContextStoreRequest\config;
use AlibabaCloud\SDK\Cms\V20240330\Models\CreateContextStoreRequest\dataset;

class CreateContextStoreRequest extends Model
{
    /**
     * @var config
     */
