...
use AlibabaCloud\SDK\Cms\V20240330\Models\CreateAggTaskGroupRequest\tags;

class CreateAggTaskGroupRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->overrideIfExists) {
            $res['overrideIfExists'] = $this->overrideIfExists;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['overrideIfExists'])) {
            $model->overrideIfExists = $map['overrideIfExists'];
        }
