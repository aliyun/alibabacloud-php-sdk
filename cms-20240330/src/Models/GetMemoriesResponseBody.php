...
use AlibabaCloud\SDK\Cms\V20240330\Models\GetMemoriesResponseBody\relations;
use AlibabaCloud\SDK\Cms\V20240330\Models\GetMemoriesResponseBody\results;

class GetMemoriesResponseBody extends Model
{
    /**
     * @var relations[]
     */
