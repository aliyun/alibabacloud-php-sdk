...
class CloudMonitoringSimpleEscalation extends Model
{
    /**
     * @var CloudMonitoringSimpleEscalationEntry[]
     */
    public $escalations;
        ...
        if (isset($map['escalations'])) {
            if (!empty($map['escalations'])) {
                ...
                foreach ($map['escalations'] as $item1) {
                    $model->escalations[$n1] = CloudMonitoringSimpleEscalationEntry::fromMap($item1);
                    ++$n1;
                }
            }
        }
