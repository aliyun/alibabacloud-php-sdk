...
namespace AlibabaCloud\SDK\Config\V20190108\Models\DescribeComplianceSummaryResponse;

use AlibabaCloud\SDK\Config\V20190108\Models\DescribeComplianceSummaryResponse\complianceSummary\complianceSummaryByConfigRule;
use AlibabaCloud\SDK\Config\V20190108\Models\DescribeComplianceSummaryResponse\complianceSummary\complianceSummaryByResource;
...
class complianceSummary extends Model
{
    ...
    {
        Model::validateRequired('complianceSummaryByConfigRule', $this->complianceSummaryByConfigRule, true);
        Model::validateRequired('complianceSummaryByResource', $this->complianceSummaryByResource, true);
    }
