...
namespace AlibabaCloud\SDK\Config\V20190108\Models\ActiveConfigRulesResponse;

use AlibabaCloud\SDK\Config\V20190108\Models\ActiveConfigRulesResponse\operateRuleResult\operateRuleItemList;
...
class operateRuleResult extends Model
{
    ...
    {
        Model::validateRequired('operateRuleItemList', $this->operateRuleItemList, true);
    }
