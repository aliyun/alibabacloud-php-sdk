...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\MobileRecycledMetaVerifyResponseBody\resultObject;

class MobileRecycledMetaVerifyResponseBody extends Model
{
    /**
     * @var string
     */
