...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\DescribeListFaceVerifyDataResponseBody\monitorData;

class DescribeListFaceVerifyDataResponseBody extends Model
{
    /**
     * @var monitorData
     */
