...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\DescribeVerifyDeviceRiskStatisticsResponseBody\resultObject;

class DescribeVerifyDeviceRiskStatisticsResponseBody extends Model
{
    /**
     * @var string
     */
