...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\DescribeVerifyPersonasOsStatisticsResponseBody\resultObject;

class DescribeVerifyPersonasOsStatisticsResponseBody extends Model
{
    /**
     * @var string
     */
