...
class QueryVerifyInvokeSatisticRequest extends Model
{
    /**
     * @var int
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->productProgramList) {
            $res['ProductProgramList'] = $this->productProgramList;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ProductProgramList'])) {
            $model->productProgramList = $map['ProductProgramList'];
        }
