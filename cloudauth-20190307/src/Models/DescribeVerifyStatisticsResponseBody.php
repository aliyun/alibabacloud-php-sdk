...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\DescribeVerifyStatisticsResponseBody\resultObject;

class DescribeVerifyStatisticsResponseBody extends Model
{
    /**
     * @var string
     */
