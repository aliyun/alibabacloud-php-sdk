...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\CredentialProductVerifyV2ResponseBody\resultObject;

class CredentialProductVerifyV2ResponseBody extends Model
{
    /**
     * @var string
     */
