...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\DescribeVerifyFailStatisticsResponseBody\resultObject;

class DescribeVerifyFailStatisticsResponseBody extends Model
{
    /**
     * @var string
     */
