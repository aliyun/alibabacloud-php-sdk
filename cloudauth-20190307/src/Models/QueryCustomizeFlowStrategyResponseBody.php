...
use AlibabaCloud\SDK\Cloudauth\V20190307\Models\QueryCustomizeFlowStrategyResponseBody\resultObject;

class QueryCustomizeFlowStrategyResponseBody extends Model
{
    /**
     * @var string
     */
