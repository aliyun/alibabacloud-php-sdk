...
use AlibabaCloud\SDK\Dms\V20250414\Models\ResetAgenticApiKeyRequest;
use AlibabaCloud\SDK\Dms\V20250414\Models\ResetAgenticApiKeyResponse;
...
class Dms extends OpenApiClient
{
     ...
     *
     * @param ResetAgenticApiKeyRequest $request
     * @param RuntimeOptions            $runtime
     *
     * @return ResetAgenticApiKeyResponse
     */
    public function resetAgenticApiKeyWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->expireAfterSeconds) {
        ...
        return ResetAgenticApiKeyResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return ResetAgenticApiKeyResponse
     */
    public function resetAgenticApiKey($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    public function sendChatMessageWithOptions($tmpReq, $runtime)
    {
        ...
        if (null !== $tmpReq->taskConfig) {
            $request->taskConfigShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->taskConfig, 'TaskConfig', 'json');
        }
        ...
        if (null !== $request->taskConfigShrink) {
