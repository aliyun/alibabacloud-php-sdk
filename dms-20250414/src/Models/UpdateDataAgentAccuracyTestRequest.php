...
class UpdateDataAgentAccuracyTestRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->customerAgentId) {
            $res['CustomerAgentId'] = $this->customerAgentId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CustomerAgentId'])) {
            $model->customerAgentId = $map['CustomerAgentId'];
        }
