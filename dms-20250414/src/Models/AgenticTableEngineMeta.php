...
class AgenticTableEngineMeta extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->fullChecksum) {
            $res['FullChecksum'] = $this->fullChecksum;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['FullChecksum'])) {
            $model->fullChecksum = $map['FullChecksum'];
        }
