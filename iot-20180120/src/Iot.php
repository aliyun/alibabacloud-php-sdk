...
use AlibabaCloud\SDK\Iot\V20180120\Models\ListTaskByPageShrinkRequest;
...
class Iot extends Rpc
{
    ...
    public function createRulengDistributeJobWithOptions($request, $runtime)
    {
        ...
        return CreateRulengDistributeJobResponse::fromMap($this->doRequest('CreateRulengDistributeJob', 'HTTPS', 'POST', '2018-01-20', 'AK', null, Tea::merge($request), $runtime));
    }
    ...
    /**
     * @param ListTaskByPageRequest $tmp
     * @param RuntimeOptions        $runtime
     *
     * @return ListTaskByPageResponse
     */
    public function listTaskByPageWithOptions($tmp, $runtime)
    {
        Utils::validateModel($tmp);
        $request = new ListTaskByPageShrinkRequest([]);
        RpcUtils::convert($tmp, $request);
        if (!Utils::isUnset($tmp->device)) {
            $request->deviceShrink = Utils::toJSONString($tmp->device);
        }

        return ListTaskByPageResponse::fromMap($this->doRequest('ListTaskByPage', 'HTTPS', 'POST', '2018-01-20', 'AK', null, Tea::merge($request), $runtime));
    }
    ...
    public function updateThingModelValidationConfigWithOptions($request, $runtime)
    {
        ...
        return UpdateThingModelValidationConfigResponse::fromMap($this->doRequest('UpdateThingModelValidationConfig', 'HTTPS', 'POST', '2018-01-20', 'AK', null, Tea::merge($request), $runtime));
    }
    ...
    public function getNodesAddingTaskWithOptions($request, $runtime)
    {
        ...
        return GetNodesAddingTaskResponse::fromMap($this->doRequest('GetNodesAddingTask', 'HTTPS', 'POST', '2018-01-20', 'AK', null, Tea::merge($request), $runtime));
    }
    ...
    public function queryAppDeviceListWithOptions($request, $runtime)
    {
        ...
        return QueryAppDeviceListResponse::fromMap($this->doRequest('QueryAppDeviceList', 'HTTPS', 'POST', '2018-01-20', 'AK', null, Tea::merge($request), $runtime));
    }
