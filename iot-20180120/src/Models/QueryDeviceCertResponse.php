...
use AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceCertResponse\deviceCertInfo;
use AlibabaCloud\Tea\Model;

class QueryDeviceCertResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('deviceCertInfo', $this->deviceCertInfo, true);
    }
