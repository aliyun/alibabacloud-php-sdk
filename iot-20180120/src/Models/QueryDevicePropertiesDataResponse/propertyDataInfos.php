...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryDevicePropertiesDataResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\QueryDevicePropertiesDataResponse\propertyDataInfos\propertyDataInfo;
...
class propertyDataInfos extends Model
{
    ...
    {
        Model::validateRequired('propertyDataInfo', $this->propertyDataInfo, true);
    }
