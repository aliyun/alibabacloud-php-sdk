...
class QueryConsumerGroupStatusResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->clientConnectionStatusList) {
            $this->clientConnectionStatusList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->clientConnectionStatusList) {
            $res['ClientConnectionStatusList'] = null !== $this->clientConnectionStatusList ? $this->clientConnectionStatusList->toArray($noStream) : $this->clientConnectionStatusList;
        }
