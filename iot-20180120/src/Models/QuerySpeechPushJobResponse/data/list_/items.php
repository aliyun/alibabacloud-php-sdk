...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QuerySpeechPushJobResponse\data\list_;
...
class items extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('failDeviceNum', $this->failDeviceNum, true);
        ...
        Model::validateRequired('runningDeviceNum', $this->runningDeviceNum, true);
        Model::validateRequired('speechNum', $this->speechNum, true);
        Model::validateRequired('speechStatus', $this->speechStatus, true);
        Model::validateRequired('status', $this->status, true);
        Model::validateRequired('successDeviceNum', $this->successDeviceNum, true);
        Model::validateRequired('totalDeviceNum', $this->totalDeviceNum, true);
    }
