...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\CreateDeviceTunnelResponse;
...
class data extends Model
{
    ...
    {
        Model::validateRequired('sourceAccessToken', $this->sourceAccessToken, true);
        Model::validateRequired('sourceURI', $this->sourceURI, true);
