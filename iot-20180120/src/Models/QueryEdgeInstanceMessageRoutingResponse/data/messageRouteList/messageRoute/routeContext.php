...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryEdgeInstanceMessageRoutingResponse\data\messageRouteList\messageRoute;
...
class routeContext extends Model
{
    ...
    {
        Model::validateRequired('qos', $this->qos, true);
        Model::validateRequired('sourceApplicationName', $this->sourceApplicationName, true);
        Model::validateRequired('sourceFcFunctionName', $this->sourceFcFunctionName, true);
        Model::validateRequired('sourceFcServiceName', $this->sourceFcServiceName, true);
        Model::validateRequired('targetApplicationName', $this->targetApplicationName, true);
        Model::validateRequired('targetFcFunctionName', $this->targetFcFunctionName, true);
        Model::validateRequired('targetFcServiceName', $this->targetFcServiceName, true);
    }
