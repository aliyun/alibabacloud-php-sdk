...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryEdgeInstanceMessageRoutingResponse\data;

use AlibabaCloud\SDK\Iot\V20180120\Models\QueryEdgeInstanceMessageRoutingResponse\data\messageRouteList\messageRoute;
...
class messageRouteList extends Model
{
    ...
    {
        Model::validateRequired('messageRoute', $this->messageRoute, true);
    }
