...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryEdgeDriverVersionResponse\data;
...
class driverVersionList extends Model
{
    ...
    {
        Model::validateRequired('argument', $this->argument, true);
        Model::validateRequired('configCheckRule', $this->configCheckRule, true);
        Model::validateRequired('containerConfig', $this->containerConfig, true);
        Model::validateRequired('description', $this->description, true);
        Model::validateRequired('driverConfig', $this->driverConfig, true);
        ...
        Model::validateRequired('sourceConfig', $this->sourceConfig, true);
        Model::validateRequired('versionState', $this->versionState, true);
    }
