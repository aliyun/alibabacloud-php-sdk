...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\PageQuerySpeechBroadcastHourResponse\data\resultData;
...
class data extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('speechId', $this->speechId, true);
        Model::validateRequired('speechs', $this->speechs, true);
