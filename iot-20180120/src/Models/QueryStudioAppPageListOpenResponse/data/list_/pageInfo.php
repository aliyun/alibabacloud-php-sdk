...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryStudioAppPageListOpenResponse\data\list_;
...
class pageInfo extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('isHidden', $this->isHidden, true);
        Model::validateRequired('isHome', $this->isHome, true);
        Model::validateRequired('isLoginPage', $this->isLoginPage, true);
