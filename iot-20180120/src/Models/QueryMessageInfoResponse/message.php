...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryMessageInfoResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\QueryMessageInfoResponse\message\userProperties;
...
class message extends Model
{
    ...
    {
        Model::validateRequired('generateTime', $this->generateTime, true);
        ...
        Model::validateRequired('userProperties', $this->userProperties, true);
    }
