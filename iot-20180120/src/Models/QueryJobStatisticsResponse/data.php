...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryJobStatisticsResponse;
...
class data extends Model
{
    ...
    {
        Model::validateRequired('cancelled', $this->cancelled, true);
        Model::validateRequired('failed', $this->failed, true);
        Model::validateRequired('inProgress', $this->inProgress, true);
        Model::validateRequired('queued', $this->queued, true);
        Model::validateRequired('rejected', $this->rejected, true);
        Model::validateRequired('sent', $this->sent, true);
