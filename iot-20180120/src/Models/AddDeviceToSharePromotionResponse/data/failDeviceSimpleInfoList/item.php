...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\AddDeviceToSharePromotionResponse\data\failDeviceSimpleInfoList;
...
class item extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('failCode', $this->failCode, true);
