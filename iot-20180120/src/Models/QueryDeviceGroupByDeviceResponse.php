...
use AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceGroupByDeviceResponse\groupInfos;
use AlibabaCloud\Tea\Model;

class QueryDeviceGroupByDeviceResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('groupInfos', $this->groupInfos, true);
    }
