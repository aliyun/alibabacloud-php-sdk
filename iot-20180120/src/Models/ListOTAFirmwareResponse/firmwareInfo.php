...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\ListOTAFirmwareResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\ListOTAFirmwareResponse\firmwareInfo\simpleFirmwareInfo;
...
class firmwareInfo extends Model
{
    ...
    {
        Model::validateRequired('simpleFirmwareInfo', $this->simpleFirmwareInfo, true);
    }
