...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryAppDeviceListResponse\data;
...
class data extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('childDeviceCount', $this->childDeviceCount, true);
        Model::validateRequired('utcActiveTime', $this->utcActiveTime, true);
        Model::validateRequired('utcLastOnlineTime', $this->utcLastOnlineTime, true);
        Model::validateRequired('utcCreateTime', $this->utcCreateTime, true);
    }
