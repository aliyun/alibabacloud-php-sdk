...
use AlibabaCloud\SDK\Iot\V20180120\Models\QueryProductCertInfoResponse\productCertInfo;
use AlibabaCloud\Tea\Model;

class QueryProductCertInfoResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('productCertInfo', $this->productCertInfo, true);
    }
