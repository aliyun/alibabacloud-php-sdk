...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryConsumerGroupStatusResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\QueryConsumerGroupStatusResponse\clientConnectionStatusList\consumerGroupClientConnectionInfo;
...
class clientConnectionStatusList extends Model
{
    ...
    {
        Model::validateRequired('consumerGroupClientConnectionInfo', $this->consumerGroupClientConnectionInfo, true);
    }
