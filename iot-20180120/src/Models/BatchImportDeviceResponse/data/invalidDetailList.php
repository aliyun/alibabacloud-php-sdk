...
{
    /**
     * @var \AlibabaCloud\SDK\Iot\V20180120\Models\BatchImportDeviceResponse\data\invalidDetailList\invalidDetailList[]
     */
        ...
        if (isset($map['InvalidDetailList'])) {
            if (!empty($map['InvalidDetailList'])) {
                ...
                foreach ($map['InvalidDetailList'] as $item) {
                    $model->invalidDetailList[$n++] = null !== $item ? \AlibabaCloud\SDK\Iot\V20180120\Models\BatchImportDeviceResponse\data\invalidDetailList\invalidDetailList::fromMap($item) : $item;
                }
            }
        }
