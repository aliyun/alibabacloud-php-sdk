...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\ListDataSourceItemResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\ListDataSourceItemResponse\dataSourceItems\dataSourceItem;
...
class dataSourceItems extends Model
{
    ...
    {
        Model::validateRequired('dataSourceItem', $this->dataSourceItem, true);
    }
