...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceGroupByDeviceResponse;

use AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceGroupByDeviceResponse\groupInfos\groupInfo;
...
class groupInfos extends Model
{
    ...
    {
        Model::validateRequired('groupInfo', $this->groupInfo, true);
    }
