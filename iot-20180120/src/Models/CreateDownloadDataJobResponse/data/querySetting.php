...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\CreateDownloadDataJobResponse\data;

use AlibabaCloud\SDK\Iot\V20180120\Models\CreateDownloadDataJobResponse\data\querySetting\astExpr;
use AlibabaCloud\SDK\Iot\V20180120\Models\CreateDownloadDataJobResponse\data\querySetting\selectedHeaders;
...
class querySetting extends Model
{
    ...
    {
        Model::validateRequired('astExpr', $this->astExpr, true);
        Model::validateRequired('selectedHeaders', $this->selectedHeaders, true);
    }
