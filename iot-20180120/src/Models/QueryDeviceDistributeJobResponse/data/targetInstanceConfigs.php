...
namespace AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceDistributeJobResponse\data;
...
{
    /**
     * @var \AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceDistributeJobResponse\data\targetInstanceConfigs\targetInstanceConfigs[]
     */
        ...
        if (isset($map['targetInstanceConfigs'])) {
            if (!empty($map['targetInstanceConfigs'])) {
                ...
                foreach ($map['targetInstanceConfigs'] as $item) {
                    $model->targetInstanceConfigs[$n++] = null !== $item ? \AlibabaCloud\SDK\Iot\V20180120\Models\QueryDeviceDistributeJobResponse\data\targetInstanceConfigs\targetInstanceConfigs::fromMap($item) : $item;
                }
            }
        }
