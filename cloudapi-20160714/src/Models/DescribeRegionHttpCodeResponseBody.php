...
use AlibabaCloud\SDK\CloudAPI\V20160714\Models\DescribeRegionHttpCodeResponseBody\httpCodePacket;
use AlibabaCloud\Tea\Model;

class DescribeRegionHttpCodeResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return DescribeRegionHttpCodeResponseBody
     */
