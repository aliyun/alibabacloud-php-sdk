...
class DescribeApisByAppResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->appApiRelationInfos) {
            $this->appApiRelationInfos->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->appApiRelationInfos) {
            $res['AppApiRelationInfos'] = null !== $this->appApiRelationInfos ? $this->appApiRelationInfos->toArray($noStream) : $this->appApiRelationInfos;
        }
