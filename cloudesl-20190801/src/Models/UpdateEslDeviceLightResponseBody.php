...
class UpdateEslDeviceLightResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->failEslBarCodes) {
            $res['FailEslBarCodes'] = $this->failEslBarCodes;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['FailEslBarCodes'])) {
            $model->failEslBarCodes = $map['FailEslBarCodes'];
        }
