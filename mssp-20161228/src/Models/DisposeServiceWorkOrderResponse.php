...
class DisposeServiceWorkOrderResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DisposeServiceWorkOrderResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DisposeServiceWorkOrderResponseBody::fromMap($map['body']);
        }
