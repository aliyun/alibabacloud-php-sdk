...
class DescribeServiceLinkedRoleResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var DescribeServiceLinkedRoleResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeServiceLinkedRoleResponseBody::fromMap($map['body']);
        }
