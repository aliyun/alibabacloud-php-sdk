...
class CreateServiceWorkOrderResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var CreateServiceWorkOrderResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateServiceWorkOrderResponseBody::fromMap($map['body']);
        }
