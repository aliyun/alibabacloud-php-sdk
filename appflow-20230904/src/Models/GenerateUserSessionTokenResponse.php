...
class GenerateUserSessionTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GenerateUserSessionTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GenerateUserSessionTokenResponseBody::fromMap($map['body']);
        }
