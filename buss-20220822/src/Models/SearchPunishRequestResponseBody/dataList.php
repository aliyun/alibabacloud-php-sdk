...
class dataList extends Model
{
     ...
     * @var string
     */
    public $punishOfficer;

    /**
     * @var string
     */
    public $punishOfficerNum;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->operatorNum) {
            $res['OperatorNum'] = $this->operatorNum;
        }
        ...
        if (null !== $this->punishOfficer) {
            $res['PunishOfficer'] = $this->punishOfficer;
        }

        if (null !== $this->punishOfficerNum) {
            $res['PunishOfficerNum'] = $this->punishOfficerNum;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['OperatorNum'])) {
            $model->operatorNum = $map['OperatorNum'];
        }
        ...
        if (isset($map['PunishOfficer'])) {
            $model->punishOfficer = $map['PunishOfficer'];
        }

        if (isset($map['PunishOfficerNum'])) {
            $model->punishOfficerNum = $map['PunishOfficerNum'];
        }
