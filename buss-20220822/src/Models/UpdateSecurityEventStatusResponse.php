...
class UpdateSecurityEventStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateSecurityEventStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateSecurityEventStatusResponseBody::fromMap($map['body']);
        }
