...
use AlibabaCloud\SDK\Ddoscoo\V20200101\Models\DescribeCdnLinkageRulesResponseBody\schedulerRules;

class DescribeCdnLinkageRulesResponseBody extends Model
{
    /**
     * @var string
     */
