...
use AlibabaCloud\SDK\Cityvisual\V20181030\Models\DescribeWorkGroupsResponseBody\workGroups;
...
class DescribeWorkGroupsResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->workGroups) {
            $res['WorkGroups'] = null !== $this->workGroups ? $this->workGroups->toMap() : null;
        }
     ...
     * @param array $map
     *
     * @return DescribeWorkGroupsResponseBody
     */
