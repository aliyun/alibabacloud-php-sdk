...
namespace AlibabaCloud\SDK\VpcIpam\V20230228\Models\ListIpamResourceDiscoveriesRequest;
...
{
    /**
     * @description The key of the tag. You can specify at most 20 tag keys. It cannot be an empty string.
     *
    ...
    /**
     * @description The value of the tag. You can specify at most 20 tag values. The tag value cannot be an empty string.
     *
