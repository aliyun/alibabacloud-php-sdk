...
class SendRCSReplyRequest extends Model
{
    /**
     * @var string
     */
    public $inReplyToRcsID;
    ...
    {
        $res = [];
        if (null !== $this->inReplyToRcsID) {
            $res['InReplyToRcsID'] = $this->inReplyToRcsID;
        }
