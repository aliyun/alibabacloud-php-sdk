...
class SendCardSmsShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $cardObjectsShrink;
    ...
    {
        $res = [];
        if (null !== $this->cardObjectsShrink) {
            $res['CardObjects'] = $this->cardObjectsShrink;
        }
     ...
     * @param array $map
     *
     * @return SendCardSmsShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['CardObjects'])) {
            $model->cardObjectsShrink = $map['CardObjects'];
        }
