...
class QuerySmsAuthorizationLetterShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $authorizationLetterIdListShrink;
    ...
    {
        $res = [];
        if (null !== $this->authorizationLetterIdListShrink) {
            $res['AuthorizationLetterIdList'] = $this->authorizationLetterIdListShrink;
        }
