...
namespace AlibabaCloud\SDK\Baas\V20180731\Models\CreateFabricChaincodePackageResponseBody;
...
class result extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->typeString) {
            $res['TypeString'] = $this->typeString;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TypeString'])) {
            $model->typeString = $map['TypeString'];
        }
