...
class StartCloudRecordRequest extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->singleStreamingRecord) {
            $this->singleStreamingRecord->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->singleStreamingRecord) {
            $res['SingleStreamingRecord'] = null !== $this->singleStreamingRecord ? $this->singleStreamingRecord->toArray($noStream) : $this->singleStreamingRecord;
        }
