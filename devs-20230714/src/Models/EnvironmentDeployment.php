...
class EnvironmentDeployment extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var EnvironmentDeploymentSpec
     */
    public $spec;

    /**
     * @var EnvironmentDeploymentStatus
     */
    public $status;
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['spec'])) {
            $model->spec = EnvironmentDeploymentSpec::fromMap($map['spec']);
        }

        if (isset($map['status'])) {
            $model->status = EnvironmentDeploymentStatus::fromMap($map['status']);
        }
