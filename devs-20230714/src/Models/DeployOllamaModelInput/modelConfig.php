...
use AlibabaCloud\SDK\Devs\V20230714\Models\DeployOllamaModelInput\modelConfig\fmkOllamaConfig;
...
class modelConfig extends Model
{
    ...
    {
        if (null !== $this->fmkOllamaConfig) {
            $this->fmkOllamaConfig->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->fmkOllamaConfig) {
            $res['fmkOllamaConfig'] = null !== $this->fmkOllamaConfig ? $this->fmkOllamaConfig->toArray($noStream) : $this->fmkOllamaConfig;
        }
    ...
    {
        $model = new self();
        if (isset($map['fmkOllamaConfig'])) {
            $model->fmkOllamaConfig = fmkOllamaConfig::fromMap($map['fmkOllamaConfig']);
        }
