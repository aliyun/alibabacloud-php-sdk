...
class PipelineTriggerEvent extends Model
{
    /**
    ...
    /**
     * @var PipelineTriggerEventSpec
     */
    public $spec;

    /**
     * @var PipelineTriggerEventStatus
     */
    public $status;
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['spec'])) {
            $model->spec = PipelineTriggerEventSpec::fromMap($map['spec']);
        }
        if (isset($map['status'])) {
            $model->status = PipelineTriggerEventStatus::fromMap($map['status']);
        }
        if (isset($map['uid'])) {
            $model->uid = $map['uid'];
        }
