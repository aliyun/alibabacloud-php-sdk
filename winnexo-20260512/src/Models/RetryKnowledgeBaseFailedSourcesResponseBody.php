...
use AlibabaCloud\SDK\WinNexo\V20260512\Models\RetryKnowledgeBaseFailedSourcesResponseBody\failedSources;

class RetryKnowledgeBaseFailedSourcesResponseBody extends Model
{
    /**
     * @var string
     */
