...
class CreatePersonalFeishuMinuteRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->minuteToken) {
            $res['minuteToken'] = $this->minuteToken;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['minuteToken'])) {
            $model->minuteToken = $map['minuteToken'];
        }
