...
namespace AlibabaCloud\SDK\Drds\V20190123\Models\GetBatchEvaluateTaskReportResponseBody\data\evaluateResults;
...
{
    /**
     * @var \AlibabaCloud\SDK\Drds\V20190123\Models\GetBatchEvaluateTaskReportResponseBody\data\evaluateResults\tableShardResults\tableShardResults[]
     */
        ...
        if (isset($map['TableShardResults'])) {
            if (!empty($map['TableShardResults'])) {
                ...
                foreach ($map['TableShardResults'] as $item) {
                    $model->tableShardResults[$n++] = null !== $item ? \AlibabaCloud\SDK\Drds\V20190123\Models\GetBatchEvaluateTaskReportResponseBody\data\evaluateResults\tableShardResults\tableShardResults::fromMap($item) : $item;
                }
            }
        }
