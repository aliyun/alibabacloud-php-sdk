...
use AlibabaCloud\SDK\Drds\V20190123\Models\CreateEvaluateTaskRequest\dbInfo;
use AlibabaCloud\Tea\Model;

class CreateEvaluateTaskRequest extends Model
{
    /**
     * @var int
     */
     ...
     * @param array $map
     *
     * @return CreateEvaluateTaskRequest
     */
