...
class ExecuteStatementRequest extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->ragWorkspaceCollection) {
            $this->ragWorkspaceCollection->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->ragWorkspaceCollection) {
            $res['RagWorkspaceCollection'] = null !== $this->ragWorkspaceCollection ? $this->ragWorkspaceCollection->toArray($noStream) : $this->ragWorkspaceCollection;
        }
