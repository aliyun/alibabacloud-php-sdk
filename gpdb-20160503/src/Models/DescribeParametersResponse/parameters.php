...
namespace AlibabaCloud\SDK\Gpdb\V20160503\Models\DescribeParametersResponse;
...
class parameters extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('currentValue', $this->currentValue, true);
        Model::validateRequired('parameterDescription', $this->parameterDescription, true);
        Model::validateRequired('forceRestartInstance', $this->forceRestartInstance, true);
        Model::validateRequired('isChangeableConfig', $this->isChangeableConfig, true);
        Model::validateRequired('optionalRange', $this->optionalRange, true);
    }
