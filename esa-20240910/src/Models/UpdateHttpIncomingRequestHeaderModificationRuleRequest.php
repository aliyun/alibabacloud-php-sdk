...
use AlibabaCloud\SDK\ESA\V20240910\Models\UpdateHttpIncomingRequestHeaderModificationRuleRequest\requestHeaderModification;

class UpdateHttpIncomingRequestHeaderModificationRuleRequest extends Model
{
    /**
     * @var int
     */
