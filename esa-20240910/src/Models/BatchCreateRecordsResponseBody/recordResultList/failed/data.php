...
namespace AlibabaCloud\SDK\ESA\V20240910\Models\BatchCreateRecordsResponseBody\recordResultList\failed;
...
class data extends Model
{
    ...
    /**
     * @description The port number of the record, associated with the SRV record. Exclusive to SRV records.
     *
     * @example 0
     *
     * @var int
    ...
    /**
     * @description Indicates its priority and handling method, used in CAA records.
     *
     * @example issue
     *
     * @var string
    ...
    /**
     * @description The weight of the record. Applicable to SRV and URI records.
     *
     * @example 0
     *
     * @var int
