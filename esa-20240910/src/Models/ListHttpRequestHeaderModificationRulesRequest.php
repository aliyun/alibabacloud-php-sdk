...
class ListHttpRequestHeaderModificationRulesRequest extends Model
{
    /**
     * @description Configuration ID, which can be obtained by calling the [ListHttpRequestHeaderModificationRules](https://help.aliyun.com/document_detail/2867483.html) API.
     *
     * @example 35281609698****
     *
     * @var int
     ...
     * @param array $map
     *
     * @return ListHttpRequestHeaderModificationRulesRequest
     */
