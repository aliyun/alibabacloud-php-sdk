...
class ApplyCertificateResponseBody extends Model
{
    ...
    /**
     * @description List of free certificate application details.
     *
     * @var result[]
     */
    public $result;
    ...
    /**
     * @description Number of certificates applied for, which is the same as the number of input domains.
     *
     * @example 2
     *
     * @var int
