...
use AlibabaCloud\SDK\ESA\V20240910\Models\ListPostpaidRatePlanInstancesResponseBody\instanceInfo;

class ListPostpaidRatePlanInstancesResponseBody extends Model
{
    /**
     * @var instanceInfo[]
     */
