...
use AlibabaCloud\SDK\ESA\V20240910\Models\GetHttpIncomingRequestHeaderModificationRuleResponseBody\requestHeaderModification;

class GetHttpIncomingRequestHeaderModificationRuleResponseBody extends Model
{
    /**
     * @var int
     */
