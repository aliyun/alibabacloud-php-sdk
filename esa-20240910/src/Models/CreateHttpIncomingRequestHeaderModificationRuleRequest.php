...
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateHttpIncomingRequestHeaderModificationRuleRequest\requestHeaderModification;

class CreateHttpIncomingRequestHeaderModificationRuleRequest extends Model
{
    /**
