...
use AlibabaCloud\SDK\ESA\V20240910\Models\DescribeHttpDDoSIntelligentRateLimitRulesResponseBody\ruleInfos;

class DescribeHttpDDoSIntelligentRateLimitRulesResponseBody extends Model
{
    /**
     * @var int
     */
