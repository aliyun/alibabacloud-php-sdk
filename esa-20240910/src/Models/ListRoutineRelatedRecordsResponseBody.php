...
use AlibabaCloud\SDK\ESA\V20240910\Models\ListRoutineRelatedRecordsResponseBody\relatedRecords;

class ListRoutineRelatedRecordsResponseBody extends Model
{
    /**
     * @var int
     */
