...
namespace AlibabaCloud\SDK\ESA\V20240910\Models\WafRuleMatch2;
...
class criteria extends Model
{
    ...
    /**
     * @var \AlibabaCloud\SDK\ESA\V20240910\Models\WafRuleMatch2\criteria\criteria[]
     */
    public $criteria;
        ...
        if (isset($map['Criteria'])) {
            if (!empty($map['Criteria'])) {
                ...
                foreach ($map['Criteria'] as $item) {
                    $model->criteria[$n++] = null !== $item ? \AlibabaCloud\SDK\ESA\V20240910\Models\WafRuleMatch2\criteria\criteria::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Logic'])) {
