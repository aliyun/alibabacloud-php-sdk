...
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\cacheReserve;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\cacheRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\cacheTags;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\cnameFlattening;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\compressionRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\crossBorderOptimization;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\developmentMode;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\httpRequestHeaderModificationRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\httpResponseHeaderModificationRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\httpsApplicationConfiguration;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\httpsBasicConfiguration;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\imageTransform;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\ipv6;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\managedTransforms;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\networkOptimization;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\originProtection;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\originRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\redirectRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\rewriteUrlRules;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\seoBypass;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\siteNameExclusive;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\sitePause;
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateSiteFunctionRequest\tieredCache;
use AlibabaCloud\Tea\Model;

class CreateSiteFunctionRequest extends Model
{
    /**
     * @var cacheReserve[]
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->originProtection) {
            $res['OriginProtection'] = [];
            if (null !== $this->originProtection && \is_array($this->originProtection)) {
                $n = 0;
                foreach ($this->originProtection as $item) {
                    $res['OriginProtection'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return CreateSiteFunctionRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['OriginProtection'])) {
            if (!empty($map['OriginProtection'])) {
                $model->originProtection = [];
                $n                       = 0;
                foreach ($map['OriginProtection'] as $item) {
                    $model->originProtection[$n++] = null !== $item ? originProtection::fromMap($item) : $item;
                }
            }
        }
