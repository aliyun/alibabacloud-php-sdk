...
class cacheRules extends Model
{
    ...
    /**
     * @description The cookie names and values included in the cache key. Multiple combinations are separated by spaces.
     *
    ...
    /**
     * @description The header names and values included in the cache key. Multiple combinations are separated by spaces.
     *
     * @example example
     *
     * @var string
    ...
    /**
     * @description The parameters to be retained or ignored in the query string. Multiple values are separated by spaces.
     *
     * @example example
     *
     * @var string
    ...
    /**
     * @description The method to process the query string when cache keys are generated. Valid values:
     *
    ...
    /**
     * @description Indicates whether query string sorting is enabled. Valid values:
     *
     *   on
     *   off
     *
