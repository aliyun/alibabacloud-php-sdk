...
class monitor extends Model
{
    ...
    /**
     * @description Expected status codes, such as 200,202, which indicate successful HTTP responses.
     *
     * @example 200,202
     *
     * @var string
    ...
    /**
     * @description Monitor request header configuration.
     *
     * @example {
     * "host": [
     * "example1.com",
    ...
    /**
     * @description Monitor interval, such as 60 seconds, which is the frequency of checks.
     *
     * @example 100
     *
     * @var int
    ...
    /**
     * @description Application health check timeout, in seconds, with a range of 1-10.
     *
     * @example 5
     *
     * @var int
