...
use AlibabaCloud\SDK\ESA\V20240910\Models\UpdateLoadBalancerRequest\rules\fixedResponse;
...
class rules extends Model
{
     ...
     *
     * @example http.request.method eq "GET"
     *
     * @var string
     */
    public $rule;
    ...
    /**
     * @description The execution order of the rule. It can be left empty, in which case the rules will be executed in the order they appear in the list. If specified, it must be a positive integer, with higher values indicating higher priority.
     *
     * @example 1
     *
     * @var int
