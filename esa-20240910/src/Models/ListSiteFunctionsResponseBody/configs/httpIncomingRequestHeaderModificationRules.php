...
use AlibabaCloud\SDK\ESA\V20240910\Models\ListSiteFunctionsResponseBody\configs\httpIncomingRequestHeaderModificationRules\requestHeaderModification;

class httpIncomingRequestHeaderModificationRules extends Model
{
    /**
     * @var int
     */
