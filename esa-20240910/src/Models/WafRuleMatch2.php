...
use AlibabaCloud\SDK\ESA\V20240910\Models\WafRuleMatch2\criteria;
use AlibabaCloud\Tea\Model;

class WafRuleMatch2 extends Model
{
    /**
     * @var bool
     */
        ...
        if (isset($map['Criteria'])) {
            if (!empty($map['Criteria'])) {
                ...
                foreach ($map['Criteria'] as $item) {
                    $model->criteria[$n++] = null !== $item ? criteria::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Logic'])) {
