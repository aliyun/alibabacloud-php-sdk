...
use AlibabaCloud\SDK\ESA\V20240910\Models\UpdateHttpIncomingResponseHeaderModificationRuleRequest\responseHeaderModification;

class UpdateHttpIncomingResponseHeaderModificationRuleRequest extends Model
{
    /**
     * @var int
     */
