...
use AlibabaCloud\SDK\ESA\V20240910\Models\CreateHttpIncomingResponseHeaderModificationRuleRequest\responseHeaderModification;

class CreateHttpIncomingResponseHeaderModificationRuleRequest extends Model
{
    /**
