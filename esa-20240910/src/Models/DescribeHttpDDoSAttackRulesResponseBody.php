...
use AlibabaCloud\SDK\ESA\V20240910\Models\DescribeHttpDDoSAttackRulesResponseBody\ruleInfos;

class DescribeHttpDDoSAttackRulesResponseBody extends Model
{
    /**
     * @var int
     */
