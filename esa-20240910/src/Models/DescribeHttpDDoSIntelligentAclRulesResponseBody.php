...
use AlibabaCloud\SDK\ESA\V20240910\Models\DescribeHttpDDoSIntelligentAclRulesResponseBody\ruleInfos;

class DescribeHttpDDoSIntelligentAclRulesResponseBody extends Model
{
    /**
     * @var int
     */
