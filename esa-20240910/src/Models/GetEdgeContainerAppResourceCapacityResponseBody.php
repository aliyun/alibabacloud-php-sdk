...
use AlibabaCloud\SDK\ESA\V20240910\Models\GetEdgeContainerAppResourceCapacityResponseBody\regions;

class GetEdgeContainerAppResourceCapacityResponseBody extends Model
{
    /**
     * @var regions[]
     */
