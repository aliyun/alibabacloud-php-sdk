...
use AlibabaCloud\SDK\ESA\V20240910\Models\DescribeCacheReservePriceGapResponseBody\priceModel;

class DescribeCacheReservePriceGapResponseBody extends Model
{
    /**
     * @var priceModel
     */
