...
use AlibabaCloud\SDK\ESA\V20240910\Models\GetEdgeContainerAppResourceStatusResponseBody\regions;

class GetEdgeContainerAppResourceStatusResponseBody extends Model
{
    /**
     * @var regions[]
     */
