...
class CreateHttpsBasicConfigurationRequest extends Model
{
    ...
    /**
     * @description Cipher suite group. Default uses all cipher suites. Value range:
    ...
    /**
     * @description Whether to enable TLS1.1. Default is enabled. Value range:
     * - on: Enable.
     * - off: Disable.
     *
     * @example on
    ...
    /**
     * @description Whether to enable TLS1.2. Default is enabled. Value range:
     * - on: Enable.
     * - off: Disable.
     *
     * @example on
    ...
    /**
     * @description Whether to enable TLS1.3. Default is enabled. Value range:
     * - on: Enable.
     * - off: Disable.
     *
     * @example on
     ...
     * @param array $map
     *
     * @return CreateHttpsBasicConfigurationRequest
     */
