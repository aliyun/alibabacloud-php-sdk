...
use AlibabaCloud\SDK\ESA\V20240910\Models\ListTransportLayerApplicationsResponseBody\applications;

class ListTransportLayerApplicationsResponseBody extends Model
{
    /**
     * @var applications[]
     */
