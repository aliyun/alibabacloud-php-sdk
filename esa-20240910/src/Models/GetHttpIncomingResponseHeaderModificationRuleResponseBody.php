...
use AlibabaCloud\SDK\ESA\V20240910\Models\GetHttpIncomingResponseHeaderModificationRuleResponseBody\responseHeaderModification;

class GetHttpIncomingResponseHeaderModificationRuleResponseBody extends Model
{
    /**
     * @var int
     */
