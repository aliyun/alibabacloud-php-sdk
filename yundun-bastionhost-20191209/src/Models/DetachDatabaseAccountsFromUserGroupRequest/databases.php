...
namespace AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\DetachDatabaseAccountsFromUserGroupRequest;
...
class databases extends Model
{
    ...
    /**
     * @description The ID of the database on which the permissions are to be revoked.
     *
     * @example 4
     *
     * @var string
