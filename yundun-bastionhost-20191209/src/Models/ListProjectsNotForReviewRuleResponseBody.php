...
use AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\ListProjectsNotForReviewRuleResponseBody\projects;

class ListProjectsNotForReviewRuleResponseBody extends Model
{
    /**
     * @var int
     */
