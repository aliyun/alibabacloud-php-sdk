...
use AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\ListUserGroupsForUserResponseBody\userGroups;

class ListUserGroupsForUserResponseBody extends Model
{
    /**
     * @var int
     */
