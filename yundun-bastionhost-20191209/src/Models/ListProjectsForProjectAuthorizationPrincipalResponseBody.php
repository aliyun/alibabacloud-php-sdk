...
use AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\ListProjectsForProjectAuthorizationPrincipalResponseBody\projects;

class ListProjectsForProjectAuthorizationPrincipalResponseBody extends Model
{
    /**
     * @var int
     */
