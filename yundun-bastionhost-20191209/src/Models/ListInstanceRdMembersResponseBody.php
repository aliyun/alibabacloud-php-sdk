...
use AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\ListInstanceRdMembersResponseBody\members;

class ListInstanceRdMembersResponseBody extends Model
{
    /**
     * @var int
     */
