...
use AlibabaCloud\SDK\Yundunbastionhost\V20191209\Models\ListMembersNotForProjectResponseBody\members;

class ListMembersNotForProjectResponseBody extends Model
{
    /**
     * @var int
     */
