...
class ListVoiceAccessProfilesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListVoiceAccessProfilesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListVoiceAccessProfilesResponseBody::fromMap($map['body']);
        }
