...
use AlibabaCloud\SDK\OutboundBot\V20251111\Models\ListFlashSmsAccessProfilesResponseBody\data;

class ListFlashSmsAccessProfilesResponseBody extends Model
{
    /**
     * @var string
     */
