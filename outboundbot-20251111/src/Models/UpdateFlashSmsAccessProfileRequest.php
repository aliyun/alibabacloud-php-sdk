...
use AlibabaCloud\SDK\OutboundBot\V20251111\Models\UpdateFlashSmsAccessProfileRequest\accessProfile;

class UpdateFlashSmsAccessProfileRequest extends Model
{
    /**
     * @var accessProfile
     */
