...
class DeleteOutboundCallRestrictionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteOutboundCallRestrictionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteOutboundCallRestrictionResponseBody::fromMap($map['body']);
        }
