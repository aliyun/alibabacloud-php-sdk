...
class ListFlashSmsAccessProfilesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListFlashSmsAccessProfilesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListFlashSmsAccessProfilesResponseBody::fromMap($map['body']);
        }
