...
use AlibabaCloud\SDK\OutboundBot\V20251111\Models\ListOutboundCallRestrictionsResponseBody\data;

class ListOutboundCallRestrictionsResponseBody extends Model
{
    /**
     * @var string
     */
