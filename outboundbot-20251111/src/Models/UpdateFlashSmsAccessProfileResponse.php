...
class UpdateFlashSmsAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateFlashSmsAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateFlashSmsAccessProfileResponseBody::fromMap($map['body']);
        }
