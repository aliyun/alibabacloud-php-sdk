...
class ListOutboundCallRestrictionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListOutboundCallRestrictionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListOutboundCallRestrictionsResponseBody::fromMap($map['body']);
        }
