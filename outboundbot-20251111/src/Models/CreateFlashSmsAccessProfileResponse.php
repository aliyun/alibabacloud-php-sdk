...
class CreateFlashSmsAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateFlashSmsAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateFlashSmsAccessProfileResponseBody::fromMap($map['body']);
        }
