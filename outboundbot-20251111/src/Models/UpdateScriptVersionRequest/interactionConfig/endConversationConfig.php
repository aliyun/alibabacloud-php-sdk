...
use AlibabaCloud\SDK\OutboundBot\V20251111\Models\UpdateScriptVersionRequest\interactionConfig\endConversationConfig\triggers;
...
class endConversationConfig extends Model
{
    ...
    {
        $res = [];
        if (null !== $this->bargeInEnabled) {
            $res['BargeInEnabled'] = $this->bargeInEnabled;
        }
    ...
    {
        $model = new self();
        if (isset($map['BargeInEnabled'])) {
            $model->bargeInEnabled = $map['BargeInEnabled'];
        }
