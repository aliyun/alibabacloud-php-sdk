...
class DeleteFlashSmsAccessProfileResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteFlashSmsAccessProfileResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteFlashSmsAccessProfileResponseBody::fromMap($map['body']);
        }
