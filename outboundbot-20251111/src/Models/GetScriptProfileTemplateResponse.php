...
class GetScriptProfileTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetScriptProfileTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetScriptProfileTemplateResponseBody::fromMap($map['body']);
        }
