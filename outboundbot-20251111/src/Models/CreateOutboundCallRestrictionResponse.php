...
class CreateOutboundCallRestrictionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateOutboundCallRestrictionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateOutboundCallRestrictionResponseBody::fromMap($map['body']);
        }
