...
use AlibabaCloud\SDK\Cas\V20200630\Models\DescribePcaAndExternalCACertificateListResponseBody\certificateList;

class DescribePcaAndExternalCACertificateListResponseBody extends Model
{
    /**
     * @var certificateList[]
     */
