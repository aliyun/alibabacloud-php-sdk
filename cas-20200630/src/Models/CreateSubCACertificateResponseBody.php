...
{
    /**
     * @description The CA certificate in the PEM format.
     *
    ...
    /**
     * @description The unique identifier of the sub CA certificate created in this request.
     *
    ...
    /**
     * @description The ID of this call request is a unique identifier generated by Alibaba Cloud for the request, which can be used for troubleshooting and locating issues.
     *
