...
class CreateClientCertificateRequest extends Model
{
    ...
    /**
     * @description The name of the client certificate user. In most cases, the user of a client certificate is an individual, a company, an organization, or an application. We recommend that you enter the common name of a user. Examples: Bob, Alibaba, Alibaba Cloud password platform, and Tmall Genie.
     *
     * @example aliyun
     *
     * @var string
    ...
    /**
     * @description The country in which the organization is located. Default value: CN.
     *
     * @example CN
     *
     * @var string
    ...
    /**
     * @description The validity period of the client certificate. Unit: day. You must specify at least one of the **Days**, **BeforeTime**, and **AfterTime** parameters. The **BeforeTime** and **AfterTime** parameters must be both empty or both specified. The following list describes how to specify these parameters:
     *
