...
class SearchImageByPicShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    {
        $res = [];
        if (null !== $this->boxShrink) {
            $res['Box'] = $this->boxShrink;
        }
     ...
     * @param array $map
     *
     * @return SearchImageByPicShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['Box'])) {
            $model->boxShrink = $map['Box'];
        }
