...
class ListWatchAssetsRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->upshelfAssetId) {
            $res['upshelfAssetId'] = $this->upshelfAssetId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['upshelfAssetId'])) {
            $model->upshelfAssetId = $map['upshelfAssetId'];
        }
