...
class MonitorMqAlertRule extends Model
{
    /**
     * @var int
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->metricDimension) {
            $res['metricDimension'] = $this->metricDimension;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['metricDimension'])) {
            $model->metricDimension = $map['metricDimension'];
        }
