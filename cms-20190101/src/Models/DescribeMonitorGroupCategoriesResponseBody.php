...
class DescribeMonitorGroupCategoriesResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->monitorGroupCategories) {
            $this->monitorGroupCategories->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->monitorGroupCategories) {
            $res['MonitorGroupCategories'] = null !== $this->monitorGroupCategories ? $this->monitorGroupCategories->toArray($noStream) : $this->monitorGroupCategories;
        }
