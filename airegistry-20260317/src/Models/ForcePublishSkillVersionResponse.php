...
class ForcePublishSkillVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ForcePublishSkillVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ForcePublishSkillVersionResponseBody::fromMap($map['body']);
        }
