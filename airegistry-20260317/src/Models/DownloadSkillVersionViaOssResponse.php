...
class DownloadSkillVersionViaOssResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DownloadSkillVersionViaOssResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DownloadSkillVersionViaOssResponseBody::fromMap($map['body']);
        }
