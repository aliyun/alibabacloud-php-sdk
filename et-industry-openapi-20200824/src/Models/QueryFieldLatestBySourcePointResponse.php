...
class QueryFieldLatestBySourcePointResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryFieldLatestBySourcePointResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryFieldLatestBySourcePointResponseBody::fromMap($map['body']);
        }
