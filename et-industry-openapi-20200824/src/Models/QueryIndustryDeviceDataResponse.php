...
class QueryIndustryDeviceDataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryIndustryDeviceDataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryIndustryDeviceDataResponseBody::fromMap($map['body']);
        }
