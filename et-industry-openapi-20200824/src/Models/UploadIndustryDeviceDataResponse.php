...
class UploadIndustryDeviceDataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UploadIndustryDeviceDataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UploadIndustryDeviceDataResponseBody::fromMap($map['body']);
        }
