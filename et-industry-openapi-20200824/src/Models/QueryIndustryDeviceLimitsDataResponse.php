...
class QueryIndustryDeviceLimitsDataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryIndustryDeviceLimitsDataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryIndustryDeviceLimitsDataResponseBody::fromMap($map['body']);
        }
