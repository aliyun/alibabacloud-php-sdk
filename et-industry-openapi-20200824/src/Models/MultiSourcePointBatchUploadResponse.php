...
class MultiSourcePointBatchUploadResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var MultiSourcePointBatchUploadResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = MultiSourcePointBatchUploadResponseBody::fromMap($map['body']);
        }
