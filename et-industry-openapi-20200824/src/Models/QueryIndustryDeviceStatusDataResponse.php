...
class QueryIndustryDeviceStatusDataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryIndustryDeviceStatusDataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryIndustryDeviceStatusDataResponseBody::fromMap($map['body']);
        }
