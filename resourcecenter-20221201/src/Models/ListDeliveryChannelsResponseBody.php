...
use AlibabaCloud\SDK\ResourceCenter\V20221201\Models\ListDeliveryChannelsResponseBody\deliveryChannels;

class ListDeliveryChannelsResponseBody extends Model
{
    /**
