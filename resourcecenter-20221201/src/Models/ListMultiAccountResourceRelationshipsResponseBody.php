...
use AlibabaCloud\SDK\ResourceCenter\V20221201\Models\ListMultiAccountResourceRelationshipsResponseBody\resourceRelationships;

class ListMultiAccountResourceRelationshipsResponseBody extends Model
{
    /**
     * @var int
     */
