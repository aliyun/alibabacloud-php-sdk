...
use AlibabaCloud\SDK\ResourceCenter\V20221201\Models\GetMultiAccountDeliveryChannelStatisticsResponseBody\deliveryChannelStatistics;

class GetMultiAccountDeliveryChannelStatisticsResponseBody extends Model
{
    /**
