...
class ReadMessageLanguageRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->returnDefaultLang) {
            $res['ReturnDefaultLang'] = $this->returnDefaultLang;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ReturnDefaultLang'])) {
            $model->returnDefaultLang = $map['ReturnDefaultLang'];
        }
