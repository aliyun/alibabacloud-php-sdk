...
class ReadMarketingPreferenceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadMarketingPreferenceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadMarketingPreferenceResponseBody::fromMap($map['body']);
        }
