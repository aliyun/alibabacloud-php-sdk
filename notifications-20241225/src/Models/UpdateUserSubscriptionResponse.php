...
class UpdateUserSubscriptionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateUserSubscriptionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateUserSubscriptionResponseBody::fromMap($map['body']);
        }
