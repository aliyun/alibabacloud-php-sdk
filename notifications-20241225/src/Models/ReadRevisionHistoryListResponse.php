...
class ReadRevisionHistoryListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadRevisionHistoryListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadRevisionHistoryListResponseBody::fromMap($map['body']);
        }
