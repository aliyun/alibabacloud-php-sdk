...
class ReadRevisionHistoryListShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->pageInfoShrink) {
            $res['PageInfo'] = $this->pageInfoShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['PageInfo'])) {
            $model->pageInfoShrink = $map['PageInfo'];
        }
