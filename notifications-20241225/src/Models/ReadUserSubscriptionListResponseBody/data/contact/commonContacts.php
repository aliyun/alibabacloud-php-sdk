...
use AlibabaCloud\SDK\Notifications\V20241225\Models\ReadUserSubscriptionListResponseBody\data\contact\commonContacts\messageSource;

class commonContacts extends Model
{
    /**
     * @var int
     */
