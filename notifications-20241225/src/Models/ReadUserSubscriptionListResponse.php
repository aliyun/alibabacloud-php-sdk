...
class ReadUserSubscriptionListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadUserSubscriptionListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadUserSubscriptionListResponseBody::fromMap($map['body']);
        }
