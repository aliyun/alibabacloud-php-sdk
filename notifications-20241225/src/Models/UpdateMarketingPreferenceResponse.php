...
class UpdateMarketingPreferenceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateMarketingPreferenceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateMarketingPreferenceResponseBody::fromMap($map['body']);
        }
