...
class UpdateMessageLanguageRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->preferLang) {
            $res['PreferLang'] = $this->preferLang;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['PreferLang'])) {
            $model->preferLang = $map['PreferLang'];
        }
