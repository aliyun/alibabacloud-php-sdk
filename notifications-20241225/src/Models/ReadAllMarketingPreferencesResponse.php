...
class ReadAllMarketingPreferencesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadAllMarketingPreferencesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadAllMarketingPreferencesResponseBody::fromMap($map['body']);
        }
