...
class ReadAllWebhookContactsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadAllWebhookContactsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadAllWebhookContactsResponseBody::fromMap($map['body']);
        }
