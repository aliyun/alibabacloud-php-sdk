...
use AlibabaCloud\SDK\Smartag\V20180313\Models\ViewSmartAccessGatewayRoutesResponseBody\routes;

class ViewSmartAccessGatewayRoutesResponseBody extends Model
{
    /**
     * @var string
     */
