...
use AlibabaCloud\SDK\Smartag\V20180313\Models\ViewSmartAccessGatewayDnsResponseBody\taskStates;

class ViewSmartAccessGatewayDnsResponseBody extends Model
{
    /**
     * @var string
     */
