...
use AlibabaCloud\SDK\Smartag\V20180313\Models\ViewSmartAccessGatewayGlobalRouteProtocolResponseBody\taskStates;

class ViewSmartAccessGatewayGlobalRouteProtocolResponseBody extends Model
{
    /**
     * @var string
     */
