...
class DescribeCloudConnectNetworksResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->cloudConnectNetworks) {
            $this->cloudConnectNetworks->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->cloudConnectNetworks) {
            $res['CloudConnectNetworks'] = null !== $this->cloudConnectNetworks ? $this->cloudConnectNetworks->toArray($noStream) : $this->cloudConnectNetworks;
        }
