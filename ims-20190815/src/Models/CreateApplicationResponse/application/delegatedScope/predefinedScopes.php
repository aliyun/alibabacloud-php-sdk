...
namespace AlibabaCloud\SDK\Ims\V20190815\Models\CreateApplicationResponse\application\delegatedScope;

use AlibabaCloud\SDK\Ims\V20190815\Models\CreateApplicationResponse\application\delegatedScope\predefinedScopes\predefinedScope;
...
class predefinedScopes extends Model
{
    ...
    {
        Model::validateRequired('predefinedScope', $this->predefinedScope, true);
    }
