...
class SetPasswordPolicyRequest extends Model
{
    ...
    /**
     * @description Specifies whether the password must contain lowercase letters. Valid values:
     *
     *   true
     *   false (default)
     *
    ...
    /**
     * @description Specifies whether the password must contain digits. Valid values:
     *
     *   true
     *   false (default)
     *
    ...
    /**
     * @description Specifies whether the password must contain special characters. Valid values:
     *
     *   true
     *   false (default)
     *
    ...
    /**
     * @description Specifies whether the password must contain uppercase letters. Valid values:
     *
     *   true
     *   false (default)
     *
