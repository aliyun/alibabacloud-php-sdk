...
class summaryMap extends Model
{
     ...
     * @var int
     */
    public $accountAccessKeysPerAccountQuota;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->accountAccessKeysPerAccountQuota) {
            $res['AccountAccessKeysPerAccountQuota'] = $this->accountAccessKeysPerAccountQuota;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AccountAccessKeysPerAccountQuota'])) {
            $model->accountAccessKeysPerAccountQuota = $map['AccountAccessKeysPerAccountQuota'];
        }
