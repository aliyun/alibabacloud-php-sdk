...
{
    /**
     * @description Indicates whether multi-factor authentication (MFA) is enabled. Valid values:
     *
     *   true
     *   false
     *
    ...
    /**
     * @description The number of Resource Access Management (RAM) users that have unused AccessKey pairs.
     *
     * @example 0
     *
     * @var int
