...
namespace AlibabaCloud\SDK\Ims\V20190815\Models\CreateServiceCredentialResponseBody;
...
class serviceCredential extends Model
{
     ...
     * @var string
     */
    public $serviceCredentialSecret;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->serviceCredentialSecret) {
            $res['ServiceCredentialSecret'] = $this->serviceCredentialSecret;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ServiceCredentialSecret'])) {
            $model->serviceCredentialSecret = $map['ServiceCredentialSecret'];
        }
