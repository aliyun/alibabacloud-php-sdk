...
class network extends Model
{
    ...
    /**
     * @description The security group IDs of the master instance.
     *
     * @var string[]
     */
    ...
    /**
     * @description The IDs of the vSwitches to which the master instance is connected.
     *
     * @var string[]
     */
    public $vSwitches;
    ...
    /**
     * @description The ID of the virtual private cloud (VPC) to which the master instance belongs.
     *
