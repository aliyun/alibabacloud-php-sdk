...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeCdnDomainLogsResponseBody\domainLogModel;
...
class DescribeCdnDomainLogsResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->domainLogModel) {
            $res['DomainLogModel'] = null !== $this->domainLogModel ? $this->domainLogModel->toArray($noStream) : $this->domainLogModel;
        }
