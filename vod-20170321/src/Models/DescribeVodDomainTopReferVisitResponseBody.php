...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodDomainTopReferVisitResponseBody\topReferList;

class DescribeVodDomainTopReferVisitResponseBody extends Model
{
    /**
     * @var string
     */
