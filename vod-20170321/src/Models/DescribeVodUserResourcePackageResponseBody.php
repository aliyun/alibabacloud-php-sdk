...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodUserResourcePackageResponseBody\resourcePackageInfos;

class DescribeVodUserResourcePackageResponseBody extends Model
{
    /**
     * @var string
     */
