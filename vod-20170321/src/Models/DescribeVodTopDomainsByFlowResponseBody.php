...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodTopDomainsByFlowResponseBody\topDomains;

class DescribeVodTopDomainsByFlowResponseBody extends Model
{
    /**
     * @var int
     */
