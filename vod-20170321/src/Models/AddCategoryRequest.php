...
class AddCategoryRequest extends Model
{
     ...
     * @description test
     *
     * @example The ID of the parent category. If you do not set this parameter, a level 1 category is generated by default. The parent category ID of a level 1 category is **-1**.
     *
