...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeDomainFlowDataResponseBody\flowDataPerInterval;
...
class DescribeDomainFlowDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->flowDataPerInterval) {
            $this->flowDataPerInterval->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->flowDataPerInterval) {
            $res['FlowDataPerInterval'] = null !== $this->flowDataPerInterval ? $this->flowDataPerInterval->toArray($noStream) : $this->flowDataPerInterval;
        }
