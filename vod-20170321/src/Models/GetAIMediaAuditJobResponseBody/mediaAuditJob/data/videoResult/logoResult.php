...
{
    /**
     * @description The average score of the snapshots in the category indicated by Label.
     *
     * @example 100
     *
     * @var string
    ...
    /**
     * @description The highest score of the snapshot of the category that is indicated by Label.
     *
     * @example 100
     *
     * @var string
