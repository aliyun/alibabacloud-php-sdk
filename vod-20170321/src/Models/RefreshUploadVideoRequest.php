...
class RefreshUploadVideoRequest extends Model
{
    /**
     * @var int
     */
    ...
    /**
     * @description The ID of the audio or video file. You can use one of the following methods to obtain the ID:
     *
     ...
     * @param array $map
     *
     * @return RefreshUploadVideoRequest
     */
