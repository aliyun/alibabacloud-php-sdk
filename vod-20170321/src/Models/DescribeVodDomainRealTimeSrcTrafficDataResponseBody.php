...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodDomainRealTimeSrcTrafficDataResponseBody\realTimeSrcTrafficDataPerInterval;

class DescribeVodDomainRealTimeSrcTrafficDataResponseBody extends Model
{
    /**
     * @var string
     */
