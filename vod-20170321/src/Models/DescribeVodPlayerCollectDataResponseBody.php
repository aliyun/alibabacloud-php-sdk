...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodPlayerCollectDataResponseBody\dataList;

class DescribeVodPlayerCollectDataResponseBody extends Model
{
    /**
     * @var dataList[]
     */
