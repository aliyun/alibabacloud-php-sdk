...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodUserBillPredictionResponseBody\billPredictionData;

class DescribeVodUserBillPredictionResponseBody extends Model
{
    /**
