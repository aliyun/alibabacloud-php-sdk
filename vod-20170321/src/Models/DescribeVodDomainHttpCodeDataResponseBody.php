...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodDomainHttpCodeDataResponseBody\httpCodeData;

class DescribeVodDomainHttpCodeDataResponseBody extends Model
{
    /**
     * @var string
     */
