...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeFileIdPlayStatisByEdgeResponseBody\filePlayStatisList;

class DescribeFileIdPlayStatisByEdgeResponseBody extends Model
{
    /**
