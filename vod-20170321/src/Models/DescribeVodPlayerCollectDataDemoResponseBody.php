...
use AlibabaCloud\SDK\Vod\V20170321\Models\DescribeVodPlayerCollectDataDemoResponseBody\dataList;

class DescribeVodPlayerCollectDataDemoResponseBody extends Model
{
    /**
     * @var dataList[]
     */
