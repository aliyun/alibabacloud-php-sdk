...
use AlibabaCloud\SDK\Vod\V20170321\Models\SetVodDomainStagingConfigResponseBody\domainConfigList;

class SetVodDomainStagingConfigResponseBody extends Model
{
    /**
