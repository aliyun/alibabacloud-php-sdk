...
class GetImageObjectDetectionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetImageObjectDetectionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetImageObjectDetectionResponseBody::fromMap($map['body']);
        }
