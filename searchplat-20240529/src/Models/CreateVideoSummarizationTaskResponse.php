...
class CreateVideoSummarizationTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateVideoSummarizationTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateVideoSummarizationTaskResponseBody::fromMap($map['body']);
        }
