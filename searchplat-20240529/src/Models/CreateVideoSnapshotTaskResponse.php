...
class CreateVideoSnapshotTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateVideoSnapshotTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateVideoSnapshotTaskResponseBody::fromMap($map['body']);
        }
