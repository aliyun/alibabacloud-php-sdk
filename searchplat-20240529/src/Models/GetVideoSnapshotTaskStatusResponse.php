...
class GetVideoSnapshotTaskStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetVideoSnapshotTaskStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetVideoSnapshotTaskStatusResponseBody::fromMap($map['body']);
        }
