...
class GetMultiModalEmbeddingResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetMultiModalEmbeddingResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetMultiModalEmbeddingResponseBody::fromMap($map['body']);
        }
