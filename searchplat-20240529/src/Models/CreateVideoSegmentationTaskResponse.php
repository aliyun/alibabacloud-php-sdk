...
class CreateVideoSegmentationTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateVideoSegmentationTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateVideoSegmentationTaskResponseBody::fromMap($map['body']);
        }
