...
use AlibabaCloud\SDK\Companyreg\V20200306\Models\QueryPartnerIntentionListResponseBody\data;
use AlibabaCloud\Tea\Model;

class QueryPartnerIntentionListResponseBody extends Model
{
    /**
     * @example 2
     *
     ...
     * @param array $map
     *
     * @return QueryPartnerIntentionListResponseBody
     */
