...
use AlibabaCloud\SDK\Companyreg\V20200306\Models\ListUserDetailSolutionsResponseBody\data;
use AlibabaCloud\Tea\Model;

class ListUserDetailSolutionsResponseBody extends Model
{
    /**
     * @example 5
     *
     ...
     * @param array $map
     *
     * @return ListUserDetailSolutionsResponseBody
     */
