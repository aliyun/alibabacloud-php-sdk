...
use AlibabaCloud\SDK\Companyreg\V20200306\Models\ListUserSolutionsResponseBody\data;
use AlibabaCloud\Tea\Model;

class ListUserSolutionsResponseBody extends Model
{
    /**
     * @example 8
     *
     ...
     * @param array $map
     *
     * @return ListUserSolutionsResponseBody
     */
