...
class UpdateApplicationVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateApplicationVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateApplicationVersionResponseBody::fromMap($map['body']);
        }
