...
class CreateApplicationVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateApplicationVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateApplicationVersionResponseBody::fromMap($map['body']);
        }
