...
use AlibabaCloud\SDK\BailianVoiceBot\V20250101\Models\GenerateFileUploadParamsResponseBody\data;

class GenerateFileUploadParamsResponseBody extends Model
{
    /**
     * @var string
     */
