...
class PublishApplicationVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PublishApplicationVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PublishApplicationVersionResponseBody::fromMap($map['body']);
        }
