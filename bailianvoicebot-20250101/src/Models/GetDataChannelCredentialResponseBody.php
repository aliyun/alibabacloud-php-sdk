...
use AlibabaCloud\SDK\BailianVoiceBot\V20250101\Models\GetDataChannelCredentialResponseBody\data;

class GetDataChannelCredentialResponseBody extends Model
{
    /**
     * @var string
     */
