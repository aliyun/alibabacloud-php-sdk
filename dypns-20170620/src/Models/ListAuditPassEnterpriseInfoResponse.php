...
class ListAuditPassEnterpriseInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListAuditPassEnterpriseInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListAuditPassEnterpriseInfoResponseBody::fromMap($map['body']);
        }
