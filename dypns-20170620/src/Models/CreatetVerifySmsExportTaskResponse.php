...
class CreatetVerifySmsExportTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreatetVerifySmsExportTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreatetVerifySmsExportTaskResponseBody::fromMap($map['body']);
        }
