...
class ConfigVerifySceneAppInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ConfigVerifySceneAppInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ConfigVerifySceneAppInfoResponseBody::fromMap($map['body']);
        }
