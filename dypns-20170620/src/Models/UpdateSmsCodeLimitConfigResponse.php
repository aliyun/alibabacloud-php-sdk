...
class UpdateSmsCodeLimitConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateSmsCodeLimitConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateSmsCodeLimitConfigResponseBody::fromMap($map['body']);
        }
