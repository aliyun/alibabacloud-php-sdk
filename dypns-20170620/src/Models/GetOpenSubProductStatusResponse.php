...
class GetOpenSubProductStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetOpenSubProductStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetOpenSubProductStatusResponseBody::fromMap($map['body']);
        }
