...
class QueryCommonStatisticPreviewResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryCommonStatisticPreviewResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryCommonStatisticPreviewResponseBody::fromMap($map['body']);
        }
