...
class RemoveGateVerifyExportLogResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var RemoveGateVerifyExportLogResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = RemoveGateVerifyExportLogResponseBody::fromMap($map['body']);
        }
