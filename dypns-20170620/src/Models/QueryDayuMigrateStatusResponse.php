...
class QueryDayuMigrateStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryDayuMigrateStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryDayuMigrateStatusResponseBody::fromMap($map['body']);
        }
