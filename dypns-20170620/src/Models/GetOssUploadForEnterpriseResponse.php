...
class GetOssUploadForEnterpriseResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetOssUploadForEnterpriseResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetOssUploadForEnterpriseResponseBody::fromMap($map['body']);
        }
