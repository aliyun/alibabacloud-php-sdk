...
use AlibabaCloud\SDK\Dypns\V20170620\Models\CreateVerifySchemeResponseBody\gateVerifySchemeDTO;
...
class CreateVerifySchemeResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->gateVerifySchemeDTO) {
            $res['GateVerifySchemeDTO'] = null !== $this->gateVerifySchemeDTO ? $this->gateVerifySchemeDTO->toArray($noStream) : $this->gateVerifySchemeDTO;
        }
