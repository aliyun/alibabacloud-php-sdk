...
class CreateFileByBizRequest extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->saveOssFileName) {
            $res['SaveOssFileName'] = $this->saveOssFileName;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SaveOssFileName'])) {
            $model->saveOssFileName = $map['SaveOssFileName'];
        }
