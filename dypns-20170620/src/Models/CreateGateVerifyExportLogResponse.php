...
class CreateGateVerifyExportLogResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateGateVerifyExportLogResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateGateVerifyExportLogResponseBody::fromMap($map['body']);
        }
