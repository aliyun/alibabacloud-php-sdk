...
class QueryGateVerifyStatisticResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryGateVerifyStatisticResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryGateVerifyStatisticResponseBody::fromMap($map['body']);
        }
