...
class QueryGateVerifyRecordListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryGateVerifyRecordListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryGateVerifyRecordListResponseBody::fromMap($map['body']);
        }
