...
class QueryGateVerifyBillingResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryGateVerifyBillingResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryGateVerifyBillingResponseBody::fromMap($map['body']);
        }
