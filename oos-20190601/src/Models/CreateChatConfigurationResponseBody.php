...
use AlibabaCloud\SDK\Oos\V20190601\Models\CreateChatConfigurationResponseBody\chatConfiguration;

class CreateChatConfigurationResponseBody extends Model
{
    /**
