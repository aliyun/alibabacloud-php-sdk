...
use AlibabaCloud\SDK\Oos\V20190601\Models\UpdateChatConfigurationResponseBody\chatConfiguration;

class UpdateChatConfigurationResponseBody extends Model
{
    /**
