...
use AlibabaCloud\SDK\Imageprocess\V20200320\Models\PredictCVDAdvanceRequest\URLList;
use AlibabaCloud\Tea\Model;

class PredictCVDAdvanceRequest extends Model
{
    /**
     * @example DICOM
     *
     ...
     * @param array $map
     *
     * @return PredictCVDAdvanceRequest
     */
