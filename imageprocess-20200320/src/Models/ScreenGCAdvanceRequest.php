...
use AlibabaCloud\SDK\Imageprocess\V20200320\Models\ScreenGCAdvanceRequest\URLList;
use AlibabaCloud\Tea\Model;

class ScreenGCAdvanceRequest extends Model
{
    /**
     * @example DICOM
     *
