...
use AlibabaCloud\SDK\Imageprocess\V20200320\Models\ScreenLCAdvanceRequest\URLList;
use AlibabaCloud\Tea\Model;

class ScreenLCAdvanceRequest extends Model
{
    /**
     * @example DICOM
     *
