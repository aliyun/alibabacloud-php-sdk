...
use AlibabaCloud\SDK\Imageprocess\V20200320\Models\ScreenCRCAdvanceRequest\URLList;
use AlibabaCloud\Tea\Model;

class ScreenCRCAdvanceRequest extends Model
{
    /**
     * @example DICOM
     *
     ...
     * @param array $map
     *
     * @return ScreenCRCAdvanceRequest
     */
