...
use AlibabaCloud\SDK\Imageprocess\V20200320\Models\ScreenECAdvanceRequest\URLList;
use AlibabaCloud\Tea\Model;

class ScreenECAdvanceRequest extends Model
{
    /**
     * @example HTTP_FILES
     *
