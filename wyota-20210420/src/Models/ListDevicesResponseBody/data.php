...
class data extends Model
{
    ...
    {
        if (\is_array($this->connectConfigs)) {
            Model::validateArray($this->connectConfigs);
        }
        if (null !== $this->customResourcePackage) {
            $this->customResourcePackage->validate();
        }
        ...
        if (null !== $this->peripheralConfig) {
            $this->peripheralConfig->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->connectConfigs) {
            if (\is_array($this->connectConfigs)) {
                $res['ConnectConfigs'] = [];
                $n1 = 0;
                foreach ($this->connectConfigs as $item1) {
                    $res['ConnectConfigs'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
        ...
        if (null !== $this->customResourcePackage) {
            $res['CustomResourcePackage'] = null !== $this->customResourcePackage ? $this->customResourcePackage->toArray($noStream) : $this->customResourcePackage;
        }
        ...
        if (null !== $this->labelList) {
            if (\is_array($this->labelList)) {
                ...
                foreach ($this->labelList as $item1) {
                    $res['LabelList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
        ...
        if (null !== $this->peripheralConfig) {
            $res['PeripheralConfig'] = null !== $this->peripheralConfig ? $this->peripheralConfig->toArray($noStream) : $this->peripheralConfig;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ConnectConfigs'])) {
            if (!empty($map['ConnectConfigs'])) {
                ...
                $n1 = 0;
                foreach ($map['ConnectConfigs'] as $item1) {
                    $model->connectConfigs[$n1] = connectConfigs::fromMap($item1);
                    ++$n1;
                }
            }
        }
