...
class version extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->wyForceUpgrade) {
            $res['WyForceUpgrade'] = $this->wyForceUpgrade;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['WyForceUpgrade'])) {
            $model->wyForceUpgrade = $map['WyForceUpgrade'];
        }
