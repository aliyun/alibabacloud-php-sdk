...
namespace AlibabaCloud\SDK\Viapiregen\V20211119\Models\GetTrainTaskResponseBody;
...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->trainUseTime) {
            $res['TrainUseTime'] = $this->trainUseTime;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TrainUseTime'])) {
            $model->trainUseTime = $map['TrainUseTime'];
        }
