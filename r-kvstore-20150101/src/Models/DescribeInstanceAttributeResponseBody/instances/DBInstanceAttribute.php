...
class DBInstanceAttribute extends Model
{
    ...
    /**
     * @description Indicates whether a secondary zone is automatically allocated.
     *
     *   **true**
     *   **false**
     *
    ...
    /**
     * @description The database engine version of the instance. Valid values: **2.8**, **4.0**, **5.0**, **6.0**, and **7.0**.
     *
     * @example 4.0
     *
     * @var string
