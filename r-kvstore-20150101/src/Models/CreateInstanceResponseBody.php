...
class CreateInstanceResponseBody extends Model
{
    ...
    /**
     * @description The username that is used to connect to the instance. By default, Tair (Redis OSS-compatible) provides a username that is named after the instance ID.
     *
     * @example r-bp1zxszhcgatnx****
     *
     * @var string
