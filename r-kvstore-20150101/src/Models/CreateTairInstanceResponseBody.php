...
{
    /**
     * @description The maximum bandwidth of the instance. Unit: Mbit/s.
     *
     * @example 96
     *
     * @var int
    ...
    /**
     * @description The detailed configurations of the instance. The value is a JSON string. For more information about the parameters, see [Configure parameters](https://help.aliyun.com/document_detail/43885.html).
     *
    ...
    /**
     * @description The current status of the instance. The value is **Creating**.
     *
     * @example Creating
     *
     * @var string
    ...
    /**
     * @description The service port number of the instance.
     *
     * @example 6379
     *
     * @var int
