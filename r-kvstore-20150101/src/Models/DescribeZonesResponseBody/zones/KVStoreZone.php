...
{
    /**
     * @description Indicates whether Tair (Redis OSS-compatible) instances can be created in the current zone. Valid values:
     *
    ...
    /**
     * @description Indicates whether the zone is managed by ApsaraDB RDS. The return value of this parameter is **true** in Tair (Redis OSS-compatible).
     *
     * @example true
     *
     * @var bool
