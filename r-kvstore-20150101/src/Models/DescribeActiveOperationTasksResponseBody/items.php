...
{
    /**
     * @description Indicates whether the event can be canceled. The value 1 indicates that the event can be canceled. The value 0 indicates that the event cannot be canceled.
     *
     * @example 1
     *
     * @var string
    ...
    /**
     * @description The time when the event is executed in the backend. The time must be in UTC. Format: YYYY-MM-DDTHH:mm:ssZ.
     *
    ...
    /**
     * @description The status of the O\\&M event. Valid values:
     *
    ...
    /**
     * @description The O\\&M event parameters.
     *
     * @example {
    ...
    /**
     * @description The cause of the O\\&M event.
     *
