...
use AlibabaCloud\SDK\Rtcwhiteboard\V20201214\Models\PauseWhiteBoardRecordingResponseBody\result;
use AlibabaCloud\Tea\Model;

class PauseWhiteBoardRecordingResponseBody extends Model
{
    /**
     * @description 请求ID
     *
     ...
     * @param array $map
     *
     * @return PauseWhiteBoardRecordingResponseBody
     */
