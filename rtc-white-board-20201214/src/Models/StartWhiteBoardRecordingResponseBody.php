...
use AlibabaCloud\SDK\Rtcwhiteboard\V20201214\Models\StartWhiteBoardRecordingResponseBody\result;
use AlibabaCloud\Tea\Model;

class StartWhiteBoardRecordingResponseBody extends Model
{
    /**
     * @description 请求ID
     *
     ...
     * @param array $map
     *
     * @return StartWhiteBoardRecordingResponseBody
     */
