...
class GetServiceResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->supportContacts) {
            $res['SupportContacts'] = [];
            if (null !== $this->supportContacts && \is_array($this->supportContacts)) {
                $n = 0;
                foreach ($this->supportContacts as $item) {
                    $res['SupportContacts'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
        if (null !== $this->tags) {
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SupportContacts'])) {
            if (!empty($map['SupportContacts'])) {
                ...
                $n = 0;
                foreach ($map['SupportContacts'] as $item) {
                    $model->supportContacts[$n++] = null !== $item ? supportContacts::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Tags'])) {
