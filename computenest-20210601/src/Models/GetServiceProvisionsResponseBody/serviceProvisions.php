...
use AlibabaCloud\SDK\ComputeNest\V20210601\Models\GetServiceProvisionsResponseBody\serviceProvisions\commodityProvisions;
...
class serviceProvisions extends Model
{
    ...
    /**
     * @description Product details. Some services (such as ACS) involve the activation of multiple products
     *
    ...
    public function toMap()
    {
        ...
        if (null !== $this->commodityProvisions) {
            ...
            if (null !== $this->commodityProvisions && \is_array($this->commodityProvisions)) {
                $n = 0;
                foreach ($this->commodityProvisions as $item) {
                    $res['CommodityProvisions'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CommodityProvisions'])) {
            if (!empty($map['CommodityProvisions'])) {
                ...
                $n = 0;
                foreach ($map['CommodityProvisions'] as $item) {
                    $model->commodityProvisions[$n++] = null !== $item ? commodityProvisions::fromMap($item) : $item;
                }
            }
        }
