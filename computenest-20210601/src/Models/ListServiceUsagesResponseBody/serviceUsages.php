...
namespace AlibabaCloud\SDK\ComputeNest\V20210601\Models\ListServiceUsagesResponseBody;
...
class serviceUsages extends Model
{
    ...
    /**
     * @description The state of the service application. Valid values:
     *
    ...
    /**
     * @description The information about the applicants.
     *
     * @var string[]
     */
