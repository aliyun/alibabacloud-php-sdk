...
class GetVideoPreviewPlayInfoResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->videoPreviewPlayInfo) {
            $this->videoPreviewPlayInfo->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->videoPreviewPlayInfo) {
            $res['video_preview_play_info'] = null !== $this->videoPreviewPlayInfo ? $this->videoPreviewPlayInfo->toArray($noStream) : $this->videoPreviewPlayInfo;
        }
