...
class FaceGroup extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->groupCoverFaceBoundary) {
            $this->groupCoverFaceBoundary->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->groupCoverFaceBoundary) {
            $res['group_cover_face_boundary'] = null !== $this->groupCoverFaceBoundary ? $this->groupCoverFaceBoundary->toArray($noStream) : $this->groupCoverFaceBoundary;
        }
