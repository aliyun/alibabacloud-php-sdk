...
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\additionalApiDescriptions;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\apiInfos;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\apis;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\prompts;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\systemMcpServerInfo;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\terraformTools;
use AlibabaCloud\SDK\OpenAPIExplorer\V20241130\Models\GetApiMcpServerResponseBody\urls;

class GetApiMcpServerResponseBody extends Model
{
    /**
    ...
    public function validate()
    {
        ...
        if (\is_array($this->apiInfos)) {
            Model::validateArray($this->apiInfos);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->apiInfos) {
            if (\is_array($this->apiInfos)) {
                $res['apiInfos'] = [];
                $n1 = 0;
                foreach ($this->apiInfos as $item1) {
                    $res['apiInfos'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
        ...
        if (null !== $this->requiredRAMPolicy) {
            $res['requiredRAMPolicy'] = $this->requiredRAMPolicy;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['apiInfos'])) {
            if (!empty($map['apiInfos'])) {
                $model->apiInfos = [];
                $n1 = 0;
                foreach ($map['apiInfos'] as $item1) {
                    $model->apiInfos[$n1] = apiInfos::fromMap($item1);
                    ++$n1;
                }
            }
        }
        ...
        if (isset($map['requiredRAMPolicy'])) {
            $model->requiredRAMPolicy = $map['requiredRAMPolicy'];
        }
