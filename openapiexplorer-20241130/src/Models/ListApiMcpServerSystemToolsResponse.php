...
class ListApiMcpServerSystemToolsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListApiMcpServerSystemToolsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListApiMcpServerSystemToolsResponseBody::fromMap($map['body']);
        }
