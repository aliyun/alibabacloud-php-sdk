...
class GetApiMcpServerUserConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetApiMcpServerUserConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetApiMcpServerUserConfigResponseBody::fromMap($map['body']);
        }
