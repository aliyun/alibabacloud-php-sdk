...
class UpdateApiMcpServerUserConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateApiMcpServerUserConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateApiMcpServerUserConfigResponseBody::fromMap($map['body']);
        }
