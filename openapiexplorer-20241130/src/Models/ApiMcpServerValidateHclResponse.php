...
class ApiMcpServerValidateHclResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ApiMcpServerValidateHclResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ApiMcpServerValidateHclResponseBody::fromMap($map['body']);
        }
