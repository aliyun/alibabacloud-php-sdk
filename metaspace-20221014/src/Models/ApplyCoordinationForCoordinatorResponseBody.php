...
use AlibabaCloud\SDK\Metaspace\V20221014\Models\ApplyCoordinationForCoordinatorResponseBody\coordinateFlowModels;

class ApplyCoordinationForCoordinatorResponseBody extends Model
{
    /**
