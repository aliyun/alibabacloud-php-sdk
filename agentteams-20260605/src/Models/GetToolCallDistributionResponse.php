...
class GetToolCallDistributionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetToolCallDistributionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetToolCallDistributionResponseBody::fromMap($map['body']);
        }
