...
class CreateTeamShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->teamMembersShrink) {
            $res['TeamMembers'] = $this->teamMembersShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TeamMembers'])) {
            $model->teamMembersShrink = $map['TeamMembers'];
        }
