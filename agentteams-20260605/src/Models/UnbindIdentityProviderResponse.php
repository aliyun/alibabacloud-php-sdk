...
class UnbindIdentityProviderResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UnbindIdentityProviderResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UnbindIdentityProviderResponseBody::fromMap($map['body']);
        }
