...
class GetWorkerBootstrapOptionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetWorkerBootstrapOptionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetWorkerBootstrapOptionsResponseBody::fromMap($map['body']);
        }
