...
class CreateWorkerBootstrapTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateWorkerBootstrapTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateWorkerBootstrapTokenResponseBody::fromMap($map['body']);
        }
