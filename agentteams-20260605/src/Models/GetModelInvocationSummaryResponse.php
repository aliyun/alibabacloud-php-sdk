...
class GetModelInvocationSummaryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetModelInvocationSummaryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetModelInvocationSummaryResponseBody::fromMap($map['body']);
        }
