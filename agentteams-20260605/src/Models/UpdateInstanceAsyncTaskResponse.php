...
class UpdateInstanceAsyncTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateInstanceAsyncTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateInstanceAsyncTaskResponseBody::fromMap($map['body']);
        }
