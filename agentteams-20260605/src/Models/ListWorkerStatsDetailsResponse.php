...
class ListWorkerStatsDetailsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListWorkerStatsDetailsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListWorkerStatsDetailsResponseBody::fromMap($map['body']);
        }
