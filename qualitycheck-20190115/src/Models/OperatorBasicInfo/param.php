...
class param extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->lgfSentences)) {
            Model::validateArray($this->lgfSentences);
        }
        ...
        if (\is_array($this->similarlySentences)) {
            Model::validateArray($this->similarlySentences);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->antModelInfo) {
            if (\is_array($this->antModelInfo)) {
                $res['AntModelInfo'] = [];
                foreach ($this->antModelInfo as $key1 => $value1) {
                    $res['AntModelInfo'][$key1] = $value1;
                }
            }
        }
        ...
        if (null !== $this->customerParam) {
            $res['CustomerParam'] = null !== $this->customerParam ? $this->customerParam->toArray($noStream) : $this->customerParam;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AntModelInfo'])) {
            if (!empty($map['AntModelInfo'])) {
                $model->antModelInfo = [];
                foreach ($map['AntModelInfo'] as $key1 => $value1) {
                    $model->antModelInfo[$key1] = $value1;
                }
            }
        }
