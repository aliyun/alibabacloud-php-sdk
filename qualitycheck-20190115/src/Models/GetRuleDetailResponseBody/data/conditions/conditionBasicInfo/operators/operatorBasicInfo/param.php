...
class param extends Model
{
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->antModelInfo) {
            $res['AntModelInfo'] = null !== $this->antModelInfo ? $this->antModelInfo->toArray($noStream) : $this->antModelInfo;
        }
        ...
        if (null !== $this->operKeyWords) {
            $res['OperKeyWords'] = null !== $this->operKeyWords ? $this->operKeyWords->toArray($noStream) : $this->operKeyWords;
        }
        ...
        if (null !== $this->pvalues) {
            $res['Pvalues'] = null !== $this->pvalues ? $this->pvalues->toArray($noStream) : $this->pvalues;
        }
        ...
        if (null !== $this->similarlySentences) {
            $res['SimilarlySentences'] = null !== $this->similarlySentences ? $this->similarlySentences->toArray($noStream) : $this->similarlySentences;
        }
