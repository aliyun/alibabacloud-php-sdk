...
{
    /**
     * @var \AlibabaCloud\SDK\Qualitycheck\V20190115\Models\GetResultToReviewResponseBody\data\reviewTypeIdList\reviewTypeIdList[]
     */
        ...
        if (isset($map['ReviewTypeIdList'])) {
            if (!empty($map['ReviewTypeIdList'])) {
                ...
                foreach ($map['ReviewTypeIdList'] as $item) {
                    $model->reviewTypeIdList[$n++] = null !== $item ? \AlibabaCloud\SDK\Qualitycheck\V20190115\Models\GetResultToReviewResponseBody\data\reviewTypeIdList\reviewTypeIdList::fromMap($item) : $item;
                }
            }
        }
