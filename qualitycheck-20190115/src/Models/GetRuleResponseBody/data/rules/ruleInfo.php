...
class ruleInfo extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->businessCategoryNameList) {
            $this->businessCategoryNameList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->businessCategoryNameList) {
            $res['BusinessCategoryNameList'] = null !== $this->businessCategoryNameList ? $this->businessCategoryNameList->toArray($noStream) : $this->businessCategoryNameList;
        }
