...
namespace AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeVulDetailsResponse;
...
class cves extends Model
{
    ...
    {
        Model::validateRequired('cveId', $this->cveId, true);
        Model::validateRequired('cvssScore', $this->cvssScore, true);
