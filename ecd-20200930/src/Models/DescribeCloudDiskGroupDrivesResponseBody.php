...
use AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeCloudDiskGroupDrivesResponseBody\cloudDriveGroups;

class DescribeCloudDiskGroupDrivesResponseBody extends Model
{
    /**
