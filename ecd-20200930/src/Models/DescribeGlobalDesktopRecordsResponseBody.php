...
use AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeGlobalDesktopRecordsResponseBody\sessions;

class DescribeGlobalDesktopRecordsResponseBody extends Model
{
    /**
     * @var string
     */
