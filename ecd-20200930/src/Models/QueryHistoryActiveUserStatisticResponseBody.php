...
use AlibabaCloud\SDK\Ecd\V20200930\Models\QueryHistoryActiveUserStatisticResponseBody\userStatisticList;

class QueryHistoryActiveUserStatisticResponseBody extends Model
{
    /**
     * @var string
     */
