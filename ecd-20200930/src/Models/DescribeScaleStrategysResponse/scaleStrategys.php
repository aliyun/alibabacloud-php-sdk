...
namespace AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeScaleStrategysResponse;
...
class scaleStrategys extends Model
{
    ...
    {
        Model::validateRequired('maxAvailableDesktopsCount', $this->maxAvailableDesktopsCount, true);
        Model::validateRequired('maxDesktopsCount', $this->maxDesktopsCount, true);
        Model::validateRequired('minAvailableDesktopsCount', $this->minAvailableDesktopsCount, true);
        Model::validateRequired('minDesktopsCount', $this->minDesktopsCount, true);
        Model::validateRequired('scaleStep', $this->scaleStep, true);
        Model::validateRequired('scaleStrategyId', $this->scaleStrategyId, true);
        Model::validateRequired('scaleStrategyName', $this->scaleStrategyName, true);
        Model::validateRequired('scaleStrategyType', $this->scaleStrategyType, true);
    }
