...
class ModifyADConnectorOfficeSiteRequest extends Model
{
    ...
    /**
     * @description The DNS address of the subdomain in the enterprise AD domain. You can specify only one DNS address. If you configure `SubDomainName` and leave this parameter empty, the value is the same as that of the enterprise AD domain.
     *
     * @example 127.0.*.*
     *
     * @var string[]
