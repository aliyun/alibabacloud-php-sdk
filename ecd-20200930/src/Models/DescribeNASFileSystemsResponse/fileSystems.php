...
namespace AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeNASFileSystemsResponse;
...
class fileSystems extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('fileSystemStatus', $this->fileSystemStatus, true);
        ...
        Model::validateRequired('mountTargetStatus', $this->mountTargetStatus, true);
        ...
        Model::validateRequired('supportAcl', $this->supportAcl, true);
