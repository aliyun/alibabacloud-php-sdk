...
class officeSites extends Model
{
    ...
    /**
     * @description The custom gateway.
     *
     * @example gw-****.com
     *
     * @var string
    ...
    /**
     * @description The array of custom DNS addresses.
     *
     * @var string[]
     */
    ...
    /**
     * @description The amount of resources.
     *
     * @var resourceAmounts[]
     */
    ...
    /**
     * @description The total number of network cards.
     *
     * @example 1
     *
     * @var int
