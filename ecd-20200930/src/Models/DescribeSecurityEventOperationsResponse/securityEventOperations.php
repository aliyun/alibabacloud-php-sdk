...
namespace AlibabaCloud\SDK\Ecd\V20200930\Models\DescribeSecurityEventOperationsResponse;
...
class securityEventOperations extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('operationParams', $this->operationParams, true);
        Model::validateRequired('userCanOperate', $this->userCanOperate, true);
    }
