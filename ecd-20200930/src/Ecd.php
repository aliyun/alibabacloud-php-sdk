...
class Ecd extends OpenApiClient
{
    ...
    public function addUserToDesktopGroupWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->simpleUserGroupId)) {
     ...
     *  *
     * @param CloneCenterPolicyRequest $request CloneCenterPolicyRequest
     * @param RuntimeOptions           $runtime runtime options for this request RuntimeOptions
     *
     * @return CloneCenterPolicyResponse CloneCenterPolicyResponse
     */
     ...
     *  *
     * @param CreateCenterPolicyRequest $request CreateCenterPolicyRequest
     * @param RuntimeOptions            $runtime runtime options for this request RuntimeOptions
     *
     * @return CreateCenterPolicyResponse CreateCenterPolicyResponse
     */
    public function createCenterPolicyWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->clientControlMenu)) {
        ...
        if (!Utils::isUnset($request->disconnectKeepSession)) {
            $query['DisconnectKeepSession'] = $request->disconnectKeepSession;
        }
        if (!Utils::isUnset($request->disconnectKeepSessionTime)) {
            $query['DisconnectKeepSessionTime'] = $request->disconnectKeepSessionTime;
        }
        if (!Utils::isUnset($request->displayMode)) {
        ...
        if (!Utils::isUnset($request->enableSessionRateLimiting)) {
        ...
        if (!Utils::isUnset($request->fileMigrate)) {
            $query['FileMigrate'] = $request->fileMigrate;
        }
        if (!Utils::isUnset($request->fileTransferAddress)) {
            $query['FileTransferAddress'] = $request->fileTransferAddress;
        }
        if (!Utils::isUnset($request->fileTransferSpeed)) {
            $query['FileTransferSpeed'] = $request->fileTransferSpeed;
        }
        if (!Utils::isUnset($request->fileTransferSpeedLocation)) {
        ...
        if (!Utils::isUnset($request->internetPrinter)) {
        ...
        if (!Utils::isUnset($request->resetDesktop)) {
        ...
        if (!Utils::isUnset($request->resolutionModel)) {
        ...
        if (!Utils::isUnset($request->safeMenu)) {
        ...
        if (!Utils::isUnset($request->useTime)) {
            $query['UseTime'] = $request->useTime;
        }
        if (!Utils::isUnset($request->videoEncAvgKbps)) {
            $query['VideoEncAvgKbps'] = $request->videoEncAvgKbps;
        }
        if (!Utils::isUnset($request->videoEncMaxQP)) {
            $query['VideoEncMaxQP'] = $request->videoEncMaxQP;
        }
        if (!Utils::isUnset($request->videoEncMinQP)) {
            $query['VideoEncMinQP'] = $request->videoEncMinQP;
        }
        if (!Utils::isUnset($request->videoEncPeakKbps)) {
            $query['VideoEncPeakKbps'] = $request->videoEncPeakKbps;
        }
        if (!Utils::isUnset($request->videoEncPolicy)) {
        ...
        if (!Utils::isUnset($request->watermarkColumnAmount)) {
            $query['WatermarkColumnAmount'] = $request->watermarkColumnAmount;
        }
        if (!Utils::isUnset($request->watermarkCustomText)) {
        ...
        if (!Utils::isUnset($request->wuyingKeeper)) {
    ...
    public function createDesktopGroupWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->deleteDuration)) {
    ...
    public function createDesktopsWithOptions($tmpReq, $runtime)
    {
        ...
        if (!Utils::isUnset($request->appRuleId)) {
    ...
    public function createImageWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->dataSnapshotIds)) {
    ...
    public function createTemplateWithOptions($request, $runtime)
    {
        ...
        $bodyFlat = [];
        if (!Utils::isUnset($request->dataDiskList)) {
        ...
        if (!Utils::isUnset($request->postPaidAfterUsedUp)) {
            $body['PostPaidAfterUsedUp'] = $request->postPaidAfterUsedUp;
        }
        if (!Utils::isUnset($request->productType)) {
            $body['ProductType'] = $request->productType;
        }
        if (!Utils::isUnset($request->regionConfigList)) {
            $bodyFlat['RegionConfigList'] = $request->regionConfigList;
        }
        if (!Utils::isUnset($request->resourceGroupId)) {
            $body['ResourceGroupId'] = $request->resourceGroupId;
        }
        if (!Utils::isUnset($request->resourceTagList)) {
            $bodyFlat['ResourceTagList'] = $request->resourceTagList;
        }
        if (!Utils::isUnset($request->siteConfigList)) {
            $bodyFlat['SiteConfigList'] = $request->siteConfigList;
        }
        if (!Utils::isUnset($request->systemDiskPerformanceLevel)) {
        ...
        if (!Utils::isUnset($request->userDuration)) {
     ...
     *  *
     * @param DeleteCenterPolicyRequest $request DeleteCenterPolicyRequest
     * @param RuntimeOptions            $runtime runtime options for this request RuntimeOptions
     *
     * @return DeleteCenterPolicyResponse DeleteCenterPolicyResponse
     */
     ...
     *  *
     * @param DescribeCenterPolicyListRequest $request DescribeCenterPolicyListRequest
     * @param RuntimeOptions                  $runtime runtime options for this request RuntimeOptions
     *
     * @return DescribeCenterPolicyListResponse DescribeCenterPolicyListResponse
     */
    ...
    public function describeClientEventsWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->fillHardwareInfo)) {
    ...
    public function describeDesktopTypesWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->scopeSet)) {
     ...
     * @summary 查询网盘列表
     *  *
     * @param DescribeDrivesRequest $request DescribeDrivesRequest
     * @param RuntimeOptions        $runtime runtime options for this request RuntimeOptions
     *
     * @return DescribeDrivesResponse DescribeDrivesResponse
     */
    ...
    /**
     * @param DescribeResourceByCenterPolicyIdRequest $request DescribeResourceByCenterPolicyIdRequest
     * @param RuntimeOptions                          $runtime runtime options for this request RuntimeOptions
     *
     * @return DescribeResourceByCenterPolicyIdResponse DescribeResourceByCenterPolicyIdResponse
     */
     ...
     *  *
     * @param ModifyCenterPolicyRequest $request ModifyCenterPolicyRequest
     * @param RuntimeOptions            $runtime runtime options for this request RuntimeOptions
     *
     * @return ModifyCenterPolicyResponse ModifyCenterPolicyResponse
     */
    ...
    /**
     * @param ModifyResourceCenterPolicyRequest $request ModifyResourceCenterPolicyRequest
     * @param RuntimeOptions                    $runtime runtime options for this request RuntimeOptions
     *
     * @return ModifyResourceCenterPolicyResponse ModifyResourceCenterPolicyResponse
     */
    public function modifyResourceCenterPolicyWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->policyGroupType)) {
     ...
     *  *
     * @param ModifyTemplateBaseInfoRequest $request ModifyTemplateBaseInfoRequest
     * @param RuntimeOptions                $runtime runtime options for this request RuntimeOptions
     *
     * @return ModifyTemplateBaseInfoResponse ModifyTemplateBaseInfoResponse
     */
    ...
    public function rebuildDesktopsWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $query = [];
        if (!Utils::isUnset($request->afterStatus)) {
    ...
    public function runCommandWithOptions($request, $runtime)
    {
        ...
        if (!Utils::isUnset($request->commandRole)) {
