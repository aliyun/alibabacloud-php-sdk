...
class SubmitDocTranslateTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitDocTranslateTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitDocTranslateTaskResponseBody::fromMap($map['body']);
        }
