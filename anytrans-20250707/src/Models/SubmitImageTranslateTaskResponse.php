...
class SubmitImageTranslateTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitImageTranslateTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitImageTranslateTaskResponseBody::fromMap($map['body']);
        }
