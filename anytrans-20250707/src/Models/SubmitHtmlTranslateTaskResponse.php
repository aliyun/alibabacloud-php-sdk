...
class SubmitHtmlTranslateTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitHtmlTranslateTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitHtmlTranslateTaskResponseBody::fromMap($map['body']);
        }
