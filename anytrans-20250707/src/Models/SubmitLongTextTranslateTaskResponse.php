...
class SubmitLongTextTranslateTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitLongTextTranslateTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitLongTextTranslateTaskResponseBody::fromMap($map['body']);
        }
