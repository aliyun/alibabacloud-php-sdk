...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeVpcFirewallDropTrafficTrendResponseBody\dataList;

class DescribeVpcFirewallDropTrafficTrendResponseBody extends Model
{
    /**
     * @var dataList[]
     */
