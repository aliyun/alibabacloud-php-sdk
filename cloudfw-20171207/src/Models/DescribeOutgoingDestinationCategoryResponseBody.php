...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeOutgoingDestinationCategoryResponseBody\typeList;

class DescribeOutgoingDestinationCategoryResponseBody extends Model
{
    /**
     * @var string
     */
