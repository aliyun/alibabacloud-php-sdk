...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeVpcFirewallTrafficTrendResponseBody\dataList;

class DescribeVpcFirewallTrafficTrendResponseBody extends Model
{
    /**
     * @var int
     */
