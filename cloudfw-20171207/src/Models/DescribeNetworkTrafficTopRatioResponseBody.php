...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeNetworkTrafficTopRatioResponseBody\dataList;

class DescribeNetworkTrafficTopRatioResponseBody extends Model
{
    /**
     * @var int
     */
