...
namespace AlibabaCloud\SDK\Cloudfw\V20171207\Models\CreateAckClusterConnectorResponseBody;
...
class ackClusterConnector extends Model
{
    ...
    {
        $res = [];
        if (null !== $this->ackClientHostIp) {
            $res['AckClientHostIp'] = $this->ackClientHostIp;
        }
    ...
    {
        $model = new self();
        if (isset($map['AckClientHostIp'])) {
            $model->ackClientHostIp = $map['AckClientHostIp'];
        }
