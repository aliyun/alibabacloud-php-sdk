...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeNatFirewallTimeTopResponseBody\dataList;

class DescribeNatFirewallTimeTopResponseBody extends Model
{
    /**
     * @var int
     */
