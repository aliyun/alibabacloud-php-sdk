...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeNatFirewallPrecheckDetailResponseBody\precheckDetail;

class DescribeNatFirewallPrecheckDetailResponseBody extends Model
{
    /**
     * @var bool
     */
