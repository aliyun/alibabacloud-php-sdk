...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeUnprotectedPortTrendResponseBody\dataList;

class DescribeUnprotectedPortTrendResponseBody extends Model
{
    /**
     * @var dataList[]
     */
