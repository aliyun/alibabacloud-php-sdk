...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeAckClusterConnectorResponseBody\ackClusterConnector;

class DescribeAckClusterConnectorResponseBody extends Model
{
    /**
