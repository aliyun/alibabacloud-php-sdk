...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeFirewallTaskResponseBody\taskSteps;

class DescribeFirewallTaskResponseBody extends Model
{
    /**
     * @var bool
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->taskWaitingTime) {
            $res['TaskWaitingTime'] = $this->taskWaitingTime;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TaskWaitingTime'])) {
            $model->taskWaitingTime = $map['TaskWaitingTime'];
        }
