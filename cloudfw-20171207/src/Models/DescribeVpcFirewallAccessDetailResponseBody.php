...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeVpcFirewallAccessDetailResponseBody\dataList;

class DescribeVpcFirewallAccessDetailResponseBody extends Model
{
    /**
     * @var dataList[]
     */
