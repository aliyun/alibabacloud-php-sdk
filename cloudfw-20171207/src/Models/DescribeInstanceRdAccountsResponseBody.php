...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeInstanceRdAccountsResponseBody\accounts;

class DescribeInstanceRdAccountsResponseBody extends Model
{
    /**
     * @var accounts[]
     */
