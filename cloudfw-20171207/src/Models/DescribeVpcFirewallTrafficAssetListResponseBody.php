...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeVpcFirewallTrafficAssetListResponseBody\dataList;

class DescribeVpcFirewallTrafficAssetListResponseBody extends Model
{
    /**
     * @var dataList[]
     */
