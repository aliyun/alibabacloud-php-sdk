...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\UpdateAclCheckDetailStatusResponseBody\checkRecord;

class UpdateAclCheckDetailStatusResponseBody extends Model
{
    /**
     * @var checkRecord
     */
