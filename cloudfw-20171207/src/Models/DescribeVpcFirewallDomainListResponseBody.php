...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeVpcFirewallDomainListResponseBody\dataList;

class DescribeVpcFirewallDomainListResponseBody extends Model
{
    /**
     * @var dataList[]
     */
