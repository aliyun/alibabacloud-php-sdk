...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeSecurityProxyResourcesResponseBody\resourceList;

class DescribeSecurityProxyResourcesResponseBody extends Model
{
    /**
     * @var string
     */
