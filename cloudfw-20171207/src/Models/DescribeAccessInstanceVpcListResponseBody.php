...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeAccessInstanceVpcListResponseBody\vpcList;

class DescribeAccessInstanceVpcListResponseBody extends Model
{
    /**
     * @var int
     */
