...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeSdlEventDetailResponseBody\sdlEventDetailList;

class DescribeSdlEventDetailResponseBody extends Model
{
    /**
     * @var string
     */
