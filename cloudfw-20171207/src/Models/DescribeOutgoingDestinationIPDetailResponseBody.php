...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\DescribeOutgoingDestinationIPDetailResponseBody\assetList;

class DescribeOutgoingDestinationIPDetailResponseBody extends Model
{
    /**
     * @var assetList[]
     */
