...
use AlibabaCloud\SDK\Cloudfw\V20171207\Models\CreateAckClusterConnectorResponseBody\ackClusterConnector;

class CreateAckClusterConnectorResponseBody extends Model
{
    /**
