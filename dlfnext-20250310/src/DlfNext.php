...
use AlibabaCloud\SDK\DlfNext\V20250310\Models\AlterTableSchemaRequest;
use AlibabaCloud\SDK\DlfNext\V20250310\Models\AlterTableSchemaResponse;
...
use AlibabaCloud\SDK\DlfNext\V20250310\Models\GetCatalogKmsGrantsRequest;
use AlibabaCloud\SDK\DlfNext\V20250310\Models\GetCatalogKmsGrantsResponse;
...
use AlibabaCloud\SDK\DlfNext\V20250310\Models\GetQueryRequest;
use AlibabaCloud\SDK\DlfNext\V20250310\Models\GetQueryResponse;
...
use AlibabaCloud\SDK\DlfNext\V20250310\Models\ListPartitionsByNamesRequest;
use AlibabaCloud\SDK\DlfNext\V20250310\Models\ListPartitionsByNamesResponse;
...
class DlfNext extends OpenApiClient
{
     ...
     * @param string                  $database
     * @param string                  $table
     * @param AlterTableSchemaRequest $request
     * @param string[]                $headers
     * @param RuntimeOptions          $runtime
     *
     * @return AlterTableSchemaResponse
     */
    public function alterTableSchemaWithOptions($catalogId, $database, $table, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        ...
        $params = new Params([
            ...
            'version' => '2025-03-10',
            'protocol' => 'HTTPS',
            'pathname' => '/dlf/v1/' . Url::percentEncode($catalogId) . '/databases/' . Url::percentEncode($database) . '/tables/' . Url::percentEncode($table) . '/schema',
            'method' => 'POST',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
        ...
        return AlterTableSchemaResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return AlterTableSchemaResponse
     */
    public function alterTableSchema($catalogId, $database, $table, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @param runtime - runtime options for this request RuntimeOptions
     *
     * @returns GetCatalogKmsGrantsResponse
     *
     * @param string                     $catalog
     * @param GetCatalogKmsGrantsRequest $request
     * @param string[]                   $headers
     * @param RuntimeOptions             $runtime
     *
     * @return GetCatalogKmsGrantsResponse
     */
    public function getCatalogKmsGrantsWithOptions($catalog, $request, $headers, $runtime)
    {
        $request->validate();
        $req = new OpenApiRequest([
            'headers' => $headers,
        ...
        $params = new Params([
            ...
            'version' => '2025-03-10',
            'protocol' => 'HTTPS',
            'pathname' => '/dlf/v1/catalogs/' . Url::percentEncode($catalog) . '/kms/grants',
            'method' => 'GET',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
        ...
        return GetCatalogKmsGrantsResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetCatalogKmsGrantsResponse
     */
    public function getCatalogKmsGrants($catalog, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     */
    public function getQueryWithOptions($queryId, $request, $headers, $runtime)
    {
        $request->validate();
        $req = new OpenApiRequest([
            'headers' => $headers,
        ...
        $params = new Params([
            ...
            'version' => '2025-03-10',
            'protocol' => 'HTTPS',
            'pathname' => '/dlf/v1/query/' . Url::percentEncode($queryId) . '',
            'method' => 'GET',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
        ...
        return GetQueryResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetQueryResponse
     */
    public function getQuery($queryId, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @param string                       $database
     * @param string                       $table
     * @param ListPartitionsByNamesRequest $request
     * @param string[]                     $headers
     * @param RuntimeOptions               $runtime
     *
     * @return ListPartitionsByNamesResponse
     */
    public function listPartitionsByNamesWithOptions($catalogId, $database, $table, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        if (null !== $request->specs) {
        ...
        $params = new Params([
            ...
            'version' => '2025-03-10',
            'protocol' => 'HTTPS',
            'pathname' => '/dlf/v1/' . Url::percentEncode($catalogId) . '/databases/' . Url::percentEncode($database) . '/tables/' . Url::percentEncode($table) . '/partitions/list-by-names',
            'method' => 'POST',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
        ...
        return ListPartitionsByNamesResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return ListPartitionsByNamesResponse
     */
    public function listPartitionsByNames($catalogId, $database, $table, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     * @param runtime - runtime options for this request RuntimeOptions
     *
     * @returns VerifyCatalogKmsResponse
     *
     * @param string                  $catalog
     * @param VerifyCatalogKmsRequest $request
     * @param string[]                $headers
     * @param RuntimeOptions          $runtime
     *
     * @return VerifyCatalogKmsResponse
     */
    public function verifyCatalogKmsWithOptions($catalog, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        ...
        $params = new Params([
            ...
            'version' => '2025-03-10',
            'protocol' => 'HTTPS',
            'pathname' => '/dlf/v1/catalogs/' . Url::percentEncode($catalog) . '/kms/verify',
            'method' => 'POST',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
        ...
        return VerifyCatalogKmsResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return VerifyCatalogKmsResponse
     */
    public function verifyCatalogKms($catalog, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
