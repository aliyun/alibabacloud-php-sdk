...
use AlibabaCloud\SDK\Cddc\V20200320\Models\DescribePrinsEcsInstancesResponseBody\instanceList;

class DescribePrinsEcsInstancesResponseBody extends Model
{
    /**
     * @var instanceList[]
     */
