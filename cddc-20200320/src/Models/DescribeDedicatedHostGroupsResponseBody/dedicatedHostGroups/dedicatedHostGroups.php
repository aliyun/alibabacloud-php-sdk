...
class dedicatedHostGroups extends Model
{
    ...
    {
        if (\is_array($this->dedicatedHostCountGroupByHostType)) {
            Model::validateArray($this->dedicatedHostCountGroupByHostType);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->dedicatedHostCountGroupByHostType) {
            if (\is_array($this->dedicatedHostCountGroupByHostType)) {
                $res['DedicatedHostCountGroupByHostType'] = [];
                foreach ($this->dedicatedHostCountGroupByHostType as $key1 => $value1) {
                    $res['DedicatedHostCountGroupByHostType'][$key1] = $value1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DedicatedHostCountGroupByHostType'])) {
            if (!empty($map['DedicatedHostCountGroupByHostType'])) {
                $model->dedicatedHostCountGroupByHostType = [];
                foreach ($map['DedicatedHostCountGroupByHostType'] as $key1 => $value1) {
                    $model->dedicatedHostCountGroupByHostType[$key1] = $value1;
                }
            }
        }
