...
class RemoveTraficMatchRuleFromTrafficMarkingPolicyRequest extends Model
{
    /**
    ...
    /**
     * @description The operation that you want to perform. Set the value to **RemoveTraficMatchRuleFromTrafficMarkingPolicy**.
     *
     * @example false
     *
     * @var bool
    ...
    /**
     * @description Deletes specified traffic classification rules from a traffic marking policy.
     *
     ...
     * @param array $map
     *
     * @return RemoveTraficMatchRuleFromTrafficMarkingPolicyRequest
     */
