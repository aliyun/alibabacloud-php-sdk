...
class GetUserAliUidByInstanceIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetUserAliUidByInstanceIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetUserAliUidByInstanceIdResponseBody::fromMap($map['body']);
        }
