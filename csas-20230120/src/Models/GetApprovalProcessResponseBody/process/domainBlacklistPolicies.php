...
use AlibabaCloud\SDK\Csas\V20230120\Models\GetApprovalProcessResponseBody\process\domainBlacklistPolicies\fieldMap;

class domainBlacklistPolicies extends Model
{
    /**
     * @var string
     */
