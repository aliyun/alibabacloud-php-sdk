...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdatePrivateAccessApplicationL7SwitchRequest\portRanges;

class UpdatePrivateAccessApplicationL7SwitchRequest extends Model
{
    /**
     * @var string
     */
