...
use AlibabaCloud\SDK\Csas\V20230120\Models\GetVulScanGlobalConfigResponseBody\wuyingVulFixConfig;

class GetVulScanGlobalConfigResponseBody extends Model
{
    /**
     * @var int
     */
