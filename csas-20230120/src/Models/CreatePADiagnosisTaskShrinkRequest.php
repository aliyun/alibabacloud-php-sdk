...
class CreatePADiagnosisTaskShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->udpExtraConfigsShrink) {
            $res['UdpExtraConfigs'] = $this->udpExtraConfigsShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['UdpExtraConfigs'])) {
            $model->udpExtraConfigsShrink = $map['UdpExtraConfigs'];
        }
