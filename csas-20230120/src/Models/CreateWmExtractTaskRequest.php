...
class CreateWmExtractTaskRequest extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->imageExtractParamsOpenApi) {
            $this->imageExtractParamsOpenApi->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->imageExtractParamsOpenApi) {
            $res['ImageExtractParamsOpenApi'] = null !== $this->imageExtractParamsOpenApi ? $this->imageExtractParamsOpenApi->toArray($noStream) : $this->imageExtractParamsOpenApi;
        }
