...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessRequest\matchSchemaConfigs\peripheralBlockSchemaConfig\fieldMap;

class peripheralBlockSchemaConfig extends Model
{
    /**
     * @var string
     */
