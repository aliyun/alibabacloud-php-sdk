...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessRequest\matchSchemaConfigs\deviceRegistrationSchemaConfig\fieldMap;

class deviceRegistrationSchemaConfig extends Model
{
    /**
     * @var string
     */
