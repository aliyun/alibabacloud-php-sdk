...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessRequest\matchSchemaConfigs\privateAccessBlockSchemaConfig\fieldMap;

class privateAccessBlockSchemaConfig extends Model
{
    /**
     * @var string
     */
