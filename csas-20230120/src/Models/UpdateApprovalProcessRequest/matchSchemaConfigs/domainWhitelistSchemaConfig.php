...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessRequest\matchSchemaConfigs\domainWhitelistSchemaConfig\fieldMap;

class domainWhitelistSchemaConfig extends Model
{
    /**
     * @var string
     */
