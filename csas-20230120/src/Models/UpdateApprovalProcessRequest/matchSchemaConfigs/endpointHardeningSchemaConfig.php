...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessRequest\matchSchemaConfigs\endpointHardeningSchemaConfig\fieldMap;

class endpointHardeningSchemaConfig extends Model
{
    /**
     * @var string
     */
