...
use AlibabaCloud\SDK\Csas\V20230120\Models\CreateVulScanScheduledStrategyResponseBody\customMatchGroup;

class CreateVulScanScheduledStrategyResponseBody extends Model
{
    /**
     * @var int
     */
