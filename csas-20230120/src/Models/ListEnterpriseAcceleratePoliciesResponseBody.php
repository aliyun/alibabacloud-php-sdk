...
use AlibabaCloud\SDK\Csas\V20230120\Models\ListEnterpriseAcceleratePoliciesResponseBody\policies;

class ListEnterpriseAcceleratePoliciesResponseBody extends Model
{
    /**
     * @var policies[]
     */
