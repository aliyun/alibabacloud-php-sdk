...
use AlibabaCloud\SDK\Csas\V20230120\Models\ListVirusScanScheduledStrategiesResponseBody\strategies;

class ListVirusScanScheduledStrategiesResponseBody extends Model
{
    /**
     * @var string
     */
