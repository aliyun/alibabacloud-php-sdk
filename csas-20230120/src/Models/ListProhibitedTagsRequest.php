...
use AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedTagsRequest\softwareId;
use AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedTagsRequest\tagIds;

class ListProhibitedTagsRequest extends Model
{
    /**
     * @var int
     */
