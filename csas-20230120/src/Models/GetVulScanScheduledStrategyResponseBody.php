...
use AlibabaCloud\SDK\Csas\V20230120\Models\GetVulScanScheduledStrategyResponseBody\customMatchGroup;

class GetVulScanScheduledStrategyResponseBody extends Model
{
    /**
     * @var int
     */
