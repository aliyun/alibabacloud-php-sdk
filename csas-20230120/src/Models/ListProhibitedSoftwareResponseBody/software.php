...
namespace AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedSoftwareResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedSoftwareResponseBody\software\linuxProcesses;
use AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedSoftwareResponseBody\software\macOSProcesses;
use AlibabaCloud\SDK\Csas\V20230120\Models\ListProhibitedSoftwareResponseBody\software\windowsProcesses;
...
class software extends Model
{
    ...
    {
        if (\is_array($this->dynamicPolicyIds)) {
            Model::validateArray($this->dynamicPolicyIds);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->dynamicPolicyIds) {
            if (\is_array($this->dynamicPolicyIds)) {
                $res['DynamicPolicyIds'] = [];
                $n1 = 0;
                foreach ($this->dynamicPolicyIds as $item1) {
                    $res['DynamicPolicyIds'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DynamicPolicyIds'])) {
            if (!empty($map['DynamicPolicyIds'])) {
                $model->dynamicPolicyIds = [];
                $n1 = 0;
                foreach ($map['DynamicPolicyIds'] as $item1) {
                    $model->dynamicPolicyIds[$n1] = $item1;
                    ++$n1;
                }
            }
        }
