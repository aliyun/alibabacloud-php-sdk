...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessResponseBody\process\endpointHardeningPolicies\fieldMap;

class endpointHardeningPolicies extends Model
{
    /**
     * @var string
     */
