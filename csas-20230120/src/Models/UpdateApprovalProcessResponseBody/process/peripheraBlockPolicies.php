...
use AlibabaCloud\SDK\Csas\V20230120\Models\UpdateApprovalProcessResponseBody\process\peripheraBlockPolicies\fieldMap;

class peripheraBlockPolicies extends Model
{
    /**
     * @var string
     */
