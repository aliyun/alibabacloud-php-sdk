...
class DeleteBroadcastStickerResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteBroadcastStickerResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteBroadcastStickerResponseBody::fromMap($map['body']);
        }
