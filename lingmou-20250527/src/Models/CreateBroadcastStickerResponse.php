...
class CreateBroadcastStickerResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateBroadcastStickerResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateBroadcastStickerResponseBody::fromMap($map['body']);
        }
