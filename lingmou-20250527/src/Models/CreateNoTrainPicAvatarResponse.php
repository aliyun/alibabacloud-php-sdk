...
class CreateNoTrainPicAvatarResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateNoTrainPicAvatarResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateNoTrainPicAvatarResponseBody::fromMap($map['body']);
        }
