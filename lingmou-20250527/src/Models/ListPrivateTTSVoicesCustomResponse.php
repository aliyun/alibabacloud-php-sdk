...
class ListPrivateTTSVoicesCustomResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListPrivateTTSVoicesCustomResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListPrivateTTSVoicesCustomResponseBody::fromMap($map['body']);
        }
