...
class ListBroadcastTemplatesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBroadcastTemplatesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBroadcastTemplatesResponseBody::fromMap($map['body']);
        }
