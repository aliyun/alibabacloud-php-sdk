...
class ListBroadcastVideosByIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBroadcastVideosByIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBroadcastVideosByIdResponseBody::fromMap($map['body']);
        }
