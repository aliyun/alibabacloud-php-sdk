...
class ListBroadcastAudiosByIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBroadcastAudiosByIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBroadcastAudiosByIdResponseBody::fromMap($map['body']);
        }
