...
use AlibabaCloud\SDK\Safe\V20220117\Models\QueryExecuteInfoRequest\levelTree;

class QueryExecuteInfoRequest extends Model
{
    /**
     * @var string
     */
