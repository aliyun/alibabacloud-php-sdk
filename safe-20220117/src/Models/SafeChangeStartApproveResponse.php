...
class SafeChangeStartApproveResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SafeChangeStartApproveResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SafeChangeStartApproveResponseBody::fromMap($map['body']);
        }
