...
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\approveFlowParam;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\bgCustomTemplateExtraDTO;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\blockInfos;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\callBackInfo;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\changeTimes;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\influenceInfo;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\instance;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\product;
use AlibabaCloud\SDK\Safe\V20220117\Models\ChangeCheckShrinkRequest\releasePackageInfos;

class ChangeCheckShrinkRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public $damagedChangeNoticesShrink;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->damagedChangeNoticesShrink) {
            $res['DamagedChangeNotices'] = $this->damagedChangeNoticesShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DamagedChangeNotices'])) {
            $model->damagedChangeNoticesShrink = $map['DamagedChangeNotices'];
        }
