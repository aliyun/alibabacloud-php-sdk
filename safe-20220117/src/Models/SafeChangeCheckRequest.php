...
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\approveFlowParam;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\bgCustomTemplateExtraDTO;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\blockInfos;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\callBackInfo;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\changeTimes;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\damagedChangeNotices;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\harmNoticeCombineParam;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\influenceInfo;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\instance;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\product;
use AlibabaCloud\SDK\Safe\V20220117\Models\SafeChangeCheckRequest\releasePackageInfos;

class SafeChangeCheckRequest extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var harmNoticeCombineParam
     */
    public $harmNoticeCombineParam;
    ...
    public function validate()
    {
        ...
        if (null !== $this->harmNoticeCombineParam) {
            $this->harmNoticeCombineParam->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->harmNoticeCombineParam) {
            $res['HarmNoticeCombineParam'] = null !== $this->harmNoticeCombineParam ? $this->harmNoticeCombineParam->toArray($noStream) : $this->harmNoticeCombineParam;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['HarmNoticeCombineParam'])) {
            $model->harmNoticeCombineParam = harmNoticeCombineParam::fromMap($map['HarmNoticeCombineParam']);
        }
