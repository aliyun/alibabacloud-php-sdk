...
class SafeChangeQueryApproveFlowResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SafeChangeQueryApproveFlowResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SafeChangeQueryApproveFlowResponseBody::fromMap($map['body']);
        }
