...
use AlibabaCloud\SDK\Safe\V20220117\Models\CreateMaYiBlockRequest\blockTimes;
use AlibabaCloud\SDK\Safe\V20220117\Models\CreateMaYiBlockRequest\scope;

class CreateMaYiBlockRequest extends Model
{
    /**
     * @var string
     */
