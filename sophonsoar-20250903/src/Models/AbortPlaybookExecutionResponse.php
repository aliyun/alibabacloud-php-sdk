...
class AbortPlaybookExecutionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AbortPlaybookExecutionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AbortPlaybookExecutionResponseBody::fromMap($map['body']);
        }
