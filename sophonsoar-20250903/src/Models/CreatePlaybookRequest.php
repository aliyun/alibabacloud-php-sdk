...
class CreatePlaybookRequest extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->srcPlaybookUuid) {
            $res['SrcPlaybookUuid'] = $this->srcPlaybookUuid;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SrcPlaybookUuid'])) {
            $model->srcPlaybookUuid = $map['SrcPlaybookUuid'];
        }
