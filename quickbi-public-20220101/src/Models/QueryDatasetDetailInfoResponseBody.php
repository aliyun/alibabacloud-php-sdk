...
class QueryDatasetDetailInfoResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return QueryDatasetDetailInfoResponseBody
     */
