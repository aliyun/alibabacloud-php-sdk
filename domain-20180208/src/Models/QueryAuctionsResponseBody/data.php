...
namespace AlibabaCloud\SDK\Domain\V20180208\Models\QueryAuctionsResponseBody;
...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->reserveMax) {
            $res['ReserveMax'] = $this->reserveMax;
        }
        if (null !== $this->reserveMet) {
            $res['ReserveMet'] = $this->reserveMet;
        }
        if (null !== $this->reserveMin) {
            $res['ReserveMin'] = $this->reserveMin;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ReserveMax'])) {
            $model->reserveMax = $map['ReserveMax'];
        }
        if (isset($map['ReserveMet'])) {
            $model->reserveMet = $map['ReserveMet'];
        }
        if (isset($map['ReserveMin'])) {
            $model->reserveMin = $map['ReserveMin'];
        }
