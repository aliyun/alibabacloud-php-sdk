...
use AlibabaCloud\SDK\Domain\V20180208\Models\BatchQueryReceivedPushStatusResponseBody\module;

class BatchQueryReceivedPushStatusResponseBody extends Model
{
    /**
     * @var string
     */
