...
use AlibabaCloud\SDK\Domain\V20180208\Models\QueryAuctionsResponseBody\data;
use AlibabaCloud\Tea\Model;

class QueryAuctionsResponseBody extends Model
{
    /**
     * @example 1
     *
     ...
     * @param array $map
     *
     * @return QueryAuctionsResponseBody
     */
