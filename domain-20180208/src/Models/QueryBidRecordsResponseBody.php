...
use AlibabaCloud\SDK\Domain\V20180208\Models\QueryBidRecordsResponseBody\data;
use AlibabaCloud\Tea\Model;

class QueryBidRecordsResponseBody extends Model
{
    /**
     * @example 1
     *
     ...
     * @param array $map
     *
     * @return QueryBidRecordsResponseBody
     */
