...
class UpdateComputeJobDraftSqlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateComputeJobDraftSqlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateComputeJobDraftSqlResponseBody::fromMap($map['body']);
        }
