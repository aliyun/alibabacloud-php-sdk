...
class ListComputeInstancesInPageResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListComputeInstancesInPageResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListComputeInstancesInPageResponseBody::fromMap($map['body']);
        }
