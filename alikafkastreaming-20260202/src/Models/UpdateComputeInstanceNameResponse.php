...
class UpdateComputeInstanceNameResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateComputeInstanceNameResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateComputeInstanceNameResponseBody::fromMap($map['body']);
        }
