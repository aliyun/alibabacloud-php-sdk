...
namespace AlibabaCloud\SDK\Ons\V20190214\Models\OnsDLQMessagePageQueryByGroupIdResponseBody\msgFoundDo\msgFoundList;

use AlibabaCloud\SDK\Ons\V20190214\Models\OnsDLQMessagePageQueryByGroupIdResponseBody\msgFoundDo\msgFoundList\onsRestMessageDo\propertyList;
...
class onsRestMessageDo extends Model
{
    ...
    /**
     * @description The timestamp when the message was produced.
     *
    ...
    /**
     * @description The timestamp when the Message Queue for Apache RocketMQ broker stored the message.
     *
