...
use AlibabaCloud\SDK\Ons\V20190214\Models\OnsMqttQueryClientByGroupIdResponseBody\mqttClientSetDo;
use AlibabaCloud\Tea\Model;

class OnsMqttQueryClientByGroupIdResponseBody extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return OnsMqttQueryClientByGroupIdResponseBody
     */
