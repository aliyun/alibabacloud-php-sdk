...
class CreateRagEvaluatorTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateRagEvaluatorTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateRagEvaluatorTaskResponseBody::fromMap($map['body']);
        }
