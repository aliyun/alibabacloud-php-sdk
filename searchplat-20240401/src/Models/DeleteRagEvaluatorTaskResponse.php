...
class DeleteRagEvaluatorTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteRagEvaluatorTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteRagEvaluatorTaskResponseBody::fromMap($map['body']);
        }
