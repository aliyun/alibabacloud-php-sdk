...
class ListOfflineTaskErrorLogsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListOfflineTaskErrorLogsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListOfflineTaskErrorLogsResponseBody::fromMap($map['body']);
        }
