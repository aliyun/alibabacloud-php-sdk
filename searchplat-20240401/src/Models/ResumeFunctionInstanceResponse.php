...
class ResumeFunctionInstanceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ResumeFunctionInstanceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ResumeFunctionInstanceResponseBody::fromMap($map['body']);
        }
