...
class ListFunctionRestrictionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListFunctionRestrictionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListFunctionRestrictionsResponseBody::fromMap($map['body']);
        }
