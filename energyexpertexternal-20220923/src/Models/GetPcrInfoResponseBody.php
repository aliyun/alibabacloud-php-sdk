...
use AlibabaCloud\SDK\EnergyExpertExternal\V20220923\Models\GetPcrInfoResponseBody\data;
use AlibabaCloud\Tea\Model;

class GetPcrInfoResponseBody extends Model
{
    /**
