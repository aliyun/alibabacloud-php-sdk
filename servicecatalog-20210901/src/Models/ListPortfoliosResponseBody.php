...
class ListPortfoliosResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->portfolioDetails) {
            ...
            if (null !== $this->portfolioDetails && \is_array($this->portfolioDetails)) {
                $n = 0;
                foreach ($this->portfolioDetails as $item) {
                    $res['PortfolioDetails'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return ListPortfoliosResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['PortfolioDetails'])) {
            if (!empty($map['PortfolioDetails'])) {
                ...
                $n                       = 0;
                foreach ($map['PortfolioDetails'] as $item) {
                    $model->portfolioDetails[$n++] = null !== $item ? portfolioDetails::fromMap($item) : $item;
                }
            }
        }
