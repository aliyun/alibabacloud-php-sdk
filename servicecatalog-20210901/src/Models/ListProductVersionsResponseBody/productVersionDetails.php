...
namespace AlibabaCloud\SDK\Servicecatalog\V20210901\Models\ListProductVersionsResponseBody;

use AlibabaCloud\Tea\Model;

class productVersionDetails extends Model
{
    /**
     * @description Indicates whether the product version is enabled. Valid values:
     *
