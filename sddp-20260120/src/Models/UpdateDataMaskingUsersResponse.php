...
class UpdateDataMaskingUsersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateDataMaskingUsersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateDataMaskingUsersResponseBody::fromMap($map['body']);
        }
