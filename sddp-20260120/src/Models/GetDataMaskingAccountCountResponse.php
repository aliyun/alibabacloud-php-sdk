...
class GetDataMaskingAccountCountResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataMaskingAccountCountResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataMaskingAccountCountResponseBody::fromMap($map['body']);
        }
