...
class ListMiniEngineVersionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMiniEngineVersionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMiniEngineVersionsResponseBody::fromMap($map['body']);
        }
