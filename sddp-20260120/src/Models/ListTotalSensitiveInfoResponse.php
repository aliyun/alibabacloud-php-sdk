...
class ListTotalSensitiveInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListTotalSensitiveInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListTotalSensitiveInfoResponseBody::fromMap($map['body']);
        }
