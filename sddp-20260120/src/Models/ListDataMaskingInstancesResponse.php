...
class ListDataMaskingInstancesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDataMaskingInstancesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDataMaskingInstancesResponseBody::fromMap($map['body']);
        }
