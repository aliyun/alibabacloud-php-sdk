...
class CheckDataMaskingInstanceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CheckDataMaskingInstanceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CheckDataMaskingInstanceResponseBody::fromMap($map['body']);
        }
