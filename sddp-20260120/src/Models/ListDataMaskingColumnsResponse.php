...
class ListDataMaskingColumnsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDataMaskingColumnsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDataMaskingColumnsResponseBody::fromMap($map['body']);
        }
