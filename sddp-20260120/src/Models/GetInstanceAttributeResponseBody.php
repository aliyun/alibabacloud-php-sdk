...
class GetInstanceAttributeResponseBody extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->kmsEncryptionSupported) {
            $res['KmsEncryptionSupported'] = $this->kmsEncryptionSupported;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['KmsEncryptionSupported'])) {
            $model->kmsEncryptionSupported = $map['KmsEncryptionSupported'];
        }
