...
class GetDataMaskingColumnCountResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDataMaskingColumnCountResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDataMaskingColumnCountResponseBody::fromMap($map['body']);
        }
