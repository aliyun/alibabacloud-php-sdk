...
class DescribeDomainPathDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->pathDataPerInterval) {
            $this->pathDataPerInterval->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->pathDataPerInterval) {
            $res['PathDataPerInterval'] = null !== $this->pathDataPerInterval ? $this->pathDataPerInterval->toArray($noStream) : $this->pathDataPerInterval;
        }
