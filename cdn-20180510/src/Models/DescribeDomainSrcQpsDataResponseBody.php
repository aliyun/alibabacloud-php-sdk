...
class DescribeDomainSrcQpsDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->srcQpsDataPerInterval) {
            $this->srcQpsDataPerInterval->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->srcQpsDataPerInterval) {
            $res['SrcQpsDataPerInterval'] = null !== $this->srcQpsDataPerInterval ? $this->srcQpsDataPerInterval->toArray($noStream) : $this->srcQpsDataPerInterval;
        }
