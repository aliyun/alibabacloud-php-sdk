...
class DescribeDomainRealTimeSrcHttpCodeDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->realTimeSrcHttpCodeData) {
            $this->realTimeSrcHttpCodeData->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->realTimeSrcHttpCodeData) {
            $res['RealTimeSrcHttpCodeData'] = null !== $this->realTimeSrcHttpCodeData ? $this->realTimeSrcHttpCodeData->toArray($noStream) : $this->realTimeSrcHttpCodeData;
        }
