...
class dataModule extends Model
{
    ...
    /**
     * @description The distribution of HTTP status codes.
     *
    ...
    /**
     * @description The IPv6 bandwidth. Unit: bit/s.
     *
     * @example 0
     *
     * @var float
    ...
    /**
     * @description The IPv6 traffic. Unit: bytes.
     *
