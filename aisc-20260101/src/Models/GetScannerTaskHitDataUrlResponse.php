...
class GetScannerTaskHitDataUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetScannerTaskHitDataUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetScannerTaskHitDataUrlResponseBody::fromMap($map['body']);
        }
