...
class GetScannerTaskResultHtmlUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetScannerTaskResultHtmlUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetScannerTaskResultHtmlUrlResponseBody::fromMap($map['body']);
        }
