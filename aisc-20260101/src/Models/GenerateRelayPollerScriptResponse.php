...
class GenerateRelayPollerScriptResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GenerateRelayPollerScriptResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GenerateRelayPollerScriptResponseBody::fromMap($map['body']);
        }
