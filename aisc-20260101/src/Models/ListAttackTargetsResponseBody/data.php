...
namespace AlibabaCloud\SDK\AISC\V20260101\Models\ListAttackTargetsResponseBody;
...
class data extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->lastVerifyMessage) {
            $res['LastVerifyMessage'] = $this->lastVerifyMessage;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['LastVerifyMessage'])) {
            $model->lastVerifyMessage = $map['LastVerifyMessage'];
        }
