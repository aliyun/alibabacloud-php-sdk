...
{
    /**
     * @description Specifies whether to enable auto node repair. This parameter takes effect only if `enable` is set to true. Valid values:
     *
    ...
    /**
     * @description The auto upgrade policy.
     *
