...
{
    /**
     * @description Specifies whether ACK is allowed to automatically upgrade the kubelet. Valid values:
     *
     *   `true`: yes.
     *   `false`: no.
     *
    ...
    /**
     * @description Specifies whether ACK is allowed to automatically upgrade the operating system. This parameter takes effect only when you specify `auto_upgrade=true`. Valid values:
     *
     *   `true`: yes.
     *   `false`: no.
     *
    ...
    /**
     * @description Specifies whether ACK is allowed to automatically upgrade the runtime. This parameter takes effect only when you specify `auto_upgrade=true`. Valid values:
     *
     *   `true`: yes.
     *   `false`: no.
     *
