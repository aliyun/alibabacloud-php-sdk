...
class scalingGroup extends Model
{
    ...
    /**
     * @description [**Deprecated**] Please use the parameter security_hardening_os instead.
     *
     * @example false
     *
     * @deprecated
    ...
    /**
     * @description Indicates whether to enable the burst feature for the system disk. Valid values:
     *
