...
class body extends Model
{
    ...
    /**
     * @description 编排模板ID，该ID主要用于应用中心。
     *
     * @var string
     */
    public $templateHashCodeVersion;

    /**
     * @description 编排模板类型，取值：kubernetes。
     *
     * @var string
     */
    public $templateType;
    ...
    protected $_name = [
        ...
        'name'                    => 'name',
        'template'                => 'template',
        'templateHashCodeVersion' => 'template_hash_code_version',
    ...
    public function toMap()
    {
        ...
        if (null !== $this->templateHashCodeVersion) {
            $res['template_hash_code_version'] = $this->templateHashCodeVersion;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['template_hash_code_version'])) {
            $model->templateHashCodeVersion = $map['template_hash_code_version'];
        }
