...
class DescribeClusterDetailResponseBody extends Model
{
    ...
    /**
     * @description The pod CIDR block. The configuration of the Flannel network plug-in.
     *
    ...
    /**
     * @description The Kubernetes version of the cluster. For more information about the Kubernetes versions supported by ACK, see [Release notes for Kubernetes versions](https://help.aliyun.com/document_detail/185269.html).
     *
    ...
    /**
     * @description This parameter is available only for Flannel.
     *
    ...
    /**
     * @description The subtype of the cluster.
     *
