...
class scalingGroup extends Model
{
    ...
    /**
     * @description The auto-renewal period. Valid value:
     *
    ...
    /**
     * @description The configurations of the data disks that are mounted to the nodes in the node pool. The configurations include the disk category and disk size.
     *
     * @var DataDisk[]
     */
    public $dataDisks;
    ...
    /**
     * @description The attribute configurations of the instance.
     *
    ...
    /**
     * @description Indicates whether a non-root user can log on to an Elastic Compute Service (ECS) instance added to the node pool.
     *
    ...
    /**
     * @description The billing cycle of the nodes in the node pool. This parameter is required if you set `instance_charge_type` to `PrePaid`. Valid values:
     *
    ...
    /**
     * @description The categories of system disks. The system creates system disks of a disk category with a lower priority if the disk category with a higher priority is unavailable.
     *
     * @var string[]
     */
    ...
    /**
     * @description The performance level (PL) of the system disk. This parameter takes effect only for an ESSD. You can specify a higher PL if you increase the size of a data disk. For more information, see [ESSDs](https://help.aliyun.com/document_detail/122389.html).
     *
    ...
    /**
     * @description The label to be added to the ECS instances.
     *
     * @var Tag[]
     */
    public $tags;
