...
class DescribeTaskInfoResponseBody extends Model
{
    ...
    /**
     * @description The event generated by the task.
     *
     * @var events[]
     */
    public $events;
    ...
    /**
     * @description Detailed information about the stage of the task.
     *
     * @var stages[]
     */
    public $stages;
    ...
    /**
     * @description The object of the task.
     *
     * @var target
     */
    public $target;
    ...
    /**
     * @description The execution details of the task.
     *
     * @var taskResult[]
     */
    public $taskResult;
