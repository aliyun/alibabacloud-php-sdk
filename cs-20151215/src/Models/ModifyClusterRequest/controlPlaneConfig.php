...
{
    /**
     * @description Specifies whether to enable auto-renewal for the instance. This parameter takes effect only when `charge_type` is set to `PrePaid`. Valid values:
     *
    ...
    /**
     * @description The auto-renewal period of the instance. Valid values: 1, 2, 3, 6, and 12.
     *
     * Default value: 1.
     * @example 1
     *
    ...
    /**
     * @description The instance type. For more information, see [Overview of ECS instance families](https://help.aliyun.com/document_detail/25378.html).
     *
     * @var string[]
     */
    ...
    /**
     * @description The billing cycle of the instance. This parameter takes effect only when `instance_charge_type` is set to `PrePaid`.
     *
     * Valid value: `Month`.
     * @example Month
     *
    ...
    /**
     * @description The type of the node system disk. Valid values:
     *
     *   `cloud`: basic disk.
