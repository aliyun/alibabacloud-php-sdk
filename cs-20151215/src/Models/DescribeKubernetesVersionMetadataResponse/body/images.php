...
class images extends Model
{
    ...
    /**
     * @description The OS platform. You can obtain the terminal ID by calling one of the following operations:
     *
     *   `AliyunLinux`
     *   `CentOS`
     *   `Windows`
    ...
    /**
     * @description The type of operating system distribution that you want to use. We recommend that you use this parameter to specify the node operating system. You can obtain the terminal ID by calling one of the following operations:
     *
     *   `CentOS`
     *   `AliyunLinux`
     *   `AliyunLinux Qboot`
