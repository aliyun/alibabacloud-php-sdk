...
class autoScaling extends Model
{
    ...
    /**
     * @description The maximum number to which the Elastic Compute Service (ECS) instances in the node pool can be scaled. The number of nodes in the node pool cannot be greater than this value. This parameter takes effect only if `enable` is set to true. Valid values: [min_instances, 2000]. Default value: 0.
     *
     * @example 10
     *
     * @var int
    ...
    /**
     * @description The minimum number to which the ECS instances in the node pool can be scaled. The number of nodes in the node pool cannot be smaller than this value. This parameter takes effect only if `enable` is set to true. Valid values: [0, max_instances]. Default value: 0.
     *
     * @example 1
     *
     * @var int
    ...
    /**
     * @description The instance type that is used for auto scaling. This parameter takes effect only if `enable` is set to true. Valid values:
     *
