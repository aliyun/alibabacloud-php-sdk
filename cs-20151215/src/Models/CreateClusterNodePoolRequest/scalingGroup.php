...
{
    /**
     * @description Specifies whether to enable auto-renewal for nodes in the node pool. This parameter takes effect only if you set `instance_charge_type` to `PrePaid`. Valid values:
     *
    ...
    /**
     * @description The auto-renewal duration of nodes in the node pool. This parameter is available and required only if you set instance_charge_type to PrePaid and auto_renew to true. Valid values when `period_unit` is set to Month: 1, 2, 3, 6, and 12.
     *
     * Default value: 1.
     * @example 1
     *
    ...
    /**
     * @description The ID of the custom image. By default, the image provided by the system is used.
     *
    ...
    /**
     * @description The type of the OS image. You must specify this parameter or the `platform` parameter. Valid values:
     *
     *   `AliyunLinux`: Alinux2
    ...
    /**
     * @description The instance types of nodes in the node pool. A node that is added to the node pool is assigned one of the specified instance types that is the most appropriate. Allowed number of instance types: 1 to 10.
     *
     * This parameter is required.
     * @var string[]
     */
    ...
    /**
     * @description The subscription duration of nodes in the node pool. This parameter is available and required if you set `instance_charge_type` to `PrePaid`.
     *
    ...
    /**
     * @description The billing cycle of nodes in the node pool. This parameter is available and required if you set `instance_charge_type` to `PrePaid`.
     *
    ...
    /**
     * @description The IDs of security groups. You must specify this parameter or the `security_group_id` parameter. We recommend that you specify `security_group_ids`. If you specify both `security_group_id` and `security_group_ids`, `security_group_ids` is used.
     *
     * @var string[]
     */
    ...
    /**
     * @description The types of system disks. The system attempts to create system disks from a disk type with a lower priority when the disk type with a higher priority is unavailable. Valid values:
     *   `cloud`: basic disk
