...
class scalingGroup extends Model
{
    ...
    /**
     * @description The billing cycle of nodes in the node pool. This parameter takes effect and is required only when you set `instance_charge_type` to `PrePaid`. Valid values:
     *
    ...
    /**
     * @description The PL of the system disk. This parameter takes effect only for an ESSD.
     *
