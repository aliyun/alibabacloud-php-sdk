...
class autoUpgradePolicy extends Model
{
    ...
    /**
     * @description Specifies whether to allow the auto upgrade of the OS. This parameter takes effect only if `auto_upgrade` is set to true. Valid values:
     *
    ...
    /**
     * @description Specifies whether to allow the auto upgrade of the runtime. This parameter takes effect only if `auto_upgrade` is set to true. Valid values:
     *
