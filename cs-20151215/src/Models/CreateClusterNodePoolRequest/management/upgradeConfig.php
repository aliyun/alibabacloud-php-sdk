...
class upgradeConfig extends Model
{
    ...
    /**
     * @description The percentage of additional nodes that are temporarily added to the node pool during an auto upgrade. You must set this parameter or `surge`.
     *
     * @example 0
     *
     * @var int
