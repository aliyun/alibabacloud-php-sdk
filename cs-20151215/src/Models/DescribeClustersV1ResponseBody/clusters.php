...
class clusters extends Model
{
    ...
    /**
     * @description The version of the cluster. For more information about the Kubernetes versions supported by ACK, see [Release notes for Kubernetes versions](https://help.aliyun.com/document_detail/185269.html).
     *
     * @example 1.16.9-aliyun.1
     *
     * @var string
    ...
    /**
     * @description The kube-proxy mode.
     *
    ...
    /**
     * @description This parameter is deprecated. Use the container_cidr parameter to obtain the pod CIDR block.
     *
    ...
    /**
     * @description The label of the cluster.
     *
     * @var Tag[]
     */
    public $tags;
    ...
    /**
     * @description The ID of the virtual private cloud (VPC) that is used by the cluster.
     *
    ...
    /**
     * @description The ID of the vSwitch in the cluster.
     *
