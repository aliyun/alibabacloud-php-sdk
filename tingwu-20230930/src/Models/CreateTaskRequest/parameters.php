...
use AlibabaCloud\SDK\Tingwu\V20230930\Models\CreateTaskRequest\parameters\identityRecognition;
...
class parameters extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->identityRecognition) {
            $this->identityRecognition->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->identityRecognition) {
            $res['IdentityRecognition'] = null !== $this->identityRecognition ? $this->identityRecognition->toArray($noStream) : $this->identityRecognition;
        }

        if (null !== $this->identityRecognitionEnabled) {
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IdentityRecognition'])) {
            $model->identityRecognition = identityRecognition::fromMap($map['IdentityRecognition']);
        }

        if (isset($map['IdentityRecognitionEnabled'])) {
