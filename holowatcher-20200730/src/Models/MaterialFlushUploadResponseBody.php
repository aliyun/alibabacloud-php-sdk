...
class MaterialFlushUploadResponseBody extends Model
{
    /**
     * @var string
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->uploadValue) {
            $res['UploadValue'] = $this->uploadValue;
        }
     ...
     * @param array $map
     *
     * @return MaterialFlushUploadResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['UploadValue'])) {
            $model->uploadValue = $map['UploadValue'];
        }
