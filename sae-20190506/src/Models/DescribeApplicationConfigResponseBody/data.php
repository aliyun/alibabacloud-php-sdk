...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->initContainersConfig) {
            ...
            if (null !== $this->initContainersConfig && \is_array($this->initContainersConfig)) {
                $n = 0;
                foreach ($this->initContainersConfig as $item) {
                    $res['InitContainersConfig'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['InitContainersConfig'])) {
            if (!empty($map['InitContainersConfig'])) {
                ...
                $n = 0;
                foreach ($map['InitContainersConfig'] as $item) {
                    $model->initContainersConfig[$n++] = null !== $item ? initContainersConfig::fromMap($item) : $item;
                }
            }
        }
