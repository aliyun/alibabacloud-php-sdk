...
namespace AlibabaCloud\SDK\Sddp\V20190103\Models\DescribeDataLimitsInstanceDimResponseBody\items;
...
class dataLimitList extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->autoCreateAccount) {
            $res['AutoCreateAccount'] = $this->autoCreateAccount;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AutoCreateAccount'])) {
            $model->autoCreateAccount = $map['AutoCreateAccount'];
        }
