...
namespace AlibabaCloud\SDK\SWASOPEN\V20200601\Models\CreateCommandRequest;
...
{
    /**
     * @description The key of tag N that you want to add to the command. Valid values of N: 1 to 20.
     *
    ...
    /**
     * @description The value of tag N that you want to add to the command. Valid values of N: 1 to 20.
     *
