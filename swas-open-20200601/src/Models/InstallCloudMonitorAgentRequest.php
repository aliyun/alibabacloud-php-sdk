...
class InstallCloudMonitorAgentRequest extends Model
{
    /**
    ...
    /**
     * @description Specifies whether to forcibly install the CloudMonitor agent. Valid values:
     *
     ...
     * @param array $map
     *
     * @return InstallCloudMonitorAgentRequest
     */
