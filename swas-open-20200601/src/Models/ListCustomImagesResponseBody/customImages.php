...
class customImages extends Model
{
    ...
    /**
     * @description The size of the image data disk. Unit: GiB.
     *
     * @example 20
     *
     * @var int
    ...
    /**
     * @description The size of the image system disk. Unit: GiB.
     *
     * @example 20
     *
     * @var int
    ...
    /**
     * @description The name of the source image that is used to create the simple application server.
     *
     * @example CentOS
     *
     * @var string
    ...
    /**
     * @description The version of the source image that is used to create the simple application server.
     *
     * @example 8.0
     *
     * @var string
