...
class DeleteCustomImagesRequest extends Model
{
    /**
    ...
    /**
     * @description The ID of the custom image. The value can be a JSON array that consists of up to 15 image IDs. Separate multiple image IDs with commas (,).
     *
     ...
     * @param array $map
     *
     * @return DeleteCustomImagesRequest
     */
