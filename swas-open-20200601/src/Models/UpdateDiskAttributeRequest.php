...
class UpdateDiskAttributeRequest extends Model
{
    ...
    /**
     * @description The disk ID. You can call the ListDisks operation to query the ID of data disk.
     *
    ...
    /**
     * @description The remarks of the data disk.
     *
     * This parameter is required.
     *
     * @example test
     ...
     * @param array $map
     *
     * @return UpdateDiskAttributeRequest
     */
