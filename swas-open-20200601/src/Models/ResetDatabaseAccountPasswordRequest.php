...
class ResetDatabaseAccountPasswordRequest extends Model
{
    /**
     * @description The password of the administrator account of the Simple Database Service instance.
     *
     ...
     * @param array $map
     *
     * @return ResetDatabaseAccountPasswordRequest
     */
