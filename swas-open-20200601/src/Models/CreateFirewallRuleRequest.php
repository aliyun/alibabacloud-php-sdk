...
class CreateFirewallRuleRequest extends Model
{
    ...
    /**
     * @description The port range. Valid values: 165535. Specify a port range in the format of \<start port number>/\<end port number>. Example: 1024/1055, which indicates the port range of 10241055.
     *
     * @example 3306
     *
     * @var string
