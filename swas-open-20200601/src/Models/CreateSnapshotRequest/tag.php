...
namespace AlibabaCloud\SDK\SWASOPEN\V20200601\Models\CreateSnapshotRequest;
...
{
    /**
     * @description The key of the tag to add to the snapshot. Valid values of N: 1 to 20.
     *
    ...
    /**
     * @description The value of the tag to add to the snapshot. Valid values of N: 1 to 20.
     *
