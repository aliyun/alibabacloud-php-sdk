...
{
    /**
     * @description The total number of simple application servers to which the key pair failed to be bound.
     *
     * @example 2
     *
     * @var int
    ...
    /**
     * @description The total number of simple application servers to which the key pair is bound.
     *
     * @example 2
     *
     * @var int
