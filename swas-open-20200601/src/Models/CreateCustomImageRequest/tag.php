...
namespace AlibabaCloud\SDK\SWASOPEN\V20200601\Models\CreateCustomImageRequest;
...
{
    /**
     * @description The key of tag N that you want to add to the custom image. Valid values of N: 1 to 20.
     *
    ...
    /**
     * @description The value of tag N that you want to add to the custom image. Valid values of N: 1 to 20.
     *
