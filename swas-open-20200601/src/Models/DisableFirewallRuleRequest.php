...
class DisableFirewallRuleRequest extends Model
{
    ...
    /**
     * @description The ID of the firewall rule. You can call the ListFirewallRules operation to query the ID of the firewall rule.
     *
     ...
     * @param array $map
     *
     * @return DisableFirewallRuleRequest
     */
