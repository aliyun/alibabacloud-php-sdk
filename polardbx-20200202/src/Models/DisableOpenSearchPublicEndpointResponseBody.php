...
use AlibabaCloud\SDK\Polardbx\V20200202\Models\DisableOpenSearchPublicEndpointResponseBody\accessDeniedDetail;

class DisableOpenSearchPublicEndpointResponseBody extends Model
{
    /**
