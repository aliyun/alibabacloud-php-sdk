...
class EnableSqlAuditRequest extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->expireAfterDays) {
            $res['ExpireAfterDays'] = $this->expireAfterDays;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ExpireAfterDays'])) {
            $model->expireAfterDays = $map['ExpireAfterDays'];
        }
