...
class RestoreDBInstanceRequest extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->recoveryTypeCode) {
            $res['RecoveryTypeCode'] = $this->recoveryTypeCode;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['RecoveryTypeCode'])) {
            $model->recoveryTypeCode = $map['RecoveryTypeCode'];
        }
