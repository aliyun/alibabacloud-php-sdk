...
class CreateSQLEvaluateTaskRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->srcResType) {
            $res['SrcResType'] = $this->srcResType;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SrcResType'])) {
            $model->srcResType = $map['SrcResType'];
        }
