...
class Service extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->instanceCountInResource) {
            $this->instanceCountInResource->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->instanceCountInResource) {
            $res['InstanceCountInResource'] = null !== $this->instanceCountInResource ? $this->instanceCountInResource->toArray($noStream) : $this->instanceCountInResource;
        }
