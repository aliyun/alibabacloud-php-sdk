...
class ListVirtualResourceResponseBody extends Model
{
    ...
    /**
     * @description The list of virtual resource groups.
     *
    ...
    public function toMap()
    {
        ...
        if (null !== $this->virtualResources) {
            ...
            if (null !== $this->virtualResources && \is_array($this->virtualResources)) {
                $n = 0;
                foreach ($this->virtualResources as $item) {
                    $res['VirtualResources'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return ListVirtualResourceResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['VirtualResources'])) {
            if (!empty($map['VirtualResources'])) {
                ...
                $n                       = 0;
                foreach ($map['VirtualResources'] as $item) {
                    $model->virtualResources[$n++] = null !== $item ? virtualResources::fromMap($item) : $item;
                }
            }
        }
