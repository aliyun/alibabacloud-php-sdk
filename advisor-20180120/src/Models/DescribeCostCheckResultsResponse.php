...
class DescribeCostCheckResultsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeCostCheckResultsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeCostCheckResultsResponseBody::fromMap($map['body']);
        }
