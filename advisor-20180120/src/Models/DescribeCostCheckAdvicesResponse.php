...
class DescribeCostCheckAdvicesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeCostCheckAdvicesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeCostCheckAdvicesResponseBody::fromMap($map['body']);
        }
