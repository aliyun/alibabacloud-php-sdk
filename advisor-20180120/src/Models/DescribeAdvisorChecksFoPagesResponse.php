...
class DescribeAdvisorChecksFoPagesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeAdvisorChecksFoPagesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeAdvisorChecksFoPagesResponseBody::fromMap($map['body']);
        }
