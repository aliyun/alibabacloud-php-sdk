...
class DescribeAdvisorResourcesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeAdvisorResourcesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeAdvisorResourcesResponseBody::fromMap($map['body']);
        }
