...
class RefreshAdvisorCostCheckResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var RefreshAdvisorCostCheckResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = RefreshAdvisorCostCheckResponseBody::fromMap($map['body']);
        }
