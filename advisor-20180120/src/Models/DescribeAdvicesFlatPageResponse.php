...
class DescribeAdvicesFlatPageResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeAdvicesFlatPageResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeAdvicesFlatPageResponseBody::fromMap($map['body']);
        }
