...
class PaChatCompletionStreamResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PaChatCompletionStreamResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PaChatCompletionStreamResponseBody::fromMap($map['body']);
        }
