...
class AigcChatCompletionStreamResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AigcChatCompletionStreamResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AigcChatCompletionStreamResponseBody::fromMap($map['body']);
        }
