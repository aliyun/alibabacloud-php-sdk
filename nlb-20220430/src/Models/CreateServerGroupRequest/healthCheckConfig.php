...
namespace AlibabaCloud\SDK\Nlb\V20220430\Models\CreateServerGroupRequest;
...
class healthCheckConfig extends Model
{
    ...
    /**
     * @description The maximum timeout period of a health check. Unit: seconds. Valid values: **1** to **300**. Default value: **5**.
     *
     * @example 5
     *
     * @var int
