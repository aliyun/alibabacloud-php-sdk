...
use AlibabaCloud\SDK\Hdr\V20170925\Models\DescribeSitePairStatisticsResponseBody\primarySiteServers\server;
use AlibabaCloud\Tea\Model;

class primarySiteServers extends Model
{
    /**
     * @var server[]
     */
