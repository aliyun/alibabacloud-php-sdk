...
use AlibabaCloud\SDK\Hdr\V20170925\Models\DescribeSitePairStatisticsResponseBody\secondarySiteServers\server;
use AlibabaCloud\Tea\Model;

class secondarySiteServers extends Model
{
    /**
     * @var server[]
     */
