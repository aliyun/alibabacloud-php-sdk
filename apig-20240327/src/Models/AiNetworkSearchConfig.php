...
use AlibabaCloud\SDK\APIG\V20240327\Models\AiNetworkSearchConfig\searchRewrite;
...
class AiNetworkSearchConfig extends Model
{
    ...
    /**
     * @var AiNetworkConfigSearchEngine
     */
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['searchEngineConfig'])) {
            $model->searchEngineConfig = AiNetworkConfigSearchEngine::fromMap($map['searchEngineConfig']);
        }
        ...
        if (isset($map['searchFrom'])) {
            if (!empty($map['searchFrom'])) {
                ...
                foreach ($map['searchFrom'] as $item1) {
                    $model->searchFrom[$n1] = AiNetworkConfigSearchEngine::fromMap($item1);
                    ++$n1;
                }
            }
        }
