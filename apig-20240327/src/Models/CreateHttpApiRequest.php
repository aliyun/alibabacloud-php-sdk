...
class CreateHttpApiRequest extends Model
{
    ...
    /**
     * @description The AI API protocols. Valid value:
     *
     *   OpenAI/v1
     *
     * @var string[]
    ...
    /**
     * @description The API deployment configurations. Currently, only AI APIs support deployment configurations, and only a single deployment configuration can be passed.
     *
    ...
    /**
     * @description The HTTP Ingress configurations.
     *
     * @var ingressConfig
     */
    ...
    /**
     * @description The protocols that are used to call the API.
     *
     * @var string[]
     */
    public $protocols;
    ...
    /**
     * @description The API type. Valid values:
     *
     *   Http
     *   Rest
     *   WebSocket
    ...
    /**
     * @description The versioning configuration of the API.
     *
