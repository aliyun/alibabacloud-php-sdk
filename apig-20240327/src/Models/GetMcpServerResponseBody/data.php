...
namespace AlibabaCloud\SDK\APIG\V20240327\Models\GetMcpServerResponseBody;
...
class data extends Model
{
     ...
     * @var string
     */
    public $mcpServerConfigPluginAttachmentId;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->mcpServerConfigPluginAttachmentId) {
            $res['mcpServerConfigPluginAttachmentId'] = $this->mcpServerConfigPluginAttachmentId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['mcpServerConfigPluginAttachmentId'])) {
            $model->mcpServerConfigPluginAttachmentId = $map['mcpServerConfigPluginAttachmentId'];
        }
