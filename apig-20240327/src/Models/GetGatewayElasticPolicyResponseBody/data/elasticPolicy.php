...
namespace AlibabaCloud\SDK\APIG\V20240327\Models\GetGatewayElasticPolicyResponseBody\data;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetGatewayElasticPolicyResponseBody\data\elasticPolicy\disableScaleTimePolicyList;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetGatewayElasticPolicyResponseBody\data\elasticPolicy\enableScaleTimePolicyList;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetGatewayElasticPolicyResponseBody\data\elasticPolicy\timePolicyList;

class elasticPolicy extends Model
{
    /**
     * @var disableScaleTimePolicyList[]
     */
    public $disableScaleTimePolicyList;
    ...
    {
        if (\is_array($this->disableScaleTimePolicyList)) {
            Model::validateArray($this->disableScaleTimePolicyList);
        }
    ...
    {
        $res = [];
        if (null !== $this->disableScaleTimePolicyList) {
            if (\is_array($this->disableScaleTimePolicyList)) {
                $res['disableScaleTimePolicyList'] = [];
                $n1 = 0;
                foreach ($this->disableScaleTimePolicyList as $item1) {
                    $res['disableScaleTimePolicyList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
    ...
    {
        $model = new self();
        if (isset($map['disableScaleTimePolicyList'])) {
            if (!empty($map['disableScaleTimePolicyList'])) {
                $model->disableScaleTimePolicyList = [];
                $n1 = 0;
                foreach ($map['disableScaleTimePolicyList'] as $item1) {
                    $model->disableScaleTimePolicyList[$n1] = disableScaleTimePolicyList::fromMap($item1);
                    ++$n1;
                }
            }
        }
