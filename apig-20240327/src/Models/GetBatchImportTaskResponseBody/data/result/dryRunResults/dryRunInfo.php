...
namespace AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\existHttpApiInfo;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\failureComponents;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\failureOperations;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\failureRoutes;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\successComponents;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\successOperations;
use AlibabaCloud\SDK\APIG\V20240327\Models\GetBatchImportTaskResponseBody\data\result\dryRunResults\dryRunInfo\successRoutes;
...
class dryRunInfo extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['existHttpApiInfo'])) {
            $model->existHttpApiInfo = existHttpApiInfo::fromMap($map['existHttpApiInfo']);
        }
