...
class resources extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->resourcePageUrl) {
            $res['resourcePageUrl'] = $this->resourcePageUrl;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['resourcePageUrl'])) {
            $model->resourcePageUrl = $map['resourcePageUrl'];
        }
