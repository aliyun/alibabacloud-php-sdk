...
- Update API GetStackExecutionResult: add response parameters Body.stackResults.$.errorCode.
- Update API TriggerStackExecution: add request parameters body.sourceTriggerId.
