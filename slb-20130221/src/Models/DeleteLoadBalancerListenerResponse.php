...
class DeleteLoadBalancerListenerResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteLoadBalancerListenerResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteLoadBalancerListenerResponseBody::fromMap($map['body']);
        }
