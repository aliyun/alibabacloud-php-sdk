...
class DescribeBackendServersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeBackendServersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeBackendServersResponseBody::fromMap($map['body']);
        }
