...
class MultiModalGuardAsyncResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var MultiModalGuardAsyncResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = MultiModalGuardAsyncResultResponseBody::fromMap($map['body']);
        }
