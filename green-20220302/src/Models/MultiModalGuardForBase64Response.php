...
class MultiModalGuardForBase64Response extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var MultiModalGuardForBase64ResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = MultiModalGuardForBase64ResponseBody::fromMap($map['body']);
        }
