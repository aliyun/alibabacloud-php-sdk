...
class Green extends OpenApiClient
{
     ...
     * @summary 查询异步多模态检测结果
     *  *
     * @param DescribeMultimodalModerationResultRequest $request DescribeMultimodalModerationResultRequest
     * @param RuntimeOptions                            $runtime runtime options for this request RuntimeOptions
     *
     * @return DescribeMultimodalModerationResultResponse DescribeMultimodalModerationResultResponse
     */
     ...
     * @summary 同步检测接口
     *  *
     * @param MultiModalGuardRequest $request MultiModalGuardRequest
     * @param RuntimeOptions         $runtime runtime options for this request RuntimeOptions
     *
     * @return MultiModalGuardResponse MultiModalGuardResponse
     */
     ...
     * @summary 多模态-异步检测
     *  *
     * @param MultimodalAsyncModerationRequest $request MultimodalAsyncModerationRequest
     * @param RuntimeOptions                   $runtime runtime options for this request RuntimeOptions
     *
     * @return MultimodalAsyncModerationResponse MultimodalAsyncModerationResponse
     */
