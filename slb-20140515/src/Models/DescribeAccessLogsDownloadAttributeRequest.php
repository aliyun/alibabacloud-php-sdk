...
class DescribeAccessLogsDownloadAttributeRequest extends Model
{
    /**
    ...
    /**
     * @description The type of access log. Set the value to **layer7**, which specifies Layer 7 access logs.
     *
     * @example layer7
     *
     * @var string
     ...
     * @param array $map
     *
     * @return DescribeAccessLogsDownloadAttributeRequest
     */
