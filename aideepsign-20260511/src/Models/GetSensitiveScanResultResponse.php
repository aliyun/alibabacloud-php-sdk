...
class GetSensitiveScanResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSensitiveScanResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSensitiveScanResultResponseBody::fromMap($map['body']);
        }
