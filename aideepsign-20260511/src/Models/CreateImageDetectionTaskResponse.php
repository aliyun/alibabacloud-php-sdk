...
class CreateImageDetectionTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateImageDetectionTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateImageDetectionTaskResponseBody::fromMap($map['body']);
        }
