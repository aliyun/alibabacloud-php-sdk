...
class CreateSensitiveScanTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateSensitiveScanTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateSensitiveScanTaskResponseBody::fromMap($map['body']);
        }
