...
class PublicTemplateRuntimeConfig extends Model
{
    /**
     * @var float
     */
    ...
    /**
     * @var PublicTemplateSandboxConfig
     */
    public $sandboxConfig;

    /**
     * @var PublicTemplateVPCConfig
     */
    public $vpcConfig;
    protected $_name = [
        'cpu' => 'cpu',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['logConfig'])) {
            $model->logConfig = PublicTemplateLogConfig::fromMap($map['logConfig']);
        }
        ...
        if (isset($map['sandboxConfig'])) {
            $model->sandboxConfig = PublicTemplateSandboxConfig::fromMap($map['sandboxConfig']);
        }

        if (isset($map['vpcConfig'])) {
            $model->vpcConfig = PublicTemplateVPCConfig::fromMap($map['vpcConfig']);
        }
