...
class DeleteMultimodalDatasetResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteMultimodalDatasetResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteMultimodalDatasetResponseBody::fromMap($map['body']);
        }
