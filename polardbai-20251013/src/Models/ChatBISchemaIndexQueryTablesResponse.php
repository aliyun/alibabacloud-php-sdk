...
class ChatBISchemaIndexQueryTablesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBISchemaIndexQueryTablesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBISchemaIndexQueryTablesResponseBody::fromMap($map['body']);
        }
