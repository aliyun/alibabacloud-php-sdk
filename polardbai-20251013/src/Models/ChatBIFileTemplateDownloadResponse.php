...
class ChatBIFileTemplateDownloadResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIFileTemplateDownloadResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIFileTemplateDownloadResponseBody::fromMap($map['body']);
        }
