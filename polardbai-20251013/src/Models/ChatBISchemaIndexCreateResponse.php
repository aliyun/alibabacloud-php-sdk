...
class ChatBISchemaIndexCreateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBISchemaIndexCreateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBISchemaIndexCreateResponseBody::fromMap($map['body']);
        }
