...
class ChatBIConfigQueryEntriesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIConfigQueryEntriesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIConfigQueryEntriesResponseBody::fromMap($map['body']);
        }
