...
class ChatBIPatternUpdateEntryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIPatternUpdateEntryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIPatternUpdateEntryResponseBody::fromMap($map['body']);
        }
