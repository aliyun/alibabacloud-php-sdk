...
class ChatBIConfigDeleteEntryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIConfigDeleteEntryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIConfigDeleteEntryResponseBody::fromMap($map['body']);
        }
