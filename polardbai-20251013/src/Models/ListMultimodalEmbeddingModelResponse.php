...
class ListMultimodalEmbeddingModelResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMultimodalEmbeddingModelResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMultimodalEmbeddingModelResponseBody::fromMap($map['body']);
        }
