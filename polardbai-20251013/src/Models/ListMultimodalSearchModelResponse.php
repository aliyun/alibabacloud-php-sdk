...
class ListMultimodalSearchModelResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMultimodalSearchModelResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMultimodalSearchModelResponseBody::fromMap($map['body']);
        }
