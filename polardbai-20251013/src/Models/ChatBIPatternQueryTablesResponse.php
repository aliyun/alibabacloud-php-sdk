...
class ChatBIPatternQueryTablesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIPatternQueryTablesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIPatternQueryTablesResponseBody::fromMap($map['body']);
        }
