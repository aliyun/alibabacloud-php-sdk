...
class ChatBIConfigUpdateEntryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIConfigUpdateEntryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIConfigUpdateEntryResponseBody::fromMap($map['body']);
        }
