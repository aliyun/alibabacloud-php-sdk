...
class ChatBIPatternDeleteEntryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIPatternDeleteEntryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIPatternDeleteEntryResponseBody::fromMap($map['body']);
        }
