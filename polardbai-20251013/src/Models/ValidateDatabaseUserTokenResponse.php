...
class ValidateDatabaseUserTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ValidateDatabaseUserTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ValidateDatabaseUserTokenResponseBody::fromMap($map['body']);
        }
