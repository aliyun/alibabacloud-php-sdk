...
class UpdateMultimodalDatasetResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateMultimodalDatasetResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateMultimodalDatasetResponseBody::fromMap($map['body']);
        }
