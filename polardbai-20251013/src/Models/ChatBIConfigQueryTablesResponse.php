...
class ChatBIConfigQueryTablesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIConfigQueryTablesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIConfigQueryTablesResponseBody::fromMap($map['body']);
        }
