...
class CreateMultimodalDatasetResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateMultimodalDatasetResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateMultimodalDatasetResponseBody::fromMap($map['body']);
        }
