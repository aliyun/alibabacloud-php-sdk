...
class CreateMultimodalSearchTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateMultimodalSearchTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateMultimodalSearchTaskResponseBody::fromMap($map['body']);
        }
