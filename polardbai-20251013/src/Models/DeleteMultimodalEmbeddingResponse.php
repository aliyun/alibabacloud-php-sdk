...
class DeleteMultimodalEmbeddingResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteMultimodalEmbeddingResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteMultimodalEmbeddingResponseBody::fromMap($map['body']);
        }
