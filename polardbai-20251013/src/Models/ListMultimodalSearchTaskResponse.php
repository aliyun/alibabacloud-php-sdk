...
class ListMultimodalSearchTaskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMultimodalSearchTaskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMultimodalSearchTaskResponseBody::fromMap($map['body']);
        }
