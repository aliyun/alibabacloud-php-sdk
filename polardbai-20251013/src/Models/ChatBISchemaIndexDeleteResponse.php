...
class ChatBISchemaIndexDeleteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBISchemaIndexDeleteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBISchemaIndexDeleteResponseBody::fromMap($map['body']);
        }
