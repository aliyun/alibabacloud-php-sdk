...
class ChatBIFileUploadCallbackResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIFileUploadCallbackResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIFileUploadCallbackResponseBody::fromMap($map['body']);
        }
