...
class ChatBIPatternIndexDeleteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ChatBIPatternIndexDeleteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ChatBIPatternIndexDeleteResponseBody::fromMap($map['body']);
        }
