...
class UploadOSSMultimodalDatasetResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UploadOSSMultimodalDatasetResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UploadOSSMultimodalDatasetResponseBody::fromMap($map['body']);
        }
