...
use AlibabaCloud\SDK\DBFS\V20200418\Models\DbfsRecordRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\DbfsRecordResponse;
...
use AlibabaCloud\SDK\DBFS\V20200418\Models\GenerateUpgradeRecordRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\GenerateUpgradeRecordResponse;
...
use AlibabaCloud\SDK\DBFS\V20200418\Models\GetSynchronizConstantsRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\GetSynchronizConstantsResponse;
use AlibabaCloud\SDK\DBFS\V20200418\Models\InsertSynchronizConstantsRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\InsertSynchronizConstantsResponse;
...
use AlibabaCloud\SDK\DBFS\V20200418\Models\PublishUpgradeTaskRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\PublishUpgradeTaskResponse;
...
use AlibabaCloud\SDK\DBFS\V20200418\Models\StopUpgradeTaskRequest;
use AlibabaCloud\SDK\DBFS\V20200418\Models\StopUpgradeTaskResponse;
...
class DBFS extends OpenApiClient
{
    ...
    /**
     * @param PublishUpgradeTaskRequest $request
     * @param RuntimeOptions            $runtime
     *
     * @return PublishUpgradeTaskResponse
     */
    public function publishUpgradeTaskWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return PublishUpgradeTaskResponse::fromMap($this->doRPCRequest('PublishUpgradeTask', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return PublishUpgradeTaskResponse
     */
    public function publishUpgradeTask($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    /**
     * @param GenerateUpgradeRecordRequest $request
     * @param RuntimeOptions               $runtime
     *
     * @return GenerateUpgradeRecordResponse
     */
    public function generateUpgradeRecordWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return GenerateUpgradeRecordResponse::fromMap($this->doRPCRequest('GenerateUpgradeRecord', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return GenerateUpgradeRecordResponse
     */
    public function generateUpgradeRecord($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    /**
     * @param DbfsRecordRequest $request
     * @param RuntimeOptions    $runtime
     *
     * @return DbfsRecordResponse
     */
    public function dbfsRecordWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return DbfsRecordResponse::fromMap($this->doRPCRequest('DbfsRecord', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return DbfsRecordResponse
     */
    public function dbfsRecord($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    /**
     * @param StopUpgradeTaskRequest $request
     * @param RuntimeOptions         $runtime
     *
     * @return StopUpgradeTaskResponse
     */
    public function stopUpgradeTaskWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return StopUpgradeTaskResponse::fromMap($this->doRPCRequest('StopUpgradeTask', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return StopUpgradeTaskResponse
     */
    public function stopUpgradeTask($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    /**
     * @param InsertSynchronizConstantsRequest $request
     * @param RuntimeOptions                   $runtime
     *
     * @return InsertSynchronizConstantsResponse
     */
    public function insertSynchronizConstantsWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return InsertSynchronizConstantsResponse::fromMap($this->doRPCRequest('InsertSynchronizConstants', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return InsertSynchronizConstantsResponse
     */
    public function insertSynchronizConstants($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    /**
     * @param GetSynchronizConstantsRequest $request
     * @param RuntimeOptions                $runtime
     *
     * @return GetSynchronizConstantsResponse
     */
    public function getSynchronizConstantsWithOptions($request, $runtime)
    {
        Utils::validateModel($request);
        $req = new OpenApiRequest([
            'body' => Utils::toMap($request),
        ...
        return GetSynchronizConstantsResponse::fromMap($this->doRPCRequest('GetSynchronizConstants', '2020-04-18', 'HTTPS', 'POST', 'AK', 'json', $req, $runtime));
    }
     ...
     * @return GetSynchronizConstantsResponse
     */
    public function getSynchronizConstants($request)
    {
        $runtime = new RuntimeOptions([]);
