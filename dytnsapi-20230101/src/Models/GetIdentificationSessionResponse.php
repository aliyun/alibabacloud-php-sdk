...
class GetIdentificationSessionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetIdentificationSessionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetIdentificationSessionResponseBody::fromMap($map['body']);
        }
