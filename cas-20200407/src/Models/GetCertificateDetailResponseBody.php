...
use AlibabaCloud\SDK\Cas\V20200407\Models\GetCertificateDetailResponseBody\certificateChainList;
use AlibabaCloud\SDK\Cas\V20200407\Models\GetCertificateDetailResponseBody\tags;

class GetCertificateDetailResponseBody extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var certificateChainList[]
     */
    public $certificateChainList;
    ...
    {
        if (\is_array($this->certificateChainList)) {
            Model::validateArray($this->certificateChainList);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->certificateChainList) {
            if (\is_array($this->certificateChainList)) {
                $res['CertificateChainList'] = [];
                $n1 = 0;
                foreach ($this->certificateChainList as $item1) {
                    $res['CertificateChainList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CertificateChainList'])) {
            if (!empty($map['CertificateChainList'])) {
                $model->certificateChainList = [];
                $n1 = 0;
                foreach ($map['CertificateChainList'] as $item1) {
                    $model->certificateChainList[$n1] = certificateChainList::fromMap($item1);
                    ++$n1;
                }
            }
        }
