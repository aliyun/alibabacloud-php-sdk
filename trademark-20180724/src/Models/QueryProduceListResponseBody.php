...
use AlibabaCloud\SDK\Trademark\V20180724\Models\QueryProduceListResponseBody\data;
use AlibabaCloud\Tea\Model;

class QueryProduceListResponseBody extends Model
{
    /**
     * @var int
     */
     ...
     * @param array $map
     *
     * @return QueryProduceListResponseBody
     */
