...
class SbrainServiceSchemeMatchShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $matchParamsShrink;
    ...
    {
        $res = [];
        if (null !== $this->matchParamsShrink) {
            $res['MatchParams'] = $this->matchParamsShrink;
        }
     ...
     * @param array $map
     *
     * @return SbrainServiceSchemeMatchShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['MatchParams'])) {
            $model->matchParamsShrink = $map['MatchParams'];
        }
