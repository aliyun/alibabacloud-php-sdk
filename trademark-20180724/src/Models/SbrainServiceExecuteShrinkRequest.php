...
class SbrainServiceExecuteShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $executeParamsShrink;
    ...
    {
        $res = [];
        if (null !== $this->executeParamsShrink) {
            $res['ExecuteParams'] = $this->executeParamsShrink;
        }
     ...
     * @param array $map
     *
     * @return SbrainServiceExecuteShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['ExecuteParams'])) {
            $model->executeParamsShrink = $map['ExecuteParams'];
        }
