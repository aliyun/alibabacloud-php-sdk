...
use AlibabaCloud\SDK\Trademark\V20180724\Models\CheckIfCollectedResponseBody\data;
use AlibabaCloud\Tea\Model;

class CheckIfCollectedResponseBody extends Model
{
    /**
     * @var int
     */
     ...
     * @param array $map
     *
     * @return CheckIfCollectedResponseBody
     */
