...
class ModifySubmitTransferMaterailShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->otherShrink) {
            $res['Other'] = $this->otherShrink;
        }
     ...
     * @param array $map
     *
     * @return ModifySubmitTransferMaterailShrinkRequest
     */
