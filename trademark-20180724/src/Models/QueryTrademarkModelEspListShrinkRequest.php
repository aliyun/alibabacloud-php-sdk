...
class QueryTrademarkModelEspListShrinkRequest extends Model
{
     ...
     * @var string
     */
    public $additionalSubmitStatus;

    /**
     * @var string
     */
    public $additionalSubmitTime;
    ...
    {
        $res = [];
        if (null !== $this->additionalSubmitStatus) {
            $res['AdditionalSubmitStatus'] = $this->additionalSubmitStatus;
        }
        if (null !== $this->additionalSubmitTime) {
            $res['AdditionalSubmitTime'] = $this->additionalSubmitTime;
        }
        if (null !== $this->bizId) {
    ...
    {
        $model = new self();
        if (isset($map['AdditionalSubmitStatus'])) {
            $model->additionalSubmitStatus = $map['AdditionalSubmitStatus'];
        }
        if (isset($map['AdditionalSubmitTime'])) {
            $model->additionalSubmitTime = $map['AdditionalSubmitTime'];
        }
        if (isset($map['BizId'])) {
