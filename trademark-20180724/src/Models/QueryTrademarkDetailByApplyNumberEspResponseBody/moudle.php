...
namespace AlibabaCloud\SDK\Trademark\V20180724\Models\QueryTrademarkDetailByApplyNumberEspResponseBody;

use AlibabaCloud\SDK\Trademark\V20180724\Models\QueryTrademarkDetailByApplyNumberEspResponseBody\moudle\leafCodes;
use AlibabaCloud\SDK\Trademark\V20180724\Models\QueryTrademarkDetailByApplyNumberEspResponseBody\moudle\materialInfo;
use AlibabaCloud\SDK\Trademark\V20180724\Models\QueryTrademarkDetailByApplyNumberEspResponseBody\moudle\rootCode;
...
class moudle extends Model
{
     ...
     * @var string
     */
    public $submitAuditTimeStr;

    /**
     * @var int
     */
    public $submitAuditTimeValue;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->submitAuditTimeStr) {
            $res['SubmitAuditTimeStr'] = $this->submitAuditTimeStr;
        }
        if (null !== $this->submitAuditTimeValue) {
            $res['SubmitAuditTimeValue'] = $this->submitAuditTimeValue;
        }
        if (null !== $this->submitStatus) {
            $res['SubmitStatus'] = $this->submitStatus;
        }
        if (null !== $this->submitTimeStr) {
            $res['SubmitTimeStr'] = $this->submitTimeStr;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SubmitAuditTimeStr'])) {
            $model->submitAuditTimeStr = $map['SubmitAuditTimeStr'];
        }
        if (isset($map['SubmitAuditTimeValue'])) {
            $model->submitAuditTimeValue = $map['SubmitAuditTimeValue'];
        }
        if (isset($map['SubmitStatus'])) {
            $model->submitStatus = $map['SubmitStatus'];
        }
        if (isset($map['SubmitTimeStr'])) {
            $model->submitTimeStr = $map['SubmitTimeStr'];
        }
