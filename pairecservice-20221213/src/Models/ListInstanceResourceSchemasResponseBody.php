...
use AlibabaCloud\SDK\PaiRecService\V20221213\Models\ListInstanceResourceSchemasResponseBody\schemas;

class ListInstanceResourceSchemasResponseBody extends Model
{
    /**
     * @var string
     */
