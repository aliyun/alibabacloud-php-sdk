...
class GetFunctionResponseBody extends Model
{
    ...
    /**
     * @description The name of the layer resource (ARN V1 version).
     *
    ...
    /**
     * @description The name of the layer resource (ARN V2 version).
     *
    ...
    /**
     * @description The environment variables that you configured for the function.
     *
