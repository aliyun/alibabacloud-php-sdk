...
class AsymmetricEncryptResponseBody extends Model
{
    /**
     * @description The Base64-encoded ciphertext that was generated after encryption.
     *
     ...
     * @param array $map
     *
     * @return AsymmetricEncryptResponseBody
     */
