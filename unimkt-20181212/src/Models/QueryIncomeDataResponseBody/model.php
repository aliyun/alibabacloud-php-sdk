...
namespace AlibabaCloud\SDK\UniMkt\V20181212\Models\QueryIncomeDataResponseBody;
...
class model extends Model
{
     ...
     * @var int
     */
    public $lastDayEstimatedIncome;

    /**
     * @var int
     */
    public $thisYearIncome;
    ...
    protected $_name = [
        'lastDayEstimatedIncome' => 'LastDayEstimatedIncome',
        ...
        'thisMonEstimatedIncome' => 'ThisMonEstimatedIncome',
    ...
    {
        $res = [];
        if (null !== $this->lastDayEstimatedIncome) {
            $res['LastDayEstimatedIncome'] = $this->lastDayEstimatedIncome;
        }
        if (null !== $this->thisYearIncome) {
            $res['ThisYearIncome'] = $this->thisYearIncome;
        }
        ...
        if (null !== $this->accumulatedIncome) {
            $res['AccumulatedIncome'] = $this->accumulatedIncome;
        }
        if (null !== $this->thisMonEstIncomeRate) {
            $res['ThisMonEstIncomeRate'] = $this->thisMonEstIncomeRate;
        }
        if (null !== $this->thisMonEstimatedIncome) {
            $res['ThisMonEstimatedIncome'] = $this->thisMonEstimatedIncome;
        }
    ...
    {
        $model = new self();
        if (isset($map['LastDayEstimatedIncome'])) {
            $model->lastDayEstimatedIncome = $map['LastDayEstimatedIncome'];
        }
        if (isset($map['ThisYearIncome'])) {
            $model->thisYearIncome = $map['ThisYearIncome'];
        }
        ...
        if (isset($map['AccumulatedIncome'])) {
            $model->accumulatedIncome = $map['AccumulatedIncome'];
        }
        if (isset($map['ThisMonEstIncomeRate'])) {
            $model->thisMonEstIncomeRate = $map['ThisMonEstIncomeRate'];
        }
        if (isset($map['ThisMonEstimatedIncome'])) {
            $model->thisMonEstimatedIncome = $map['ThisMonEstimatedIncome'];
        }
