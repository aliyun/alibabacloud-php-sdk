...
class CreatesSlotTemplateRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->adSlotTemplate) {
            $res['AdSlotTemplate'] = $this->adSlotTemplate;
        }
     ...
     * @param array $map
     *
     * @return CreatesSlotTemplateRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AdSlotTemplate'])) {
            $model->adSlotTemplate = $map['AdSlotTemplate'];
        }
