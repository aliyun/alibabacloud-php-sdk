...
use AlibabaCloud\SDK\Dysms\V20170620\Models\QueryTagResourcesNewRequest\tag;

class QueryTagResourcesNewRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->resourceIdListString) {
            $res['ResourceIdListString'] = $this->resourceIdListString;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ResourceIdListString'])) {
            $model->resourceIdListString = $map['ResourceIdListString'];
        }
