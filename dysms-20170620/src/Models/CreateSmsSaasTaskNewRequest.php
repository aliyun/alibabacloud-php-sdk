...
class CreateSmsSaasTaskNewRequest extends Model
{
    /**
     * @var string
     */
    ...
    protected $_name = [
        'bizType' => 'BizType',
        'dataAbilityTaskId' => 'DataAbilityTaskId',
        'dataType' => 'DataType',
        'orderTime' => 'OrderTime',
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->dataAbilityTaskId) {
            $res['DataAbilityTaskId'] = $this->dataAbilityTaskId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DataAbilityTaskId'])) {
            $model->dataAbilityTaskId = $map['DataAbilityTaskId'];
        }
