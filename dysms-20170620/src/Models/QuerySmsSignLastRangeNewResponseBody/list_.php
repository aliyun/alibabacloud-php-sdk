...
namespace AlibabaCloud\SDK\Dysms\V20170620\Models\QuerySmsSignLastRangeNewResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Dysms\V20170620\Models\QuerySmsSignLastRangeNewResponseBody\list_\smsSign;
        ...
        if (isset($map['SmsSign'])) {
            if (!empty($map['SmsSign'])) {
                ...
                foreach ($map['SmsSign'] as $item1) {
                    $model->smsSign[$n1] = smsSign::fromMap($item1);
                    ++$n1;
                }
            }
        }
