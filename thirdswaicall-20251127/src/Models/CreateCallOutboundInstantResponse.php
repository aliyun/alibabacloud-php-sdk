...
class CreateCallOutboundInstantResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateCallOutboundInstantResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateCallOutboundInstantResponseBody::fromMap($map['body']);
        }
