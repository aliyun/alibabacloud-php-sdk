...
class ReadOutboundTaskCallListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ReadOutboundTaskCallListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ReadOutboundTaskCallListResponseBody::fromMap($map['body']);
        }
