...
use AlibabaCloud\SDK\Servicemesh\V20200111\Models\CreateIstioGatewayRoutesRequest\gatewayRoute\HTTPAdvancedOptions\retries\retryRemoteLocalities;
...
class retries extends Model
{
    ...
    /**
     * @description The timeout period for each retry. Example: `5s`.
     *
     * @example 5s
     *
     * @var string
