...
namespace AlibabaCloud\SDK\Servicemesh\V20200111\Models\DescribeServiceMeshesResponse\serviceMeshes\spec\meshConfig\sidecarInjector;
...
class initCNIConfiguration extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('excludeNamespaces', $this->excludeNamespaces, true);
    }
