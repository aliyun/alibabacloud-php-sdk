...
class CreateServiceMeshRequest extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->enableACMG) {
            $res['EnableACMG'] = $this->enableACMG;
        }
        ...
        if (null !== $this->playgroundScene) {
            $res['PlaygroundScene'] = $this->playgroundScene;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['EnableACMG'])) {
            $model->enableACMG = $map['EnableACMG'];
        }
        ...
        if (isset($map['PlaygroundScene'])) {
            $model->playgroundScene = $map['PlaygroundScene'];
        }
