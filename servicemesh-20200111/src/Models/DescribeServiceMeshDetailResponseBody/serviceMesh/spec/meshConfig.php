...
class meshConfig extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->webAssemblyFilterDeployment) {
            $this->webAssemblyFilterDeployment->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->accessLog) {
            $res['AccessLog'] = null !== $this->accessLog ? $this->accessLog->toArray($noStream) : $this->accessLog;
        }
        ...
        if (null !== $this->controlPlaneLogInfo) {
            $res['ControlPlaneLogInfo'] = null !== $this->controlPlaneLogInfo ? $this->controlPlaneLogInfo->toArray($noStream) : $this->controlPlaneLogInfo;
        }
        ...
        if (null !== $this->edition) {
            $res['Edition'] = null !== $this->edition ? $this->edition->toArray($noStream) : $this->edition;
        }
        ...
        if (null !== $this->k8sNewAPIsSupport) {
            $res['K8sNewAPIsSupport'] = null !== $this->k8sNewAPIsSupport ? $this->k8sNewAPIsSupport->toArray($noStream) : $this->k8sNewAPIsSupport;
        }

        if (null !== $this->kiali) {
            $res['Kiali'] = null !== $this->kiali ? $this->kiali->toArray($noStream) : $this->kiali;
        }

        if (null !== $this->localityLB) {
            $res['LocalityLB'] = null !== $this->localityLB ? $this->localityLB->toArray($noStream) : $this->localityLB;
        }

        if (null !== $this->MSE) {
            $res['MSE'] = null !== $this->MSE ? $this->MSE->toArray($noStream) : $this->MSE;
        }

        if (null !== $this->OPA) {
            $res['OPA'] = null !== $this->OPA ? $this->OPA->toArray($noStream) : $this->OPA;
        }
        ...
        if (null !== $this->protocolSupport) {
            $res['ProtocolSupport'] = null !== $this->protocolSupport ? $this->protocolSupport->toArray($noStream) : $this->protocolSupport;
        }

        if (null !== $this->proxy) {
            $res['Proxy'] = null !== $this->proxy ? $this->proxy->toArray($noStream) : $this->proxy;
        }
        ...
        if (null !== $this->webAssemblyFilterDeployment) {
            $res['WebAssemblyFilterDeployment'] = null !== $this->webAssemblyFilterDeployment ? $this->webAssemblyFilterDeployment->toArray($noStream) : $this->webAssemblyFilterDeployment;
        }
