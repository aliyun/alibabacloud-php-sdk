...
class Servicemesh extends Rpc
{
    ...
    public function getAutoInjectionLabelSyncStatusWithOptions($request, $runtime)
    {
        ...
        return GetAutoInjectionLabelSyncStatusResponse::fromMap($this->doRequest('GetAutoInjectionLabelSyncStatus', 'HTTPS', 'POST', '2020-01-11', 'AK', null, Tea::merge($request), $runtime));
    }
