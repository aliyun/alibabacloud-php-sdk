...
class DeleteProtectionPolicyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteProtectionPolicyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteProtectionPolicyResponseBody::fromMap($map['body']);
        }
