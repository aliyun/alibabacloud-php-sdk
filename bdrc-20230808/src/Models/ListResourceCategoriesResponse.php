...
class ListResourceCategoriesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListResourceCategoriesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListResourceCategoriesResponseBody::fromMap($map['body']);
        }
