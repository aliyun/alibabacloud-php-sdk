...
class CreateResourceCategoryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateResourceCategoryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateResourceCategoryResponseBody::fromMap($map['body']);
        }
