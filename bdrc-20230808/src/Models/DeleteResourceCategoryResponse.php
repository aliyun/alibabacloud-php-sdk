...
class DeleteResourceCategoryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteResourceCategoryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteResourceCategoryResponseBody::fromMap($map['body']);
        }
