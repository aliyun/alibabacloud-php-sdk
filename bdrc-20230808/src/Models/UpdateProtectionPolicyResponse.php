...
class UpdateProtectionPolicyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateProtectionPolicyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateProtectionPolicyResponseBody::fromMap($map['body']);
        }
