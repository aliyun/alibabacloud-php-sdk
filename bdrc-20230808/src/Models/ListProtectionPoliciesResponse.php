...
class ListProtectionPoliciesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListProtectionPoliciesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListProtectionPoliciesResponseBody::fromMap($map['body']);
        }
