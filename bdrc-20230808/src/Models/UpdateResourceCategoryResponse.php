...
class UpdateResourceCategoryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateResourceCategoryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateResourceCategoryResponseBody::fromMap($map['body']);
        }
