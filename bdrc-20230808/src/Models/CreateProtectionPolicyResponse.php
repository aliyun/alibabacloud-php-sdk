...
class CreateProtectionPolicyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateProtectionPolicyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateProtectionPolicyResponseBody::fromMap($map['body']);
        }
