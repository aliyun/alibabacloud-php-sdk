...
namespace AlibabaCloud\SDK\Brainindustrial\V20200920\Models\ListPidProjectsResponse;

use AlibabaCloud\Tea\Model;

class pidProjectList extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('pidProjectDesc', $this->pidProjectDesc, true);
