...
use AlibabaCloud\SDK\Brainindustrial\V20200920\Models\ListLoopParameterTagValuesResponse\tagsValuesRsp;
use AlibabaCloud\Tea\Model;

class ListLoopParameterTagValuesResponse extends Model
{
    /**
     * @var string
     */
