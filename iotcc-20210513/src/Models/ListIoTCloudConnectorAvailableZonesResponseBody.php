...
class ListIoTCloudConnectorAvailableZonesResponseBody extends Model
{
    /**
     * @var string[]
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->availableZoneList) {
            $res['AvailableZoneList'] = $this->availableZoneList;
        }
     ...
     * @param array $map
     *
     * @return ListIoTCloudConnectorAvailableZonesResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AvailableZoneList'])) {
            if (!empty($map['AvailableZoneList'])) {
                $model->availableZoneList = $map['AvailableZoneList'];
            }
        }
