...
class UpdateWorkitemShrinkRequest extends Model
{
    /**
     * @var int
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->cfListShrink) {
            $res['CfList'] = $this->cfListShrink;
        }
        ...
        if (null !== $this->cfsShrink) {
            $res['Cfs'] = $this->cfsShrink;
        }
     ...
     * @param array $map
     *
     * @return UpdateWorkitemShrinkRequest
     */
