...
class GetDigitalEmployeeUmodelResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDigitalEmployeeUmodelResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDigitalEmployeeUmodelResponseBody::fromMap($map['body']);
        }
