...
class GetArtifactDownloadUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetArtifactDownloadUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetArtifactDownloadUrlResponseBody::fromMap($map['body']);
        }
