...
class CreateArtifactUploadTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateArtifactUploadTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateArtifactUploadTokenResponseBody::fromMap($map['body']);
        }
