...
class ConnectorUpdateInput extends Model
{
    /**
     * @var ConnectorAuthenticationUpdateInput
     */
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['authentication'])) {
            $model->authentication = ConnectorAuthenticationUpdateInput::fromMap($map['authentication']);
        }
