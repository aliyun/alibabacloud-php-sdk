...
class UpdateDigitalEmployeeUmodelResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateDigitalEmployeeUmodelResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateDigitalEmployeeUmodelResponseBody::fromMap($map['body']);
        }
