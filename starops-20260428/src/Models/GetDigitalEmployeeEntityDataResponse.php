...
class GetDigitalEmployeeEntityDataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDigitalEmployeeEntityDataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDigitalEmployeeEntityDataResponseBody::fromMap($map['body']);
        }
