...
class DeleteDigitalEmployeeSkillResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteDigitalEmployeeSkillResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteDigitalEmployeeSkillResponseBody::fromMap($map['body']);
        }
