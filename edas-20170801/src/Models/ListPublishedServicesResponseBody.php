...
class ListPublishedServicesResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->publishedServicesList) {
            $this->publishedServicesList->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->publishedServicesList) {
            $res['PublishedServicesList'] = null !== $this->publishedServicesList ? $this->publishedServicesList->toArray($noStream) : $this->publishedServicesList;
        }
