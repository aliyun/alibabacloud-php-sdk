...
class ecsEntity extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->ecuEntity) {
            $this->ecuEntity->validate();
        }
        if (null !== $this->vpcEntity) {
            $this->vpcEntity->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->ecuEntity) {
            $res['EcuEntity'] = null !== $this->ecuEntity ? $this->ecuEntity->toArray($noStream) : $this->ecuEntity;
        }
        ...
        if (null !== $this->vpcEntity) {
            $res['VpcEntity'] = null !== $this->vpcEntity ? $this->vpcEntity->toArray($noStream) : $this->vpcEntity;
        }
