...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateDataServiceAppMemberRequest\updateCommand;

class UpdateDataServiceAppMemberRequest extends Model
{
    /**
     * @var int
     */
