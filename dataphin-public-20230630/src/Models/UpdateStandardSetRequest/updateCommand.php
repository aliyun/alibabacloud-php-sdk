...
namespace AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardSetRequest;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardSetRequest\updateCommand\approvalConfig;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardSetRequest\updateCommand\directoryReference;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardSetRequest\updateCommand\offlineApprovalConfig;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardSetRequest\updateCommand\visibilityConfig;
        ...
        if (isset($map['MemberGroupList'])) {
            if (!empty($map['MemberGroupList'])) {
                ...
                foreach ($map['MemberGroupList'] as $item1) {
                    $model->memberGroupList[$n1] = $item1;
                    ++$n1;
                }
            }
        }
