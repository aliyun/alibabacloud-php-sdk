...
namespace AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\GetTableColumnLineagesResponseBody;

use AlibabaCloud\Dara\Model;

class tableColumnLineageList extends Model
{
    /**
     * @var int
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->inputColumnGuid) {
            $res['InputColumnGuid'] = $this->inputColumnGuid;
        }
        ...
        if (null !== $this->outputColumnGuid) {
            $res['OutputColumnGuid'] = $this->outputColumnGuid;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['InputColumnGuid'])) {
            $model->inputColumnGuid = $map['InputColumnGuid'];
        }
        ...
        if (isset($map['OutputColumnGuid'])) {
            $model->outputColumnGuid = $map['OutputColumnGuid'];
        }
