...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateSecurityClassifyCatalogRequest\updateCommand;

class UpdateSecurityClassifyCatalogRequest extends Model
{
    /**
     * @var int
     */
