...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateSecurityIdentifyResultStatusRequest\updateCommand;

class UpdateSecurityIdentifyResultStatusRequest extends Model
{
    /**
     * @var int
     */
