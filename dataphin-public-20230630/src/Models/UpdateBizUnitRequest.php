...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateBizUnitRequest\updateCommand;
use AlibabaCloud\Tea\Model;

class UpdateBizUnitRequest extends Model
{
    /**
