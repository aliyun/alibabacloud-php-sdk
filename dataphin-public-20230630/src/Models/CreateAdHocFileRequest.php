...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateAdHocFileRequest\createCommand;
use AlibabaCloud\Tea\Model;

class CreateAdHocFileRequest extends Model
{
    /**
