...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardMappingToInvalidRequest\updateCommand;

class UpdateStandardMappingToInvalidRequest extends Model
{
    /**
     * @var int
     */
