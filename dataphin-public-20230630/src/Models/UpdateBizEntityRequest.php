...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateBizEntityRequest\updateCommand;
use AlibabaCloud\Tea\Model;

class UpdateBizEntityRequest extends Model
{
    /**
