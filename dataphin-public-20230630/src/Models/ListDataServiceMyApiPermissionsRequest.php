...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListDataServiceMyApiPermissionsRequest\listQuery;

class ListDataServiceMyApiPermissionsRequest extends Model
{
    /**
     * @var listQuery
     */
