...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\GetStandardSetResponseBody\standardSetInfo\visibilityConfig\specifiedUserList;

class visibilityConfig extends Model
{
    /**
     * @var specifiedUserList[]
     */
        ...
        if (null !== $this->specifiedUserList) {
            if (\is_array($this->specifiedUserList)) {
                ...
                foreach ($this->specifiedUserList as $item1) {
                    $res['SpecifiedUserList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
        ...
        if (isset($map['SpecifiedUserList'])) {
            if (!empty($map['SpecifiedUserList'])) {
                ...
                foreach ($map['SpecifiedUserList'] as $item1) {
                    $model->specifiedUserList[$n1] = specifiedUserList::fromMap($item1);
                    ++$n1;
                }
            }
        }
