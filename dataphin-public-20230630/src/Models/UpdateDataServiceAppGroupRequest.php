...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateDataServiceAppGroupRequest\updateCommand;

class UpdateDataServiceAppGroupRequest extends Model
{
    /**
     * @var int
     */
