...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\DeleteSecurityIdentifyResultsRequest\deleteCommand;

class DeleteSecurityIdentifyResultsRequest extends Model
{
    /**
     * @var deleteCommand
     */
