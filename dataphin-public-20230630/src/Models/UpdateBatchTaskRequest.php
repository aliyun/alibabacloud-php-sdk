...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateBatchTaskRequest\updateCommand;
use AlibabaCloud\Tea\Model;

class UpdateBatchTaskRequest extends Model
{
    /**
