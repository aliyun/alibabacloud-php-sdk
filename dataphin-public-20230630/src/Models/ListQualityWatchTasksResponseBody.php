...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListQualityWatchTasksResponseBody\pageResult;

class ListQualityWatchTasksResponseBody extends Model
{
    /**
     * @var string
     */
