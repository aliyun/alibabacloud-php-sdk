...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\DeleteStandardValidMappingRequest\deleteCommand;

class DeleteStandardValidMappingRequest extends Model
{
    /**
     * @var deleteCommand
     */
