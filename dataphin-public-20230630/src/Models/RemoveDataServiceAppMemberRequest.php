...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\RemoveDataServiceAppMemberRequest\removeCommand;

class RemoveDataServiceAppMemberRequest extends Model
{
    /**
     * @var int
     */
