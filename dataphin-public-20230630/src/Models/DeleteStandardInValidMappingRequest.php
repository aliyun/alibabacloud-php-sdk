...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\DeleteStandardInValidMappingRequest\deleteCommand;

class DeleteStandardInValidMappingRequest extends Model
{
    /**
     * @var deleteCommand
     */
