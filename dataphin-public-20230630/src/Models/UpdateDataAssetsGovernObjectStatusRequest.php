...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateDataAssetsGovernObjectStatusRequest\updateCommand;

class UpdateDataAssetsGovernObjectStatusRequest extends Model
{
    /**
     * @var int
     */
