...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateSecurityIdentifyResultRequest\createCommand;

class CreateSecurityIdentifyResultRequest extends Model
{
    /**
     * @var createCommand
     */
