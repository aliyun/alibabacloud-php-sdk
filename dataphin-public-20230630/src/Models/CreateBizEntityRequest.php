...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateBizEntityRequest\createCommand;
use AlibabaCloud\Tea\Model;

class CreateBizEntityRequest extends Model
{
    /**
