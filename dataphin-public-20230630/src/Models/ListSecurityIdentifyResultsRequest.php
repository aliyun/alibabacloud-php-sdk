...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListSecurityIdentifyResultsRequest\listQuery;

class ListSecurityIdentifyResultsRequest extends Model
{
    /**
     * @var listQuery
     */
