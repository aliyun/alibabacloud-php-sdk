...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateDevProdProjectResponseBody\createResult;

class CreateDevProdProjectResponseBody extends Model
{
    /**
     * @var string
     */
