...
namespace AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ExecKgGremlinResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ExecKgGremlinResponseBody\data\edgeList;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ExecKgGremlinResponseBody\data\nodeList;
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ExecKgGremlinResponseBody\data\rowList;
...
class data extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->execQuery) {
            $res['ExecQuery'] = $this->execQuery;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ExecQuery'])) {
            $model->execQuery = $map['ExecQuery'];
        }
