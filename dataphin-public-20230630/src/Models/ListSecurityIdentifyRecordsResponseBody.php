...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListSecurityIdentifyRecordsResponseBody\pageResult;

class ListSecurityIdentifyRecordsResponseBody extends Model
{
    /**
     * @var string
     */
