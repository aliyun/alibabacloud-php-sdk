...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\TransferOwnershipForAllObjectRequest\privilegeTransferRecord;

class TransferOwnershipForAllObjectRequest extends Model
{
    /**
     * @var int
     */
