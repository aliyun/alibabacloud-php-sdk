...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListApprovalTasksByUserResponseBody\pageResult;

class ListApprovalTasksByUserResponseBody extends Model
{
    /**
     * @var string
     */
