...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\GetAssetMappingRelationsRequest\assetMappingQuery;

class GetAssetMappingRelationsRequest extends Model
{
    /**
