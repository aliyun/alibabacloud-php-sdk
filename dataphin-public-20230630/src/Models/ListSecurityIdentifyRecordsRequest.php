...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListSecurityIdentifyRecordsRequest\listQuery;

class ListSecurityIdentifyRecordsRequest extends Model
{
    /**
     * @var listQuery
     */
