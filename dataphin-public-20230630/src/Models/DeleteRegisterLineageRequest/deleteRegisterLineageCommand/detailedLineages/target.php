...
namespace AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\DeleteRegisterLineageRequest\deleteRegisterLineageCommand\detailedLineages;
...
class target extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->parentGuid) {
            $res['ParentGuid'] = $this->parentGuid;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ParentGuid'])) {
            $model->parentGuid = $map['ParentGuid'];
        }
