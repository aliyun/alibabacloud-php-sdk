...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\UpdateStandardLookupTableRequest\updateCommand;

class UpdateStandardLookupTableRequest extends Model
{
    /**
     * @var int
     */
