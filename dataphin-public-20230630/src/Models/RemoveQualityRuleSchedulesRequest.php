...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\RemoveQualityRuleSchedulesRequest\removeCommand;

class RemoveQualityRuleSchedulesRequest extends Model
{
    /**
     * @var int
     */
