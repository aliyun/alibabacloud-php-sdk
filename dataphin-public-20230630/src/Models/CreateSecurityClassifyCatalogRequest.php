...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateSecurityClassifyCatalogRequest\createCommand;

class CreateSecurityClassifyCatalogRequest extends Model
{
    /**
     * @var createCommand
     */
