...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ListSecurityIdentifyResultsResponseBody\pageResult;

class ListSecurityIdentifyResultsResponseBody extends Model
{
    /**
     * @var string
     */
