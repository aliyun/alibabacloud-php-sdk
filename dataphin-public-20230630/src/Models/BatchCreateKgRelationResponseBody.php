...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\BatchCreateKgRelationResponseBody\createResult;

class BatchCreateKgRelationResponseBody extends Model
{
    /**
     * @var string
     */
