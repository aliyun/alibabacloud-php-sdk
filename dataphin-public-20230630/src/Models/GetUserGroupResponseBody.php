...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\GetUserGroupResponseBody\userGroupInfo;
...
class GetUserGroupResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->userGroupInfo) {
            $res['UserGroupInfo'] = null !== $this->userGroupInfo ? $this->userGroupInfo->toMap() : null;
        }
