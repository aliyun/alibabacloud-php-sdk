...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\CreateStandardLookupTableRequest\createCommand;

class CreateStandardLookupTableRequest extends Model
{
    /**
     * @var createCommand
     */
