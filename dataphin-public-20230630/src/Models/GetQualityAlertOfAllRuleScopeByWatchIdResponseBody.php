...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\GetQualityAlertOfAllRuleScopeByWatchIdResponseBody\qualityAlertInfo;

class GetQualityAlertOfAllRuleScopeByWatchIdResponseBody extends Model
{
    /**
     * @var string
     */
