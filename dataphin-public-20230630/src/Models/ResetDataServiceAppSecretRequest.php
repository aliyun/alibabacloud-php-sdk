...
use AlibabaCloud\SDK\Dataphinpublic\V20230630\Models\ResetDataServiceAppSecretRequest\updateCommand;

class ResetDataServiceAppSecretRequest extends Model
{
    /**
     * @var int
     */
