...
class GetCommissionDetailFileListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var GetCommissionDetailFileListResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetCommissionDetailFileListResponseBody::fromMap($map['body']);
        }
