...
class GetSubPartnerOrderListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var GetSubPartnerOrderListResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSubPartnerOrderListResponseBody::fromMap($map['body']);
        }
