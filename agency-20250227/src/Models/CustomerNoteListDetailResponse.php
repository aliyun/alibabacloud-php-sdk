...
class CustomerNoteListDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CustomerNoteListDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CustomerNoteListDetailResponseBody::fromMap($map['body']);
        }
