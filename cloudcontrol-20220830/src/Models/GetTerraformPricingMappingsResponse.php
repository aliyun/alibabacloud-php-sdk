...
class GetTerraformPricingMappingsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetTerraformPricingMappingsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetTerraformPricingMappingsResponseBody::fromMap($map['body']);
        }
