...
class ListSupportedPricingApisResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListSupportedPricingApisResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListSupportedPricingApisResponseBody::fromMap($map['body']);
        }
