...
class MemoryCollection extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->memoryCollectionId) {
            $res['memoryCollectionId'] = $this->memoryCollectionId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['memoryCollectionId'])) {
            $model->memoryCollectionId = $map['memoryCollectionId'];
        }
