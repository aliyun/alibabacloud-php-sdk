...
class PullRpaModelResponseBody extends Model
{
    /**
     ...
     *
     * @example can not find env: vpc-sg-pre
     *
     * @var string
     */
     ...
     *
     * @example 06055768-6BC0-5FE7-BDFF-BD4D79537035
     *
     * @var string
     */
    public $requestId;
     ...
     * @param array $map
     *
     * @return PullRpaModelResponseBody
     */
