...
use AlibabaCloud\SDK\OceanBasePro\V20190901\Models\DescribeInstanceAvailableZonesResponseBody\zoneList;

class DescribeInstanceAvailableZonesResponseBody extends Model
{
    /**
     * @var string
     */
