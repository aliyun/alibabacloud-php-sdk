...
class destConfig extends Model
{
    ...
    /**
     * @description The partitioned index, which must be specified if the destination data source is a message queue system, such as Kafka, DataHub, and RocketMQ, and the partitioning mode is set to ONE.
     *
     * @example 0
     *
     * @var int
