...
namespace AlibabaCloud\SDK\OceanBasePro\V20190901\Models\DeleteOmsOpenAPIProjectResponseBody;
...
{
    /**
     * @description The operation that you want to perform. Set the value to **DeleteOmsOpenAPIProject**.
     *
