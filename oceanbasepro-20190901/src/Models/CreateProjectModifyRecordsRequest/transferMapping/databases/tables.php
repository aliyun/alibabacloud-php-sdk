...
use AlibabaCloud\SDK\OceanBasePro\V20190901\Models\CreateProjectModifyRecordsRequest\transferMapping\databases\tables\adbTableSchema;
use AlibabaCloud\SDK\OceanBasePro\V20190901\Models\CreateProjectModifyRecordsRequest\transferMapping\databases\tables\obkvPartitionConfig;
...
class tables extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->obkvPartitionConfig) {
            $this->obkvPartitionConfig->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->obkvPartitionConfig) {
            $res['ObkvPartitionConfig'] = null !== $this->obkvPartitionConfig ? $this->obkvPartitionConfig->toArray($noStream) : $this->obkvPartitionConfig;
        }
