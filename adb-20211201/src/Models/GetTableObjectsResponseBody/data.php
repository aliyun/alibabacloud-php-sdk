...
namespace AlibabaCloud\SDK\Adb\V20211201\Models\GetTableObjectsResponseBody;
...
{
    /**
     * @description The number of the returned page. The value is an integer that is greater than 0. Default value: **1**.
     *
     * @example 1
     *
     * @var int
    ...
    /**
     * @description Details of the tables.
     *
