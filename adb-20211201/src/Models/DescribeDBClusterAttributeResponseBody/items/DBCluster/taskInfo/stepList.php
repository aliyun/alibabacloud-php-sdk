...
{
    /**
     * @var \AlibabaCloud\SDK\Adb\V20211201\Models\DescribeDBClusterAttributeResponseBody\items\DBCluster\taskInfo\stepList\stepList[]
     */
    public $stepList;
    protected $_name = [
        'stepList' => 'StepList',
        ...
        if (isset($map['StepList'])) {
            if (!empty($map['StepList'])) {
                ...
                foreach ($map['StepList'] as $item) {
                    $model->stepList[$n++] = null !== $item ? \AlibabaCloud\SDK\Adb\V20211201\Models\DescribeDBClusterAttributeResponseBody\items\DBCluster\taskInfo\stepList\stepList::fromMap($item) : $item;
                }
            }
        }
