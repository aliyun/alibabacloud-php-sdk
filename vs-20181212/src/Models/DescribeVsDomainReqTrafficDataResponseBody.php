...
class DescribeVsDomainReqTrafficDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->reqTrafficDataPerInterval) {
            $this->reqTrafficDataPerInterval->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->reqTrafficDataPerInterval) {
            $res['ReqTrafficDataPerInterval'] = null !== $this->reqTrafficDataPerInterval ? $this->reqTrafficDataPerInterval->toArray($noStream) : $this->reqTrafficDataPerInterval;
        }
