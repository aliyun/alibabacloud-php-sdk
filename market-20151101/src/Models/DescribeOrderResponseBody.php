...
class DescribeOrderResponseBody extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->supplierTelephones) {
            $this->supplierTelephones->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->supplierTelephones) {
            $res['SupplierTelephones'] = null !== $this->supplierTelephones ? $this->supplierTelephones->toArray($noStream) : $this->supplierTelephones;
        }
