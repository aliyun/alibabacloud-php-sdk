...
class DescribeProductResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->productExtras) {
            $this->productExtras->validate();
        }
        if (null !== $this->productSkus) {
            $this->productSkus->validate();
        }
        if (null !== $this->shopInfo) {
            $this->shopInfo->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->productExtras) {
            $res['ProductExtras'] = null !== $this->productExtras ? $this->productExtras->toArray($noStream) : $this->productExtras;
        }

        if (null !== $this->productSkus) {
            $res['ProductSkus'] = null !== $this->productSkus ? $this->productSkus->toArray($noStream) : $this->productSkus;
        }
        ...
        if (null !== $this->shopInfo) {
            $res['ShopInfo'] = null !== $this->shopInfo ? $this->shopInfo->toArray($noStream) : $this->shopInfo;
        }
