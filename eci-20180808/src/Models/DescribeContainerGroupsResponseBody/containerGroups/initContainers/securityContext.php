...
use AlibabaCloud\SDK\Eci\V20180808\Models\DescribeContainerGroupsResponseBody\containerGroups\initContainers\securityContext\capability;
...
class securityContext extends Model
{
    ...
    /**
     * @description The UID this is used to run the entry point of the container process.
     *
     * @example 1557
     *
     * @var int
