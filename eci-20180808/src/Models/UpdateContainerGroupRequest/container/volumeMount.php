...
class volumeMount extends Model
{
    ...
    /**
     * @description The subdirectory of the volume that is mounted to the container. The pod can mount different directories of the same volume to different subdirectories of containers.
     *
