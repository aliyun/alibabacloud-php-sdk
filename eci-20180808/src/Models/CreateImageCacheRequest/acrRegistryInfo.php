...
class acrRegistryInfo extends Model
{
    ...
    /**
     * @description The ARN of the RAM roles in the Alibaba Cloud account to which the Container Registry Enterprise Edition instance belongs.
     *
    ...
    /**
     * @description The name of Container Registry Enterprise Edition instance N.
     *
     * @example test****
     *
     * @var string
    ...
    /**
     * @description The region ID of Container Registry Enterprise Edition instance N.
     *
     * @example cn-beijing
     *
     * @var string
