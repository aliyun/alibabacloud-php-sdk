...
class container extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->lifecyclePostStartHandlerHttpGetHttpHeader)) {
            Model::validateArray($this->lifecyclePostStartHandlerHttpGetHttpHeader);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->lifecyclePostStartHandlerHttpGetHttpHeader) {
            if (\is_array($this->lifecyclePostStartHandlerHttpGetHttpHeader)) {
                ...
                $n1 = 0;
                foreach ($this->lifecyclePostStartHandlerHttpGetHttpHeader as $item1) {
                    $res['LifecyclePostStartHandlerHttpGetHttpHeader'][$n1++] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['LifecyclePostStartHandlerHttpGetHttpHeader'])) {
            if (!empty($map['LifecyclePostStartHandlerHttpGetHttpHeader'])) {
                ...
                $n1 = 0;
                foreach ($map['LifecyclePostStartHandlerHttpGetHttpHeader'] as $item1) {
                    $model->lifecyclePostStartHandlerHttpGetHttpHeader[$n1++] = lifecyclePostStartHandlerHttpGetHttpHeader::fromMap($item1);
                }
            }
        }
