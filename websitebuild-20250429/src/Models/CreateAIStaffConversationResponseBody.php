...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\CreateAIStaffConversationResponseBody\module;

class CreateAIStaffConversationResponseBody extends Model
{
    /**
     * @var string
     */
