...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppInstanceForPartnerResponseBody\module;

class GetAppInstanceForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
