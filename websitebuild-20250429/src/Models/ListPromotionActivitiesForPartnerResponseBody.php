...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListPromotionActivitiesForPartnerResponseBody\module;

class ListPromotionActivitiesForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
