...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\AllocateSupabaseForAdminResponseBody\module;

class AllocateSupabaseForAdminResponseBody extends Model
{
    /**
     * @var string
     */
