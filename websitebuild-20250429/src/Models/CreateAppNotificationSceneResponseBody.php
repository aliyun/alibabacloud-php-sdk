...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\CreateAppNotificationSceneResponseBody\module;

class CreateAppNotificationSceneResponseBody extends Model
{
    /**
     * @var string
     */
