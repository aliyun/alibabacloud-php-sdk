...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\RefreshAppInstanceTicketResponseBody\module;

class RefreshAppInstanceTicketResponseBody extends Model
{
    /**
     * @var string
     */
