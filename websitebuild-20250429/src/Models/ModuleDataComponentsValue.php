...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ModuleDataComponentsValue\instanceProperty;

class ModuleDataComponentsValue extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var ModuleDataComponentsValuePropertiesValue[]
     */
    public $properties;
        ...
        if (isset($map['Properties'])) {
            if (!empty($map['Properties'])) {
                ...
                foreach ($map['Properties'] as $key1 => $value1) {
                    $model->properties[$key1] = ModuleDataComponentsValuePropertiesValue::fromMap($value1);
                }
            }
        }
