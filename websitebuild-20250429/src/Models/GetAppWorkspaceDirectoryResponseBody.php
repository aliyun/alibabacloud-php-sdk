...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppWorkspaceDirectoryResponseBody\module;

class GetAppWorkspaceDirectoryResponseBody extends Model
{
    /**
     * @var string
     */
