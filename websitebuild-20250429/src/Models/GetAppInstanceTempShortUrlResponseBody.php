...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppInstanceTempShortUrlResponseBody\module;

class GetAppInstanceTempShortUrlResponseBody extends Model
{
    /**
     * @var string
     */
