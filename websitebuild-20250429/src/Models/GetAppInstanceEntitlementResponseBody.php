...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppInstanceEntitlementResponseBody\module;

class GetAppInstanceEntitlementResponseBody extends Model
{
    /**
     * @var string
     */
