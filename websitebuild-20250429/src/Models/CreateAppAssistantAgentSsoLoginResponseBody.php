...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\CreateAppAssistantAgentSsoLoginResponseBody\module;

class CreateAppAssistantAgentSsoLoginResponseBody extends Model
{
    /**
     * @var string
     */
