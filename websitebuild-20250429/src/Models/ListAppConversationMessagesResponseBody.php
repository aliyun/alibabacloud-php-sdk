...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListAppConversationMessagesResponseBody\module;

class ListAppConversationMessagesResponseBody extends Model
{
    /**
     * @var string
     */
