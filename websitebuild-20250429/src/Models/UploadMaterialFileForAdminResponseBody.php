...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\UploadMaterialFileForAdminResponseBody\module;

class UploadMaterialFileForAdminResponseBody extends Model
{
    /**
     * @var string
     */
