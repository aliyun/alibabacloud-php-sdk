...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppSupabaseAuthConfigResponseBody\module;

class GetAppSupabaseAuthConfigResponseBody extends Model
{
    /**
     * @var string
     */
