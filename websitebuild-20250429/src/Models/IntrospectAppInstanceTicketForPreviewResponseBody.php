...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\IntrospectAppInstanceTicketForPreviewResponseBody\module;

class IntrospectAppInstanceTicketForPreviewResponseBody extends Model
{
    /**
     * @var string
     */
