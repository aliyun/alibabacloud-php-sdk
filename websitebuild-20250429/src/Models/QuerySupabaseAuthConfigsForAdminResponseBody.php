...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QuerySupabaseAuthConfigsForAdminResponseBody\module;

class QuerySupabaseAuthConfigsForAdminResponseBody extends Model
{
    /**
     * @var string
     */
