...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QueryInspirationBalanceForPartnerResponseBody\module;

class QueryInspirationBalanceForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
