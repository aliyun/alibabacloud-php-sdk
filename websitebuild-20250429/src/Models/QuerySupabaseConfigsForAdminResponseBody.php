...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QuerySupabaseConfigsForAdminResponseBody\module;

class QuerySupabaseConfigsForAdminResponseBody extends Model
{
    /**
     * @var string
     */
