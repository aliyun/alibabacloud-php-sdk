...
namespace AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QueryMaterialTaskListResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\AppMaterialTask;
        ...
        if (isset($map['Data'])) {
            if (!empty($map['Data'])) {
                ...
                foreach ($map['Data'] as $item1) {
                    $model->data[$n1] = AppMaterialTask::fromMap($item1);
                    ++$n1;
                }
            }
        }
