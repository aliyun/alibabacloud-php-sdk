...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\BatchCheckResourceMeasureResponseBody\module;

class BatchCheckResourceMeasureResponseBody extends Model
{
    /**
     * @var string
     */
