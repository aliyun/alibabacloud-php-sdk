...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\RefundAppInstanceForPartnerResponseBody\module;

class RefundAppInstanceForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
