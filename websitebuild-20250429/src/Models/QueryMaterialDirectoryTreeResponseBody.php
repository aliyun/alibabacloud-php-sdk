...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QueryMaterialDirectoryTreeResponseBody\module;

class QueryMaterialDirectoryTreeResponseBody extends Model
{
    /**
     * @var string
     */
