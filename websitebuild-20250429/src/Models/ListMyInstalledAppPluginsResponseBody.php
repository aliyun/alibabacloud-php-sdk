...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListMyInstalledAppPluginsResponseBody\module;

class ListMyInstalledAppPluginsResponseBody extends Model
{
    /**
     * @var string
     */
