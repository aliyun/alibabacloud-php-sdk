...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListAppCommoditySpecificationsForPartnerResponseBody\module;

class ListAppCommoditySpecificationsForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
