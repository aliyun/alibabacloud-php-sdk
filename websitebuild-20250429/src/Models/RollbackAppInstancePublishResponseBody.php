...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\RollbackAppInstancePublishResponseBody\module;

class RollbackAppInstancePublishResponseBody extends Model
{
    /**
     * @var string
     */
