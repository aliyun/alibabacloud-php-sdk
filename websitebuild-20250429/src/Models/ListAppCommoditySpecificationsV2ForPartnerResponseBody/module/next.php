...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ModuleNextComponentsValue;
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ModuleNextPropertiesValue;
        ...
        if (isset($map['Components'])) {
            if (!empty($map['Components'])) {
                ...
                foreach ($map['Components'] as $key1 => $value1) {
                    $model->components[$key1] = ModuleNextComponentsValue::fromMap($value1);
                }
            }
        }
        ...
        if (isset($map['Properties'])) {
            if (!empty($map['Properties'])) {
                ...
                foreach ($map['Properties'] as $key1 => $value1) {
                    $model->properties[$key1] = ModuleNextPropertiesValue::fromMap($value1);
                }
            }
        }
