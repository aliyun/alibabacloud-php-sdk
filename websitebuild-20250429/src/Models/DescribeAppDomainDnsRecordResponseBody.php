...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\DescribeAppDomainDnsRecordResponseBody\module;

class DescribeAppDomainDnsRecordResponseBody extends Model
{
    /**
     * @var string
     */
