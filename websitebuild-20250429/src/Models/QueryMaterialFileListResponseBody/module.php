...
namespace AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QueryMaterialFileListResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\AppMaterialFile;
        ...
        if (isset($map['Data'])) {
            if (!empty($map['Data'])) {
                ...
                foreach ($map['Data'] as $item1) {
                    $model->data[$n1] = AppMaterialFile::fromMap($item1);
                    ++$n1;
                }
            }
        }
