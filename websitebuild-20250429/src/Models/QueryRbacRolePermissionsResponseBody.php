...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\QueryRbacRolePermissionsResponseBody\module;

class QueryRbacRolePermissionsResponseBody extends Model
{
    /**
     * @var string
     */
