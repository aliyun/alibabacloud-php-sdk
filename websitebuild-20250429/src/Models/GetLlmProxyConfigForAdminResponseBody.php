...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetLlmProxyConfigForAdminResponseBody\module;

class GetLlmProxyConfigForAdminResponseBody extends Model
{
    /**
     * @var string
     */
