...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\DeleteAppDomainCertificateResponseBody\module;

class DeleteAppDomainCertificateResponseBody extends Model
{
    /**
     * @var string
     */
