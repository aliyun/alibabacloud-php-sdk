...
namespace AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppInstanceForPartnerResponseBody\module\appServiceList\operationAddress;

use AlibabaCloud\Dara\Model;

class dashboardActions extends Model
{
    /**
     * @var string
     */
