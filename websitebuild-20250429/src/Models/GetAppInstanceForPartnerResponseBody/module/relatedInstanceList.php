...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppInstanceForPartnerResponseBody\module\relatedInstanceList\profile;

class relatedInstanceList extends Model
{
    /**
     * @var string
     */
