...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GrantPromotionOfferForPartnerResponseBody\module;

class GrantPromotionOfferForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
