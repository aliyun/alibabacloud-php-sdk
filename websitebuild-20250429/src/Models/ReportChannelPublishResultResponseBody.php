...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ReportChannelPublishResultResponseBody\module;

class ReportChannelPublishResultResponseBody extends Model
{
    /**
     * @var string
     */
