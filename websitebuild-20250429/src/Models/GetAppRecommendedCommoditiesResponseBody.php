...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\GetAppRecommendedCommoditiesResponseBody\module;

class GetAppRecommendedCommoditiesResponseBody extends Model
{
    /**
     * @var string
     */
