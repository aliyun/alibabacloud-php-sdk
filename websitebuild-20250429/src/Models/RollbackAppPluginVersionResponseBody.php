...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\RollbackAppPluginVersionResponseBody\module;

class RollbackAppPluginVersionResponseBody extends Model
{
    /**
     * @var string
     */
