...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListIsvPaymentPluginConfigsResponseBody\module;

class ListIsvPaymentPluginConfigsResponseBody extends Model
{
    /**
     * @var string
     */
