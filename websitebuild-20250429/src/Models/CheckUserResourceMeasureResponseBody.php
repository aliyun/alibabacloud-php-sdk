...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\CheckUserResourceMeasureResponseBody\module;

class CheckUserResourceMeasureResponseBody extends Model
{
    /**
     * @var string
     */
