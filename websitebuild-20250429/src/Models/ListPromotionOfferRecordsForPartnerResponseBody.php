...
use AlibabaCloud\SDK\WebsiteBuild\V20250429\Models\ListPromotionOfferRecordsForPartnerResponseBody\module;

class ListPromotionOfferRecordsForPartnerResponseBody extends Model
{
    /**
     * @var string
     */
