...
class UpdateModelPermissionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateModelPermissionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateModelPermissionsResponseBody::fromMap($map['body']);
        }
