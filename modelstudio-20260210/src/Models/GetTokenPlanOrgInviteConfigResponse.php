...
class GetTokenPlanOrgInviteConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetTokenPlanOrgInviteConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetTokenPlanOrgInviteConfigResponseBody::fromMap($map['body']);
        }
