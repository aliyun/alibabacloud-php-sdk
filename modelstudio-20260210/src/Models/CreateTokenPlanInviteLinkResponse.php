...
class CreateTokenPlanInviteLinkResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateTokenPlanInviteLinkResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateTokenPlanInviteLinkResponseBody::fromMap($map['body']);
        }
