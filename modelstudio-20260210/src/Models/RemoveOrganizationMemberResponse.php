...
class RemoveOrganizationMemberResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var RemoveOrganizationMemberResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = RemoveOrganizationMemberResponseBody::fromMap($map['body']);
        }
