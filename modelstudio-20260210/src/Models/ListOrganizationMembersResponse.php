...
class ListOrganizationMembersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListOrganizationMembersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListOrganizationMembersResponseBody::fromMap($map['body']);
        }
