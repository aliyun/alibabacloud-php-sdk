...
class GetTokenPlanInviteLinkResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetTokenPlanInviteLinkResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetTokenPlanInviteLinkResponseBody::fromMap($map['body']);
        }
