...
class UpdateOrganizationMemberResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateOrganizationMemberResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateOrganizationMemberResponseBody::fromMap($map['body']);
        }
