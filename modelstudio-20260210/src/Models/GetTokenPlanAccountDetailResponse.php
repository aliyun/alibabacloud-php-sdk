...
class GetTokenPlanAccountDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetTokenPlanAccountDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetTokenPlanAccountDetailResponseBody::fromMap($map['body']);
        }
