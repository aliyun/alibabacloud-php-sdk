...
class SetTokenPlanOrgInviteConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SetTokenPlanOrgInviteConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SetTokenPlanOrgInviteConfigResponseBody::fromMap($map['body']);
        }
