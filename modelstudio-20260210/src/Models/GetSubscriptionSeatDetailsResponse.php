...
class GetSubscriptionSeatDetailsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSubscriptionSeatDetailsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSubscriptionSeatDetailsResponseBody::fromMap($map['body']);
        }
