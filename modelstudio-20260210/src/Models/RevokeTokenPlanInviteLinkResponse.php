...
class RevokeTokenPlanInviteLinkResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var RevokeTokenPlanInviteLinkResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = RevokeTokenPlanInviteLinkResponseBody::fromMap($map['body']);
        }
