...
class DownloadApiCallDailyDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DownloadApiCallDailyDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DownloadApiCallDailyDetailResponseBody::fromMap($map['body']);
        }
