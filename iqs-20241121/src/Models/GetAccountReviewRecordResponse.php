...
class GetAccountReviewRecordResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAccountReviewRecordResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAccountReviewRecordResponseBody::fromMap($map['body']);
        }
