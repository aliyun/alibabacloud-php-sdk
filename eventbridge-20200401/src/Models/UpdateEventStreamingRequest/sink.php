...
{
    /**
     * @description The parameters that are configured if you specify Apache RocketMQ (Offset Data) as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify BaiLian as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify Kafka Sink Connect as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify Kafka Source Connect as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify DashVector as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify Simple Message Queue (SMQ, formerly MNS) as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify open source RabbitMQ as the event target.
     *
    ...
    /**
     * @description The parameters that are configured if you specify ApsaraMQ for RocketMQ (Offset Data) as the event target.
     *
