...
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\UpdateEventStreamingRequest\sink\sinkCustomizedKafkaConnectorParameters\connectorParameters;
use AlibabaCloud\Tea\Model;

class sinkCustomizedKafkaConnectorParameters extends Model
{
    /**
     * @description The download link of the ZIP package that includes Object Storage Service (OSS) resources.
     *
    ...
    /**
     * @description The parameters that are configured for the parsing of the .properties file in the ZIP package.
     *
    ...
    /**
     * @description The instance configurations.
     *
     * @example {
