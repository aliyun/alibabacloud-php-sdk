...
namespace AlibabaCloud\SDK\Eventbridge\V20200401\Models\UpdateEventStreamingRequest\sink\sinkOpenSourceRabbitMQParameters;
...
class messageId extends Model
{
    ...
    /**
     * @description The value of the message ID.
     *
     * @example 12345
     *
     * @var string
