...
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\GetEventBusResponseBody\data;
use AlibabaCloud\Tea\Model;

class GetEventBusResponseBody extends Model
{
    /**
     * @description The response code. The value Success indicates that the request was successful. Other values indicate that the request failed. For more information about error codes, see Error codes.
     *
     * @example Success
     *
     * @var string
