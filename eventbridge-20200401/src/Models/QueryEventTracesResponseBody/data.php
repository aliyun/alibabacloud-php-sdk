...
{
    /**
     * @description The type of the event trace. Valid values: PutEvent, FilterEvent, and PushEvent. The value PutEvent indicates that the event was delivered. The value FilterEvent indicates that the event was filtered. The value PushEvent indicates that the event was pushed.
     *
     * @example PutEvent
     *
     * @var string
    ...
    /**
     * @description The endpoint of the event target. This parameter is returned only if Action is set to PushEvent.
     *
    ...
    /**
     * @description The delay period for which the event was delivered to the event target. This parameter is returned only if Action is set to PushEvent.
     *
     * @example 80
     *
     * @var string
    ...
    /**
     * @description The time when the event was delivered to the event target. This parameter is returned only if Action is set to PushEvent.
     *
     * @example 1659495343896
     *
     * @var int
    ...
    /**
     * @description The time when the event was delivered to the event bus. This parameter is returned only if Action is set to PutEvent.
     *
     * @example 1659495343896
     *
     * @var int
    ...
    /**
     * @description The time when the event rule was matched. This parameter is returned only if Action is set to FilterEvent.
     *
     * @example 1659495343896
     *
     * @var string
