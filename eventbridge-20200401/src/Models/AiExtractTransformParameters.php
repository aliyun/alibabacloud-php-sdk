...
class AiExtractTransformParameters extends Model
{
    /**
     * @var string
     */
    ...
    {
        $res = [];
        if (null !== $this->extractSchema) {
            $res['ExtractSchema'] = $this->extractSchema;
        }
    ...
    {
        $model = new self();
        if (isset($map['ExtractSchema'])) {
            $model->extractSchema = $map['ExtractSchema'];
        }
