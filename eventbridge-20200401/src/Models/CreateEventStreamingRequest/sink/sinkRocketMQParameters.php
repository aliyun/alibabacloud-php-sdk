...
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\CreateEventStreamingRequest\sink\sinkRocketMQParameters\deliveryOrderType;
...
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\CreateEventStreamingRequest\sink\sinkRocketMQParameters\shardingKey;
...
class sinkRocketMQParameters extends Model
{
    ...
    /**
     * @description The endpoint that you want to use to access the ApsaraMQ for RocketMQ instance.
     *
    ...
    /**
     * @description The username that you want to use to access the ApsaraMQ for RocketMQ instance.
     *
