...
namespace AlibabaCloud\SDK\Eventbridge\V20200401\Models\ListEventHouseRuntimesResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\EventHouseRuntime;
        ...
        if (isset($map['Runtimes'])) {
            if (!empty($map['Runtimes'])) {
                ...
                foreach ($map['Runtimes'] as $item1) {
                    $model->runtimes[$n1] = EventHouseRuntime::fromMap($item1);
                    ++$n1;
                }
            }
        }
