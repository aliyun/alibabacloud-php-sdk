...
class sourceRocketMQParameters extends Model
{
    ...
    /**
     * @description The ID of the virtual private cloud (VPC) to which the ApsaraMQ for RocketMQ instance belongs.
     *
    ...
    /**
     * @description The offset from which messages are consumed. Valid values: CONSUMEFROMLASTOFFSET: Messages are consumed from the latest offset. CONSUMEFROMFIRSTOFFSET: Messages are consumed from the earliest offset. CONSUME_FROM_TIMESTAMP: Messages are consumed from the offset at the specified point in time.
     *
    ...
    /**
     * @description The timestamp that indicates the time from which messages are consumed. This parameter is valid only if Offset is set to CONSUMEFROMTIMESTAMP.
     *
