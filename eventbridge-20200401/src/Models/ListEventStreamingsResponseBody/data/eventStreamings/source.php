...
class source extends Model
{
    ...
    /**
     * @description The parameters that are returned if Message Queue (MNS) is specified as the event source.
     *
    ...
    /**
     * @description The parameters that are returned if ApsaraMQ for RabbitMQ is specified as the event source.
     *
