...
{
    /**
     * @description The IP address of the authorized endpoint. The default value of a column can be up to 127 characters in length.
     *
    ...
    /**
     * @description The request parameters that are configured for OAuth authentication.
     *
