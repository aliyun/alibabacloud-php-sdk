...
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\CreateConnectionRequest\authParameters\OAuthParameters\OAuthHttpParameters\bodyParameters;
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\CreateConnectionRequest\authParameters\OAuthParameters\OAuthHttpParameters\headerParameters;
use AlibabaCloud\SDK\Eventbridge\V20200401\Models\CreateConnectionRequest\authParameters\OAuthParameters\OAuthHttpParameters\queryStringParameters;
use AlibabaCloud\Tea\Model;

class OAuthHttpParameters extends Model
{
    /**
     * @description The parameters that are configured for the request body.
     *
     * @var bodyParameters[]
     */
