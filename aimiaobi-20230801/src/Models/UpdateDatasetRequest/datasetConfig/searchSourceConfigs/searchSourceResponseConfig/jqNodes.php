...
{
    /**
     * @var \AlibabaCloud\SDK\AiMiaoBi\V20230801\Models\UpdateDatasetRequest\datasetConfig\searchSourceConfigs\searchSourceResponseConfig\jqNodes\jqNodes[]
     */
    public $jqNodes;
        ...
        if (isset($map['JqNodes'])) {
            if (!empty($map['JqNodes'])) {
                ...
                foreach ($map['JqNodes'] as $item) {
                    $model->jqNodes[$n++] = null !== $item ? \AlibabaCloud\SDK\AiMiaoBi\V20230801\Models\UpdateDatasetRequest\datasetConfig\searchSourceConfigs\searchSourceResponseConfig\jqNodes\jqNodes::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Key'])) {
