...
class ListDatasetsResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->customSemanticSearchConfig) {
            $res['CustomSemanticSearchConfig'] = null !== $this->customSemanticSearchConfig ? $this->customSemanticSearchConfig->toMap() : null;
        }
        if (null !== $this->data) {
            $res['Data'] = [];
        ...
        if (null !== $this->thirdSearchConfig) {
            $res['ThirdSearchConfig'] = null !== $this->thirdSearchConfig ? $this->thirdSearchConfig->toMap() : null;
        }
