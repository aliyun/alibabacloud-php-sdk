...
{
    /**
     * @var \AlibabaCloud\SDK\AiMiaoBi\V20230801\Models\GetDatasetResponseBody\data\datasetConfig\searchSourceConfigs\searchSourceResponseConfig\jqNodes\jqNodes\jqNodes[]
     */
    public $jqNodes;
        ...
        if (isset($map['JqNodes'])) {
            if (!empty($map['JqNodes'])) {
                ...
                foreach ($map['JqNodes'] as $item) {
                    $model->jqNodes[$n++] = null !== $item ? \AlibabaCloud\SDK\AiMiaoBi\V20230801\Models\GetDatasetResponseBody\data\datasetConfig\searchSourceConfigs\searchSourceResponseConfig\jqNodes\jqNodes\jqNodes::fromMap($item) : $item;
                }
            }
        }
        if (isset($map['Key'])) {
