...
use AlibabaCloud\SDK\Linkedmall\V20180116\Models\ModifyRefundRequest\leavePictureList;
use AlibabaCloud\Tea\Model;

class ModifyRefundRequest extends Model
{
    /**
     * @example ANONY
     *
