...
{
    /**
     * @var \AlibabaCloud\SDK\Linkedmall\V20180116\Models\CreateOrderV2ResponseBody\model\lmOrderList\lmOrderList[]
     */
    public $lmOrderList;
    protected $_name = [
        ...
        if (isset($map['LmOrderList'])) {
            if (!empty($map['LmOrderList'])) {
                ...
                foreach ($map['LmOrderList'] as $item) {
                    $model->lmOrderList[$n++] = null !== $item ? \AlibabaCloud\SDK\Linkedmall\V20180116\Models\CreateOrderV2ResponseBody\model\lmOrderList\lmOrderList::fromMap($item) : $item;
                }
            }
        }
