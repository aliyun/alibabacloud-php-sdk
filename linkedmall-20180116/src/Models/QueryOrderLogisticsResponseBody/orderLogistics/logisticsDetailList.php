...
{
    /**
     * @var \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderLogisticsResponseBody\orderLogistics\logisticsDetailList\logisticsDetailList[]
     */
        ...
        if (isset($map['LogisticsDetailList'])) {
            if (!empty($map['LogisticsDetailList'])) {
                ...
                foreach ($map['LogisticsDetailList'] as $item) {
                    $model->logisticsDetailList[$n++] = null !== $item ? \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderLogisticsResponseBody\orderLogistics\logisticsDetailList\logisticsDetailList::fromMap($item) : $item;
                }
            }
        }
