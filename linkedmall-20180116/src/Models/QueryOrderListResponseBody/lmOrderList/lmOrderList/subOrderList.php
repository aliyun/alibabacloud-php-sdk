...
{
    /**
     * @var \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderListResponseBody\lmOrderList\lmOrderList\subOrderList\subOrderList[]
     */
    public $subOrderList;
    protected $_name = [
        ...
        if (isset($map['SubOrderList'])) {
            if (!empty($map['SubOrderList'])) {
                ...
                foreach ($map['SubOrderList'] as $item) {
                    $model->subOrderList[$n++] = null !== $item ? \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderListResponseBody\lmOrderList\lmOrderList\subOrderList\subOrderList::fromMap($item) : $item;
                }
            }
        }
