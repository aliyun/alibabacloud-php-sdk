...
{
    /**
     * @var \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderListResponseBody\lmOrderList\lmOrderList[]
     */
    public $lmOrderList;
    protected $_name = [
        ...
        if (isset($map['LmOrderList'])) {
            if (!empty($map['LmOrderList'])) {
                ...
                foreach ($map['LmOrderList'] as $item) {
                    $model->lmOrderList[$n++] = null !== $item ? \AlibabaCloud\SDK\Linkedmall\V20180116\Models\QueryOrderListResponseBody\lmOrderList\lmOrderList::fromMap($item) : $item;
                }
            }
        }
