...
class QueryRecognitionResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryRecognitionResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryRecognitionResultResponseBody::fromMap($map['body']);
        }
