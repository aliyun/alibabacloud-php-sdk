...
use AlibabaCloud\SDK\ICE\V20201109\Models\ListSmartVoiceGroupsRequest;
...
use AlibabaCloud\SDK\ICE\V20201109\Models\SubmitSegmentationJobResponse;
...
class ICE extends OpenApiClient
{
     ...
     *
     * @param CreateMediaLiveChannelRequest $tmpReq
     * @param RuntimeOptions                $runtime
     *
    ...
    public function createMediaLiveChannelWithOptions($tmpReq, $runtime)
    {
        ...
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->audioSettings) {
            $request->audioSettingsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->audioSettings, 'AudioSettings', 'json');
        }

        if (null !== $tmpReq->inputAttachments) {
            $request->inputAttachmentsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->inputAttachments, 'InputAttachments', 'json');
        }

        if (null !== $tmpReq->outputGroups) {
            $request->outputGroupsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->outputGroups, 'OutputGroups', 'json');
        }

        if (null !== $tmpReq->videoSettings) {
            $request->videoSettingsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->videoSettings, 'VideoSettings', 'json');
        }

        $body = [];
        if (null !== $request->audioSettingsShrink) {
            @$body['AudioSettings'] = $request->audioSettingsShrink;
        }

        if (null !== $request->inputAttachmentsShrink) {
        ...
        if (null !== $request->outputGroupsShrink) {
            @$body['OutputGroups'] = $request->outputGroupsShrink;
        }

        if (null !== $request->videoSettingsShrink) {
     ...
     * @returns CreateMediaLiveChannelResponse
     *
     * @param CreateMediaLiveChannelRequest $request
     *
     * @return CreateMediaLiveChannelResponse
     */
     ...
     *
     * @param CreateMediaLiveInputRequest $tmpReq
     * @param RuntimeOptions              $runtime
     *
    ...
    public function createMediaLiveInputWithOptions($tmpReq, $runtime)
    {
        ...
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->inputSettings) {
            $request->inputSettingsShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->inputSettings, 'InputSettings', 'json');
        }
        ...
        $body = [];
        if (null !== $request->inputSettingsShrink) {
     ...
     * @returns CreateMediaLiveInputResponse
     *
     * @param CreateMediaLiveInputRequest $request
     *
     * @return CreateMediaLiveInputResponse
     */
     ...
     *
     * @param CreateMediaLiveInputSecurityGroupRequest $tmpReq
     * @param RuntimeOptions                           $runtime
     *
    ...
    public function createMediaLiveInputSecurityGroupWithOptions($tmpReq, $runtime)
    {
        ...
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->whitelistRules) {
            $request->whitelistRulesShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->whitelistRules, 'WhitelistRules', 'json');
        }
        ...
        if (null !== $request->whitelistRulesShrink) {
     ...
     * @returns CreateMediaLiveInputSecurityGroupResponse
     *
     * @param CreateMediaLiveInputSecurityGroupRequest $request
     *
     * @return CreateMediaLiveInputSecurityGroupResponse
     */
     ...
     *
     * @param DeleteMediaLiveChannelRequest $request
     * @param RuntimeOptions                $runtime
     *
     ...
     *
     * @param DeleteMediaLiveInputRequest $request
     * @param RuntimeOptions              $runtime
     *
     ...
     *
     * @param DeleteMediaLiveInputSecurityGroupRequest $request
     * @param RuntimeOptions                           $runtime
     *
     ...
     *
     * @param GetMediaLiveChannelRequest $request
     * @param RuntimeOptions             $runtime
     *
     ...
     *
     * @param GetMediaLiveInputRequest $request
     * @param RuntimeOptions           $runtime
     *
     ...
     *
     * @param GetMediaLiveInputSecurityGroupRequest $request
     * @param RuntimeOptions                        $runtime
     *
     ...
     *
     * @param ListMediaLiveChannelsRequest $request
     * @param RuntimeOptions               $runtime
     *
     ...
     *
     * @param ListMediaLiveInputSecurityGroupsRequest $request
     * @param RuntimeOptions                          $runtime
     *
     ...
     *
     * @param ListMediaLiveInputsRequest $request
     * @param RuntimeOptions             $runtime
     *
     ...
     *
     * @param ListSmartVoiceGroupsRequest $request
     * @param RuntimeOptions              $runtime
     *
     * @return ListSmartVoiceGroupsResponse
     */
    public function listSmartVoiceGroupsWithOptions($request, $runtime)
    {
        $request->validate();
        $query = Utils::query($request->toMap());
        $req = new OpenApiRequest([
     ...
     * @return ListSmartVoiceGroupsResponse
     */
    public function listSmartVoiceGroups($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param SendMessageChatTextRequest $request
     * @param RuntimeOptions             $runtime
     *
     ...
     *
     * @param StartMediaLiveChannelRequest $request
     * @param RuntimeOptions               $runtime
     *
     ...
     *
     * @param StopMediaLiveChannelRequest $request
     * @param RuntimeOptions              $runtime
     *
     ...
     *
     * @param SubmitSegmentationJobRequest $request
     * @param RuntimeOptions               $runtime
     *
     * @return SubmitSegmentationJobResponse
     */
    public function submitSegmentationJobWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->clientToken) {
        ...
        if (null === $this->_signatureVersion || 'v4' != $this->_signatureVersion) {
            return SubmitSegmentationJobResponse::fromMap($this->callApi($params, $req, $runtime));
        }

        return SubmitSegmentationJobResponse::fromMap($this->execute($params, $req, $runtime));
    }
     ...
     * @return SubmitSegmentationJobResponse
     */
    public function submitSegmentationJob($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param UpdateMediaLiveChannelRequest $tmpReq
     * @param RuntimeOptions                $runtime
     *
     ...
     * @returns UpdateMediaLiveChannelResponse
     *
     * @param UpdateMediaLiveChannelRequest $request
     *
     * @return UpdateMediaLiveChannelResponse
     */
     ...
     *
     * @param UpdateMediaLiveInputRequest $tmpReq
     * @param RuntimeOptions              $runtime
     *
     ...
     * @returns UpdateMediaLiveInputResponse
     *
     * @param UpdateMediaLiveInputRequest $request
     *
     * @return UpdateMediaLiveInputResponse
     */
     ...
     *
     * @param UpdateMediaLiveInputSecurityGroupRequest $tmpReq
     * @param RuntimeOptions                           $runtime
     *
     ...
     * @returns UpdateMediaLiveInputSecurityGroupResponse
     *
     * @param UpdateMediaLiveInputSecurityGroupRequest $request
     *
     * @return UpdateMediaLiveInputSecurityGroupResponse
     */
