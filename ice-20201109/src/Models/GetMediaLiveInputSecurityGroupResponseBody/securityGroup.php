...
namespace AlibabaCloud\SDK\ICE\V20201109\Models\GetMediaLiveInputSecurityGroupResponseBody;
...
{
    /**
     * @description The time when the security group was created. It follows the ISO 8601 standard in the yyyy-MM-ddTHH:mm:ssZ format. The time is displayed in UTC.
     *
     * @example 2024-06-13T08:31:56Z
     *
     * @var string
     */
    public $createTime;
