...
use AlibabaCloud\SDK\ICE\V20201109\Models\BatchGetYikeAssetMediaInfosResponseBody\mediaInfos;

class BatchGetYikeAssetMediaInfosResponseBody extends Model
{
    /**
     * @var string[]
     */
