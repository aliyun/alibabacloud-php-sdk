...
{
    /**
     * @description The keyword of the query. You can perform a fuzzy search on security group ID or name.
     *
     * @example 123
     *
     * @var string
    ...
    /**
     * @description The sorting order of the security groups by creation time. Default value: asc. Valid values: desc and asc. asc indicates the ascending order, and desc indicates the descending order.
     *
     * @example desc
     *
     * @var string
     ...
     * @param array $map
     *
     * @return ListMediaLiveInputSecurityGroupsRequest
     */
