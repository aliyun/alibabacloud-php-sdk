...
class videoParams extends Model
{
    ...
    /**
     * @description The height of the output video. Valid values:
     *
     *   Height ≥ 128
    ...
    /**
     * @description The video encoding profile. The profile determines how a video is encoded. In most cases, a greater value indicates better image quality and higher resource consumption. Valid values:
     *
    ...
    /**
     * @description The width of the output video. Valid values:
     *
     *   Width ≥ 128
     *   max (Height,Width) ≤ 2560
     *   min（Height,Width）≤ 1440
