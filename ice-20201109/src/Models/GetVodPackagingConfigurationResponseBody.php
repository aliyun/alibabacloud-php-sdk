...
class GetVodPackagingConfigurationResponseBody extends Model
{
    /**
     * @description The information about the packaging configuration.
     *
     ...
     * @param array $map
     *
     * @return GetVodPackagingConfigurationResponseBody
     */
