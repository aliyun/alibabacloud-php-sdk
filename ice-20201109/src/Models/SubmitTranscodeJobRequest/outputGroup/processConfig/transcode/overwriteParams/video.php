...
{
    /**
     * @description The maximum adaptive bitrate (ABR). This parameter takes effect only for Narrowband HD 1.0. Valid values: [10,50000]. Unit: Kbit/s.
     *
     * @example 6000
     *
     * @var string
    ...
    /**
     * @description The average video bitrate. Valid values: [10,50000]. Unit: Kbit/s.
     *
     * @example 3000
     *
     * @var string
    ...
    /**
     * @description The buffer size. Valid values: [1000,128000]. Default value: 6000. Unit: KB.
     *
     * @example 6000
     *
     * @var string
    ...
    /**
     * @description The maximum number of frames between keyframes. Valid values: [1,1080000]. Default value: 250.
     *
     * @example 250
     *
     * @var string
    ...
    /**
     * @description The height of the video. Valid values: [128,4096]. Unit: pixels. Default value: the original height of the video.
     *
     * @example 1080
     *
     * @var string
    ...
    /**
     * @description Specifies whether to enable the auto-rotate screen feature.
     *
     * @example false
     *
     * @var string
    ...
    /**
     * @description The maximum bitrate of the video. Valid values: [10,50000]. Unit: Kbit/s.
     *
     * @example 9000
     *
     * @var string
    ...
    /**
     * @description The black bars added to the video. Format: width:height:left:top. Example: 1280:800:0:140.
     *
     * @example 1280:800:0:140
     *
     * @var string
    ...
    /**
     * @description Specifies whether to remove the video.
     *
     * @example false
     *
     * @var string
    ...
    /**
     * @description The width of the video. Valid values: [128,4096]. Unit: pixels. Default value: the original width of the video.
     *
     * @example 1920
     *
     * @var string
