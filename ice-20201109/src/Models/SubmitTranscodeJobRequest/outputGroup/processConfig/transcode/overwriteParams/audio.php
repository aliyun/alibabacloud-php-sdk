...
{
    /**
     * @description The audio bitrate of the output file. Valid values: [8,1000]. Unit: Kbit/s. Default value: 128.
     *
     * @example 128
     *
     * @var string
    ...
    /**
     * @description The sampling rate. Valid values: 22050, 32000, 44100, 48000, and 96000. Default value: 44100. Unit: Hz.
     *
     * @example 44100
     *
     * @var string
