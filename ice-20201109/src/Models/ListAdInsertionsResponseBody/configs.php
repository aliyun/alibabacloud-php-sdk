...
namespace AlibabaCloud\SDK\ICE\V20201109\Models\ListAdInsertionsResponseBody;

use AlibabaCloud\SDK\ICE\V20201109\Models\ListAdInsertionsResponseBody\configs\cdnConfig;
use AlibabaCloud\SDK\ICE\V20201109\Models\ListAdInsertionsResponseBody\configs\manifestEndpointConfig;
...
class configs extends Model
{
    ...
    /**
     * @description The request URL of the ad decision server (ADS).
     *
    ...
    /**
     * @description The personalization threshold that defines the maximum duration of underfilled time allowed in an ad break.
     *
     * @example 5
     *
     * @var int
