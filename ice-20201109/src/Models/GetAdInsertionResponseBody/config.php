...
namespace AlibabaCloud\SDK\ICE\V20201109\Models\GetAdInsertionResponseBody;

use AlibabaCloud\SDK\ICE\V20201109\Models\GetAdInsertionResponseBody\config\cdnConfig;
use AlibabaCloud\SDK\ICE\V20201109\Models\GetAdInsertionResponseBody\config\manifestEndpointConfig;
...
class config extends Model
{
    ...
    /**
     * @description The URL of the ad decision server (ADS).
     *
    ...
    /**
     * @description The aliases for dynamic variable replacement.
     *
     * @example {
     * }
     * @var string
    ...
    /**
     * @description The prefix of the source URL.
     *
    ...
    /**
     * @description The playback endpoint prefix for accessing manifests.
     *
