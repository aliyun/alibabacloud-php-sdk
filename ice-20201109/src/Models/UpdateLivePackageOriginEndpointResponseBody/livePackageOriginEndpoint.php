...
class livePackageOriginEndpoint extends Model
{
     ...
     *
     * @example https://xxx.packagepull-abcxxx.ap-southeast-1.aliyuncsiceintl.com/v1/group01/1/ch01/manifest
     *
     * @var string
     */
    public $endpointUrl;
    ...
    /**
     * @description The IP address blacklist. It supports subnet masks. Multiple IP addresses are separated by commas (,).
     *
    ...
    /**
     * @description The IP address whitelist. It supports subnet masks. Multiple IP addresses are separated by commas (,).
     *
