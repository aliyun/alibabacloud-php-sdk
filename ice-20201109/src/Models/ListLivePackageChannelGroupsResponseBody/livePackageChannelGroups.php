...
namespace AlibabaCloud\SDK\ICE\V20201109\Models\ListLivePackageChannelGroupsResponseBody;

use AlibabaCloud\Tea\Model;

class livePackageChannelGroups extends Model
{
    /**
