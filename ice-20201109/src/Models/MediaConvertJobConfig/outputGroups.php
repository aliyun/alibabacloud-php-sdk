...
use AlibabaCloud\SDK\ICE\V20201109\Models\MediaConvertJobConfig\outputGroups\groupConfig;
use AlibabaCloud\SDK\ICE\V20201109\Models\MediaConvertJobConfig\outputGroups\outputs;
...
class outputGroups extends Model
{
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['GroupConfig'])) {
            $model->groupConfig = groupConfig::fromMap($map['GroupConfig']);
        }
