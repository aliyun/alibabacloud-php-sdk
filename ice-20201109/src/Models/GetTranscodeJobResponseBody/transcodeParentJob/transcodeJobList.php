...
class transcodeJobList extends Model
{
    ...
    /**
     * @description The state of the transcoding job. Valid values: Init (the job is submitted), Success (the job is successful), Fail (the job failed), and Deleted (the job is deleted).
     *
     * @example Init
     *
     * @var string
