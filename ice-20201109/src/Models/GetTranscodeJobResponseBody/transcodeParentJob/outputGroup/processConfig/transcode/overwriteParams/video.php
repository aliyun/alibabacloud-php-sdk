...
{
    /**
     * @description The maximum ABR. This parameter takes effect only for Narrowband HD 1.0.
     *
    ...
    /**
     * @description The method of video cropping. Valid values: border: automatically detects and removes black bars. A value in the width:height:left:top format: crops the videos based on the custom settings. Example: 1280:800:0:140.
     *
    ...
    /**
     * @description The black bars added to the video.
     *
