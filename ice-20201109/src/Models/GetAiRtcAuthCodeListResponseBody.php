...
class GetAiRtcAuthCodeListResponseBody extends Model
{
    /**
     * @var AiRtcAuthCodeDTO[]
     */
    public $authCodeList;
        ...
        if (null !== $this->authCodeList) {
            if (\is_array($this->authCodeList)) {
                ...
                foreach ($this->authCodeList as $item1) {
                    $res['AuthCodeList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
        ...
        if (isset($map['AuthCodeList'])) {
            if (!empty($map['AuthCodeList'])) {
                ...
                foreach ($map['AuthCodeList'] as $item1) {
                    $model->authCodeList[$n1] = AiRtcAuthCodeDTO::fromMap($item1);
                    ++$n1;
                }
            }
        }
