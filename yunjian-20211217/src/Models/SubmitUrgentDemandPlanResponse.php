...
class SubmitUrgentDemandPlanResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitUrgentDemandPlanResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitUrgentDemandPlanResponseBody::fromMap($map['body']);
        }
