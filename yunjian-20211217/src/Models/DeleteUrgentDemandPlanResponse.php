...
class DeleteUrgentDemandPlanResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteUrgentDemandPlanResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteUrgentDemandPlanResponseBody::fromMap($map['body']);
        }
