...
class GetUrgentDemandPlanDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetUrgentDemandPlanDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetUrgentDemandPlanDetailResponseBody::fromMap($map['body']);
        }
