...
class GetUrgentDemandPlanListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetUrgentDemandPlanListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetUrgentDemandPlanListResponseBody::fromMap($map['body']);
        }
