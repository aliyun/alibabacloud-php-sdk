...
class DeleteUrgentDemandItemResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteUrgentDemandItemResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteUrgentDemandItemResponseBody::fromMap($map['body']);
        }
