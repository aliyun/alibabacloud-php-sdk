...
class GetUrgentDemandItemListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetUrgentDemandItemListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetUrgentDemandItemListResponseBody::fromMap($map['body']);
        }
