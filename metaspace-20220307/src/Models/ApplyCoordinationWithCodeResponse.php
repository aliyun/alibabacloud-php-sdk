...
class ApplyCoordinationWithCodeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ApplyCoordinationWithCodeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ApplyCoordinationWithCodeResponseBody::fromMap($map['body']);
        }
