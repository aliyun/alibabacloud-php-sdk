...
class EndAllCoordinationByOwnerResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EndAllCoordinationByOwnerResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EndAllCoordinationByOwnerResponseBody::fromMap($map['body']);
        }
