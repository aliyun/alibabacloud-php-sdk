...
class StartVerificationResponseBody extends Model
{
    /**
    ...
    /**
     * @description The data that was returned only if the request was successful. Example: "Model": { "verifyCode": "", "verificationId": "", "status": "" }
     *
     * @var mixed[]
     */
    public $model;
     ...
     * @param array $map
     *
     * @return StartVerificationResponseBody
     */
