...
class CheckVerificationResponseBody extends Model
{
    /**
    ...
    /**
     * @description The data that was returned for the successful request. Example: "Model": { "phoneNumber": "", "channel": "", "verificationId": "", "status": "approved" },
     *
     * @var mixed[]
     */
    public $model;
     ...
     * @param array $map
     *
     * @return CheckVerificationResponseBody
     */
