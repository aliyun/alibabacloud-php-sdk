...
class Schedulerx2 extends OpenApiClient
{
     ...
     *
     * @param ManageSchedulerxJobSyncRequest $tmpReq
     * @param RuntimeOptions                 $runtime
     *
    ...
    public function manageSchedulerxJobSyncWithOptions($tmpReq, $runtime)
    {
        ...
        if (null !== $tmpReq->jobIdList) {
            $request->jobIdListShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->jobIdList, 'JobIdList', 'json');
        }

        $body = [];
        if (null !== $request->jobIdListShrink) {
        ...
        if (null !== $request->originalGroupId) {
            @$body['OriginalGroupId'] = $request->originalGroupId;
        }

        if (null !== $request->originalNamespace) {
     ...
     * @returns ManageSchedulerxJobSyncResponse
     *
     * @param ManageSchedulerxJobSyncRequest $request
     *
     * @return ManageSchedulerxJobSyncResponse
     */
    ...
    public function updateAppGroupWithOptions($request, $runtime)
    {
        ...
        if (null !== $request->notificationPolicyName) {
