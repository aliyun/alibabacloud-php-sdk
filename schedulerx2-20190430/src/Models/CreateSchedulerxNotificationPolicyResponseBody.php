...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\CreateSchedulerxNotificationPolicyResponseBody\accessDeniedDetail;

class CreateSchedulerxNotificationPolicyResponseBody extends Model
{
    /**
