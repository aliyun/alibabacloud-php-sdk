...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\DeleteSchedulerxCalendarResponseBody\accessDeniedDetail;

class DeleteSchedulerxCalendarResponseBody extends Model
{
    /**
