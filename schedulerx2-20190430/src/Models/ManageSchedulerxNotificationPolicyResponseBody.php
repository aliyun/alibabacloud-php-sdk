...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\ManageSchedulerxNotificationPolicyResponseBody\accessDeniedDetail;

class ManageSchedulerxNotificationPolicyResponseBody extends Model
{
    /**
