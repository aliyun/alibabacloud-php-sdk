...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\ManageSchedulerxCalendarResponseBody\accessDeniedDetail;

class ManageSchedulerxCalendarResponseBody extends Model
{
    /**
