...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\DeleteSchedulerxNotificationPolicyResponseBody\accessDeniedDetail;

class DeleteSchedulerxNotificationPolicyResponseBody extends Model
{
    /**
