...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\RerunJobResponseBody\accessDeniedDetail;
use AlibabaCloud\Tea\Model;

class RerunJobResponseBody extends Model
{
    /**
