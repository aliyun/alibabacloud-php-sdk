...
use AlibabaCloud\SDK\Schedulerx2\V20190430\Models\CreateSchedulerxCalendarResponseBody\accessDeniedDetail;

class CreateSchedulerxCalendarResponseBody extends Model
{
    /**
