...
class ListProjectsByDependencyIdResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListProjectsByDependencyIdResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListProjectsByDependencyIdResponseBody::fromMap($map['body']);
        }
