...
class QueryProjectBuildDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryProjectBuildDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryProjectBuildDetailResponseBody::fromMap($map['body']);
        }
