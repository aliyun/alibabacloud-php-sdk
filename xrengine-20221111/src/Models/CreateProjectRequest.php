...
use AlibabaCloud\SDK\XrEngine\V20221111\Models\CreateProjectRequest\tryOnParams;
...
class CreateProjectRequest extends Model
{
    ...
    {
        if (null !== $this->tryOnParams) {
            $this->tryOnParams->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->tryOnParams) {
            $res['TryOnParams'] = null !== $this->tryOnParams ? $this->tryOnParams->toArray($noStream) : $this->tryOnParams;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['TryOnParams'])) {
            $model->tryOnParams = tryOnParams::fromMap($map['TryOnParams']);
        }
