...
class GetArEditCommonMaterialResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetArEditCommonMaterialResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetArEditCommonMaterialResponseBody::fromMap($map['body']);
        }
