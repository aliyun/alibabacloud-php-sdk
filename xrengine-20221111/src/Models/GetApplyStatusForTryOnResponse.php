...
class GetApplyStatusForTryOnResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetApplyStatusForTryOnResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetApplyStatusForTryOnResponseBody::fromMap($map['body']);
        }
