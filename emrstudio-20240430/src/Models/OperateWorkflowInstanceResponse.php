...
class OperateWorkflowInstanceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var OperateWorkflowInstanceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = OperateWorkflowInstanceResponseBody::fromMap($map['body']);
        }
