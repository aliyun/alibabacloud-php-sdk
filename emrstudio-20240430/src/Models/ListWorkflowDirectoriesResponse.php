...
class ListWorkflowDirectoriesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListWorkflowDirectoriesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListWorkflowDirectoriesResponseBody::fromMap($map['body']);
        }
