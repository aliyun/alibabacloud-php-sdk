...
class GetAccessChannelOfStagingResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAccessChannelOfStagingResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAccessChannelOfStagingResponseBody::fromMap($map['body']);
        }
