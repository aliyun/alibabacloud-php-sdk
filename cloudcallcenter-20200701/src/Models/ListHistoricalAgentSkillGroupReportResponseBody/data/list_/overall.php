...
use AlibabaCloud\SDK\CloudCallCenter\V20200701\Models\ListHistoricalAgentSkillGroupReportResponseBody\data\list_\overall\breakCodeDetailList;
...
class overall extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->satisfactionCount) {
            $res['SatisfactionCount'] = $this->satisfactionCount;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SatisfactionCount'])) {
            $model->satisfactionCount = $map['SatisfactionCount'];
        }
