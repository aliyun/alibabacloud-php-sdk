...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module;

use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\airlineInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\arrAirportInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\cabinInfoList;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\depAirportInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\flightRuleList;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightSearchListResponseBody\module\flightList\transferInfo;
...
class flightList extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->cabinInfoList) {
            $res['cabin_info_list'] = [];
            if (null !== $this->cabinInfoList && \is_array($this->cabinInfoList)) {
                $n = 0;
                foreach ($this->cabinInfoList as $item) {
                    $res['cabin_info_list'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
        ...
        if (null !== $this->transferInfo) {
            $res['transfer_info'] = null !== $this->transferInfo ? $this->transferInfo->toMap() : null;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['cabin_info_list'])) {
            if (!empty($map['cabin_info_list'])) {
                $model->cabinInfoList = [];
                $n                    = 0;
                foreach ($map['cabin_info_list'] as $item) {
                    $model->cabinInfoList[$n++] = null !== $item ? cabinInfoList::fromMap($item) : $item;
                }
            }
        }
        ...
        if (isset($map['transfer_info'])) {
            $model->transferInfo = transferInfo::fromMap($map['transfer_info']);
        }
