...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue\priceShowInfo;

class ModuleItemListSubItemsShoppingItemMapValueSegmentPriceValue extends Model
{
    /**
     * @var int
     */
