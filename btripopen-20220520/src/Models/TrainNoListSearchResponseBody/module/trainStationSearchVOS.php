...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\TrainNoListSearchResponseBody\module\trainStationSearchVOS\seatInfos;
use AlibabaCloud\Tea\Model;

class trainStationSearchVOS extends Model
{
    /**
     * @example 0
     *
    ...
    public function toMap()
    {
        ...
        if (null !== $this->seagmentIndex) {
            $res['seagment_index'] = $this->seagmentIndex;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['seagment_index'])) {
            $model->seagmentIndex = $map['seagment_index'];
        }
