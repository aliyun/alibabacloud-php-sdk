...
class cabinList extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->changeOtaItemRuleRq) {
            $this->changeOtaItemRuleRq->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->changeOtaItemRuleRq) {
            $res['change_ota_item_rule_rq'] = null !== $this->changeOtaItemRuleRq ? $this->changeOtaItemRuleRq->toArray($noStream) : $this->changeOtaItemRuleRq;
        }
