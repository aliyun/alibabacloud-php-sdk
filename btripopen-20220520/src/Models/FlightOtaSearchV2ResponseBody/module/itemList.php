...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightOtaSearchV2ResponseBody\module;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightOtaSearchV2ResponseBody\module\itemList\subItems;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleItemListFlightRuleInfosValue;
        ...
        if (isset($map['flight_rule_infos'])) {
            if (!empty($map['flight_rule_infos'])) {
                ...
                foreach ($map['flight_rule_infos'] as $key1 => $value1) {
                    $model->flightRuleInfos[$key1] = ModuleItemListFlightRuleInfosValue::fromMap($value1);
                }
            }
        }
