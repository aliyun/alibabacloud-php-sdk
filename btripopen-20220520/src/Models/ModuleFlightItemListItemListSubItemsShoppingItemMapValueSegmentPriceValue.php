...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue\priceShowInfo;

class ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue extends Model
{
    /**
     * @var int
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->priceShowInfo) {
            $res['price_show_info'] = null !== $this->priceShowInfo ? $this->priceShowInfo->toArray($noStream) : $this->priceShowInfo;
        }
