...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightModifyListingSearchV2ResponseBody\module\directFlightList;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\FlightModifyListingSearchV2ResponseBody\module\directFlightList\priceInfoDTO\reShopPriceInfoDTO;
...
class priceInfoDTO extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->reShopPriceInfoDTO) {
            $this->reShopPriceInfoDTO->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->reShopPriceInfoDTO) {
            $res['re_shop_price_info_d_t_o'] = null !== $this->reShopPriceInfoDTO ? $this->reShopPriceInfoDTO->toArray($noStream) : $this->reShopPriceInfoDTO;
        }
