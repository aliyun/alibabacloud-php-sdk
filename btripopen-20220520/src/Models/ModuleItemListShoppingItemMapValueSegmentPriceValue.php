...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleItemListShoppingItemMapValueSegmentPriceValue\priceShowInfo;

class ModuleItemListShoppingItemMapValueSegmentPriceValue extends Model
{
    /**
     * @var int
     */
