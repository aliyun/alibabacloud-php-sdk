...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleFlightItemListItemListSubItemsShoppingItemMapValue\searchPrice;

class ModuleFlightItemListItemListSubItemsShoppingItemMapValue extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue[]
     */
    ...
    /**
     * @var ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue[]
     */
    public $segmentPrice;
    protected $_name = [
        'id' => 'id',
        ...
        if (isset($map['cabin_quantity'])) {
            if (!empty($map['cabin_quantity'])) {
                ...
                foreach ($map['cabin_quantity'] as $key1 => $value1) {
                    $model->cabinQuantity[$key1] = ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue::fromMap($value1);
                }
            }
        }
        ...
        if (isset($map['segment_price'])) {
            if (!empty($map['segment_price'])) {
                ...
                foreach ($map['segment_price'] as $key1 => $value1) {
                    $model->segmentPrice[$key1] = ModuleFlightItemListItemListSubItemsShoppingItemMapValueSegmentPriceValue::fromMap($value1);
                }
            }
        }
