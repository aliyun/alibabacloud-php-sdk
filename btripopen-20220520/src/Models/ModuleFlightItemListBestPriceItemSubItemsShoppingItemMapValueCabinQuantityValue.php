...
class ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue extends Model
{
    /**
     * @example R
     *
     ...
     * @param array $map
     *
     * @return ModuleFlightItemListBestPriceItemSubItemsShoppingItemMapValueCabinQuantityValue
     */
