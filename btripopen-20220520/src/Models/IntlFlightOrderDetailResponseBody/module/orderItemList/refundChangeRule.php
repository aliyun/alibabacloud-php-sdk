...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue;
...
class refundChangeRule extends Model
{
    ...
    /**
     * @var ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue[][]
     */
            ...
            if (!empty($map['offer_penalty_info_map'])) {
                ...
                foreach ($map['offer_penalty_info_map'] as $key1 => $value1) {
                    if (!empty($value1)) {
                        ...
                        $n2 = 0;
                        foreach ($value1 as $item2) {
                            $model->offerPenaltyInfoMap[$key1][$n2++] = ModuleOrderItemListRefundChangeRuleOfferPenaltyInfoMapValue::fromMap($item2);
                        }
                    }
                }
            }
