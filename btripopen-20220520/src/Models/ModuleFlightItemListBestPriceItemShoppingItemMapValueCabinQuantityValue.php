...
class ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue extends Model
{
    /**
     * @example R
     *
     ...
     * @param array $map
     *
     * @return ModuleFlightItemListBestPriceItemShoppingItemMapValueCabinQuantityValue
     */
