        ...
        if (isset($map['flight_rule_infos'])) {
            if (!empty($map['flight_rule_infos'])) {
                ...
                foreach ($map['flight_rule_infos'] as $key1 => $value1) {
                    $model->flightRuleInfos[$key1] = ModuleFlightItemListBestPriceItemFlightRuleInfosValue::fromMap($value1);
                }
            }
        }
        ...
        if (isset($map['shopping_item_map'])) {
            if (!empty($map['shopping_item_map'])) {
                ...
                foreach ($map['shopping_item_map'] as $key1 => $value1) {
                    $model->shoppingItemMap[$key1] = ModuleFlightItemListBestPriceItemShoppingItemMapValue::fromMap($value1);
                }
            }
        }
            ...
            if (!empty($map['sub_item_position_map'])) {
                ...
                foreach ($map['sub_item_position_map'] as $key1 => $value1) {
                    if (!empty($value1)) {
                        ...
                        $n2 = 0;
                        foreach ($value1 as $item2) {
                            $model->subItemPositionMap[$key1][$n2] = ModuleFlightItemListBestPriceItemSubItemPositionMapValue::fromMap($item2);
                            ++$n2;
                        }
                    }
                }
