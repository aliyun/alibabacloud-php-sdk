...
class ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue extends Model
{
    /**
     * @example R
     *
     ...
     * @param array $map
     *
     * @return ModuleFlightItemListItemListSubItemsShoppingItemMapValueCabinQuantityValue
     */
