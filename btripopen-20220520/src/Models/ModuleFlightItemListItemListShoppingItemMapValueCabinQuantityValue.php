...
class ModuleFlightItemListItemListShoppingItemMapValueCabinQuantityValue extends Model
{
    /**
     * @example R
     *
     ...
     * @param array $map
     *
     * @return ModuleFlightItemListItemListShoppingItemMapValueCabinQuantityValue
     */
