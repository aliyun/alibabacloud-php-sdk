...
class ModuleGroupItemSubItemsRefundChangeRuleOfferPenaltyInfoMapValue extends Model
{
    /**
     * @example true
     *
     ...
     * @param array $map
     *
     * @return ModuleGroupItemSubItemsRefundChangeRuleOfferPenaltyInfoMapValue
     */
