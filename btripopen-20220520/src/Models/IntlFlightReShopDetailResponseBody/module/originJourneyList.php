...
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopDetailResponseBody\module\originJourneyList\flightSegmentInfos;

class originJourneyList extends Model
{
    /**
     * @var string
     */
