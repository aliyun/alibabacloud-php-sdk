...
class dataList extends Model
{
     ...
     * @var string
     */
    public $arrStationLocation;

    /**
     * @var string
     */
    public $arrStationLocationCode;
     ...
     * @var string
     */
    public $depStationLocation;

    /**
     * @var string
     */
    public $depStationLocationCode;
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['arr_station_location'])) {
            $model->arrStationLocation = $map['arr_station_location'];
        }

        if (isset($map['arr_station_location_code'])) {
            $model->arrStationLocationCode = $map['arr_station_location_code'];
        }
        ...
        if (isset($map['dep_station_location'])) {
            $model->depStationLocation = $map['dep_station_location'];
        }

        if (isset($map['dep_station_location_code'])) {
            $model->depStationLocationCode = $map['dep_station_location_code'];
        }
