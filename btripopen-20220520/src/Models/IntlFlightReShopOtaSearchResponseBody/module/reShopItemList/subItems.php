...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\reShopItemList;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\reShopItemList\subItems\baggageRule;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\reShopItemList\subItems\refundChangeRule;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\reShopItemList\subItems\segmentPositionList;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleReShopItemListSubItemsShoppingItemMapValue;
...
class subItems extends Model
{
    ...
    /**
     * @var ModuleReShopItemListSubItemsShoppingItemMapValue[]
     */
        ...
        if (isset($map['shopping_item_map'])) {
            if (!empty($map['shopping_item_map'])) {
                ...
                foreach ($map['shopping_item_map'] as $key1 => $value1) {
                    $model->shoppingItemMap[$key1] = ModuleReShopItemListSubItemsShoppingItemMapValue::fromMap($value1);
                }
            }
        }
