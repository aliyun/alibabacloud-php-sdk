...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\flightJourneyInfos\flightSegmentInfos;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopOtaSearchResponseBody\module\flightJourneyInfos\flightSegmentInfos\flightStopInfoList\stopAirportCountyInfo;

class flightStopInfoList extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var stopAirportCountyInfo
     */
    public $stopAirportCountyInfo;
    ...
    {
        if (null !== $this->stopAirportCountyInfo) {
            $this->stopAirportCountyInfo->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->stopAirportCountyInfo) {
            $res['stop_airport_county_info'] = null !== $this->stopAirportCountyInfo ? $this->stopAirportCountyInfo->toArray($noStream) : $this->stopAirportCountyInfo;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['stop_airport_county_info'])) {
            $model->stopAirportCountyInfo = stopAirportCountyInfo::fromMap($map['stop_airport_county_info']);
        }
