...
class destFlightInfoDTOS extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->flightChange) {
            $res['flight_change'] = null !== $this->flightChange ? $this->flightChange->toArray($noStream) : $this->flightChange;
        }
        ...
        if (null !== $this->segmentIId) {
            $res['segmentI_id'] = $this->segmentIId;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['segmentI_id'])) {
            $model->segmentIId = $map['segmentI_id'];
        }
