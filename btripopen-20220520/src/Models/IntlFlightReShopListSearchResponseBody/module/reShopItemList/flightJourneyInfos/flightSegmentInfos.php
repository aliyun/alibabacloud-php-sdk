...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\airlineInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\arrAirportInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\depAirportInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\flightShareInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\flightStopInfoList;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\luggageDirectInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\otherInfo;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\segmentVisaRemark;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\flightJourneyInfos\flightSegmentInfos\ticketingAirlineInfo;
...
class flightSegmentInfos extends Model
{
    ...
    /**
     * @var ticketingAirlineInfo
     */
    public $ticketingAirlineInfo;
    ...
    public function validate()
    {
        ...
        if (null !== $this->otherInfo) {
            $this->otherInfo->validate();
        }
        if (null !== $this->segmentVisaRemark) {
            $this->segmentVisaRemark->validate();
        }
        if (null !== $this->ticketingAirlineInfo) {
            $this->ticketingAirlineInfo->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->arrTimeUTC) {
            $res['arr_time_u_t_c'] = $this->arrTimeUTC;
        }
        ...
        if (null !== $this->depTimeUTC) {
            $res['dep_time_u_t_c'] = $this->depTimeUTC;
        }
        ...
        if (null !== $this->otherInfo) {
            $res['other_info'] = null !== $this->otherInfo ? $this->otherInfo->toArray($noStream) : $this->otherInfo;
        }
        ...
        if (null !== $this->ticketingAirlineInfo) {
            $res['ticketing_airline_info'] = null !== $this->ticketingAirlineInfo ? $this->ticketingAirlineInfo->toArray($noStream) : $this->ticketingAirlineInfo;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['arr_time_u_t_c'])) {
            $model->arrTimeUTC = $map['arr_time_u_t_c'];
        }
        ...
        if (isset($map['dep_time_u_t_c'])) {
            $model->depTimeUTC = $map['dep_time_u_t_c'];
        }
        ...
        if (isset($map['other_info'])) {
            $model->otherInfo = otherInfo::fromMap($map['other_info']);
        }
        ...
        if (isset($map['ticketing_airline_info'])) {
            $model->ticketingAirlineInfo = ticketingAirlineInfo::fromMap($map['ticketing_airline_info']);
        }
