...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\bestPriceItem\subItems;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\ModuleReShopItemListBestPriceItemShoppingItemMapValue;
...
class bestPriceItem extends Model
{
    ...
    /**
     * @var ModuleReShopItemListBestPriceItemShoppingItemMapValue[]
     */
        ...
        if (isset($map['shopping_item_map'])) {
            if (!empty($map['shopping_item_map'])) {
                ...
                foreach ($map['shopping_item_map'] as $key1 => $value1) {
                    $model->shoppingItemMap[$key1] = ModuleReShopItemListBestPriceItemShoppingItemMapValue::fromMap($value1);
                }
            }
        }
