...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopListSearchResponseBody\module\reShopItemList\bestPriceItem\subItems;

use AlibabaCloud\Dara\Model;

class segmentPositionList extends Model
{
    /**
     * @var int
     */
