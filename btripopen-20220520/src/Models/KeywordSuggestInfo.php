...
class KeywordSuggestInfo extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->businessAreaWithCity) {
            $this->businessAreaWithCity->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->businessAreaWithCity) {
            $res['business_area_with_city'] = null !== $this->businessAreaWithCity ? $this->businessAreaWithCity->toArray($noStream) : $this->businessAreaWithCity;
        }
