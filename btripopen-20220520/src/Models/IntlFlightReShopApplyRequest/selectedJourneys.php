...
namespace AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopApplyRequest;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BtripOpen\V20220520\Models\IntlFlightReShopApplyRequest\selectedJourneys\selectedFlights;

class selectedJourneys extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->intentDate) {
            $res['intent_date'] = $this->intentDate;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['intent_date'])) {
            $model->intentDate = $map['intent_date'];
        }
