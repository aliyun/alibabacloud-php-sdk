...
class PublicUpdateTemplateSandboxConfig extends Model
{
    /**
     * @var string
     */
    ...
    /**
     * @var PublicUpdateTemplateRegistryConfig
     */
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['registryConfig'])) {
            $model->registryConfig = PublicUpdateTemplateRegistryConfig::fromMap($map['registryConfig']);
        }
