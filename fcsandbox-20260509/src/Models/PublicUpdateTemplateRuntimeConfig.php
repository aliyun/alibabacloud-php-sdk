...
class PublicUpdateTemplateRuntimeConfig extends Model
{
    /**
     * @var float
     */
    ...
    /**
     * @var PublicUpdateTemplateLogConfig
     */
    public $logConfig;
    ...
    /**
     * @var PublicUpdateTemplateSandboxConfig
     */
    public $sandboxConfig;

    /**
     * @var PublicUpdateTemplateVPCConfig
     */
    public $vpcConfig;
    protected $_name = [
        'cpu' => 'cpu',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['logConfig'])) {
            $model->logConfig = PublicUpdateTemplateLogConfig::fromMap($map['logConfig']);
        }
        ...
        if (isset($map['sandboxConfig'])) {
            $model->sandboxConfig = PublicUpdateTemplateSandboxConfig::fromMap($map['sandboxConfig']);
        }

        if (isset($map['vpcConfig'])) {
            $model->vpcConfig = PublicUpdateTemplateVPCConfig::fromMap($map['vpcConfig']);
        }
