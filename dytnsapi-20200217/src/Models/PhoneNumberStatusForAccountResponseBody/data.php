...
{
    /**
     * @description The basic carrier who assings the phone number. If the queried phone number involves mobile number portability, the carrier after mobile number portability is returned. Valid values:
     *
     *   **CMCC**: China Mobile
     *   **CUCC**: China Unicom
     *   **CTCC**: China Telecom
