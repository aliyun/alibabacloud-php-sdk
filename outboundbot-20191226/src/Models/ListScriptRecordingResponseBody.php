...
class ListScriptRecordingResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->scriptRecordings) {
            ...
            if (null !== $this->scriptRecordings && \is_array($this->scriptRecordings)) {
                $n = 0;
                foreach ($this->scriptRecordings as $item) {
                    $res['ScriptRecordings'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return ListScriptRecordingResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ScriptRecordings'])) {
            if (!empty($map['ScriptRecordings'])) {
                ...
                $n = 0;
                foreach ($map['ScriptRecordings'] as $item) {
                    $model->scriptRecordings[$n++] = null !== $item ? scriptRecordings::fromMap($item) : $item;
                }
            }
        }
