...
class DescribeDialogueNodeStatisticsResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->hangUpDialogueNodes) {
            ...
            if (null !== $this->hangUpDialogueNodes && \is_array($this->hangUpDialogueNodes)) {
                $n = 0;
                foreach ($this->hangUpDialogueNodes as $item) {
                    $res['HangUpDialogueNodes'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['HangUpDialogueNodes'])) {
            if (!empty($map['HangUpDialogueNodes'])) {
                ...
                $n = 0;
                foreach ($map['HangUpDialogueNodes'] as $item) {
                    $model->hangUpDialogueNodes[$n++] = null !== $item ? hangUpDialogueNodes::fromMap($item) : $item;
                }
            }
        }
