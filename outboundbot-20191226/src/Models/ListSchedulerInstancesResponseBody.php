...
class ListSchedulerInstancesResponseBody extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->schedulerInstances) {
            ...
            if (null !== $this->schedulerInstances && \is_array($this->schedulerInstances)) {
                $n = 0;
                foreach ($this->schedulerInstances as $item) {
                    $res['SchedulerInstances'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
     ...
     * @param array $map
     *
     * @return ListSchedulerInstancesResponseBody
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SchedulerInstances'])) {
            if (!empty($map['SchedulerInstances'])) {
                ...
                $n                         = 0;
                foreach ($map['SchedulerInstances'] as $item) {
                    $model->schedulerInstances[$n++] = null !== $item ? schedulerInstances::fromMap($item) : $item;
                }
            }
        }
