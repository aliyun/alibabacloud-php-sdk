...
class jobGroup extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->flashSmsExtras) {
            $res['FlashSmsExtras'] = null !== $this->flashSmsExtras ? $this->flashSmsExtras->toMap() : null;
        }
        ...
        if (null !== $this->recallCallingNumbers) {
            $res['RecallCallingNumbers'] = $this->recallCallingNumbers;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['RecallCallingNumbers'])) {
            if (!empty($map['RecallCallingNumbers'])) {
                $model->recallCallingNumbers = $map['RecallCallingNumbers'];
            }
        }
