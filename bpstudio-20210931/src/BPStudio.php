...
class BPStudio extends OpenApiClient
{
     ...
     *
     * @param GetLinkageAttributesTemplateRequest $tmpReq
     * @param RuntimeOptions                      $runtime
     *
     * @return GetLinkageAttributesTemplateResponse
     */
    public function getLinkageAttributesTemplateWithOptions($tmpReq, $runtime)
    {
        $tmpReq->validate();
        $request = new GetLinkageAttributesTemplateShrinkRequest([]);
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->instances) {
            $request->instancesShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->instances, 'Instances', 'json');
        }
        ...
        if (null !== $request->targetVariable) {
        ...
        return GetLinkageAttributesTemplateResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @returns GetLinkageAttributesTemplateResponse
     *
     * @param GetLinkageAttributesTemplateRequest $request
     *
     * @return GetLinkageAttributesTemplateResponse
     */
    public function getLinkageAttributesTemplate($request)
    {
        $runtime = new RuntimeOptions([]);
