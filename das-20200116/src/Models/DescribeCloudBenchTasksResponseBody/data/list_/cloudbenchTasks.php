...
class cloudbenchTasks extends Model
{
    ...
    /**
     * @description The archiving status of the file that stores the analysis result of full SQL statistics. Valid values:
     *
    ...
    /**
     * @description The status that indicates the substep performed for the stress testing task. Valid values:
     *
    ...
    /**
     * @description The name of the Data Transmission Service (DTS) migration task.
     *
    ...
    /**
     * @description The status of the DTS migration task. Valid values:
     *
    ...
    /**
     * @description The state that indicates the last operation performed for the stress testing task. Valid values:
     *
    ...
    /**
     * @description The rate at which the stress testing task replayed the traffic. This value is a positive integer. Valid values: **0** to **30**. Default value: **1**.
     *
     * @example 1
     *
     * @var int
    ...
    /**
     * @description The duration of the stress testing task. Unit: millisecond.
     *
     * @example 86400000
     *
     * @var int
    ...
    /**
     * @description The duration of the stress testing task of the smart pressure test type. Unit: millisecond.
     *
     * @example 86400000
     *
     * @var int
    ...
    /**
     * @description The reused information about the analysis result of full SQL statistics.
     *
