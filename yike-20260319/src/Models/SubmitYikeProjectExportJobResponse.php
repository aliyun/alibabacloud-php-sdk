...
class SubmitYikeProjectExportJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitYikeProjectExportJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitYikeProjectExportJobResponseBody::fromMap($map['body']);
        }
