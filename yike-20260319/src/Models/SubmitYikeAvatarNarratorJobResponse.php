...
class SubmitYikeAvatarNarratorJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitYikeAvatarNarratorJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitYikeAvatarNarratorJobResponseBody::fromMap($map['body']);
        }
