...
class GetYikeProjectExportJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetYikeProjectExportJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetYikeProjectExportJobResponseBody::fromMap($map['body']);
        }
