...
class SubmitImageGenerationJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitImageGenerationJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitImageGenerationJobResponseBody::fromMap($map['body']);
        }
