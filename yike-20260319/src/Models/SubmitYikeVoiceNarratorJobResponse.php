...
class SubmitYikeVoiceNarratorJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitYikeVoiceNarratorJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitYikeVoiceNarratorJobResponseBody::fromMap($map['body']);
        }
