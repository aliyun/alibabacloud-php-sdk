...
class SubmitVideoGenerationJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitVideoGenerationJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitVideoGenerationJobResponseBody::fromMap($map['body']);
        }
