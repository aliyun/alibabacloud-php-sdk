...
use AlibabaCloud\SDK\Yike\V20260319\Models\GetYikeProjectExportJobResponseBody\projectExportJob;

class GetYikeProjectExportJobResponseBody extends Model
{
    /**
