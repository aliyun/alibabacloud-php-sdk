...
class GetYikeVoiceNarratorJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetYikeVoiceNarratorJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetYikeVoiceNarratorJobResponseBody::fromMap($map['body']);
        }
