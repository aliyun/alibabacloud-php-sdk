...
class GenerateYikeLoginTokenResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GenerateYikeLoginTokenResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GenerateYikeLoginTokenResponseBody::fromMap($map['body']);
        }
