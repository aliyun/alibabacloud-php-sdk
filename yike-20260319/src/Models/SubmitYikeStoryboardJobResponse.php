...
class SubmitYikeStoryboardJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitYikeStoryboardJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitYikeStoryboardJobResponseBody::fromMap($map['body']);
        }
