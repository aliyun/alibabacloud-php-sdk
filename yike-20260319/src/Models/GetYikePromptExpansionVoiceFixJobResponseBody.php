...
use AlibabaCloud\SDK\Yike\V20260319\Models\GetYikePromptExpansionVoiceFixJobResponseBody\jobResult;

class GetYikePromptExpansionVoiceFixJobResponseBody extends Model
{
    /**
     * @var string
     */
