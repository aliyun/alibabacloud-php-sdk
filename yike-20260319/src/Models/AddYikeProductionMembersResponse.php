...
class AddYikeProductionMembersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AddYikeProductionMembersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AddYikeProductionMembersResponseBody::fromMap($map['body']);
        }
