...
class CreateYikeEditingProjectResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateYikeEditingProjectResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateYikeEditingProjectResponseBody::fromMap($map['body']);
        }
