...
class SubmitYikeVideoCloneJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitYikeVideoCloneJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitYikeVideoCloneJobResponseBody::fromMap($map['body']);
        }
