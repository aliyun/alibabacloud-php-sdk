...
use AlibabaCloud\SDK\QuanMiaoLightApp\V20240801\Models\GetFileContentRequest;
...
class QuanMiaoLightApp extends OpenApiClient
{
     ...
     *
     * @param string                $workspaceId
     * @param GetFileContentRequest $request
     * @param string[]              $headers
     * @param RuntimeOptions        $runtime
     *
     * @return GetFileContentResponse
     */
    public function getFileContentWithOptions($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        ...
        $params = new Params([
            ...
            'version' => '2024-08-01',
            'protocol' => 'HTTPS',
            'pathname' => '/' . Url::percentEncode($workspaceId) . '/quanmiao/lightapp/getFileContent',
            'method' => 'POST',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'formData',
        ...
        return GetFileContentResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetFileContentResponse
     */
    public function getFileContent($workspaceId, $request)
    {
        $runtime = new RuntimeOptions([]);
        $headers = [];
     ...
     */
    public function runEnterpriseVocAnalysisWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runHotTopicChatWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runHotTopicSummaryWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runMarketingInformationExtractWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runNetworkContentAuditWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runOcrParseWithSSE($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        if (null !== $request->fileKey) {
     ...
     */
    public function runScriptChatWithSSE($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        if (null !== $request->prompt) {
     ...
     */
    public function runScriptContinueWithSSE($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
     ...
     */
    public function runScriptPlanningWithSSE($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
     ...
     */
    public function runScriptRefineWithSSE($workspaceId, $request, $headers, $runtime)
    {
        $request->validate();
        $body = [];
        if (null !== $request->taskId) {
     ...
     */
    public function runStyleWritingWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runTagMiningAnalysisWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
     ...
     */
    public function runVideoAnalysisWithSSE($workspaceId, $tmpReq, $headers, $runtime)
    {
        $tmpReq->validate();
