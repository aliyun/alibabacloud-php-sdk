...
use AlibabaCloud\SDK\Cloudesl\V20200201\Models\DescribeTemplateByModelResponseBody\items;
use AlibabaCloud\Tea\Model;

class DescribeTemplateByModelResponseBody extends Model
{
    /**
     * @example -1001
     *
     ...
     * @param array $map
     *
     * @return DescribeTemplateByModelResponseBody
     */
