...
class UpdateKnowledgeBaseChunkResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateKnowledgeBaseChunkResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateKnowledgeBaseChunkResponseBody::fromMap($map['body']);
        }
