...
class CreateKnowledgeBaseJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateKnowledgeBaseJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateKnowledgeBaseJobResponseBody::fromMap($map['body']);
        }
