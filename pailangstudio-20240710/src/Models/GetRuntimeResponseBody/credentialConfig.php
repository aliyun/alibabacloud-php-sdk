...
namespace AlibabaCloud\SDK\PAILangStudio\V20240710\Models\GetRuntimeResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\PAILangStudio\V20240710\Models\GetRuntimeResponseBody\credentialConfig\credentialConfigItems;
        ...
        if (isset($map['CredentialConfigItems'])) {
            if (!empty($map['CredentialConfigItems'])) {
                ...
                foreach ($map['CredentialConfigItems'] as $item1) {
                    $model->credentialConfigItems[$n1] = credentialConfigItems::fromMap($item1);
                    ++$n1;
                }
            }
        }
