...
class DeleteKnowledgeBaseJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteKnowledgeBaseJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteKnowledgeBaseJobResponseBody::fromMap($map['body']);
        }
