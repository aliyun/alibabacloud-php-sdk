...
class ListKnowledgeBaseChunksResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListKnowledgeBaseChunksResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListKnowledgeBaseChunksResponseBody::fromMap($map['body']);
        }
