...
class UpdateKnowledgeBaseJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateKnowledgeBaseJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateKnowledgeBaseJobResponseBody::fromMap($map['body']);
        }
