...
namespace AlibabaCloud\SDK\Openanalyticsopen\V20180619\Models\GetEndPointByDomainResponse;
...
class endPointInfo extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('cloudInstanceID', $this->cloudInstanceID, true);
