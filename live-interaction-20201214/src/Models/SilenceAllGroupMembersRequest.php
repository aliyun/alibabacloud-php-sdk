...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\SilenceAllGroupMembersRequest\requestParams;
use AlibabaCloud\Tea\Model;

class SilenceAllGroupMembersRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return SilenceAllGroupMembersRequest
     */
