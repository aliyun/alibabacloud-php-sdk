...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\BindInterconnectionUidRequest\requestParams;
use AlibabaCloud\Tea\Model;

class BindInterconnectionUidRequest extends Model
{
    /**
     * @description AppId
     *
     ...
     * @param array $map
     *
     * @return BindInterconnectionUidRequest
     */
