...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\SetMessageExtensionByKeysRequest\requestParams;
use AlibabaCloud\Tea\Model;

class SetMessageExtensionByKeysRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return SetMessageExtensionByKeysRequest
     */
