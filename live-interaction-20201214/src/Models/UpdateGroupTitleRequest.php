...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\UpdateGroupTitleRequest\requestParams;
use AlibabaCloud\Tea\Model;

class UpdateGroupTitleRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return UpdateGroupTitleRequest
     */
