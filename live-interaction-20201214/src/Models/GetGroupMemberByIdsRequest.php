...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\GetGroupMemberByIdsRequest\requestParams;
use AlibabaCloud\Tea\Model;

class GetGroupMemberByIdsRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @param array $map
     *
     * @return GetGroupMemberByIdsRequest
     */
