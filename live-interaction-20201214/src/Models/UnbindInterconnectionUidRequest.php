...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\UnbindInterconnectionUidRequest\requestParams;
use AlibabaCloud\Tea\Model;

class UnbindInterconnectionUidRequest extends Model
{
    /**
     * @description AppId
     *
     ...
     * @param array $map
     *
     * @return UnbindInterconnectionUidRequest
     */
