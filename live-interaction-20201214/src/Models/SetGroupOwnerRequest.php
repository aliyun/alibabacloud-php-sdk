...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\SetGroupOwnerRequest\requestParams;
use AlibabaCloud\Tea\Model;

class SetGroupOwnerRequest extends Model
{
    /**
