...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\QueryInterconnectionCidMappingRequest\requestParams;
use AlibabaCloud\Tea\Model;

class QueryInterconnectionCidMappingRequest extends Model
{
    /**
     * @description AppId
     *
     ...
     * @param array $map
     *
     * @return QueryInterconnectionCidMappingRequest
     */
