...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\ListDetailReportStatisticsRequest\requestParams;
use AlibabaCloud\Tea\Model;

class ListDetailReportStatisticsRequest extends Model
{
    /**
     * @example aaa111
     *
     ...
     * @param array $map
     *
     * @return ListDetailReportStatisticsRequest
     */
