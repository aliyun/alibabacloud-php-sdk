...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\RemoveMessageExtensionByKeysRequest\requestParams;
use AlibabaCloud\Tea\Model;

class RemoveMessageExtensionByKeysRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return RemoveMessageExtensionByKeysRequest
     */
