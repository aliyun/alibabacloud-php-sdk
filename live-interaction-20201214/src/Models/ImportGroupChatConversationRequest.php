...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\ImportGroupChatConversationRequest\requestParams;
use AlibabaCloud\Tea\Model;

class ImportGroupChatConversationRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return ImportGroupChatConversationRequest
     */
