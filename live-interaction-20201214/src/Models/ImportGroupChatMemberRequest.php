...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\ImportGroupChatMemberRequest\requestParams;
use AlibabaCloud\Tea\Model;

class ImportGroupChatMemberRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return ImportGroupChatMemberRequest
     */
