...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\AddGroupSilenceBlacklistRequest\requestParams;
use AlibabaCloud\Tea\Model;

class AddGroupSilenceBlacklistRequest extends Model
{
    /**
     * @description AppId
     *
     ...
     * @param array $map
     *
     * @return AddGroupSilenceBlacklistRequest
     */
