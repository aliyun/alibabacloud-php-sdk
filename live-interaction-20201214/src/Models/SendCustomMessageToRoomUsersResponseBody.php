...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\SendCustomMessageToRoomUsersResponseBody\result;
use AlibabaCloud\Tea\Model;

class SendCustomMessageToRoomUsersResponseBody extends Model
{
    /**
     * @description 请求ID。
     *
     ...
     * @param array $map
     *
     * @return SendCustomMessageToRoomUsersResponseBody
     */
