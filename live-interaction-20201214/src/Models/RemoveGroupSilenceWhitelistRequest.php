...
use AlibabaCloud\SDK\Liveinteraction\V20201214\Models\RemoveGroupSilenceWhitelistRequest\requestParams;
use AlibabaCloud\Tea\Model;

class RemoveGroupSilenceWhitelistRequest extends Model
{
    /**
     * @example apitest
     *
     ...
     * @param array $map
     *
     * @return RemoveGroupSilenceWhitelistRequest
     */
