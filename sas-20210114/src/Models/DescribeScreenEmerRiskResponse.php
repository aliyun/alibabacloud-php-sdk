...
class DescribeScreenEmerRiskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeScreenEmerRiskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeScreenEmerRiskResponseBody::fromMap($map['body']);
        }
