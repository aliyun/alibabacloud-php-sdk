...
class DescribeScreenCloudHcRiskResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeScreenCloudHcRiskResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeScreenCloudHcRiskResponseBody::fromMap($map['body']);
        }
