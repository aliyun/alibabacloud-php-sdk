...
class DescribeScreenSummaryInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeScreenSummaryInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeScreenSummaryInfoResponseBody::fromMap($map['body']);
        }
