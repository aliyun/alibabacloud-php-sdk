...
class rules extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->bindEdgeDnsClusters) {
            ...
            if (null !== $this->bindEdgeDnsClusters && \is_array($this->bindEdgeDnsClusters)) {
                $n = 0;
                foreach ($this->bindEdgeDnsClusters as $item) {
                    $res['BindEdgeDnsClusters'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['BindEdgeDnsClusters'])) {
            if (!empty($map['BindEdgeDnsClusters'])) {
                ...
                $n = 0;
                foreach ($map['BindEdgeDnsClusters'] as $item) {
                    $model->bindEdgeDnsClusters[$n++] = null !== $item ? bindEdgeDnsClusters::fromMap($item) : $item;
                }
            }
        }
