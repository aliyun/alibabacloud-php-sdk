...
use AlibabaCloud\SDK\Pvtz\V20180101\Models\DescribePvtzStatisticsSummaryResponseBody\pageData;

class DescribePvtzStatisticsSummaryResponseBody extends Model
{
    /**
     * @var int
     */
