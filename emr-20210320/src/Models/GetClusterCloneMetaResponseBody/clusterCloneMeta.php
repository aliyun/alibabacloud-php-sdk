...
class clusterCloneMeta extends Model
{
    ...
    /**
     * @description The cluster applications.
     *
     * @var Application[]
     */
    public $applications;
    ...
    /**
     * @description An array of bootstrap scripts. The number of elements in the array: 1 to 10.
     *
     * @var Script[]
     */
    ...
    /**
     * @description Indicates whether release protection is enabled for the cluster. Valid values:
     *
    ...
    /**
     * @description The node groups. The number of elements in the array: 1 to 100.
     *
     * @var NodeGroup[]
     */
    public $nodeGroups;
