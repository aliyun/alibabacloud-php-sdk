...
use AlibabaCloud\SDK\Emr\V20210320\Models\CreateNodeGroupConfig\spotBidPrices;

class CreateNodeGroupConfig extends Model
{
    /**
     * @var string[]
     */
        ...
        if (isset($map['SpotBidPrices'])) {
            if (!empty($map['SpotBidPrices'])) {
                ...
                foreach ($map['SpotBidPrices'] as $item1) {
                    $model->spotBidPrices[$n1] = spotBidPrices::fromMap($item1);
                    ++$n1;
                }
            }
        }
