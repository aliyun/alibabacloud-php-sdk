...
class coupon extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->productCodes) {
            $this->productCodes->validate();
        }
        if (null !== $this->tradeTypes) {
            $this->tradeTypes->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->productCodes) {
            $res['ProductCodes'] = null !== $this->productCodes ? $this->productCodes->toArray($noStream) : $this->productCodes;
        }
        ...
        if (null !== $this->tradeTypes) {
            $res['TradeTypes'] = null !== $this->tradeTypes ? $this->tradeTypes->toArray($noStream) : $this->tradeTypes;
        }
