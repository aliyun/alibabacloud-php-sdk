...
class QueryBatchTaskDetailListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryBatchTaskDetailListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryBatchTaskDetailListResponseBody::fromMap($map['body']);
        }
