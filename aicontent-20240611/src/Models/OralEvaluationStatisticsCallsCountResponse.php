...
use AlibabaCloud\SDK\AiContent\V20240611\Models\OralEvaluationStatisticsCallsCountResponse\projectData;

class OralEvaluationStatisticsCallsCountResponse extends Model
{
    /**
     * @var projectData
     */
