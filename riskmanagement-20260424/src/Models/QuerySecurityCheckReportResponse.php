...
class QuerySecurityCheckReportResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QuerySecurityCheckReportResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QuerySecurityCheckReportResponseBody::fromMap($map['body']);
        }
