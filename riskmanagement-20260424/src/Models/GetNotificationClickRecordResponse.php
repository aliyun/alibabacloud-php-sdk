...
class GetNotificationClickRecordResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetNotificationClickRecordResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetNotificationClickRecordResponseBody::fromMap($map['body']);
        }
