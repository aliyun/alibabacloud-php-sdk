...
class GetServiceLinkedRoleStatusResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetServiceLinkedRoleStatusResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetServiceLinkedRoleStatusResponseBody::fromMap($map['body']);
        }
