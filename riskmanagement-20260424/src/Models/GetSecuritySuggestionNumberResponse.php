...
class GetSecuritySuggestionNumberResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSecuritySuggestionNumberResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSecuritySuggestionNumberResponseBody::fromMap($map['body']);
        }
