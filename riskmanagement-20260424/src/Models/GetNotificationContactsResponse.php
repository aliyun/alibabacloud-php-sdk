...
class GetNotificationContactsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetNotificationContactsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetNotificationContactsResponseBody::fromMap($map['body']);
        }
