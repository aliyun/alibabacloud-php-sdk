...
class GetAliYunSafeCenterResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAliYunSafeCenterResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAliYunSafeCenterResultResponseBody::fromMap($map['body']);
        }
