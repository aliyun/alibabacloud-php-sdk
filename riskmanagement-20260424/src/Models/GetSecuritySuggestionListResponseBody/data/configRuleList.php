...
namespace AlibabaCloud\SDK\RiskManagement\V20260424\Models\GetSecuritySuggestionListResponseBody\data;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\RiskManagement\V20260424\Models\GetSecuritySuggestionListResponseBody\data\configRuleList\complianceObject;
use AlibabaCloud\SDK\RiskManagement\V20260424\Models\GetSecuritySuggestionListResponseBody\data\configRuleList\createBy;
use AlibabaCloud\SDK\RiskManagement\V20260424\Models\GetSecuritySuggestionListResponseBody\data\configRuleList\tags;
...
class configRuleList extends Model
{
    ...
    {
        if (null !== $this->complianceObject) {
            $this->complianceObject->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->compliance) {
            $res['Compliance'] = $this->compliance;
        }

        if (null !== $this->complianceObject) {
            $res['ComplianceObject'] = null !== $this->complianceObject ? $this->complianceObject->toArray($noStream) : $this->complianceObject;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Compliance'])) {
            $model->compliance = $map['Compliance'];
        }

        if (isset($map['ComplianceObject'])) {
            $model->complianceObject = complianceObject::fromMap($map['ComplianceObject']);
        }
