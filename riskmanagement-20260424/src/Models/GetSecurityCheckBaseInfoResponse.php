...
class GetSecurityCheckBaseInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSecurityCheckBaseInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSecurityCheckBaseInfoResponseBody::fromMap($map['body']);
        }
