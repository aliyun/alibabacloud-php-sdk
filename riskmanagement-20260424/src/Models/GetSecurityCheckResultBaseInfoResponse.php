...
class GetSecurityCheckResultBaseInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSecurityCheckResultBaseInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSecurityCheckResultBaseInfoResponseBody::fromMap($map['body']);
        }
