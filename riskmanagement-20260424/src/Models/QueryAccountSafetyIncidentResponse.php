...
class QueryAccountSafetyIncidentResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryAccountSafetyIncidentResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryAccountSafetyIncidentResponseBody::fromMap($map['body']);
        }
