...
class GetAlertRecordAnalysisResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAlertRecordAnalysisResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAlertRecordAnalysisResultResponseBody::fromMap($map['body']);
        }
