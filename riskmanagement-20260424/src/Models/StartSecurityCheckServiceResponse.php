...
class StartSecurityCheckServiceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var StartSecurityCheckServiceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = StartSecurityCheckServiceResponseBody::fromMap($map['body']);
        }
