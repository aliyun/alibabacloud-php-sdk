...
class GetSecuritySuggestionListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetSecuritySuggestionListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetSecuritySuggestionListResponseBody::fromMap($map['body']);
        }
