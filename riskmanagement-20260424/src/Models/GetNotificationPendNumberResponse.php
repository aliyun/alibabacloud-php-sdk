...
class GetNotificationPendNumberResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetNotificationPendNumberResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetNotificationPendNumberResponseBody::fromMap($map['body']);
        }
