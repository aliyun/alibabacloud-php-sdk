...
class GetResourceControlEventResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetResourceControlEventResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetResourceControlEventResponseBody::fromMap($map['body']);
        }
