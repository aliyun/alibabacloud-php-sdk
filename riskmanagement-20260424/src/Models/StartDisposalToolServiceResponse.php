...
class StartDisposalToolServiceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var StartDisposalToolServiceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = StartDisposalToolServiceResponseBody::fromMap($map['body']);
        }
