...
class DownloadResourceControlEventsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DownloadResourceControlEventsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DownloadResourceControlEventsResponseBody::fromMap($map['body']);
        }
