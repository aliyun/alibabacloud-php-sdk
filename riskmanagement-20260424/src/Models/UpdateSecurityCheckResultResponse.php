...
class UpdateSecurityCheckResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateSecurityCheckResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateSecurityCheckResultResponseBody::fromMap($map['body']);
        }
