...
use AlibabaCloud\SDK\ResourceSharing\V20200110\Models\AssociateResourceShareResponse\resourceShareAssociations;
use AlibabaCloud\Tea\Model;

class AssociateResourceShareResponse extends Model
{
    /**
     * @var string
     */
