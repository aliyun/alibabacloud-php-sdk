...
use AlibabaCloud\SDK\Appstreamcenter\V20210901\Models\ListAppsByAppInstanceGroupIdResponseBody\apps;

class ListAppsByAppInstanceGroupIdResponseBody extends Model
{
    /**
     * @var apps[]
     */
