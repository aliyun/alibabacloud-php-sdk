...
use AlibabaCloud\SDK\Appstreamcenter\V20210901\Models\ListAuthorizedAppsByUserResponseBody\apps;

class ListAuthorizedAppsByUserResponseBody extends Model
{
    /**
     * @var apps[]
     */
