...
{
    /**
     * @description The image ID of the app. You can obtain the ID from the Images page in the App Streaming console.
     *
    ...
    /**
     * @description The name of the delivery groups to query. Fuzzy match is used for queries. For example, if you set this parameter to `Office App`, all delivery groups whose names contain `Office App` are queried, such as `My Office Apps` and `Office App A`.
     *
     * @var string
     */
    ...
    /**
     * @example cn-hongkong+dir-643067****
     *
     * @var string
     */
    public $officeSiteId;
    ...
    /**
     * @description The status of the delivery groups.
     *
     * @var string[]
     */
    public $status;
