...
use AlibabaCloud\SDK\Appstreamcenter\V20210901\Models\ListPublishedAppInstanceGroupResponseBody\appInstanceGroupModels;

class ListPublishedAppInstanceGroupResponseBody extends Model
{
    /**
