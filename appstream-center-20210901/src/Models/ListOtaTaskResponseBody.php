...
use AlibabaCloud\SDK\Appstreamcenter\V20210901\Models\ListOtaTaskResponseBody\taskList;
...
class ListOtaTaskResponseBody extends Model
{
    ...
    /**
     * @description The OTA update tasks.
     *
     * @var taskList[]
     */
    public $taskList;
    ...
    /**
     * @description The total number of OTA update tasks.
     *
     * @example 6
     *
     * @var int
     ...
     * @param array $map
     *
     * @return ListOtaTaskResponseBody
     */
