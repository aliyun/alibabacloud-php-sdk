...
class ApproveOtaTaskResponseBody extends Model
{
    /**
    ...
    /**
     * @description The error message. If the value of `Code` is `success`, this parameter is not returned.
     *
     ...
     * @param array $map
     *
     * @return ApproveOtaTaskResponseBody
     */
