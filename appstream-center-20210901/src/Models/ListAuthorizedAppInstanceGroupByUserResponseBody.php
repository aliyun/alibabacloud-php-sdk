...
use AlibabaCloud\SDK\Appstreamcenter\V20210901\Models\ListAuthorizedAppInstanceGroupByUserResponseBody\appInstanceGroupModels;

class ListAuthorizedAppInstanceGroupByUserResponseBody extends Model
{
    /**
