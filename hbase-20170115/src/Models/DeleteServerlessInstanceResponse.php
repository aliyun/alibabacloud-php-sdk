...
class DeleteServerlessInstanceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteServerlessInstanceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteServerlessInstanceResponseBody::fromMap($map['body']);
        }
