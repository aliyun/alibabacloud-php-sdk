...
class DescribeClusterConnectAddrsResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->serviceConnAddrs) {
            $this->serviceConnAddrs->validate();
        }
        if (null !== $this->slbConnAddrs) {
            $this->slbConnAddrs->validate();
        }
        if (null !== $this->thriftConn) {
            $this->thriftConn->validate();
        }
        if (null !== $this->uiProxyConnAddrInfo) {
            $this->uiProxyConnAddrInfo->validate();
        }
        if (null !== $this->zkConnAddrs) {
            $this->zkConnAddrs->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->serviceConnAddrs) {
            $res['ServiceConnAddrs'] = null !== $this->serviceConnAddrs ? $this->serviceConnAddrs->toArray($noStream) : $this->serviceConnAddrs;
        }

        if (null !== $this->slbConnAddrs) {
            $res['SlbConnAddrs'] = null !== $this->slbConnAddrs ? $this->slbConnAddrs->toArray($noStream) : $this->slbConnAddrs;
        }

        if (null !== $this->thriftConn) {
            $res['ThriftConn'] = null !== $this->thriftConn ? $this->thriftConn->toArray($noStream) : $this->thriftConn;
        }

        if (null !== $this->uiProxyConnAddrInfo) {
            $res['UiProxyConnAddrInfo'] = null !== $this->uiProxyConnAddrInfo ? $this->uiProxyConnAddrInfo->toArray($noStream) : $this->uiProxyConnAddrInfo;
        }
        ...
        if (null !== $this->zkConnAddrs) {
            $res['ZkConnAddrs'] = null !== $this->zkConnAddrs ? $this->zkConnAddrs->toArray($noStream) : $this->zkConnAddrs;
        }
