...
class DescribeClusterAttributeResponseBody extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->connectionInfo) {
            $res['ConnectionInfo'] = null !== $this->connectionInfo ? $this->connectionInfo->toArray($noStream) : $this->connectionInfo;
        }
        ...
        if (null !== $this->netInfo) {
            $res['NetInfo'] = null !== $this->netInfo ? $this->netInfo->toArray($noStream) : $this->netInfo;
        }
