...
class QueryStaticsAvailabilityResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryStaticsAvailabilityResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryStaticsAvailabilityResponseBody::fromMap($map['body']);
        }
