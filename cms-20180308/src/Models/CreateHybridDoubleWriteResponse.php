...
class CreateHybridDoubleWriteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateHybridDoubleWriteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateHybridDoubleWriteResponseBody::fromMap($map['body']);
        }
