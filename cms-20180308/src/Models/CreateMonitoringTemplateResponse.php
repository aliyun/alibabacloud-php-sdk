...
class CreateMonitoringTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateMonitoringTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateMonitoringTemplateResponseBody::fromMap($map['body']);
        }
