...
class DeleteMyGroupInstancesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteMyGroupInstancesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteMyGroupInstancesResponseBody::fromMap($map['body']);
        }
