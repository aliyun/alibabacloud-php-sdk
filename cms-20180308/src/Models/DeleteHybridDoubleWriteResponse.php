...
class DeleteHybridDoubleWriteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteHybridDoubleWriteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteHybridDoubleWriteResponseBody::fromMap($map['body']);
        }
