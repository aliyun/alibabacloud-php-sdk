...
class UpdateMonitoringTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateMonitoringTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateMonitoringTemplateResponseBody::fromMap($map['body']);
        }
