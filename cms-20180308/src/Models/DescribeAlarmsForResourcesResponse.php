...
class DescribeAlarmsForResourcesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeAlarmsForResourcesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeAlarmsForResourcesResponseBody::fromMap($map['body']);
        }
