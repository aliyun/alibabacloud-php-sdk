...
class DescribeHybridDoubleWriteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeHybridDoubleWriteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeHybridDoubleWriteResponseBody::fromMap($map['body']);
        }
