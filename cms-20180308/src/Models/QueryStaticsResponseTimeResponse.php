...
class QueryStaticsResponseTimeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryStaticsResponseTimeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryStaticsResponseTimeResponseBody::fromMap($map['body']);
        }
