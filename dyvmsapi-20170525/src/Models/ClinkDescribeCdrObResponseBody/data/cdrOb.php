...
namespace AlibabaCloud\SDK\Dyvmsapi\V20170525\Models\ClinkDescribeCdrObResponseBody\data;
...
class cdrOb extends Model
{
    ...
    {
        if (\is_array($this->investigation)) {
            Model::validateArray($this->investigation);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->investigation) {
            if (\is_array($this->investigation)) {
                $res['Investigation'] = [];
                foreach ($this->investigation as $key1 => $value1) {
                    $res['Investigation'][$key1] = $value1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Investigation'])) {
            if (!empty($map['Investigation'])) {
                $model->investigation = [];
                foreach ($map['Investigation'] as $key1 => $value1) {
                    $model->investigation[$key1] = $value1;
                }
            }
        }
