...
use AlibabaCloud\SDK\Dyvmsapi\V20170525\Models\ClinkCreateClientRequest\clidArea;
use AlibabaCloud\SDK\Dyvmsapi\V20170525\Models\ClinkCreateClientRequest\permission;

class ClinkCreateClientRequest extends Model
{
    /**
     * @var int
     */
