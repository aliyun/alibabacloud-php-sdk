...
class AddVirtualNumberRelationResponseBody extends Model
{
    /**
    ...
    /**
     * @description The numbers that failed to be associated.
     *
     ...
     * @param array $map
     *
     * @return AddVirtualNumberRelationResponseBody
     */
