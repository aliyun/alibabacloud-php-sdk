...
class GetYzdInstanceTaskResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetYzdInstanceTaskResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetYzdInstanceTaskResultResponseBody::fromMap($map['body']);
        }
