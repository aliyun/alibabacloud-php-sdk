...
namespace AlibabaCloud\SDK\Nlscloudmeta\V20180518;

use AlibabaCloud\Dara\Models\RuntimeOptions;
use AlibabaCloud\SDK\Nlscloudmeta\V20180518\Models\CreateTokenResponse;
...
class Nlscloudmeta extends OpenApiClient
{
     ...
     */
    public function createTokenWithOptions($headers, $runtime)
    {
        ...
        $params = new Params([
            ...
            'version' => '2018-05-18',
            'protocol' => 'HTTPS',
            'pathname' => '/pop/2018-05-18/tokens',
            'method' => 'POST',
            'authType' => 'AK',
            'style' => 'ROA',
            'reqBodyType' => 'json',
    ...
    public function createToken()
    {
        ...
        return $this->createTokenWithOptions($headers, $runtime);
    }
}
