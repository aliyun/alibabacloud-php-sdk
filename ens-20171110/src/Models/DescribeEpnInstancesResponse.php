...
use AlibabaCloud\SDK\Ens\V20171110\Models\DescribeEpnInstancesResponse\EPNInstances;
use AlibabaCloud\Tea\Model;

class DescribeEpnInstancesResponse extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        Model::validateRequired('EPNInstances', $this->EPNInstances, true);
    }
