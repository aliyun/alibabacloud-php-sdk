...
use AlibabaCloud\SDK\Ens\V20171110\Models\CreateClusterNodePoolRequest\scalingGroup\dataDisks;
...
class scalingGroup extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->desiredSize) {
            $res['DesiredSize'] = $this->desiredSize;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DesiredSize'])) {
            $model->desiredSize = $map['DesiredSize'];
        }
