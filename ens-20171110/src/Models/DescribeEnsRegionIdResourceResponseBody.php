...
class DescribeEnsRegionIdResourceResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->ensRegionIdResources) {
            $this->ensRegionIdResources->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->ensRegionIdResources) {
            $res['EnsRegionIdResources'] = null !== $this->ensRegionIdResources ? $this->ensRegionIdResources->toArray($noStream) : $this->ensRegionIdResources;
        }
