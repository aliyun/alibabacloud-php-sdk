...
class DescribeNetworkInterfacesShrinkRequest extends Model
{
    /**
    ...
    public function toMap()
    {
        ...
        if (null !== $this->ipv6AddressShrink) {
            $res['Ipv6Address'] = $this->ipv6AddressShrink;
        }
     ...
     * @param array $map
     *
     * @return DescribeNetworkInterfacesShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Ipv6Address'])) {
            $model->ipv6AddressShrink = $map['Ipv6Address'];
        }
