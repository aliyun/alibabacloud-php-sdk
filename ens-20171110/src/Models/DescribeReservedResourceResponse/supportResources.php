...
namespace AlibabaCloud\SDK\Ens\V20171110\Models\DescribeReservedResourceResponse;

use AlibabaCloud\SDK\Ens\V20171110\Models\DescribeReservedResourceResponse\supportResources\supportResource;
...
class supportResources extends Model
{
    ...
    {
        Model::validateRequired('supportResource', $this->supportResource, true);
    }
