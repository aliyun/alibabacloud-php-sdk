...
class DisassociateSourceServersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DisassociateSourceServersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DisassociateSourceServersResponseBody::fromMap($map['body']);
        }
