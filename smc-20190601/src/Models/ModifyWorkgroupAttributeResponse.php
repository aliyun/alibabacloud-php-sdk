...
class ModifyWorkgroupAttributeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ModifyWorkgroupAttributeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ModifyWorkgroupAttributeResponseBody::fromMap($map['body']);
        }
