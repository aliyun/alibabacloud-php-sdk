...
class AssociateSourceServersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AssociateSourceServersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AssociateSourceServersResponseBody::fromMap($map['body']);
        }
