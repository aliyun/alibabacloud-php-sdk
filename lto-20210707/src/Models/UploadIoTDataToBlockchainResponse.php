...
class UploadIoTDataToBlockchainResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UploadIoTDataToBlockchainResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UploadIoTDataToBlockchainResponseBody::fromMap($map['body']);
        }
