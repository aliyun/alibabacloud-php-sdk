...
class ListBaaSFabricOrganizationResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBaaSFabricOrganizationResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBaaSFabricOrganizationResponseBody::fromMap($map['body']);
        }
