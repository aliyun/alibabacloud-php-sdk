...
class ListBaaSAntChainConsortiumResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBaaSAntChainConsortiumResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBaaSAntChainConsortiumResponseBody::fromMap($map['body']);
        }
