...
namespace AlibabaCloud\SDK\Lto\V20210707\Models\ListEdgeDeviceGroupResponseBody\data;
...
class pageData extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->edgeName) {
            $res['EdgeName'] = $this->edgeName;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['EdgeName'])) {
            $model->edgeName = $map['EdgeName'];
        }
