...
class ListMemberAccessRecordResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListMemberAccessRecordResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListMemberAccessRecordResponseBody::fromMap($map['body']);
        }
