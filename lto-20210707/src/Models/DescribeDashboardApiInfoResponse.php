...
class DescribeDashboardApiInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeDashboardApiInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeDashboardApiInfoResponseBody::fromMap($map['body']);
        }
