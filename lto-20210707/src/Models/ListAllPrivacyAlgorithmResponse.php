...
class ListAllPrivacyAlgorithmResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListAllPrivacyAlgorithmResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListAllPrivacyAlgorithmResponseBody::fromMap($map['body']);
        }
