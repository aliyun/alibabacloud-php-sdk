...
class AuthorizeMemberBizChainResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AuthorizeMemberBizChainResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AuthorizeMemberBizChainResponseBody::fromMap($map['body']);
        }
