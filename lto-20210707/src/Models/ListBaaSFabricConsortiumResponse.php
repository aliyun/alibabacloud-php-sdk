...
class ListBaaSFabricConsortiumResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListBaaSFabricConsortiumResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListBaaSFabricConsortiumResponseBody::fromMap($map['body']);
        }
