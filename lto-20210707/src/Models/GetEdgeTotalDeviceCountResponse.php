...
class GetEdgeTotalDeviceCountResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetEdgeTotalDeviceCountResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetEdgeTotalDeviceCountResponseBody::fromMap($map['body']);
        }
