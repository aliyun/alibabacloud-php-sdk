...
class AddBaaSAntChainBizChainResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AddBaaSAntChainBizChainResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AddBaaSAntChainBizChainResponseBody::fromMap($map['body']);
        }
