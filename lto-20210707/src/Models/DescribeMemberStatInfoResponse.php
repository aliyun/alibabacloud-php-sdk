...
class DescribeMemberStatInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeMemberStatInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeMemberStatInfoResponseBody::fromMap($map['body']);
        }
