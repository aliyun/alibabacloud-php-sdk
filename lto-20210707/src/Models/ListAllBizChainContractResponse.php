...
class ListAllBizChainContractResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListAllBizChainContractResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListAllBizChainContractResponseBody::fromMap($map['body']);
        }
