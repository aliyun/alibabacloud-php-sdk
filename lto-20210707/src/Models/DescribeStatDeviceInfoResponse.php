...
class DescribeStatDeviceInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeStatDeviceInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeStatDeviceInfoResponseBody::fromMap($map['body']);
        }
