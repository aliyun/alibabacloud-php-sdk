...
class DescribeBizChainStatInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeBizChainStatInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeBizChainStatInfoResponseBody::fromMap($map['body']);
        }
