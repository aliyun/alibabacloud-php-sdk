...
class QueryBlockchainMetadataResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryBlockchainMetadataResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryBlockchainMetadataResponseBody::fromMap($map['body']);
        }
