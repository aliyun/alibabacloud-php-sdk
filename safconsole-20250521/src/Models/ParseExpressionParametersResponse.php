...
class ParseExpressionParametersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ParseExpressionParametersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ParseExpressionParametersResponseBody::fromMap($map['body']);
        }
