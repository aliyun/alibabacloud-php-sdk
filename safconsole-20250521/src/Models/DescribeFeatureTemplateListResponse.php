...
class DescribeFeatureTemplateListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeFeatureTemplateListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeFeatureTemplateListResponseBody::fromMap($map['body']);
        }
