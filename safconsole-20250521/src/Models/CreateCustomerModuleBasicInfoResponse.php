...
class CreateCustomerModuleBasicInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateCustomerModuleBasicInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateCustomerModuleBasicInfoResponseBody::fromMap($map['body']);
        }
