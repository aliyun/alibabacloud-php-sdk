...
class DescribeServiceAndSceneResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeServiceAndSceneResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeServiceAndSceneResponseBody::fromMap($map['body']);
        }
