...
class DescribeFileDownloadUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeFileDownloadUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeFileDownloadUrlResponseBody::fromMap($map['body']);
        }
