...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\ParseExpressionParametersResponseBody\resultObject;

class ParseExpressionParametersResponseBody extends Model
{
    /**
     * @var int
     */
