...
class DescribeModelingProjectListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeModelingProjectListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeModelingProjectListResponseBody::fromMap($map['body']);
        }
