...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeModelingProjectDetailResponseBody\resultObject;

class DescribeModelingProjectDetailResponseBody extends Model
{
    /**
     * @var int
     */
