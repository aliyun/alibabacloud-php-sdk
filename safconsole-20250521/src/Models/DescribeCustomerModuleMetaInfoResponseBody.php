...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeCustomerModuleMetaInfoResponseBody\resultObject;

class DescribeCustomerModuleMetaInfoResponseBody extends Model
{
    /**
     * @var int
     */
