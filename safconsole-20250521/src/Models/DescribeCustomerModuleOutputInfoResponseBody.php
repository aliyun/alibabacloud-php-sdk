...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeCustomerModuleOutputInfoResponseBody\resultObject;

class DescribeCustomerModuleOutputInfoResponseBody extends Model
{
    /**
     * @var int
     */
