...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeFeatureTemplateListResponseBody\resultObject;

class DescribeFeatureTemplateListResponseBody extends Model
{
    /**
     * @var string
     */
