...
class DescribeModuleServiceExistResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeModuleServiceExistResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeModuleServiceExistResponseBody::fromMap($map['body']);
        }
