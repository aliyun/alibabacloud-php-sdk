...
class DescribeModelingProjectDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeModelingProjectDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeModelingProjectDetailResponseBody::fromMap($map['body']);
        }
