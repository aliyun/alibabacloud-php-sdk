...
class CreateCustomerModuleMetaInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateCustomerModuleMetaInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateCustomerModuleMetaInfoResponseBody::fromMap($map['body']);
        }
