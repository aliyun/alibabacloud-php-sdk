...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeModelingProjectListResponseBody\resultObject;

class DescribeModelingProjectListResponseBody extends Model
{
    /**
     * @var int
     */
