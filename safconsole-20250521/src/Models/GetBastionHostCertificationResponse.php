...
class GetBastionHostCertificationResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetBastionHostCertificationResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetBastionHostCertificationResponseBody::fromMap($map['body']);
        }
