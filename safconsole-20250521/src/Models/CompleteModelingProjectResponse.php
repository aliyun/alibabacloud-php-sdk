...
class CompleteModelingProjectResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CompleteModelingProjectResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CompleteModelingProjectResponseBody::fromMap($map['body']);
        }
