...
use AlibabaCloud\SDK\Safconsole\V20250521\Models\DescribeCustomerModuleBasicInfoResponseBody\resultObject;

class DescribeCustomerModuleBasicInfoResponseBody extends Model
{
    /**
     * @var string
     */
