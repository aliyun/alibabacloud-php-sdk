...
use AlibabaCloud\SDK\Eiamdeveloperapi\V20220225\Models\ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody\jwtContent;

class ObtainJwtAuthenticationTokenByDerivedShortTokenResponseBody extends Model
{
    /**
     * @var string
     */
