...
use AlibabaCloud\SDK\Eiamdeveloperapi\V20220225\Models\ObtainJwtAuthenticationTokenResponseBody\jwtContent;

class ObtainJwtAuthenticationTokenResponseBody extends Model
{
    /**
     * @var string
     */
