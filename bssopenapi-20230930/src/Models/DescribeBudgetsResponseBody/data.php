...
namespace AlibabaCloud\SDK\BssOpenApi\V20230930\Models\DescribeBudgetsResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\BssOpenApi\V20230930\Models\DescribeBudgetsResponseBody\data\cycleQuota;
use AlibabaCloud\SDK\BssOpenApi\V20230930\Models\DescribeBudgetsResponseBody\data\ecIdAccountIdsFilter;
use AlibabaCloud\SDK\BssOpenApi\V20230930\Models\DescribeBudgetsResponseBody\data\queryFilter;
use AlibabaCloud\SDK\BssOpenApi\V20230930\Models\DescribeBudgetsResponseBody\data\warnConfs;
...
class data extends Model
{
    ...
    /**
     * @var ecIdAccountIdsFilter
     */
    public $ecIdAccountIdsFilter;
    ...
    public function validate()
    {
        ...
        if (null !== $this->ecIdAccountIdsFilter) {
            $this->ecIdAccountIdsFilter->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->ecIdAccountIdsFilter) {
            $res['EcIdAccountIdsFilter'] = null !== $this->ecIdAccountIdsFilter ? $this->ecIdAccountIdsFilter->toArray($noStream) : $this->ecIdAccountIdsFilter;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['EcIdAccountIdsFilter'])) {
            $model->ecIdAccountIdsFilter = ecIdAccountIdsFilter::fromMap($map['EcIdAccountIdsFilter']);
        }
