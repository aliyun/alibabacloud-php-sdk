...
use AlibabaCloud\SDK\BssOpenApi\V20230930\Models\CheckAccountExistRequest\ecIdAccountIds;

class CheckAccountExistRequest extends Model
{
    /**
     * @var ecIdAccountIds[]
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->toUserType) {
            $res['ToUserType'] = $this->toUserType;
        }

        if (null !== $this->transferAccount) {
            $res['TransferAccount'] = $this->transferAccount;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ToUserType'])) {
            $model->toUserType = $map['ToUserType'];
        }

        if (isset($map['TransferAccount'])) {
            $model->transferAccount = $map['TransferAccount'];
        }
