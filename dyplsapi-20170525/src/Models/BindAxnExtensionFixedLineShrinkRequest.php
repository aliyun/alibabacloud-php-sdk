...
class BindAxnExtensionFixedLineShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->extraaxxShrink) {
            $res['Extraaxx'] = $this->extraaxxShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Extraaxx'])) {
            $model->extraaxxShrink = $map['Extraaxx'];
        }
