...
use AlibabaCloud\SDK\Dyplsapi\V20170525\Models\UpdateAxnExtensionBindFixedLineRequest\extraaxx;

class UpdateAxnExtensionBindFixedLineRequest extends Model
{
    /**
     * @var string
     */
