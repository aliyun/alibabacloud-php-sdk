...
class DescribeMultiZoneClusterResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->multiZoneInstanceModels) {
            $this->multiZoneInstanceModels->validate();
        }
        if (null !== $this->tags) {
            $this->tags->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->multiZoneInstanceModels) {
            $res['MultiZoneInstanceModels'] = null !== $this->multiZoneInstanceModels ? $this->multiZoneInstanceModels->toArray($noStream) : $this->multiZoneInstanceModels;
        }
