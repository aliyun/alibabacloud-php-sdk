...
class AppliedNearRealStatShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $appliedVersionIdShrink;
    ...
    {
        $res = [];
        if (null !== $this->appliedVersionIdShrink) {
            $res['AppliedVersionId'] = $this->appliedVersionIdShrink;
        }
     ...
     * @param array $map
     *
     * @return AppliedNearRealStatShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['AppliedVersionId'])) {
            $model->appliedVersionIdShrink = $map['AppliedVersionId'];
        }
