...
use AlibabaCloud\SDK\CGCS\V20211111\Models\ReportUploadResultRequest\fileFingerprintDTOList;
use AlibabaCloud\Tea\Model;

class ReportUploadResultRequest extends Model
{
    /**
     * @description 应用ID
     *
     ...
     * @param array $map
     *
     * @return ReportUploadResultRequest
     */
