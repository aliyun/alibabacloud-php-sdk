...
class instances extends Model
{
    ...
    /**
     * @description The description of the anti-DDoS diversion instance.
     *
    ...
    /**
     * @description The mode that is used to enable traffic rerouting to the anti-DDoS diversion instance. Valid values:
     *
