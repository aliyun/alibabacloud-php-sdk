...
use AlibabaCloud\SDK\ResourceDirectoryMaster\V20220419\Models\ListAuthorizedFoldersResponseBody\folders;

class ListAuthorizedFoldersResponseBody extends Model
{
    /**
     * @var folders
     */
