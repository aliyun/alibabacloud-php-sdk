...
class CreateAgentSpecVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateAgentSpecVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateAgentSpecVersionResponseBody::fromMap($map['body']);
        }
