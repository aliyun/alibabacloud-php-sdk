...
class InstallWorkspacePluginResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var InstallWorkspacePluginResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = InstallWorkspacePluginResponseBody::fromMap($map['body']);
        }
