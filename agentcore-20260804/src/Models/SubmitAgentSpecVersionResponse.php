...
class SubmitAgentSpecVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitAgentSpecVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitAgentSpecVersionResponseBody::fromMap($map['body']);
        }
