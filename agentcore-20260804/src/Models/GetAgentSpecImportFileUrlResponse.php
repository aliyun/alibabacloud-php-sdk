...
class GetAgentSpecImportFileUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAgentSpecImportFileUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAgentSpecImportFileUrlResponseBody::fromMap($map['body']);
        }
