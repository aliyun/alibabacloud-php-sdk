...
class DownloadAgentSpecViaOssResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DownloadAgentSpecViaOssResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DownloadAgentSpecViaOssResponseBody::fromMap($map['body']);
        }
