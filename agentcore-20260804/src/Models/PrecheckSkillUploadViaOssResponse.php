...
class PrecheckSkillUploadViaOssResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PrecheckSkillUploadViaOssResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PrecheckSkillUploadViaOssResponseBody::fromMap($map['body']);
        }
