...
class BatchUploadSkillsViaOssResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var BatchUploadSkillsViaOssResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = BatchUploadSkillsViaOssResponseBody::fromMap($map['body']);
        }
