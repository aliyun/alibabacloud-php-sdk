...
class GetServiceEndpointApiKeyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetServiceEndpointApiKeyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetServiceEndpointApiKeyResponseBody::fromMap($map['body']);
        }
