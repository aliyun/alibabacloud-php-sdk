...
class ListPredefinedModelProvidersResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListPredefinedModelProvidersResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListPredefinedModelProvidersResponseBody::fromMap($map['body']);
        }
