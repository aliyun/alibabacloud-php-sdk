...
class DeleteAgentSpecVersionResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteAgentSpecVersionResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteAgentSpecVersionResponseBody::fromMap($map['body']);
        }
