...
use AlibabaCloud\SDK\Cloudauthintl\V20220809\Models\DeepfakeDetectIntlStreamResponseBody\resultObject;

class DeepfakeDetectIntlStreamResponseBody extends Model
{
    /**
     * @var string
     */
