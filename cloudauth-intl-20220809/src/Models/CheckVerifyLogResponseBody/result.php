...
class result extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->logInfoEn)) {
            Model::validateArray($this->logInfoEn);
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->interruptPageEn) {
            $res['InterruptPageEn'] = $this->interruptPageEn;
        }
        ...
        if (null !== $this->logInfoEn) {
            if (\is_array($this->logInfoEn)) {
                $res['LogInfoEn'] = [];
                $n1 = 0;
                foreach ($this->logInfoEn as $item1) {
                    $res['LogInfoEn'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['InterruptPageEn'])) {
            $model->interruptPageEn = $map['InterruptPageEn'];
        }
        ...
        if (isset($map['LogInfoEn'])) {
            if (!empty($map['LogInfoEn'])) {
                $model->logInfoEn = [];
                $n1 = 0;
                foreach ($map['LogInfoEn'] as $item1) {
                    $model->logInfoEn[$n1] = $item1;
                    ++$n1;
                }
            }
        }
