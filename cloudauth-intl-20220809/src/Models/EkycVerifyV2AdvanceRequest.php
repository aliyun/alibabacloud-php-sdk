...
class EkycVerifyV2AdvanceRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->facePictureFileObject) {
            $res['FacePictureFile'] = $this->facePictureFileObject;
        }
        ...
        if (null !== $this->idOcrPictureFileObject) {
            $res['IdOcrPictureFile'] = $this->idOcrPictureFileObject;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['FacePictureFile'])) {
            $model->facePictureFileObject = $map['FacePictureFile'];
        }
        ...
        if (isset($map['IdOcrPictureFile'])) {
            $model->idOcrPictureFileObject = $map['IdOcrPictureFile'];
        }
