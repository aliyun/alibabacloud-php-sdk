...
class FaceVerifyIntlRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->sourceFacePictureFile) {
            $res['SourceFacePictureFile'] = $this->sourceFacePictureFile;
        }
        ...
        if (null !== $this->targetFacePictureFile) {
            $res['TargetFacePictureFile'] = $this->targetFacePictureFile;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SourceFacePictureFile'])) {
            $model->sourceFacePictureFile = $map['SourceFacePictureFile'];
        }
        ...
        if (isset($map['TargetFacePictureFile'])) {
            $model->targetFacePictureFile = $map['TargetFacePictureFile'];
        }
