...
use AlibabaCloud\SDK\Ocr\V20191230\Models\RecognizeVietnamIdentityCardResponseBody\data\originPlaceFirstLine\keyPoints;
use AlibabaCloud\Tea\Model;

class originPlaceFirstLine extends Model
{
    /**
     * @var keyPoints[]
     */
