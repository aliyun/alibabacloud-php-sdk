...
use AlibabaCloud\SDK\Ocr\V20191230\Models\RecognizeVietnamIdentityCardResponseBody\data\originPlaceSecondLine\keyPoints;
use AlibabaCloud\Tea\Model;

class originPlaceSecondLine extends Model
{
    /**
     * @var keyPoints[]
     */
