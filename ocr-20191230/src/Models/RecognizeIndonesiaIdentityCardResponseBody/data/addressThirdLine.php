...
use AlibabaCloud\SDK\Ocr\V20191230\Models\RecognizeIndonesiaIdentityCardResponseBody\data\addressThirdLine\keyPoints;
use AlibabaCloud\Tea\Model;

class addressThirdLine extends Model
{
    /**
     * @var keyPoints[]
     */
