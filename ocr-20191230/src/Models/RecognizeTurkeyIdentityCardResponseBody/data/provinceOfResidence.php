...
use AlibabaCloud\SDK\Ocr\V20191230\Models\RecognizeTurkeyIdentityCardResponseBody\data\provinceOfResidence\keyPoints;
use AlibabaCloud\Tea\Model;

class provinceOfResidence extends Model
{
    /**
     * @var keyPoints[]
     */
