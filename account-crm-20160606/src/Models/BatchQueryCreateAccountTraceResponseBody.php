...
use AlibabaCloud\SDK\Accountcrm\V20160606\Models\BatchQueryCreateAccountTraceResponseBody\traces;

class BatchQueryCreateAccountTraceResponseBody extends Model
{
    /**
     * @var string
     */
