...
use AlibabaCloud\SDK\Accountcrm\V20160606\Models\QueryAccountAddressInfoResponseBody\profileInfo;

class QueryAccountAddressInfoResponseBody extends Model
{
    /**
     * @var string
     */
