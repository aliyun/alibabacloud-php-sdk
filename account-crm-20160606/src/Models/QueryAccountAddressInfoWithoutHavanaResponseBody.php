...
use AlibabaCloud\SDK\Accountcrm\V20160606\Models\QueryAccountAddressInfoWithoutHavanaResponseBody\profileInfo;

class QueryAccountAddressInfoWithoutHavanaResponseBody extends Model
{
    /**
     * @var string
     */
