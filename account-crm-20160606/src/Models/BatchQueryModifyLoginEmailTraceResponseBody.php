...
use AlibabaCloud\SDK\Accountcrm\V20160606\Models\BatchQueryModifyLoginEmailTraceResponseBody\traces;

class BatchQueryModifyLoginEmailTraceResponseBody extends Model
{
    /**
     * @var string
     */
