...
class CreateTransitUploadPolicyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateTransitUploadPolicyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateTransitUploadPolicyResponseBody::fromMap($map['body']);
        }
