...
class UpdateMmAppAndBindingShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->memoryConfigShrink) {
            $res['MemoryConfig'] = $this->memoryConfigShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['MemoryConfig'])) {
            $model->memoryConfigShrink = $map['MemoryConfig'];
        }
