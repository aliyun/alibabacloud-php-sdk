...
class InterruptForArbitrationResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var InterruptForArbitrationResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = InterruptForArbitrationResponseBody::fromMap($map['body']);
        }
