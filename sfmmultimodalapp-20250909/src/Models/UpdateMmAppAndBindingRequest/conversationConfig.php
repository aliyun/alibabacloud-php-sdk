...
class conversationConfig extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->stopOrRejectFlag) {
            $res['StopOrRejectFlag'] = $this->stopOrRejectFlag;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['StopOrRejectFlag'])) {
            $model->stopOrRejectFlag = $map['StopOrRejectFlag'];
        }
