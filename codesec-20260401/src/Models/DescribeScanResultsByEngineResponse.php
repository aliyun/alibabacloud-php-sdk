...
class DescribeScanResultsByEngineResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeScanResultsByEngineResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeScanResultsByEngineResponseBody::fromMap($map['body']);
        }
