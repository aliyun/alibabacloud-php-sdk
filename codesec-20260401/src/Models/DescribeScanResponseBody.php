...
use AlibabaCloud\SDK\CodeSec\V20260401\Models\DescribeScanResponseBody\engineSnapshot;
use AlibabaCloud\SDK\CodeSec\V20260401\Models\DescribeScanResponseBody\scanMetrics;

class DescribeScanResponseBody extends Model
{
    /**
     * @var int
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->securityCredits) {
            $res['securityCredits'] = $this->securityCredits;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['securityCredits'])) {
            $model->securityCredits = $map['securityCredits'];
        }
