...
class GetProfileListRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->profileIdList) {
            $res['ProfileIdList'] = $this->profileIdList;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ProfileIdList'])) {
            $model->profileIdList = $map['ProfileIdList'];
        }
