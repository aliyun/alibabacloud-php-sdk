...
class QueryQwenConferenceSgTicketPopResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryQwenConferenceSgTicketPopResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryQwenConferenceSgTicketPopResponseBody::fromMap($map['body']);
        }
