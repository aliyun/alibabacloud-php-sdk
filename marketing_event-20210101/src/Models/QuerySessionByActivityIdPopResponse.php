...
class QuerySessionByActivityIdPopResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QuerySessionByActivityIdPopResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QuerySessionByActivityIdPopResponseBody::fromMap($map['body']);
        }
