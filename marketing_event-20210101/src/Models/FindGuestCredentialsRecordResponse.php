...
class FindGuestCredentialsRecordResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var FindGuestCredentialsRecordResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = FindGuestCredentialsRecordResponseBody::fromMap($map['body']);
        }
