...
class AddAgendaSumRecordFlowPopResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AddAgendaSumRecordFlowPopResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AddAgendaSumRecordFlowPopResponseBody::fromMap($map['body']);
        }
