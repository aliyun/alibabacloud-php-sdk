...
class TicketOrCredentialsSignInPopResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var TicketOrCredentialsSignInPopResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = TicketOrCredentialsSignInPopResponseBody::fromMap($map['body']);
        }
