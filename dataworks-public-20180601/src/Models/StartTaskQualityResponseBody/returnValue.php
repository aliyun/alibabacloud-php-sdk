...
namespace AlibabaCloud\SDK\Dataworkspublic\V20180601\Models\StartTaskQualityResponseBody;

use AlibabaCloud\SDK\Dataworkspublic\V20180601\Models\StartTaskQualityResponseBody\returnValue\strongMethodSet;
use AlibabaCloud\SDK\Dataworkspublic\V20180601\Models\StartTaskQualityResponseBody\returnValue\weakMethodSet;
...
class returnValue extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->statisticsFlag) {
            $res['StatisticsFlag'] = $this->statisticsFlag;
        }
        ...
        if (null !== $this->triggerFlag) {
            $res['TriggerFlag'] = $this->triggerFlag;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['StatisticsFlag'])) {
            $model->statisticsFlag = $map['StatisticsFlag'];
        }
        ...
        if (isset($map['TriggerFlag'])) {
            $model->triggerFlag = $map['TriggerFlag'];
        }
