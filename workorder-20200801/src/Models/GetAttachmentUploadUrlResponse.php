...
class GetAttachmentUploadUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetAttachmentUploadUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetAttachmentUploadUrlResponseBody::fromMap($map['body']);
        }
