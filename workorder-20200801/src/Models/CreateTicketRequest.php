...
class CreateTicketRequest extends Model
{
    ...
    {
        $res = [];
        if (null !== $this->commonQuestionId) {
            $res['CommonQuestionId'] = $this->commonQuestionId;
        }
    ...
    {
        $model = new self();
        if (isset($map['CommonQuestionId'])) {
            $model->commonQuestionId = $map['CommonQuestionId'];
        }
