...
class aiJobLogInfo extends Model
{
    ...
    /**
     * @description The end time. The value is in the timestamp format. Unit: seconds.
     *
    ...
    /**
     * @description The start time. The value is in the timestamp format. Unit: seconds.
     *
     * >  This timestamp must indicate a point in time that is accurate to the minute.
     *
