...
class diagnosticResults extends Model
{
    ...
    /**
     * @description Diagnosis content. For example, in network diagnosis, there are static configuration checks, dynamic operation checks, etc.
     *
     * @example diagcontent
     *
     * @var string
    ...
    /**
     * @description Diagnosis result, success or failure.
     *
     * @example Success
     *
     * @var string
