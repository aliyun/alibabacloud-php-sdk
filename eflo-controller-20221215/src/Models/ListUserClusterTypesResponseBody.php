...
{
    /**
     * @description List of cluster types. The number of array elements N ranges from 1 to 100.
     *
     * @var clusterTypes[]
     */
    public $clusterTypes;
    ...
    /**
     * @description The NextToken for the next page. Include this value when requesting the next page.
     *
