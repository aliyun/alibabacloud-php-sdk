...
class DescribeEmbodiedAIPlatformsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeEmbodiedAIPlatformsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeEmbodiedAIPlatformsResponseBody::fromMap($map['body']);
        }
