...
class CreateEmbodiedAIPlatformResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateEmbodiedAIPlatformResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateEmbodiedAIPlatformResponseBody::fromMap($map['body']);
        }
