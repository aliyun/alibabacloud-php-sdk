...
class UnlockEmbodiedAIPlatformResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UnlockEmbodiedAIPlatformResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UnlockEmbodiedAIPlatformResponseBody::fromMap($map['body']);
        }
