...
class DeleteEmbodiedAIPlatformResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteEmbodiedAIPlatformResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteEmbodiedAIPlatformResponseBody::fromMap($map['body']);
        }
