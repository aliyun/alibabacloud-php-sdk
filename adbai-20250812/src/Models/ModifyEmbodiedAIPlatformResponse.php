...
class ModifyEmbodiedAIPlatformResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ModifyEmbodiedAIPlatformResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ModifyEmbodiedAIPlatformResponseBody::fromMap($map['body']);
        }
