...
class LockEmbodiedAIPlatformResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var LockEmbodiedAIPlatformResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = LockEmbodiedAIPlatformResponseBody::fromMap($map['body']);
        }
