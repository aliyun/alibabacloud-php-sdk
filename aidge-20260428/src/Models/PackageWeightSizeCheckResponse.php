...
class PackageWeightSizeCheckResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PackageWeightSizeCheckResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PackageWeightSizeCheckResponseBody::fromMap($map['body']);
        }
