...
class ImageTranslationStandardResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ImageTranslationStandardResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ImageTranslationStandardResponseBody::fromMap($map['body']);
        }
