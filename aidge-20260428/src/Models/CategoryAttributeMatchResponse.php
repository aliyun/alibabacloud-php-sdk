...
class CategoryAttributeMatchResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CategoryAttributeMatchResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CategoryAttributeMatchResponseBody::fromMap($map['body']);
        }
