...
namespace AlibabaCloud\SDK\Cloudsso\V20210515\Models\ProvisionAccessConfigurationResponseBody;
...
class tasks extends Model
{
    ...
    /**
     * @description The type of the task object. The value is fixed as RD-Account, which indicates an account your resource directory.
     *
     * @example RD-Account
     *
     * @var string
    ...
    /**
     * @description The type of the task. The value is fixed as ProvisionAccessConfiguration, which indicates that an access configuration is provisioned.
     *
