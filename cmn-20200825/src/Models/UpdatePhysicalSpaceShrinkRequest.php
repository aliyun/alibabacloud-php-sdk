...
class UpdatePhysicalSpaceShrinkRequest extends Model
{
    /**
     * @example 文一西路969号
     *
    ...
    /**
     * @example space-twnepee1234xxxxx
     *
     * @var string
     */
    public $targetUid;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->moveAction) {
            $res['MoveAction'] = $this->moveAction;
        }
        if (null !== $this->owner) {
     ...
     * @param array $map
     *
     * @return UpdatePhysicalSpaceShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['MoveAction'])) {
            $model->moveAction = $map['MoveAction'];
        }
        if (isset($map['Owner'])) {
