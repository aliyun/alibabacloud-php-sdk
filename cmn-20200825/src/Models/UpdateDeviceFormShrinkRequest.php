...
class UpdateDeviceFormShrinkRequest extends Model
{
    /**
    ...
    public function toMap()
    {
        ...
        if (null !== $this->attributeListShrink) {
            $res['AttributeList'] = $this->attributeListShrink;
        }
     ...
     * @param array $map
     *
     * @return UpdateDeviceFormShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AttributeList'])) {
            $model->attributeListShrink = $map['AttributeList'];
        }
