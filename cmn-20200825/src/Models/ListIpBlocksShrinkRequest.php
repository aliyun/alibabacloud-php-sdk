...
class ListIpBlocksShrinkRequest extends Model
{
    /**
     * @example false
     *
    ...
    protected $_name = [
        ...
        'category'            => 'Category',
        'extAttributesShrink' => 'ExtAttributes',
    ...
    public function toMap()
    {
        ...
        if (null !== $this->extAttributesShrink) {
            $res['ExtAttributes'] = $this->extAttributesShrink;
        }
     ...
     * @param array $map
     *
     * @return ListIpBlocksShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ExtAttributes'])) {
            $model->extAttributesShrink = $map['ExtAttributes'];
        }
