...
class CreateMonitorItemShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $alarmRuleListShrink;
    ...
    public $type;
    protected $_name = [
        'alarmRuleListShrink'    => 'AlarmRuleList',
    ...
    {
        $res = [];
        if (null !== $this->alarmRuleListShrink) {
            $res['AlarmRuleList'] = $this->alarmRuleListShrink;
        }
     ...
     * @param array $map
     *
     * @return CreateMonitorItemShrinkRequest
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['AlarmRuleList'])) {
            $model->alarmRuleListShrink = $map['AlarmRuleList'];
        }
