...
class SetInstanceRecordConfigResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SetInstanceRecordConfigResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SetInstanceRecordConfigResponseBody::fromMap($map['body']);
        }
