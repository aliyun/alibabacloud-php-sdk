...
class OpenDatasetResourceUrlResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var OpenDatasetResourceUrlResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = OpenDatasetResourceUrlResponseBody::fromMap($map['body']);
        }
