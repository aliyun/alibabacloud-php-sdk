...
class ApplyNodesRequest extends Model
{
    ...
    /**
     * @description The type of the resource to be added. Valid values:
     *
    ...
    /**
     * @description The performance level of the ESSD used as the system disk. Valid values:
     *
    ...
    /**
     * @description The number of the resource that you want to add. The specific number depends on the value of the ResourceAmountType parameter:
     *
