...
class imageInfo extends Model
{
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->baseOsTag) {
            $res['BaseOsTag'] = null !== $this->baseOsTag ? $this->baseOsTag->toArray($noStream) : $this->baseOsTag;
        }
        ...
        if (null !== $this->osTag) {
            $res['OsTag'] = null !== $this->osTag ? $this->osTag->toArray($noStream) : $this->osTag;
        }
