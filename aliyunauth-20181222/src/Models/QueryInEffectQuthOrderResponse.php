...
class QueryInEffectQuthOrderResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryInEffectQuthOrderResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryInEffectQuthOrderResponseBody::fromMap($map['body']);
        }
