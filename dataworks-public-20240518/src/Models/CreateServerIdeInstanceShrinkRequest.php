...
class CreateServerIdeInstanceShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->userCommandShrink) {
            $res['UserCommand'] = $this->userCommandShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['UserCommand'])) {
            $model->userCommandShrink = $map['UserCommand'];
        }
