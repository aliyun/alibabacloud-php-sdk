...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\GetAgentSessionTokenUsageResponseBody\jsonRpcResponse;

class GetAgentSessionTokenUsageResponseBody extends Model
{
    /**
     * @var jsonRpcResponse
     */
