...
class GetFileRequest extends Model
{
    ...
    /**
     * @description The ID of the node that is scheduled. You can call the [ListFiles](https://help.aliyun.com/document_detail/173942.html) operation to query the ID.
     *
     * @example 200000001
     *
     * @var int
