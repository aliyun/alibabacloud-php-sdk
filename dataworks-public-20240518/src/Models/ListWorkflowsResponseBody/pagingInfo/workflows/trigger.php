...
class trigger extends Model
{
    ...
    /**
     * @description The running mode of the workflow after it is triggered. This parameter takes effect only if the Type parameter is set to Scheduler. Valid values:
     *
     *   Pause
     *   Skip
     *   Normal
