...
namespace AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListCustomAttributesResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\CustomAttribute;
        ...
        if (isset($map['CustomAttributes'])) {
            if (!empty($map['CustomAttributes'])) {
                ...
                foreach ($map['CustomAttributes'] as $item1) {
                    $model->customAttributes[$n1] = CustomAttribute::fromMap($item1);
                    ++$n1;
                }
            }
        }
