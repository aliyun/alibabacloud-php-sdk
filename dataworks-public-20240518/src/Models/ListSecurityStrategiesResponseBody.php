...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListSecurityStrategiesResponseBody\pagingInfo;

class ListSecurityStrategiesResponseBody extends Model
{
    /**
     * @var pagingInfo
     */
