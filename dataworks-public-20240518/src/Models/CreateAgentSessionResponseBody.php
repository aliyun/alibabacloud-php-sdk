...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\CreateAgentSessionResponseBody\jsonRpcResponse;

class CreateAgentSessionResponseBody extends Model
{
    /**
     * @var jsonRpcResponse
     */
