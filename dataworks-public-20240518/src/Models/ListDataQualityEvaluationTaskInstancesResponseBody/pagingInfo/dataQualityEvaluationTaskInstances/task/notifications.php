        ...
        if (isset($map['Notifications'])) {
            if (!empty($map['Notifications'])) {
                ...
                foreach ($map['Notifications'] as $item1) {
                    $model->notifications[$n1++] = \AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListDataQualityEvaluationTaskInstancesResponseBody\pagingInfo\dataQualityEvaluationTaskInstances\task\notifications\notifications::fromMap($item1);
                }
            }
        }
