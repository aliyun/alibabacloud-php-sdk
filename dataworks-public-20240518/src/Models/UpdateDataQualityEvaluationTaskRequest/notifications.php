...
class notifications extends Model
{
     ...
     *
     * @var \AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\UpdateDataQualityEvaluationTaskRequest\notifications\notifications[]
     */
        ...
        if (isset($map['Notifications'])) {
            if (!empty($map['Notifications'])) {
                ...
                foreach ($map['Notifications'] as $item) {
                    $model->notifications[$n++] = null !== $item ? \AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\UpdateDataQualityEvaluationTaskRequest\notifications\notifications::fromMap($item) : $item;
                }
            }
        }
