...
class BatchUpdateTasksResponseBody extends Model
{
    /**
    ...
    /**
     * @description The result of the batch operation, which is in the MAP structure. The task ID serves as a key, and the result serves as a value.
     *
     ...
     * @param array $map
     *
     * @return BatchUpdateTasksResponseBody
     */
