        ...
        if (isset($map['Notifications'])) {
            if (!empty($map['Notifications'])) {
                ...
                foreach ($map['Notifications'] as $item1) {
                    $model->notifications[$n1++] = \AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListDataQualityEvaluationTasksResponseBody\pagingInfo\dataQualityEvaluationTasks\notifications\notifications::fromMap($item1);
                }
            }
        }
