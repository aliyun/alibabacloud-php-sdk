        ...
        if (isset($map['Notifications'])) {
            if (!empty($map['Notifications'])) {
                ...
                foreach ($map['Notifications'] as $item) {
                    $model->notifications[$n++] = null !== $item ? \AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListDataQualityEvaluationTasksResponseBody\pagingInfo\dataQualityEvaluationTasks\notifications\notifications::fromMap($item) : $item;
                }
            }
        }
