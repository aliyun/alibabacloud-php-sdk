...
class taskInstances extends Model
{
    ...
    /**
     * @description The environment of the workspace. This parameter is deprecated and replaced by the EnvType parameter. Valid values:
     *
    ...
    /**
     * @description The method to trigger instance scheduling.
     *
     * Valid values:
     *
