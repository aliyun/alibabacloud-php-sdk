...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListTaskOperationLogsResponseBody\pagingInfo;
use AlibabaCloud\Tea\Model;

class ListTaskOperationLogsResponseBody extends Model
{
    /**
     * @var pagingInfo
     */
     ...
     * @param array $map
     *
     * @return ListTaskOperationLogsResponseBody
     */
