...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListAgentSessionArtifactsResponseBody\jsonRpcResponse;

class ListAgentSessionArtifactsResponseBody extends Model
{
    /**
     * @var jsonRpcResponse
     */
