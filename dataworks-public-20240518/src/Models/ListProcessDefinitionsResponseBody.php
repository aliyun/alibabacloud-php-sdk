...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListProcessDefinitionsResponseBody\pagingInfo;

class ListProcessDefinitionsResponseBody extends Model
{
    /**
     * @var pagingInfo
     */
