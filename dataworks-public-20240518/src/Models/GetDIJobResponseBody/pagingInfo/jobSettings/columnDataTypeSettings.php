...
class columnDataTypeSettings extends Model
{
    ...
    /**
     * @description The data type of the source field. Valid values: bigint, boolean, string, text, datetime, timestamp, decimal, and binary. Different types of data sources support different data types.
     *
     * @example bigint
     *
     * @var string
