...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\UpdateDIJobRequest\tableMappings\sourceObjectSelectionRules;
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\UpdateDIJobRequest\tableMappings\transformationRules;
...
class tableMappings extends Model
{
    ...
    /**
     * @description The list of transformation rules that you want to apply to the synchronization objects selected from the source. Each entry in the list defines a transformation rule.
     *
