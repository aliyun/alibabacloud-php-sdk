...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\ListServerIdeInstancesResponseBody\pagingInfo;

class ListServerIdeInstancesResponseBody extends Model
{
    /**
     * @var int
     */
