...
{
    /**
     * @description The time when the data quality check result was generated.
     *
    ...
    /**
     * @description The information about the data quality check.
     *
     * @var details[]
     */
    public $details;
    ...
    /**
     * @description The sample values used for the check.
     *
     * @example [
     * {
     * "gender": "male",
