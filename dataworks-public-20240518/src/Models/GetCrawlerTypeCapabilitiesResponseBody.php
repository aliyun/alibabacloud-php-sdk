...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\GetCrawlerTypeCapabilitiesResponseBody\crawlerTypes;

class GetCrawlerTypeCapabilitiesResponseBody extends Model
{
    /**
     * @var crawlerTypes[]
     */
        ...
        if (isset($map['CrawlerTypes'])) {
            if (!empty($map['CrawlerTypes'])) {
                ...
                foreach ($map['CrawlerTypes'] as $item1) {
                    $model->crawlerTypes[$n1] = crawlerTypes::fromMap($item1);
                    ++$n1;
                }
            }
        }
