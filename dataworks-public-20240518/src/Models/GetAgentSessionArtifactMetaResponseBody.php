...
use AlibabaCloud\SDK\Dataworkspublic\V20240518\Models\GetAgentSessionArtifactMetaResponseBody\jsonRpcResponse;

class GetAgentSessionArtifactMetaResponseBody extends Model
{
    /**
     * @var jsonRpcResponse
     */
