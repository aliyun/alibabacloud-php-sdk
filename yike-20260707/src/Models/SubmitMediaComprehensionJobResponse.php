...
class SubmitMediaComprehensionJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SubmitMediaComprehensionJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SubmitMediaComprehensionJobResponseBody::fromMap($map['body']);
        }
