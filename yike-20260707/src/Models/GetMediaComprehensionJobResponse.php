...
class GetMediaComprehensionJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetMediaComprehensionJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetMediaComprehensionJobResponseBody::fromMap($map['body']);
        }
