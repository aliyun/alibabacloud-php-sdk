...
class GetVideoTranslationJobResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetVideoTranslationJobResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetVideoTranslationJobResponseBody::fromMap($map['body']);
        }
