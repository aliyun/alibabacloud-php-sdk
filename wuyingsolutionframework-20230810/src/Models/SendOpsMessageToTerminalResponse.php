...
class SendOpsMessageToTerminalResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SendOpsMessageToTerminalResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SendOpsMessageToTerminalResponseBody::fromMap($map['body']);
        }
