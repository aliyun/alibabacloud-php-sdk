...
namespace AlibabaCloud\SDK\Cloudsiem\V20220616\Models\BatchJobCheckResponseBody\data\errTaskList\productList;
...
class logList extends Model
{
    ...
    /**
     * @description The pattern of SLS log store name.
     *
     * @example vpc_logstore_test
     *
     * @var string
     */
