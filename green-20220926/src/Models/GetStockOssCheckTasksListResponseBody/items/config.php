...
use AlibabaCloud\SDK\Green\V20220926\Models\GetStockOssCheckTasksListResponseBody\items\config\userFreezeConfig;
...
class config extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->userFreezeConfig) {
            $res['UserFreezeConfig'] = null !== $this->userFreezeConfig ? $this->userFreezeConfig->toMap() : null;
        }
