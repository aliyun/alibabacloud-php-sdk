...
namespace AlibabaCloud\SDK\Green\V20220926\Models\GetAiAppStatsResponseBody;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Green\V20220926\Models\DataTotalStatValue;
use AlibabaCloud\SDK\Green\V20220926\Models\GetAiAppStatsResponseBody\data\labelStatChart;
use AlibabaCloud\SDK\Green\V20220926\Models\GetAiAppStatsResponseBody\data\y;
        ...
        if (null !== $this->totalStat) {
            if (\is_array($this->totalStat)) {
                ...
                foreach ($this->totalStat as $key1 => $value1) {
                    $res['TotalStat'][$key1] = null !== $value1 ? $value1->toArray($noStream) : $value1;
                }
            }
        }
        ...
        if (isset($map['TotalStat'])) {
            if (!empty($map['TotalStat'])) {
                ...
                foreach ($map['TotalStat'] as $key1 => $value1) {
                    $model->totalStat[$key1] = DataTotalStatValue::fromMap($value1);
                }
            }
        }
