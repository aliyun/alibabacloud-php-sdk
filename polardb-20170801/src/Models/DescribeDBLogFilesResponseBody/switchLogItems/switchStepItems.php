...
namespace AlibabaCloud\SDK\Polardb\V20170801\Models\DescribeDBLogFilesResponseBody\switchLogItems;
...
class switchStepItems extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->stepMsg) {
            $res['StepMsg'] = $this->stepMsg;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['StepMsg'])) {
            $model->stepMsg = $map['StepMsg'];
        }
