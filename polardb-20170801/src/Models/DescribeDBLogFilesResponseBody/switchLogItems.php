...
use AlibabaCloud\SDK\Polardb\V20170801\Models\DescribeDBLogFilesResponseBody\switchLogItems\switchStepItems;
...
class switchLogItems extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->simulatecode) {
            $res['Simulatecode'] = $this->simulatecode;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Simulatecode'])) {
            $model->simulatecode = $map['Simulatecode'];
        }
