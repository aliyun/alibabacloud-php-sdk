...
namespace AlibabaCloud\SDK\Polardb\V20170801\Models\CreatePolarClawCronJobRequest;
...
class schedule extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->staggerMs) {
            $res['StaggerMs'] = $this->staggerMs;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['StaggerMs'])) {
            $model->staggerMs = $map['StaggerMs'];
        }
