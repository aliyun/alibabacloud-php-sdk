...
use AlibabaCloud\SDK\Polardb\V20170801\Models\DescribeAIDBClusterTaskMetricsResponseBody\items;

class DescribeAIDBClusterTaskMetricsResponseBody extends Model
{
    /**
     * @var string
     */
