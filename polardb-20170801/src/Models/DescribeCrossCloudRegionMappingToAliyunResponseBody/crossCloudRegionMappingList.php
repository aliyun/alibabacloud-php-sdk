...
namespace AlibabaCloud\SDK\Polardb\V20170801\Models\DescribeCrossCloudRegionMappingToAliyunResponseBody;

use AlibabaCloud\Dara\Model;

class crossCloudRegionMappingList extends Model
{
    /**
     * @var string
     */
