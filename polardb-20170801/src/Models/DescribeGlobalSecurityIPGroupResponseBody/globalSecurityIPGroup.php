...
namespace AlibabaCloud\SDK\Polardb\V20170801\Models\DescribeGlobalSecurityIPGroupResponseBody;
...
{
    /**
     * @description The details of the clusters that are associated with the global IP address whitelist template.
     *
     * @var string[]
     */
    public $DBInstances;
