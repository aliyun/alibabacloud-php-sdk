...
class ModifyEncryptionDBRolePrivilegeRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->rolePrivilegeConfig) {
            $res['RolePrivilegeConfig'] = $this->rolePrivilegeConfig;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['RolePrivilegeConfig'])) {
            $model->rolePrivilegeConfig = $map['RolePrivilegeConfig'];
        }
