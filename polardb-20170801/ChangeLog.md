2026-09-17 Version: 8.4.1
- Update API CreateKBSyncLink: add request parameters UserAccessToken.
- Update API DescribeKnowledgeBaseAnswer: add response parameters Body.Sources.$.ImageResources.
- Update API DescribeKnowledgeBaseFileShards: add response parameters Body.Shards.$.Captions.
- Update API DescribeKnowledgeBaseFileShards: add response parameters Body.Shards.$.DocItems.
- Update API DescribeKnowledgeBaseFileShards: add response parameters Body.Shards.$.ImageResources.
- Update API ModifyAIDBClusterModel: add request parameters RestartMode.
- Update API ModifyAIDBClusterModel: add request parameters WorkerBatchSize.
- Update API UpdateKBSyncLink: add request parameters UserAccessToken.
...
2026-09-09 Version: 8.2.4
- Update API CreateApplication: add request parameters AgenticDBBranchSpec.
- Update API CreateApplication: add request parameters Storages.
...
- Support API DescribeAIDBClusterApiKeys.
...
- Support API DescribePolarClawTask.
- Support API ListPolarClawDevicePairs.
- Support API LoginPolarClawChannel.
- Support API RejectPolarClawDevicePair.
- Support API RemovePolarClawDevicePair.
- Update API DescribeBackupPolicy: add response parameters Body.AdvancedDataPolicies.$.StorageClass.
- Update API ModifyBackupPolicy: add request parameters AdvancedDataPolicies.$.StorageClass.


2026-05-09 Version: 6.20.0
- Support API CreateBatchTask.
- Support API DescribeBatchTask.
- Support API DescribeBatchTasks.


2026-05-08 Version: 6.19.1
...
2026-04-30 Version: 6.19.0
- Support API CreateAIDBCluster.


2026-04-29 Version: 6.18.0
...
2026-04-22 Version: 6.14.0
- Support API DescribeApplicationLogs.


2026-04-20 Version: 6.13.0
...
- Update API DescribeApplicationAttribute: add response parameters Body.MinorVersion.
