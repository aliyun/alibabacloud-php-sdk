...
class EnterpriseAccountSeparateEaResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseAccountSeparateEaResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseAccountSeparateEaResponseBody::fromMap($map['body']);
        }
