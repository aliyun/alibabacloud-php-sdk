...
class EnterpriseOrgCreateNodeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseOrgCreateNodeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseOrgCreateNodeResponseBody::fromMap($map['body']);
        }
