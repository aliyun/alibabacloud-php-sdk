...
class EnterpriseRoleDeleteBizRoleResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseRoleDeleteBizRoleResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseRoleDeleteBizRoleResponseBody::fromMap($map['body']);
        }
