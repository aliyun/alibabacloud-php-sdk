...
class EnterpriseOrgQueryLoadTreeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseOrgQueryLoadTreeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseOrgQueryLoadTreeResponseBody::fromMap($map['body']);
        }
