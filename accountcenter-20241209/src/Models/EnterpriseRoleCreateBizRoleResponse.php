...
class EnterpriseRoleCreateBizRoleResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseRoleCreateBizRoleResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseRoleCreateBizRoleResponseBody::fromMap($map['body']);
        }
