...
class EnterpriseAccountUpdateAccountBizRoleGrantRequest extends Model
{
    /**
     * @var string
     */
    public $bizRoleCodeListJson;
    ...
    {
        $res = [];
        if (null !== $this->bizRoleCodeListJson) {
            $res['BizRoleCodeListJson'] = $this->bizRoleCodeListJson;
        }
    ...
    {
        $model = new self();
        if (isset($map['BizRoleCodeListJson'])) {
            $model->bizRoleCodeListJson = $map['BizRoleCodeListJson'];
        }
