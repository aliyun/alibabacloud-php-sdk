...
class EnterpriseOrgDeleteNodeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseOrgDeleteNodeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseOrgDeleteNodeResponseBody::fromMap($map['body']);
        }
