...
class AccountContactQueryDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AccountContactQueryDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AccountContactQueryDetailResponseBody::fromMap($map['body']);
        }
