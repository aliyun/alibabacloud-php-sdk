...
class EnterpriseTodoDealAccountTodoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseTodoDealAccountTodoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseTodoDealAccountTodoResponseBody::fromMap($map['body']);
        }
