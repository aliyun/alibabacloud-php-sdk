...
class EnterpriseRegisterAccountResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseRegisterAccountResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseRegisterAccountResponseBody::fromMap($map['body']);
        }
