...
class EnterpriseContactDeleteResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseContactDeleteResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseContactDeleteResponseBody::fromMap($map['body']);
        }
