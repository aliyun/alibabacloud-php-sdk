...
class EnterpriseContactQueryPageListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseContactQueryPageListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseContactQueryPageListResponseBody::fromMap($map['body']);
        }
