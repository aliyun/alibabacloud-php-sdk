...
class EnterpriseContactQueryDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseContactQueryDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseContactQueryDetailResponseBody::fromMap($map['body']);
        }
