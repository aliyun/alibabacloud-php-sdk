...
class EnterpriseAccountUpdateIpMaskRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->ipMasksJson) {
            $res['IpMasksJson'] = $this->ipMasksJson;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IpMasksJson'])) {
            $model->ipMasksJson = $map['IpMasksJson'];
        }
