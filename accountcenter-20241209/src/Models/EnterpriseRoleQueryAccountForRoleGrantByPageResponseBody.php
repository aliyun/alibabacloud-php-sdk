...
use AlibabaCloud\SDK\AccountCenter\V20241209\Models\EnterpriseRoleQueryAccountForRoleGrantByPageResponseBody\accounts;

class EnterpriseRoleQueryAccountForRoleGrantByPageResponseBody extends Model
{
    /**
     * @var accounts[]
     */
