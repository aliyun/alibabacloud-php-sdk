...
namespace AlibabaCloud\SDK\AccountCenter\V20241209\Models\EnterpriseContactQueryDetailResponseBody;
...
class data extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->hasSubscription) {
            $res['HasSubscription'] = $this->hasSubscription;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['HasSubscription'])) {
            $model->hasSubscription = $map['HasSubscription'];
        }
