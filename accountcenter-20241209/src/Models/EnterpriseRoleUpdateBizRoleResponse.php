...
class EnterpriseRoleUpdateBizRoleResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseRoleUpdateBizRoleResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseRoleUpdateBizRoleResponseBody::fromMap($map['body']);
        }
