...
use AlibabaCloud\SDK\AccountCenter\V20241209\Models\EnterpriseRegisterAccountResponseBody\accountInfo;

class EnterpriseRegisterAccountResponseBody extends Model
{
    /**
     * @var accountInfo
     */
