...
class EnterpriseAccountRemoveMfaResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseAccountRemoveMfaResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseAccountRemoveMfaResponseBody::fromMap($map['body']);
        }
