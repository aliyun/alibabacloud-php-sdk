...
class EnterpriseOrgRenameNodeResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var EnterpriseOrgRenameNodeResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = EnterpriseOrgRenameNodeResponseBody::fromMap($map['body']);
        }
