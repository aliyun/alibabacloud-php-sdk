...
class AccountContactQueryPageListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var AccountContactQueryPageListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = AccountContactQueryPageListResponseBody::fromMap($map['body']);
        }
