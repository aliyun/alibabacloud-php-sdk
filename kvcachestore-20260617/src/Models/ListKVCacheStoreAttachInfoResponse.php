...
class ListKVCacheStoreAttachInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListKVCacheStoreAttachInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListKVCacheStoreAttachInfoResponseBody::fromMap($map['body']);
        }
