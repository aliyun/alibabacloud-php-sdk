...
class ListKVCacheStoreAvailableVscsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListKVCacheStoreAvailableVscsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListKVCacheStoreAvailableVscsResponseBody::fromMap($map['body']);
        }
