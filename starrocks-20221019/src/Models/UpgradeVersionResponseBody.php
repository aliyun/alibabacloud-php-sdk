...
class UpgradeVersionResponseBody extends Model
{
    /**
     ...
     *
     * @example Invalid instance status: [cannot upgrade when instance is not running].
     *
     * @var string
     */
    public $errMessage;
     ...
     * @param array $map
     *
     * @return UpgradeVersionResponseBody
     */
