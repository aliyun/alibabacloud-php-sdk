...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListApplicationFederatedCredentialsResponseBody\applicationFederatedCredentials;

class ListApplicationFederatedCredentialsResponseBody extends Model
{
    /**
