...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListAuthorizationRulesForUserResponseBody\authorizationRules;

class ListAuthorizationRulesForUserResponseBody extends Model
{
    /**
