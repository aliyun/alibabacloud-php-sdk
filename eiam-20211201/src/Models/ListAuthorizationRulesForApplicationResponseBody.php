...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListAuthorizationRulesForApplicationResponseBody\authorizationRules;

class ListAuthorizationRulesForApplicationResponseBody extends Model
{
    /**
