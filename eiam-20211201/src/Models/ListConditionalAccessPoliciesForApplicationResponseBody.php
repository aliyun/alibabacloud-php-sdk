...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListConditionalAccessPoliciesForApplicationResponseBody\conditionalAccessPolicies;

class ListConditionalAccessPoliciesForApplicationResponseBody extends Model
{
    /**
