...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListOrganizationalUnitsForResourceServerRequest\filter;

class ListOrganizationalUnitsForResourceServerRequest extends Model
{
    /**
     * @var string
     */
