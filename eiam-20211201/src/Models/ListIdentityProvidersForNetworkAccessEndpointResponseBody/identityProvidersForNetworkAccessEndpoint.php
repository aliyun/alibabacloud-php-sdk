...
namespace AlibabaCloud\SDK\Eiam\V20211201\Models\ListIdentityProvidersForNetworkAccessEndpointResponseBody;

use AlibabaCloud\Dara\Model;

class identityProvidersForNetworkAccessEndpoint extends Model
{
    /**
     * @var string
     */
