...
use AlibabaCloud\SDK\Eiam\V20211201\Models\UpdateAuthorizationRuleGroupAttachmentRequest\validityPeriod;

class UpdateAuthorizationRuleGroupAttachmentRequest extends Model
{
    /**
     * @var string
     */
