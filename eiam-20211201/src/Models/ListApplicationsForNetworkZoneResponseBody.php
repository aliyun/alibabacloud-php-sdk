...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListApplicationsForNetworkZoneResponseBody\applications;

class ListApplicationsForNetworkZoneResponseBody extends Model
{
    /**
     * @var applications[]
     */
