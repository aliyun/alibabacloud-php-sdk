...
use AlibabaCloud\SDK\Eiam\V20211201\Models\UpdateAuthorizationRuleUserAttachmentRequest\validityPeriod;

class UpdateAuthorizationRuleUserAttachmentRequest extends Model
{
    /**
     * @var string
     */
