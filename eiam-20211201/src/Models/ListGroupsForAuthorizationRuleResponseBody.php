...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListGroupsForAuthorizationRuleResponseBody\groups;

class ListGroupsForAuthorizationRuleResponseBody extends Model
{
    /**
     * @var groups[]
     */
