...
use AlibabaCloud\SDK\Eiam\V20211201\Models\AddApplicationToAuthorizationRuleRequest\validityPeriod;

class AddApplicationToAuthorizationRuleRequest extends Model
{
    /**
     * @var string
     */
