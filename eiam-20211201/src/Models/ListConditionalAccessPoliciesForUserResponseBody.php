...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListConditionalAccessPoliciesForUserResponseBody\conditionalAccessPolicies;

class ListConditionalAccessPoliciesForUserResponseBody extends Model
{
    /**
