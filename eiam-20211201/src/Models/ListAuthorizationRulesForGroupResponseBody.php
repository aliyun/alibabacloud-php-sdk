...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListAuthorizationRulesForGroupResponseBody\authorizationRules;

class ListAuthorizationRulesForGroupResponseBody extends Model
{
    /**
