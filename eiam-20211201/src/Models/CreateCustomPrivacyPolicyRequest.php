...
use AlibabaCloud\SDK\Eiam\V20211201\Models\CreateCustomPrivacyPolicyRequest\customPrivacyPolicyContents;

class CreateCustomPrivacyPolicyRequest extends Model
{
    /**
     * @var string
     */
