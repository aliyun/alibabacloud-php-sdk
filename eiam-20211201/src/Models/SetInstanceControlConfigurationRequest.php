...
use AlibabaCloud\SDK\Eiam\V20211201\Models\SetInstanceControlConfigurationRequest\controlElements;

class SetInstanceControlConfigurationRequest extends Model
{
    /**
     * @var controlElements[]
     */
