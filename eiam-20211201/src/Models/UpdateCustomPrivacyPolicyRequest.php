...
use AlibabaCloud\SDK\Eiam\V20211201\Models\UpdateCustomPrivacyPolicyRequest\customPrivacyPolicyContents;

class UpdateCustomPrivacyPolicyRequest extends Model
{
    /**
