...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListApplicationsForAuthorizationRuleResponseBody\applications;

class ListApplicationsForAuthorizationRuleResponseBody extends Model
{
    /**
     * @var applications[]
     */
