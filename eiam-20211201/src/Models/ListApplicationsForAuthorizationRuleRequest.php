...
use AlibabaCloud\SDK\Eiam\V20211201\Models\ListApplicationsForAuthorizationRuleRequest\filter;

class ListApplicationsForAuthorizationRuleRequest extends Model
{
    /**
     * @var string
     */
