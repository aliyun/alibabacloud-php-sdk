...
namespace AlibabaCloud\SDK\Miniapplcdp\V20200113\Models\GetCommitResponseBody;
...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->modelPack) {
            $res['ModelPack'] = $this->modelPack;
        }
        ...
        if (null !== $this->resourcePack) {
            $res['ResourcePack'] = $this->resourcePack;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ModelPack'])) {
            if (!empty($map['ModelPack'])) {
                $model->modelPack = $map['ModelPack'];
            }
        }
        ...
        if (isset($map['ResourcePack'])) {
            if (!empty($map['ResourcePack'])) {
                $model->resourcePack = $map['ResourcePack'];
            }
        }
