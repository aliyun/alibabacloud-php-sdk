...
namespace AlibabaCloud\SDK\Mts\V20140618\Models\QueryMediaListResponseBody\mediaList\media\mediaInfo\streams\videoStreamList;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Mts\V20140618\Models\QueryMediaListResponseBody\mediaList\media\mediaInfo\streams\videoStreamList\videoStream\networkCost;
...
class videoStream extends Model
{
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->networkCost) {
            $res['NetworkCost'] = null !== $this->networkCost ? $this->networkCost->toArray($noStream) : $this->networkCost;
        }
