...
use AlibabaCloud\SDK\Ecs\V20160314\Models\DescribeCapacityReservationsRequest\tag;
...
class DescribeCapacityReservationsRequest extends Model
{
    ...
    {
        $res = [];
        if (null !== $this->capacityReservationIds) {
            $res['CapacityReservationIds'] = $this->capacityReservationIds;
        }
    ...
    {
        $model = new self();
        if (isset($map['CapacityReservationIds'])) {
            $model->capacityReservationIds = $map['CapacityReservationIds'];
        }
