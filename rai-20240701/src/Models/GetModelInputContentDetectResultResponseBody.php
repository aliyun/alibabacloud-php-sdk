...
use AlibabaCloud\SDK\RAI\V20240701\Models\GetModelInputContentDetectResultResponseBody\detectResultList;

class GetModelInputContentDetectResultResponseBody extends Model
{
    /**
     * @var string
     */
