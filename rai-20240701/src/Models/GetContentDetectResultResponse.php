...
class GetContentDetectResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetContentDetectResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetContentDetectResultResponseBody::fromMap($map['body']);
        }
