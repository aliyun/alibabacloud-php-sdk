...
class BatchContentSyncDetectResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var BatchContentSyncDetectResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = BatchContentSyncDetectResponseBody::fromMap($map['body']);
        }
