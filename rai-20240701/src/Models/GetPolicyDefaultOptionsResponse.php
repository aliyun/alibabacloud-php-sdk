...
class GetPolicyDefaultOptionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetPolicyDefaultOptionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetPolicyDefaultOptionsResponseBody::fromMap($map['body']);
        }
