...
class UpdateUdfArtifactResponseBody extends Model
{
    /**
     * @description The result of updating the JAR file of the UDF.
     *
     * @var UpdateUdfArtifactResult
     */
    public $data;
     ...
     * @param array $map
     *
     * @return UpdateUdfArtifactResponseBody
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['data'])) {
            $model->data = UpdateUdfArtifactResult::fromMap($map['data']);
        }
