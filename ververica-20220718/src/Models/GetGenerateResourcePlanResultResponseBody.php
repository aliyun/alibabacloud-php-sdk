...
class GetGenerateResourcePlanResultResponseBody extends Model
{
     ...
     * @param array $map
     *
     * @return GetGenerateResourcePlanResultResponseBody
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['data'])) {
            $model->data = AsyncResourcePlanOperationResult::fromMap($map['data']);
        }
