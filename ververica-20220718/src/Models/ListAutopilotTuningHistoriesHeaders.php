...
class ListAutopilotTuningHistoriesHeaders extends Model
{
    /**
     * @var string[]
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->acceptLanguage) {
            $res['Accept-Language'] = $this->acceptLanguage;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Accept-Language'])) {
            $model->acceptLanguage = $map['Accept-Language'];
        }
