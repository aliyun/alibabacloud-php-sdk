...
class HotUpdateJobResponseBody extends Model
{
    /**
     * @description The dynamic update result.
     *
     * @var HotUpdateJobResult
     */
    public $data;
     ...
     * @param array $map
     *
     * @return HotUpdateJobResponseBody
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['data'])) {
            $model->data = HotUpdateJobResult::fromMap($map['data']);
        }
