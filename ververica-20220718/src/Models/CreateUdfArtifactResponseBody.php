...
class CreateUdfArtifactResponseBody extends Model
{
    /**
     * @description The result of creating an artifact configuration for the UDF.
     *
     * @var CreateUdfArtifactResult
     */
    public $data;
     ...
     * @param array $map
     *
     * @return CreateUdfArtifactResponseBody
     */
    public static function fromMap($map = [])
    {
        $model = new self();
        if (isset($map['data'])) {
            $model->data = CreateUdfArtifactResult::fromMap($map['data']);
        }
