...
class CreateSavepointResponseBody extends Model
{
    /**
     * @description *   If the value of success was true, the savepoint that was created was returned.
     ...
     * @param array $map
     *
     * @return CreateSavepointResponseBody
     */
