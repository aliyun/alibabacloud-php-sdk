...
namespace AlibabaCloud\SDK\WebPlus\V20190320\Models\DescribeGatherStatsResultResponseBody\gatherStatsResult;
...
class change extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->changeSucceeded) {
            $res['ChangeSucceeded'] = $this->changeSucceeded;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ChangeSucceeded'])) {
            $model->changeSucceeded = $map['ChangeSucceeded'];
        }
