...
class BatchFetchAccountLabelResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var BatchFetchAccountLabelResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = BatchFetchAccountLabelResponseBody::fromMap($map['body']);
        }
