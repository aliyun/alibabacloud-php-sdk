...
class PodcastTaskResultQueryResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PodcastTaskResultQueryResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PodcastTaskResultQueryResponseBody::fromMap($map['body']);
        }
