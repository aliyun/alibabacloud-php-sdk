...
class UpdateMPCoSAuthorizedInfoShrinkRequest extends Model
{
    /**
     * @example 1.0.0
     *
     ...
     * @var string
     */
    public $authorizedPhaseListShrink;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->authorizedPhaseListShrink) {
            $res['AuthorizedPhaseList'] = $this->authorizedPhaseListShrink;
        }
     ...
     * @param array $map
     *
     * @return UpdateMPCoSAuthorizedInfoShrinkRequest
     */
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AuthorizedPhaseList'])) {
            $model->authorizedPhaseListShrink = $map['AuthorizedPhaseList'];
        }
