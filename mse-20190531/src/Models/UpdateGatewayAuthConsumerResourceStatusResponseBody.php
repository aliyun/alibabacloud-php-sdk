...
class UpdateGatewayAuthConsumerResourceStatusResponseBody extends Model
{
    /**
    ...
    /**
     * @description Indicates whether the execution was successful. Valid values:
     *
     ...
     * @param array $map
     *
     * @return UpdateGatewayAuthConsumerResourceStatusResponseBody
     */
