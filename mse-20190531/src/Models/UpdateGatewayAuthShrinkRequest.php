...
class UpdateGatewayAuthShrinkRequest extends Model
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public $deleteResourceIdListShrink;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->deleteResourceIdListShrink) {
            $res['DeleteResourceIdList'] = $this->deleteResourceIdListShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DeleteResourceIdList'])) {
            $model->deleteResourceIdListShrink = $map['DeleteResourceIdList'];
        }
