...
class result extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->gatewayEntry) {
            $res['GatewayEntry'] = [];
            if (null !== $this->gatewayEntry && \is_array($this->gatewayEntry)) {
                $n = 0;
                foreach ($this->gatewayEntry as $item) {
                    $res['GatewayEntry'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['GatewayEntry'])) {
            if (!empty($map['GatewayEntry'])) {
                $model->gatewayEntry = [];
                $n = 0;
                foreach ($map['GatewayEntry'] as $item) {
                    $model->gatewayEntry[$n++] = null !== $item ? gatewayEntry::fromMap($item) : $item;
                }
            }
        }
