...
class data extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->isCreatedSlb) {
            $res['IsCreatedSlb'] = $this->isCreatedSlb;
        }
        ...
        if (null !== $this->nameServerPublic) {
            $res['NameServerPublic'] = $this->nameServerPublic;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IsCreatedSlb'])) {
            $model->isCreatedSlb = $map['IsCreatedSlb'];
        }
        ...
        if (isset($map['NameServerPublic'])) {
            $model->nameServerPublic = $map['NameServerPublic'];
        }
