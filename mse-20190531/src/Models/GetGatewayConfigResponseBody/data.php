...
class data extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->enableK8sSourceWorkloadFilter) {
            $this->enableK8sSourceWorkloadFilter->validate();
        }
        if (null !== $this->enableXffTrustedCidrs) {
            $this->enableXffTrustedCidrs->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->enableK8sSourceWorkloadFilter) {
            $res['EnableK8sSourceWorkloadFilter'] = null !== $this->enableK8sSourceWorkloadFilter ? $this->enableK8sSourceWorkloadFilter->toArray($noStream) : $this->enableK8sSourceWorkloadFilter;
        }
        ...
        if (null !== $this->enableXffTrustedCidrs) {
            $res['EnableXffTrustedCidrs'] = null !== $this->enableXffTrustedCidrs ? $this->enableXffTrustedCidrs->toArray($noStream) : $this->enableXffTrustedCidrs;
        }
