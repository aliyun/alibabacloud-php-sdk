...
use AlibabaCloud\SDK\Mse\V20190531\Models\UpdateGatewayAuthRequest\authResourceList;
use AlibabaCloud\SDK\Mse\V20190531\Models\UpdateGatewayAuthRequest\externalAuthZJSON;

class UpdateGatewayAuthRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function validate()
    {
        ...
        if (\is_array($this->deleteResourceIdList)) {
            Model::validateArray($this->deleteResourceIdList);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->deleteResourceIdList) {
            if (\is_array($this->deleteResourceIdList)) {
                $res['DeleteResourceIdList'] = [];
                $n1 = 0;
                foreach ($this->deleteResourceIdList as $item1) {
                    $res['DeleteResourceIdList'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DeleteResourceIdList'])) {
            if (!empty($map['DeleteResourceIdList'])) {
                $model->deleteResourceIdList = [];
                $n1 = 0;
                foreach ($map['DeleteResourceIdList'] as $item1) {
                    $model->deleteResourceIdList[$n1] = $item1;
                    ++$n1;
                }
            }
        }
