...
class CreateOrUpdateSwimmingLaneRequest extends Model
{
    ...
    public function validate()
    {
        ...
        if (null !== $this->gatewaySwimmingLaneRouteJson) {
            $this->gatewaySwimmingLaneRouteJson->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->gatewaySwimmingLaneRouteJson) {
            $res['GatewaySwimmingLaneRouteJson'] = null !== $this->gatewaySwimmingLaneRouteJson ? $this->gatewaySwimmingLaneRouteJson->toArray($noStream) : $this->gatewaySwimmingLaneRouteJson;
        }
