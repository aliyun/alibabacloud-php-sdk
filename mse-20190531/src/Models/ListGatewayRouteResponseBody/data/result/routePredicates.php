...
use AlibabaCloud\SDK\Mse\V20190531\Models\ListGatewayRouteResponseBody\data\result\routePredicates\headerPredicates;
use AlibabaCloud\SDK\Mse\V20190531\Models\ListGatewayRouteResponseBody\data\result\routePredicates\pathPredicates;
use AlibabaCloud\SDK\Mse\V20190531\Models\ListGatewayRouteResponseBody\data\result\routePredicates\queryPredicates;
use AlibabaCloud\Tea\Model;

class routePredicates extends Model
{
    /**
     * @description The headers used for route matching.
     *
    ...
    /**
     * @description The HTTP methods used for route matching.
     *
     * @var string[]
     */
    ...
    /**
     * @description The parameters used for route matching.
     *
     * @var queryPredicates[]
     */
