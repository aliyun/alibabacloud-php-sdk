...
class UpdateGatewayAuthConsumerResourceResponseBody extends Model
{
    /**
    ...
    /**
     * @description Indicates whether the list of the resources was updated. Valid values:
     *
     ...
     * @param array $map
     *
     * @return UpdateGatewayAuthConsumerResourceResponseBody
     */
