...
class ListInstanceCountResponseBody extends Model
{
    ...
    /**
     * @description The error code returned if the request failed. If the request failed, the ErrorCode parameter is returned. For more information, see the "Error codes" section of this topic.
     *
     * @example mse-100-100
     *
     * @var string
