...
use AlibabaCloud\SDK\Tablestore\V20201209\Models\ListVpcInfoByAgentStorageResponseBody\vpcInfos;

class ListVpcInfoByAgentStorageResponseBody extends Model
{
    /**
     * @var string
     */
