...
namespace AlibabaCloud\SDK\PAIABTest\V20240119\Models\ListMetricGroupsResponseBody\metricGroups;
...
class metrics extends Model
{
     ...
     * @var int
     */
    public $relatedExperimentsNumber;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->relatedExperimentsNumber) {
            $res['RelatedExperimentsNumber'] = $this->relatedExperimentsNumber;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['RelatedExperimentsNumber'])) {
            $model->relatedExperimentsNumber = $map['RelatedExperimentsNumber'];
        }
