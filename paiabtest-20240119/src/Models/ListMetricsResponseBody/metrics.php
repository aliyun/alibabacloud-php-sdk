...
namespace AlibabaCloud\SDK\PAIABTest\V20240119\Models\ListMetricsResponseBody;
...
class metrics extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->sourceTableMetaName) {
            $res['SourceTableMetaName'] = $this->sourceTableMetaName;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SourceTableMetaName'])) {
            $model->sourceTableMetaName = $map['SourceTableMetaName'];
        }
