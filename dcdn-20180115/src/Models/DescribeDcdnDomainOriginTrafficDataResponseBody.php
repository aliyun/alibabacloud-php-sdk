...
class DescribeDcdnDomainOriginTrafficDataResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->originTrafficDataPerInterval) {
            $this->originTrafficDataPerInterval->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->originTrafficDataPerInterval) {
            $res['OriginTrafficDataPerInterval'] = null !== $this->originTrafficDataPerInterval ? $this->originTrafficDataPerInterval->toArray($noStream) : $this->originTrafficDataPerInterval;
        }
