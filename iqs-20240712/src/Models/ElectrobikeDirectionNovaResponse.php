...
class ElectrobikeDirectionNovaResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var ElectrobikeDirectionNovaResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ElectrobikeDirectionNovaResponseBody::fromMap($map['body']);
        }
