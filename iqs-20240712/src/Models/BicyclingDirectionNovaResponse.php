...
class BicyclingDirectionNovaResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    public $statusCode;
    /**
     * @var BicyclingDirectionNovaResponseBody
     */
    public $body;
    protected $_name = [
        'headers'    => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = BicyclingDirectionNovaResponseBody::fromMap($map['body']);
        }
