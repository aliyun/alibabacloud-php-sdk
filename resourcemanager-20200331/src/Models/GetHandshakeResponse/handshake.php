...
namespace AlibabaCloud\SDK\ResourceManager\V20200331\Models\GetHandshakeResponse;
...
class handshake extends Model
{
    ...
    public function validate()
    {
        ...
        Model::validateRequired('masterAccountRealName', $this->masterAccountRealName, true);
        Model::validateRequired('expireTime', $this->expireTime, true);
        Model::validateRequired('invitedAccountRealName', $this->invitedAccountRealName, true);
