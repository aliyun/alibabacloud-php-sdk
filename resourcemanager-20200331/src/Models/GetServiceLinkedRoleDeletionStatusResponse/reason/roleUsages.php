...
namespace AlibabaCloud\SDK\ResourceManager\V20200331\Models\GetServiceLinkedRoleDeletionStatusResponse\reason;

use AlibabaCloud\SDK\ResourceManager\V20200331\Models\GetServiceLinkedRoleDeletionStatusResponse\reason\roleUsages\roleUsage;
...
class roleUsages extends Model
{
    ...
    {
        Model::validateRequired('roleUsage', $this->roleUsage, true);
    }
