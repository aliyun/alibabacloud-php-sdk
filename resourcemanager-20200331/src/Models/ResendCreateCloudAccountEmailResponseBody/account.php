...
namespace AlibabaCloud\SDK\ResourceManager\V20200331\Models\ResendCreateCloudAccountEmailResponseBody;
...
class account extends Model
{
    ...
    /**
     * @description The type of the member account. The value CloudAccount indicates that the member account is a cloud account.
     *
