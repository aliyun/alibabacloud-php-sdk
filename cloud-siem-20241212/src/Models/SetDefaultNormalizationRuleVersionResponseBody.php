...
use AlibabaCloud\SDK\Cloudsiem\V20241212\Models\SetDefaultNormalizationRuleVersionResponseBody\normalizationRuleVersion;

class SetDefaultNormalizationRuleVersionResponseBody extends Model
{
    /**
