...
class ListDataConnectorsShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $dataConnectorIdsShrink;
    ...
    {
        $res = [];
        if (null !== $this->dataConnectorIdsShrink) {
            $res['DataConnectorIds'] = $this->dataConnectorIdsShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DataConnectorIds'])) {
            $model->dataConnectorIdsShrink = $map['DataConnectorIds'];
        }
