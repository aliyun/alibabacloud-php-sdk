...
namespace AlibabaCloud\SDK\Cloudsiem\V20241212\Models\GetNormalizationRuleVersionResponseBody;
...
class normalizationRuleVersion extends Model
{
     ...
     * @var string
     */
    public $normalizationRuleVersionName;
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->normalizationRuleVersionName) {
            $res['NormalizationRuleVersionName'] = $this->normalizationRuleVersionName;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['NormalizationRuleVersionName'])) {
            $model->normalizationRuleVersionName = $map['NormalizationRuleVersionName'];
        }
