...
use AlibabaCloud\SDK\Cloudsiem\V20241212\Models\UpdateDataSetRecordResponseBody\dataSetRecordStatistic;

class UpdateDataSetRecordResponseBody extends Model
{
    /**
