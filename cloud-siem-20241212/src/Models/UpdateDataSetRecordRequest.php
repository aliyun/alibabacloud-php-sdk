...
class UpdateDataSetRecordRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->dataSetRecords) {
            $res['DataSetRecords'] = $this->dataSetRecords;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['DataSetRecords'])) {
            $model->dataSetRecords = $map['DataSetRecords'];
        }
