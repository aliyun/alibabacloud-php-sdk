...
use AlibabaCloud\SDK\NAS\V20170626\Models\DescribeFilesystemsAssociatedHpnZonesResponseBody\filesystems;

class DescribeFilesystemsAssociatedHpnZonesResponseBody extends Model
{
    /**
     * @var filesystems[]
     */
