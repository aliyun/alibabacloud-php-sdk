...
class ListExperimentPlanTemplatesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListExperimentPlanTemplatesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListExperimentPlanTemplatesResponseBody::fromMap($map['body']);
        }
