...
class GetExperimentPlanTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetExperimentPlanTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetExperimentPlanTemplateResponseBody::fromMap($map['body']);
        }
