...
class UpdateExperimentPlanTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var UpdateExperimentPlanTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = UpdateExperimentPlanTemplateResponseBody::fromMap($map['body']);
        }
