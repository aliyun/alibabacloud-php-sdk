...
class GetResourcePredictResultResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetResourcePredictResultResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetResourcePredictResultResponseBody::fromMap($map['body']);
        }
