...
class CreateExperimentPlanTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateExperimentPlanTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateExperimentPlanTemplateResponseBody::fromMap($map['body']);
        }
