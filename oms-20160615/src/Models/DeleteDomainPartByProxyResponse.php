...
class DeleteDomainPartByProxyResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DeleteDomainPartByProxyResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DeleteDomainPartByProxyResponseBody::fromMap($map['body']);
        }
