...
class PushDeviceNotificationResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var PushDeviceNotificationResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = PushDeviceNotificationResponseBody::fromMap($map['body']);
        }
