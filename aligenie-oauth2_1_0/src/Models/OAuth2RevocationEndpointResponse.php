...
class OAuth2RevocationEndpointResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var OAuth2RevocationEndpointResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = OAuth2RevocationEndpointResponseBody::fromMap($map['body']);
        }
