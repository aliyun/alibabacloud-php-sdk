...
class accessPortDetails extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->subStatusDetails) {
            ...
            if (null !== $this->subStatusDetails && \is_array($this->subStatusDetails)) {
                $n = 0;
                foreach ($this->subStatusDetails as $item) {
                    $res['SubStatusDetails'][$n++] = null !== $item ? $item->toMap() : $item;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['SubStatusDetails'])) {
            if (!empty($map['SubStatusDetails'])) {
                ...
                $n = 0;
                foreach ($map['SubStatusDetails'] as $item) {
                    $model->subStatusDetails[$n++] = null !== $item ? subStatusDetails::fromMap($item) : $item;
                }
            }
        }
