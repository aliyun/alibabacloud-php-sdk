...
use AlibabaCloud\SDK\Wafopenapi\V20211001\Models\DescribeAddressesResponseBody\addressList;

class DescribeAddressesResponseBody extends Model
{
    /**
     * @var addressList[]
     */
        ...
        if (isset($map['AddressList'])) {
            if (!empty($map['AddressList'])) {
                ...
                foreach ($map['AddressList'] as $item1) {
                    $model->addressList[$n1] = addressList::fromMap($item1);
                    ++$n1;
                }
            }
        }
