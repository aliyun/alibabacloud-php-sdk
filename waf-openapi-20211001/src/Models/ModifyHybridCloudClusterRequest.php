...
class ModifyHybridCloudClusterRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->logFieldsNotReturned) {
            $res['LogFieldsNotReturned'] = $this->logFieldsNotReturned;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['LogFieldsNotReturned'])) {
            $model->logFieldsNotReturned = $map['LogFieldsNotReturned'];
        }
