...
class DescribeDefenseResourceGroupNamesRequest extends Model
{
    /**
     * @description The name of the protected object group. Fuzzy queries are supported.
     *
     ...
     * @param array $map
     *
     * @return DescribeDefenseResourceGroupNamesRequest
     */
