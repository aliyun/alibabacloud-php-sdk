...
class CreateDeliveryChannelRequest extends Model
{
    ...
    /**
     * @description The ARN of the role that you want to assign to the delivery channel. Specify an ARN in the following format: `acs:ram::{accountId}:role/aliyunserviceroleforconfig`.
     *
