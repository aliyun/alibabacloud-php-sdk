...
namespace AlibabaCloud\SDK\Config\V20200907\Models\ListConfigDeliveryChannelsResponseBody;
...
class deliveryChannels extends Model
{
    ...
    /**
     * @description Indicates whether the specified destination receives resource change logs. If the value of this parameter is true, Cloud Config delivers resource change logs to OSS, Log Service, or MNS when the configurations of the resources change. Valid values:
     *
    ...
    /**
     * @description Indicates whether the specified destination receives scheduled resource snapshots. Cloud Config delivers scheduled resource snapshots to OSS, MNS, or Log Service at `04:00Z` and `16:00Z` every day. The time is displayed in UTC. Valid values:
     *
    ...
    /**
     * @description The time when Cloud Config delivers scheduled resource snapshots every day.
     *
    ...
    /**
     * @description Indicates whether the specified destination receives resource non-compliance events. If the value of this parameter is true, Cloud Config delivers resource non-compliance events to Log Service or MNS when resources are considered non-compliant. Valid values:
     *
    ...
    /**
     * @description The ARN of the OSS bucket to which the delivery data is transferred when the size of the data exceeds the specified upper limit of the delivery channel.
     *
