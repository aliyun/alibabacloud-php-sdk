...
namespace AlibabaCloud\SDK\Config\V20200907\Models\ListAggregateCompliancePacksResponseBody;

use AlibabaCloud\SDK\Config\V20200907\Models\ListAggregateCompliancePacksResponseBody\compliancePacksResult\compliancePacks;
use AlibabaCloud\Tea\Model;

class compliancePacksResult extends Model
{
    /**
     * @description The compliance packages.
     *
     * @var compliancePacks[]
     */
