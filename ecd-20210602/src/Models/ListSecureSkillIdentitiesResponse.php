...
class ListSecureSkillIdentitiesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListSecureSkillIdentitiesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListSecureSkillIdentitiesResponseBody::fromMap($map['body']);
        }
