...
class SetIdentitySkillSecurityResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var SetIdentitySkillSecurityResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = SetIdentitySkillSecurityResponseBody::fromMap($map['body']);
        }
