...
class ListSkillAuthedIdentitiesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListSkillAuthedIdentitiesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListSkillAuthedIdentitiesResponseBody::fromMap($map['body']);
        }
