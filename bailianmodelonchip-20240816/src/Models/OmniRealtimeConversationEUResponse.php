...
class OmniRealtimeConversationEUResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var OmniRealtimeConversationEUResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = OmniRealtimeConversationEUResponseBody::fromMap($map['body']);
        }
