...
class ActiveInteractionEuCreateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ActiveInteractionEuCreateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ActiveInteractionEuCreateResponseBody::fromMap($map['body']);
        }
