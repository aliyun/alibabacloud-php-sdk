...
class ActiveInteractionCreateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ActiveInteractionCreateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ActiveInteractionCreateResponseBody::fromMap($map['body']);
        }
