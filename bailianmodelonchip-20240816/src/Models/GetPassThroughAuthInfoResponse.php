...
class GetPassThroughAuthInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetPassThroughAuthInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetPassThroughAuthInfoResponseBody::fromMap($map['body']);
        }
