...
use AlibabaCloud\SDK\RdsAi\V20250507\Models\DescribeCommonSandboxTemplatesResponseBody\templates;

class DescribeCommonSandboxTemplatesResponseBody extends Model
{
    /**
     * @var int
     */
