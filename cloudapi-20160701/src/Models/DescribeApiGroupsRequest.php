...
use AlibabaCloud\SDK\CloudAPI\V20160701\Models\DescribeApiGroupsRequest\tag;
...
class DescribeApiGroupsRequest extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->notClassic) {
            $res['NotClassic'] = $this->notClassic;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['NotClassic'])) {
            $model->notClassic = $map['NotClassic'];
        }
