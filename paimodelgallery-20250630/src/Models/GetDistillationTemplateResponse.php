...
class GetDistillationTemplateResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetDistillationTemplateResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetDistillationTemplateResponseBody::fromMap($map['body']);
        }
