...
class ListDistillationTemplatesResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListDistillationTemplatesResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListDistillationTemplatesResponseBody::fromMap($map['body']);
        }
