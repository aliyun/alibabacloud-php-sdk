...
class ListModelGalleryModelsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ListModelGalleryModelsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ListModelGalleryModelsResponseBody::fromMap($map['body']);
        }
