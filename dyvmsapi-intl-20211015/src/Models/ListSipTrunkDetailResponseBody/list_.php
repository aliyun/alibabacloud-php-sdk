...
namespace AlibabaCloud\SDK\Dyvmsapiintl\V20211015\Models\ListSipTrunkDetailResponseBody;
...
class list_ extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->ivnCliType) {
            $res['IvnCliType'] = $this->ivnCliType;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['IvnCliType'])) {
            $model->ivnCliType = $map['IvnCliType'];
        }
