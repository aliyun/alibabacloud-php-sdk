...
class CreateEnvCustomJobResponseBody extends Model
{
    /**
    ...
    /**
     * @description The name of the custom job that was created, or the exception information.
     *
     * @example cutomJob1
     *
     * @var string
     ...
     * @param array $map
     *
     * @return CreateEnvCustomJobResponseBody
     */
