...
use AlibabaCloud\SDK\ARMS\V20190808\Models\GetRumAppInfoResponseBody\data;
use AlibabaCloud\Tea\Model;

class GetRumAppInfoResponseBody extends Model
{
    /**
     ...
     * @param array $map
     *
     * @return GetRumAppInfoResponseBody
     */
