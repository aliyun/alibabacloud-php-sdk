...
class ChangeAlarmSeverityResponseBody extends Model
{
    /**
    ...
    /**
     * @description Indicates whether the severity level was modified.
     *
     ...
     * @param array $map
     *
     * @return ChangeAlarmSeverityResponseBody
     */
