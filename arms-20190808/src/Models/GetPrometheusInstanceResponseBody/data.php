...
class data extends Model
{
    ...
    /**
     * @description The extra information. This parameter is returned only for console requests.
     *
     * @var string[]
     */
    public $extraInfo;
     ...
     * @var string
     */
    public $openTelemetryInterUrl;

    /**
     * @var string
     */
    public $openTelemetryIntraUrl;
    ...
    public function toMap()
    {
        ...
        if (null !== $this->openTelemetryInterUrl) {
            $res['OpenTelemetryInterUrl'] = $this->openTelemetryInterUrl;
        }
        if (null !== $this->openTelemetryIntraUrl) {
            $res['OpenTelemetryIntraUrl'] = $this->openTelemetryIntraUrl;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['OpenTelemetryInterUrl'])) {
            $model->openTelemetryInterUrl = $map['OpenTelemetryInterUrl'];
        }
        if (isset($map['OpenTelemetryIntraUrl'])) {
            $model->openTelemetryIntraUrl = $map['OpenTelemetryIntraUrl'];
        }
