...
{
    /**
     * @description The status code. The status code 200 indicates a successful request, whereas others indicate a failed request.
     *
     * @example 200
     *
     * @var int
    ...
    /**
     * @description The supplemental message providing additional context about the response.
     *
     * @example success
     *
     * @var string
     ...
     * @param array $map
     *
     * @return DeletePrometheusGlobalViewResponseBody
     */
