...
{
    /**
     * @description Time to claim the alarm.
     *
     * @example -1
     *
     * @var int
    ...
    /**
     * @description The contact card of an instant messaging app.
     *
     * @example Test Robot
     *
     * @var string
    ...
    /**
     * @description The notification object configured in the notification policy, responsible for handling alerts.
     *
     * @example Alice
     *
     * @var string
    ...
    /**
     * @description Alarm recovery time.
     *
     * @example -1
     *
     * @var int
