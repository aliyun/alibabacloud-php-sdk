...
use AlibabaCloud\SDK\ARMS\V20190808\Models\ListPrometheusIntegrationResponseBody\data;
...
class ListPrometheusIntegrationResponseBody extends Model
{
    ...
    /**
     * @description The queried exporters.
     *
     * @var data[]
     */
    public $data;
     ...
     * @param array $map
     *
     * @return ListPrometheusIntegrationResponseBody
     */
