...
class silencePolicy extends Model
{
    ...
    /**
     * @description Effective period. Valid values: DAY: daily WEEK: weekly
     *
     * @example WEEK
     *
     * @var string
    ...
    /**
     * @description The time period during which the silence policy is effective.
     *
     * @example [{startWeek: "1", startTime: "00:00", endTime: "11:59", endWeek:"7"}]
     *
     * @var string
     */
    public $timeSlots;
