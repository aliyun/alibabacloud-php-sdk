...
use AlibabaCloud\SDK\Emrserverlessspark\V20230808\Models\GetRayClusterResponseBody\headSpec;
use AlibabaCloud\SDK\Emrserverlessspark\V20230808\Models\GetRayClusterResponseBody\instances;
use AlibabaCloud\SDK\Emrserverlessspark\V20230808\Models\GetRayClusterResponseBody\workerSpec;

class GetRayClusterResponseBody extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->submitToken) {
            $res['submitToken'] = $this->submitToken;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['submitToken'])) {
            $model->submitToken = $map['submitToken'];
        }
