...
use AlibabaCloud\SDK\Emrserverlessspark\V20230808\Models\RefreshLivyComputeTokenRequest\autoExpireConfiguration;

class RefreshLivyComputeTokenRequest extends Model
{
    /**
