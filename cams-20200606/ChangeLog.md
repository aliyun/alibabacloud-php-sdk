...
2026-04-15 Version: 5.0.1
- Generated php 2020-06-06 for cams.

2026-04-14 Version: 5.0.0
- Support API CheckDirectSendMessageSample.
- Support API GetAutoGeneratedTemplate.
- Support API ListWhatAppTemplate.
- Update API AddAuditViberOpen: add request parameters AuditRecord.ContactEmail.
- Update API AddAuditViberOpen: add request parameters AuditRecord.ContactName.
- Update API AddAuditViberOpen: add request parameters AuditRecord.ContactPhone.
- Update API AddAuditViberOpen: add request parameters AuditRecord.ContactPosition.
- Update API AddChatGroup: add request parameters GroupLink.
- Update API CreateInstance: delete request parameters OwnerId.
- Update API CreateInstance: delete request parameters ResourceOwnerAccount.
- Update API CreateInstance: delete request parameters ResourceOwnerId.
- Update API DeleteInstance: delete request parameters OwnerId.
- Update API DeleteInstance: delete request parameters ResourceOwnerAccount.
- Update API DeleteInstance: delete request parameters ResourceOwnerId.
- Update API GetViberByRequestNo: add response parameters Body.Data.AuditRecord.ContactEmail.
- Update API GetViberByRequestNo: add response parameters Body.Data.AuditRecord.ContactName.
- Update API GetViberByRequestNo: add response parameters Body.Data.AuditRecord.ContactPhone.
- Update API GetViberByRequestNo: add response parameters Body.Data.AuditRecord.ContactPosition.
- Update API ListChatGroup: add request parameters GroupLink.
- Update API ListChatGroup: add request parameters GroupType.
- Update API ListChatGroup: add response parameters Body.Data.List.$.BusinessRole.
- Update API ListChatGroup: add response parameters Body.Data.List.$.GmtModifier.
- Update API ListChatGroup: add response parameters Body.Data.List.$.GroupLink.
- Update API ListChatGroup: add response parameters Body.Data.List.$.GroupType.
- Update API ListChatGroup: add response parameters Body.Data.List.$.TotalParticipantCount.
- Update API ListInstance: delete request parameters OwnerId.
- Update API ListInstance: delete request parameters ResourceOwnerAccount.
- Update API ListInstance: delete request parameters ResourceOwnerId.
- Update API QueryInstance: delete request parameters OwnerId.
- Update API QueryInstance: delete request parameters ResourceOwnerAccount.
- Update API QueryInstance: delete request parameters ResourceOwnerId.
- Update API UpdateAuditRequest: add request parameters AuditRecord.ContactEmail.
- Update API UpdateAuditRequest: add request parameters AuditRecord.ContactName.
- Update API UpdateAuditRequest: add request parameters AuditRecord.ContactPhone.
- Update API UpdateAuditRequest: add request parameters AuditRecord.ContactPosition.
- Update API UpdateInstance: delete request parameters OwnerId.
- Update API UpdateInstance: delete request parameters ResourceOwnerAccount.
- Update API UpdateInstance: delete request parameters ResourceOwnerId.
