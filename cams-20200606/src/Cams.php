...
use AlibabaCloud\SDK\Cams\V20200606\Models\ArchiveChatappTemplateRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\ArchiveChatappTemplateResponse;
use AlibabaCloud\SDK\Cams\V20200606\Models\ArchiveChatappTemplateShrinkRequest;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\CheckDirectSendMessageSampleRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\CheckDirectSendMessageSampleResponse;
use AlibabaCloud\SDK\Cams\V20200606\Models\CheckDirectSendMessageSampleShrinkRequest;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\DeleteWhatsappUserNameRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\DeleteWhatsappUserNameResponse;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\GetAutoGeneratedTemplateRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetAutoGeneratedTemplateResponse;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\GetWhatsappUserNameRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetWhatsappUserNameResponse;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetWhatsappUserNameSuggestionsRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetWhatsappUserNameSuggestionsResponse;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\ListWhatAppTemplateRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\ListWhatAppTemplateResponse;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\SubmitVerifyCodeResultRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\SubmitVerifyCodeResultResponse;
...
use AlibabaCloud\SDK\Cams\V20200606\Models\UpdateWhatsappUserNameRequest;
use AlibabaCloud\SDK\Cams\V20200606\Models\UpdateWhatsappUserNameResponse;
...
class Cams extends OpenApiClient
{
     ...
     *
     * @param ArchiveChatappTemplateRequest $tmpReq
     * @param RuntimeOptions                $runtime
     *
     * @return ArchiveChatappTemplateResponse
     */
    public function archiveChatappTemplateWithOptions($tmpReq, $runtime)
    {
        $tmpReq->validate();
        $request = new ArchiveChatappTemplateShrinkRequest([]);
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->templateList) {
            $request->templateListShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->templateList, 'TemplateList', 'json');
        }

        $query = [];
        if (null !== $request->archiveType) {
        ...
        if (null !== $request->templateListShrink) {
        ...
        return ArchiveChatappTemplateResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @returns ArchiveChatappTemplateResponse
     *
     * @param ArchiveChatappTemplateRequest $request
     *
     * @return ArchiveChatappTemplateResponse
     */
    public function archiveChatappTemplate($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param CheckDirectSendMessageSampleRequest $tmpReq
     * @param RuntimeOptions                      $runtime
     *
     * @return CheckDirectSendMessageSampleResponse
     */
    public function checkDirectSendMessageSampleWithOptions($tmpReq, $runtime)
    {
        $tmpReq->validate();
        $request = new CheckDirectSendMessageSampleShrinkRequest([]);
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->interactive) {
            $request->interactiveShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->interactive, 'Interactive', 'json');
        }
        ...
        if (null !== $request->interactiveShrink) {
        ...
        return CheckDirectSendMessageSampleResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @returns CheckDirectSendMessageSampleResponse
     *
     * @param CheckDirectSendMessageSampleRequest $request
     *
     * @return CheckDirectSendMessageSampleResponse
     */
    public function checkDirectSendMessageSample($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    public function createChatFlowWithOptions($tmpReq, $runtime)
    {
        ...
        if (null !== $tmpReq->lifeCycleExtendData) {
            $request->lifeCycleExtendDataShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->lifeCycleExtendData, 'LifeCycleExtendData', 'json');
        }
        ...
        if (null !== $request->createFromFlowCode) {
            @$query['CreateFromFlowCode'] = $request->createFromFlowCode;
        }

        if (null !== $request->createFromFlowVersion) {
        ...
        if (null !== $request->lifeCycleExtendDataShrink) {
     ...
     *
     * @param DeleteWhatsappUserNameRequest $request
     * @param RuntimeOptions                $runtime
     *
     * @return DeleteWhatsappUserNameResponse
     */
    public function deleteWhatsappUserNameWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        return DeleteWhatsappUserNameResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return DeleteWhatsappUserNameResponse
     */
    public function deleteWhatsappUserName($request)
    {
        $runtime = new RuntimeOptions([]);
    ...
    public function flowBindPhoneWithOptions($tmpReq, $runtime)
    {
        ...
        Utils::convert($tmpReq, $request);
        if (null !== $tmpReq->multiWabaPhoneNumbers) {
            $request->multiWabaPhoneNumbersShrink = Utils::arrayToStringWithSpecifiedStyle($tmpReq->multiWabaPhoneNumbers, 'MultiWabaPhoneNumbers', 'json');
        }
        ...
        if (null !== $request->multiWabaPhoneNumbersShrink) {
     ...
     *
     * @param GetAutoGeneratedTemplateRequest $request
     * @param RuntimeOptions                  $runtime
     *
     * @return GetAutoGeneratedTemplateResponse
     */
    public function getAutoGeneratedTemplateWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        return GetAutoGeneratedTemplateResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetAutoGeneratedTemplateResponse
     */
    public function getAutoGeneratedTemplate($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param GetWhatsappUserNameRequest $request
     * @param RuntimeOptions             $runtime
     *
     * @return GetWhatsappUserNameResponse
     */
    public function getWhatsappUserNameWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        return GetWhatsappUserNameResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetWhatsappUserNameResponse
     */
    public function getWhatsappUserName($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param GetWhatsappUserNameSuggestionsRequest $request
     * @param RuntimeOptions                        $runtime
     *
     * @return GetWhatsappUserNameSuggestionsResponse
     */
    public function getWhatsappUserNameSuggestionsWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        return GetWhatsappUserNameSuggestionsResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return GetWhatsappUserNameSuggestionsResponse
     */
    public function getWhatsappUserNameSuggestions($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param ListWhatAppTemplateRequest $request
     * @param RuntimeOptions             $runtime
     *
     * @return ListWhatAppTemplateResponse
     */
    public function listWhatAppTemplateWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        return ListWhatAppTemplateResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return ListWhatAppTemplateResponse
     */
    public function listWhatAppTemplate($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param SubmitVerifyCodeResultRequest $request
     * @param RuntimeOptions                $runtime
     *
     * @return SubmitVerifyCodeResultResponse
     */
    public function submitVerifyCodeResultWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        ...
        return SubmitVerifyCodeResultResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return SubmitVerifyCodeResultResponse
     */
    public function submitVerifyCodeResult($request)
    {
        $runtime = new RuntimeOptions([]);
     ...
     *
     * @param UpdateWhatsappUserNameRequest $request
     * @param RuntimeOptions                $runtime
     *
     * @return UpdateWhatsappUserNameResponse
     */
    public function updateWhatsappUserNameWithOptions($request, $runtime)
    {
        $request->validate();
        $query = [];
        if (null !== $request->custSpaceId) {
        ...
        if (null !== $request->transferAction) {
        ...
        return UpdateWhatsappUserNameResponse::fromMap($this->callApi($params, $req, $runtime));
    }
     ...
     * @return UpdateWhatsappUserNameResponse
     */
    public function updateWhatsappUserName($request)
    {
        $runtime = new RuntimeOptions([]);
