...
class UpdateAuditRequestShrinkRequest extends Model
{
    /**
     * @var string
     */
    public $auditRecordShrink;
    ...
    {
        $res = [];
        if (null !== $this->auditRecordShrink) {
            $res['AuditRecord'] = $this->auditRecordShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['AuditRecord'])) {
            $model->auditRecordShrink = $map['AuditRecord'];
        }
