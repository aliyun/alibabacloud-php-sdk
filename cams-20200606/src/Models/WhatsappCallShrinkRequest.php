...
class WhatsappCallShrinkRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->sessionShrink) {
            $res['Session'] = $this->sessionShrink;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['Session'])) {
            $model->sessionShrink = $map['Session'];
        }
