...
namespace AlibabaCloud\SDK\Cams\V20200606\Models\GetAuditRequestByTypeUnAuditResponseBody\data;

use AlibabaCloud\Dara\Model;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetAuditRequestByTypeUnAuditResponseBody\data\auditRecord\companyAddress;
use AlibabaCloud\SDK\Cams\V20200606\Models\GetAuditRequestByTypeUnAuditResponseBody\data\auditRecord\companyTel;
...
class auditRecord extends Model
{
    ...
    public function validate()
    {
        ...
        if (\is_array($this->companyRegisteredCountry)) {
            Model::validateArray($this->companyRegisteredCountry);
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->companyRegisteredCountry) {
            if (\is_array($this->companyRegisteredCountry)) {
                $res['CompanyRegisteredCountry'] = [];
                $n1 = 0;
                foreach ($this->companyRegisteredCountry as $item1) {
                    $res['CompanyRegisteredCountry'][$n1] = $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['CompanyRegisteredCountry'])) {
            if (!empty($map['CompanyRegisteredCountry'])) {
                $model->companyRegisteredCountry = [];
                $n1 = 0;
                foreach ($map['CompanyRegisteredCountry'] as $item1) {
                    $model->companyRegisteredCountry[$n1] = $item1;
                    ++$n1;
                }
            }
        }
