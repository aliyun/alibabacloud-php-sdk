...
class GetPtsReportsBySceneIdResponseBody extends Model
{
    ...
    {
        if (\is_array($this->reportOverViewList)) {
            Model::validateArray($this->reportOverViewList);
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->reportOverViewList) {
            if (\is_array($this->reportOverViewList)) {
                ...
                $n1 = 0;
                foreach ($this->reportOverViewList as $item1) {
                    $res['ReportOverViewList'][$n1] = null !== $item1 ? $item1->toArray($noStream) : $item1;
                    ++$n1;
                }
            }
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ReportOverViewList'])) {
            if (!empty($map['ReportOverViewList'])) {
                ...
                $n1 = 0;
                foreach ($map['ReportOverViewList'] as $item1) {
                    $model->reportOverViewList[$n1] = reportOverViewList::fromMap($item1);
                    ++$n1;
                }
            }
        }
