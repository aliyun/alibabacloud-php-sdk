...
use AlibabaCloud\SDK\Adp\V20210720\Models\InstanceInfo\clusterTaints;
use AlibabaCloud\SDK\Adp\V20210720\Models\InstanceInfo\networkCards;
use AlibabaCloud\SDK\Adp\V20210720\Models\InstanceInfo\taints;
...
class InstanceInfo extends Model
{
    ...
    public function toMap()
    {
        ...
        if (null !== $this->diskConfigAnnotations) {
            $res['diskConfigAnnotations'] = $this->diskConfigAnnotations;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['diskConfigAnnotations'])) {
            $model->diskConfigAnnotations = $map['diskConfigAnnotations'];
        }
