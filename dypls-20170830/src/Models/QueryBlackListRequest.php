...
class QueryBlackListRequest extends Model
{
    /**
     * @var string
     */
    ...
    public function toMap()
    {
        ...
        if (null !== $this->blackPrefix) {
            $res['BlackPrefix'] = $this->blackPrefix;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['BlackPrefix'])) {
            $model->blackPrefix = $map['BlackPrefix'];
        }
