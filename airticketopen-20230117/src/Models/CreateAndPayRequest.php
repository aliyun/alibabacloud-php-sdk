...
use AlibabaCloud\SDK\AirticketOpen\V20230117\Models\CreateAndPayRequest\contact;
use AlibabaCloud\SDK\AirticketOpen\V20230117\Models\CreateAndPayRequest\guests;

class CreateAndPayRequest extends Model
{
    /**
     * @var int
     */
