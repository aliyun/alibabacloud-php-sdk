...
namespace AlibabaCloud\SDK\AirticketOpen\V20230117\Models\OrderListResponseBody\data\list_\passengerList;
...
{
    /**
     * @description issuing place (two-letter code)
     *
     * @example CN
     *
     * @var string
    ...
    /**
     * @description credential type , only support "1"(1 means passport) currently.
     *
     * @example 1
     *
     * @var int
