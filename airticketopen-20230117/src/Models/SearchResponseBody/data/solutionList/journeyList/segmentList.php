...
namespace AlibabaCloud\SDK\AirticketOpen\V20230117\Models\SearchResponseBody\data\solutionList\journeyList;
...
class segmentList extends Model
{
    ...
    /**
     * @description available seats (for reference only)
     *
     * @example 7
     *
     * @var string
    ...
    /**
     * @description marketing airline code (ex.: KA)
     *
     * @example HO
     *
     * @var string
    ...
    /**
     * @description marketing airline flight no. (ex.: KA5809)
     *
     * @example HO1295
     *
     * @var string
    ...
    /**
     * @description marketing airline integer flight no. (ex.: 5809)
     *
     * @example 1259
     *
     * @var int
    ...
    /**
     * @description operating airline code (ex.: CX)
     *
     * @example HO
     *
     * @var string
    ...
    /**
     * @description operating airline flight no. (ex.: CX601)
     *
     * @example HO1295
     *
     * @var string
