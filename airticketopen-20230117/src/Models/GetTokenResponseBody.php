...
use AlibabaCloud\SDK\AirticketOpen\V20230117\Models\GetTokenResponseBody\data;
...
class GetTokenResponseBody extends Model
{
    ...
    /**
     * @description Correctly processed return data
     *
     * @var data
     */
    public $data;
    ...
    /**
     * @description Data carried during error handling
     *
     * @example null
     *
     * @var mixed
    ...
    /**
     * @description When the HTTP request is successful, the status value is 200.
     *
     * @example 200
     *
     * @var int
    ...
    /**
     * @description Whether it is correct
     *
     * @example true
     *
     * @var bool
