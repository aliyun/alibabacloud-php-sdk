...
use AlibabaCloud\SDK\AirticketOpen\V20230117\Models\ChangeDetailListOfOrderNumResponseBody\data\list_\originalJourneys\segmentList;
use AlibabaCloud\Tea\Model;

class originalJourneys extends Model
{
    /**
     * @var segmentList[]
     */
