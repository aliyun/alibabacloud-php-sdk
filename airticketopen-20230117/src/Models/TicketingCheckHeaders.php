...
class TicketingCheckHeaders extends Model
{
    ...
    /**
     * @description language Code(refer to ISO_639), defaults to the buyer\\"s account configuration
     *
     * @example en_US
     *
     * @var string
