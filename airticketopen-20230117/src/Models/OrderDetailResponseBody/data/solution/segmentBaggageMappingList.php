...
use AlibabaCloud\SDK\AirticketOpen\V20230117\Models\DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue;
        ...
        if (isset($map['passenger_baggage_allowance_mapping'])) {
            if (!empty($map['passenger_baggage_allowance_mapping'])) {
                ...
                foreach ($map['passenger_baggage_allowance_mapping'] as $key1 => $value1) {
                    $model->passengerBaggageAllowanceMapping[$key1] = DataSolutionSegmentBaggageMappingListPassengerBaggageAllowanceMappingValue::fromMap($value1);
                }
            }
        }
