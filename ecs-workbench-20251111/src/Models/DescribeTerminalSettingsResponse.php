...
class DescribeTerminalSettingsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeTerminalSettingsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeTerminalSettingsResponseBody::fromMap($map['body']);
        }
