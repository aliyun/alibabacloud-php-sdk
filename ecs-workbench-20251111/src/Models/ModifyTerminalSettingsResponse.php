...
class ModifyTerminalSettingsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var ModifyTerminalSettingsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = ModifyTerminalSettingsResponseBody::fromMap($map['body']);
        }
