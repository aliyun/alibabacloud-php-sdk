...
use AlibabaCloud\SDK\Alikafka\V20190916\Models\GetMetaProductListResponseBody\metaData\productsProfessional\specVO;
use AlibabaCloud\Tea\Model;

class productsProfessional extends Model
{
    /**
     * @var specVO[]
     */
