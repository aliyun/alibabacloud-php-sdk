...
use AlibabaCloud\SDK\Alikafka\V20190916\Models\GetInstanceListResponseBody\instanceList\instanceVO\confluentInstanceComponents;
...
class instanceVO extends Model
{
    ...
    /**
     * @var confluentInstanceComponents
     */
    public $confluentInstanceComponents;
    ...
    public function validate()
    {
        ...
        if (null !== $this->confluentInstanceComponents) {
            $this->confluentInstanceComponents->validate();
        }
        if (null !== $this->tags) {
            $this->tags->validate();
        }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->confluentInstanceComponents) {
            $res['ConfluentInstanceComponents'] = null !== $this->confluentInstanceComponents ? $this->confluentInstanceComponents->toArray($noStream) : $this->confluentInstanceComponents;
        }
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['ConfluentInstanceComponents'])) {
            $model->confluentInstanceComponents = confluentInstanceComponents::fromMap($map['ConfluentInstanceComponents']);
        }
