...
class DescribeRunIdDeductionsResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeRunIdDeductionsResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeRunIdDeductionsResponseBody::fromMap($map['body']);
        }
