...
class DescribeCreditUsageInfoResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeCreditUsageInfoResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeCreditUsageInfoResponseBody::fromMap($map['body']);
        }
