...
class DescribeDeductionStatisticResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var DescribeDeductionStatisticResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = DescribeDeductionStatisticResponseBody::fromMap($map['body']);
        }
