...
{
    /**
     * @var \AlibabaCloud\SDK\BssOpenApi\V20171214\Models\QueryAccountTransactionsResponseBody\data\accountTransactionsList\accountTransactionsList[]
     */
        ...
        if (isset($map['AccountTransactionsList'])) {
            if (!empty($map['AccountTransactionsList'])) {
                ...
                foreach ($map['AccountTransactionsList'] as $item) {
                    $model->accountTransactionsList[$n++] = null !== $item ? \AlibabaCloud\SDK\BssOpenApi\V20171214\Models\QueryAccountTransactionsResponseBody\data\accountTransactionsList\accountTransactionsList::fromMap($item) : $item;
                }
            }
        }
