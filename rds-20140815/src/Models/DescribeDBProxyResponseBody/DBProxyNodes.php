...
{
    /**
     * @var \AlibabaCloud\SDK\Rds\V20140815\Models\DescribeDBProxyResponseBody\DBProxyNodes\DBProxyNodes[]
     */
    public $DBProxyNodes;
    protected $_name = [
        ...
        if (isset($map['DBProxyNodes'])) {
            if (!empty($map['DBProxyNodes'])) {
                ...
                foreach ($map['DBProxyNodes'] as $item) {
                    $model->DBProxyNodes[$n++] = null !== $item ? \AlibabaCloud\SDK\Rds\V20140815\Models\DescribeDBProxyResponseBody\DBProxyNodes\DBProxyNodes::fromMap($item) : $item;
                }
            }
        }
