...
use AlibabaCloud\SDK\Rds\V20140815\Models\DescribeParameterTimedScheduleTaskResponseBody\taskList;

class DescribeParameterTimedScheduleTaskResponseBody extends Model
{
    /**
     * @var string
     */
