...
class ModifyDBInstanceSpecRequest extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->serverlessConfiguration) {
            $this->serverlessConfiguration->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        ...
        if (null !== $this->serverlessConfiguration) {
            $res['ServerlessConfiguration'] = null !== $this->serverlessConfiguration ? $this->serverlessConfiguration->toArray($noStream) : $this->serverlessConfiguration;
        }
