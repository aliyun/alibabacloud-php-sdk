...
class ModifyAccountSecurityPolicyRequest extends Model
{
    ...
    /**
     * @description The custom password policy for the account of the ApsaraDB RDS for SQL Server instance. The following policies are supported:
     *
     ...
     *
     * This parameter is required.
     * @example {"accountSecurityPolicy": {"MaximumPasswordAge": 30, "MinimumPasswordAge": 20}}
     *
     * @var string
     */
    public $groupPolicy;
     ...
     * @param array $map
     *
     * @return ModifyAccountSecurityPolicyRequest
     */
