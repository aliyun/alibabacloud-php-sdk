...
use AlibabaCloud\SDK\Rds\V20140815\Models\DescribeRCResourcesModificationResponseBody\availableZones;

class DescribeRCResourcesModificationResponseBody extends Model
{
    /**
     * @var availableZones[]
     */
