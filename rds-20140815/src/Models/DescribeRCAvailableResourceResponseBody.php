...
use AlibabaCloud\SDK\Rds\V20140815\Models\DescribeRCAvailableResourceResponseBody\availableZones;

class DescribeRCAvailableResourceResponseBody extends Model
{
    /**
     * @var availableZones[]
     */
