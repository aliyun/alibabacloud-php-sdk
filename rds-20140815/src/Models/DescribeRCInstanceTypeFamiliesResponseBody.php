...
use AlibabaCloud\SDK\Rds\V20140815\Models\DescribeRCInstanceTypeFamiliesResponseBody\instanceTypeFamilies;

class DescribeRCInstanceTypeFamiliesResponseBody extends Model
{
    /**
