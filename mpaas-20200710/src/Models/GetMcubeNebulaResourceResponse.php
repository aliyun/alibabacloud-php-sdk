...
class GetMcubeNebulaResourceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var GetMcubeNebulaResourceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = GetMcubeNebulaResourceResponseBody::fromMap($map['body']);
        }
