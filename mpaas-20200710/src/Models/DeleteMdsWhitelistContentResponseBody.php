...
use AlibabaCloud\SDK\MPaaS\V20200710\Models\DeleteMdsWhitelistContentResponseBody\resultContent;

class DeleteMdsWhitelistContentResponseBody extends Model
{
    /**
     * @var string
     */
