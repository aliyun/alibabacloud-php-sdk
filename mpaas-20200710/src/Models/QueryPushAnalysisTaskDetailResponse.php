...
class QueryPushAnalysisTaskDetailResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryPushAnalysisTaskDetailResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryPushAnalysisTaskDetailResponseBody::fromMap($map['body']);
        }
