...
class QueryPushSchedulerListResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var QueryPushSchedulerListResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = QueryPushSchedulerListResponseBody::fromMap($map['body']);
        }
