...
class CreateMcubeNebulaResourceResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateMcubeNebulaResourceResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateMcubeNebulaResourceResponseBody::fromMap($map['body']);
        }
