...
use AlibabaCloud\SDK\MPaaS\V20200710\Models\QueryPushAnalysisTaskDetailResponseBody\resultContent;

class QueryPushAnalysisTaskDetailResponseBody extends Model
{
    /**
     * @var string
     */
