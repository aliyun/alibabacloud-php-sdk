...
use AlibabaCloud\SDK\MPaaS\V20200710\Models\QueryMcubeVhostResponseBody\queryVhostResult;
...
class QueryMcubeVhostResponseBody extends Model
{
    ...
    public function validate()
    {
        if (null !== $this->queryVhostResult) {
            $this->queryVhostResult->validate();
        }
        parent::validate();
    }
    ...
    public function toArray($noStream = false)
    {
        $res = [];
        if (null !== $this->queryVhostResult) {
            $res['QueryVhostResult'] = null !== $this->queryVhostResult ? $this->queryVhostResult->toArray($noStream) : $this->queryVhostResult;
        }
