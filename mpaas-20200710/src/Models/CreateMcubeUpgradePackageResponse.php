...
class CreateMcubeUpgradePackageResponse extends Model
{
    /**
     * @var string[]
     */
    ...
    /**
     * @var CreateMcubeUpgradePackageResponseBody
     */
    public $body;
    protected $_name = [
        'headers' => 'headers',
    ...
    public static function fromMap($map = [])
    {
        ...
        if (isset($map['body'])) {
            $model->body = CreateMcubeUpgradePackageResponseBody::fromMap($map['body']);
        }
