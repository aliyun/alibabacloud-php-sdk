...
use AlibabaCloud\SDK\Emr\V20160408\Models\DescribeSecurityGroupAttributeResponseBody\availableGroupList\securityGroup;
use AlibabaCloud\Tea\Model;

class availableGroupList extends Model
{
    /**
     * @var securityGroup[]
     */
