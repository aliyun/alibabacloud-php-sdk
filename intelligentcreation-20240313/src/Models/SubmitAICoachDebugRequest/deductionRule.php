...
class deductionRule extends Model
{
    ...
    {
        $res = [];
        if (null !== $this->deductionRuleId) {
            $res['deductionRuleId'] = $this->deductionRuleId;
        }
    ...
    {
        $model = new self();
        if (isset($map['deductionRuleId'])) {
            $model->deductionRuleId = $map['deductionRuleId'];
        }
